...
setuptools.setup(
    ...
    author="The sherpa-onnx development team, modified at Education First by György Szaszák",
    author_email="dpovey@gmail.com, gyorgy.szaszak@ef.com",
    package_dir={
        "ef_sherpa_onnx": "sherpa-onnx/python/sherpa_onnx",
    },
    packages=["ef_sherpa_onnx"],
