...
def gp_list():
    ...
    gp_s_list.append("ascript.android.screen.gp_tasks.Crop")
    gp_s_list.append("ascript.android.screen.gp_tasks.GrayImage")
    gp_s_list.append("ascript.android.screen.gp_tasks.Threshold")
    gp_s_list.append("ascript.android.screen.Eraser")
    gp_s_list.append("ascript.android.screen.gp_tasks.GaussianBlur")
    gp_s_list.append("ascript.android.screen.gp_tasks.Erode")
    gp_s_list.append("ascript.android.screen.gp_tasks.Dilate")
    gp_s_list.append("ascript.android.screen.gp_tasks.MorphOpen")
    gp_s_list.append("ascript.android.screen.gp_tasks.MorphClose")
    ...
    for gp_s in gp_s_list:
        ...
        dao = {"name": gp_class.name, "ui_path": gp_class.ui_path, "id": gp_s, "class_name": class_name, "type": 0}
    ...
    try:
        for gp_s in gp_module_list:
            ...
            module = gp_tool.load_or_reload_module(module_name)
            gp_class = getattr(module, class_name)
            dao = {"name": gp_class.name, "ui_path": gp_class.ui_path, "id": gp_s, "class_name": class_name, "type": 1}
            class_list.append(dao)
