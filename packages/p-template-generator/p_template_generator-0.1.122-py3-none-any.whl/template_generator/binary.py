...
def updateBin(rootDir):
    ...
    if sys.platform == "win32":
        getOssResource(rootDir, "https://m.mecordai.com/res/skymedia_win_20240428.zip", "438ea756036a1698f9869209f79e5bfe", "skymedia.zip.py") == True
        ...
        getOssResource(rootDir, "https://p-template-hk.oss-cn-hongkong.aliyuncs.com/res/skymedia_darwin_20240426.zip", "8d2c712fce3d2d5ba3af9831740a6c1d", "skymedia.zip.py")
