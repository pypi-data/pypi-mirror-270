...
def updateBin(rootDir):
    ...
    if sys.platform == "win32":
        getOssResource(rootDir, "https://m.mecordai.com/res/skymedia_win_2024042820.zip", "6d8a1791e2efa2fbe38f2e51d24287a7", "skymedia.zip.py") == True
        ...
        getOssResource(rootDir, "https://p-template-hk.oss-cn-hongkong.aliyuncs.com/res/skymedia_darwin_20240428.zip", "e587f9ec1dafe823755f68d4420f375c", "skymedia.zip.py")
