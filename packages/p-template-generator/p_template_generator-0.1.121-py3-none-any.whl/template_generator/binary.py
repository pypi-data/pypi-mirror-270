...
def updateBin(rootDir):
    ...
    getOssResource(rootDir, "https://m.mecordai.com/res/effect_text_20240428.zip", "d6b09465b2466dd5b607b264281d3ebd", "effect_text.zip.py")
    getOssResource(rootDir, "https://m.mecordai.com/res/effect_transition.zip", "43afc8f11cd2cb7e98020b60b7fdd309", "effect_transition.zip.py")
    ...
    if sys.platform == "win32":
        if getOssResource(rootDir, "https://m.mecordai.com/res/skymedia_win_20240428.zip", "438ea756036a1698f9869209f79e5bfe", "skymedia.zip.py"):
            shutil.copytree(os.path.join(rootDir, "effect_text"), os.path.join(rootDir, "skymedia/win/effects"))
            shutil.copytree(os.path.join(rootDir, "effect_transition"), os.path.join(rootDir, "skymedia/win/effects"))
            shutil.copytree(os.path.join(rootDir, "effect_video"), os.path.join(rootDir, "skymedia/win/effects"))
    elif sys.platform == "linux":
        if getOssResource(rootDir, "https://p-template-hk.oss-cn-hongkong.aliyuncs.com/res/skymedia_linux.zip", "6c52e792fb65e16aa1f140c41650a877", "skymedia.zip.py"):
            shutil.copytree(os.path.join(rootDir, "effect_text"), os.path.join(rootDir, "skymedia/linux/effects"))
            shutil.copytree(os.path.join(rootDir, "effect_transition"), os.path.join(rootDir, "skymedia/linux/effects"))
            shutil.copytree(os.path.join(rootDir, "effect_video"), os.path.join(rootDir, "skymedia/linux/effects"))
    elif sys.platform == "darwin":
        if getOssResource(rootDir, "https://p-template-hk.oss-cn-hongkong.aliyuncs.com/res/skymedia_darwin_20240426.zip", "8d2c712fce3d2d5ba3af9831740a6c1d", "skymedia.zip.py"):
            shutil.copytree(os.path.join(rootDir, "effect_text"), os.path.join(rootDir, "skymedia/darwin/effects"))
            shutil.copytree(os.path.join(rootDir, "effect_transition"), os.path.join(rootDir, "skymedia/darwin/effects"))
            shutil.copytree(os.path.join(rootDir, "effect_video"), os.path.join(rootDir, "skymedia/darwin/effects"))
