...
def updateBin(rootDir):
    ...
    if sys.platform == "win32":
        ...
        getOssResource(rootDir, "https://p-template-hk.oss-cn-hongkong.aliyuncs.com/res/skymedia_darwin_20240429.zip", "7f95cecba0e87e20ecef43388abd8713", "skymedia.zip.py")
