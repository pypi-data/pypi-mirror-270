...
def modify_run_configuration(settings: AzureAutoMLSettings,
    ...
    spacy_regex = r"spacy==3.4.4"

    # download english tokenizer model
    spacy_english_model_url = "https://aka.ms/automl-resources/packages/en_core_web_sm-3.4.1.tar.gz"
    ...
    if settings.enable_dnn:
        required_package_list.extend([
            ...
            _Package(spacy_pkg, spacy_regex, False, "==3.4.4"),
