...
from claroai.api_response import ApiResponse, T as ApiResponseT
import claroai.models
from claroai import rest
from claroai.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def param_serialize(
        ...
        # body
        if body:
            body = self.sanitize_for_serialization(body.to_dict())
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(claroai.models, klass)
