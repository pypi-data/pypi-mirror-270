...
class TestAppendixHotelSearchesGoogleBusinessDataPriceData(unittest.TestCase):
    """AppendixHotelSearchesGoogleBusinessDataPriceData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixHotelSearchesGoogleBusinessDataPriceData:
        """Test AppendixHotelSearchesGoogleBusinessDataPriceData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixHotelSearchesGoogleBusinessDataPriceData`
        """
        model = AppendixHotelSearchesGoogleBusinessDataPriceData()
        if include_optional:
            return AppendixHotelSearchesGoogleBusinessDataPriceData(
    ...
    def testAppendixHotelSearchesGoogleBusinessDataPriceData(self):
        """Test AppendixHotelSearchesGoogleBusinessDataPriceData"""
