...
class TestAppendixLighthouseOnPagePriceData(unittest.TestCase):
    """AppendixLighthouseOnPagePriceData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppendixLighthouseOnPagePriceData:
        """Test AppendixLighthouseOnPagePriceData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppendixLighthouseOnPagePriceData`
        """
        model = AppendixLighthouseOnPagePriceData()
        if include_optional:
            return AppendixLighthouseOnPagePriceData(
    ...
    def testAppendixLighthouseOnPagePriceData(self):
        """Test AppendixLighthouseOnPagePriceData"""
