...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.tolerances import _1928, _1931, _1937
...
class InterferenceDetail(_1918.BearingConnectionComponent):
    """InterferenceDetail
    ...
    @property
    def material(self: Self) -> "_276.Material":
