...
if TYPE_CHECKING:
    from mastapy.bearings.tolerances import _1938, _1933, _1918
...
class SupportDetail(_1925.InterferenceDetail):
    """SupportDetail
    ...
    class _Cast_SupportDetail:
        ...
        def bearing_connection_component(
            ...
            return self._parent._cast(_1918.BearingConnectionComponent)
    ...
    @property
    def material_source(self: Self) -> "_1938.SupportMaterialSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1938", "SupportMaterialSource"
        )(value)
    ...
    @property
    def radial_specification_method(self: Self) -> "_1933.RadialSpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1933", "RadialSpecificationMethod"
        )(value)

    @radial_specification_method.setter
    @enforce_parameter_types
    def radial_specification_method(
        self: Self, value: "_1933.RadialSpecificationMethod"
    ):
