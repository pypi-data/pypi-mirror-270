...
from mastapy.bearings.tolerances import _1927, _1940, _1926
...
if TYPE_CHECKING:
    from mastapy.bearings.tolerances import _1924, _1930, _1918
...
class SupportTolerance(_1926.InterferenceTolerance):
    """SupportTolerance
    ...
    def tolerance_band_designation(self: Self, value: "_1927.ITDesignation"):
    ...
    @enforce_parameter_types
    def tolerance_deviation_class(
        self: Self, value: "_1940.SupportToleranceLocationDesignation"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
