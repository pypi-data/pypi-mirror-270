...
if TYPE_CHECKING:
    from mastapy.bearings.roller_bearing_profiles import _1944, _1946, _1957
...
class RollerBearingUserSpecifiedProfile(_1953.RollerBearingProfile):
    """RollerBearingUserSpecifiedProfile
    ...
    @property
    def data_to_use(self: Self) -> "_1944.ProfileDataToUse":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.roller_bearing_profiles._1944", "ProfileDataToUse"
        )(value)

    @data_to_use.setter
    @enforce_parameter_types
    def data_to_use(self: Self, value: "_1944.ProfileDataToUse"):
    ...
    @property
    def profile_to_fit(self: Self) -> "_1946.ProfileToFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.roller_bearing_profiles._1946", "ProfileToFit"
        )(value)

    @profile_to_fit.setter
    @enforce_parameter_types
    def profile_to_fit(self: Self, value: "_1946.ProfileToFit"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def points(self: Self) -> "List[_1957.UserSpecifiedProfilePoint]":
