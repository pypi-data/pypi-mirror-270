...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_designs.rolling import _2178, _2180, _2183
...
class CylindricalRollerBearing(_2179.NonBarrelRollerBearing):
    """CylindricalRollerBearing
    ...
    @enforce_parameter_types
    def permissible_axial_load_default_calculation_method(
        self: Self, value: "_1960.CylindricalRollerMaxAxialLoadMethod"
    ):
