...
class ThrustBallBearing(_2158.BallBearing):
    """ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self: Self) -> "_1906.OuterRingMounting":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1906", "OuterRingMounting"
        )(value)

    @outer_ring_mounting.setter
    @enforce_parameter_types
    def outer_ring_mounting(self: Self, value: "_1906.OuterRingMounting"):
