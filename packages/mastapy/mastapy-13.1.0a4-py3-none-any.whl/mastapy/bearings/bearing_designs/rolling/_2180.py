...
if TYPE_CHECKING:
    from mastapy.bearings.roller_bearing_profiles import _1945, _1956
...
class RollerBearing(_2183.RollingBearing):
    """RollerBearing
    ...
    @enforce_parameter_types
    def roller_profile(self: Self, value: "_1908.RollerBearingProfileTypes"):
    ...
    @property
    def inner_race_profile_set(self: Self) -> "_1945.ProfileSet":
    ...
    @property
    def outer_race_profile_set(self: Self) -> "_1945.ProfileSet":
        """mastapy.bearings.roller_bearing_profiles.ProfileSet
    ...
    @property
    def roller_profile_set(self: Self) -> "_1945.ProfileSet":
        """mastapy.bearings.roller_bearing_profiles.ProfileSet
    ...
    def inner_race_and_roller_profiles(
        self: Self,
    ) -> "List[_1956.RollerRaceProfilePoint]":
