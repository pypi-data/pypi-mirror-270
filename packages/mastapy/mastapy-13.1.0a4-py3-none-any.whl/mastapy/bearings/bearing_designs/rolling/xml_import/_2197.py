...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.rolling.xml_import import _2195, _2194
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self: Self) -> "List[_2195.BearingImportFile]":
    ...
    @property
    def variables(self: Self) -> "List[_2194.AbstractXmlVariableAssignment]":
