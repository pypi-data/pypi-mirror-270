...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.fluid_film import _2212, _2213
...
class PadFluidFilmBearing(_2149.DetailedBearing):
    """PadFluidFilmBearing
    ...
    @enforce_parameter_types
    def rotational_direction(self: Self, value: "_1914.RotationalDirections"):
