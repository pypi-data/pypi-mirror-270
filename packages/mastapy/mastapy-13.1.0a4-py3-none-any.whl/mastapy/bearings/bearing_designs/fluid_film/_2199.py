...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.fluid_film import _2200, _2201
...
class AxialFeedJournalBearing(_0.APIBase):
    ...
    class _Cast_AxialFeedJournalBearing:
        ...
        def axial_groove_journal_bearing(
            ...
            return self._parent._cast(_2200.AxialGrooveJournalBearing)
        ...
        def axial_hole_journal_bearing(
            ...
            return self._parent._cast(_2201.AxialHoleJournalBearing)
