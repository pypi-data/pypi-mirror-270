...
class SKFModuleResults(_0.APIBase):
    ...
    @property
    def adjusted_speed(self: Self) -> "_2094.AdjustedSpeed":
    ...
    @property
    def bearing_loads(self: Self) -> "_2096.BearingLoads":
    ...
    @property
    def bearing_rating_life(self: Self) -> "_2097.BearingRatingLife":
    ...
    @property
    def frequencies(self: Self) -> "_2099.Frequencies":
    ...
    @property
    def friction(self: Self) -> "_2101.Friction":
    ...
    @property
    def minimum_load(self: Self) -> "_2109.MinimumLoad":
    ...
    @property
    def static_safety_factors(self: Self) -> "_2117.StaticSafetyFactors":
    ...
    @property
    def viscosities(self: Self) -> "_2118.Viscosities":
