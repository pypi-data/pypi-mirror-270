...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2075, _2052
...
class LoadedToroidalRollerBearingRow(_2048.LoadedRollerBearingRow):
    """LoadedToroidalRollerBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2075.LoadedToroidalRollerBearingResults":
