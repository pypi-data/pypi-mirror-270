...
class MaximumStaticContactStress(_2080.MaximumStaticContactStressResultsAbstract):
    """MaximumStaticContactStress
    ...
    class _Cast_MaximumStaticContactStress:
        ...
        def maximum_static_contact_stress_results_abstract(
            ...
            return self._parent._cast(_2080.MaximumStaticContactStressResultsAbstract)
