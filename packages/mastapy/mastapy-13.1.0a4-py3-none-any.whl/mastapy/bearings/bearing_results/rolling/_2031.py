...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2030, _2052
...
class LoadedDeepGrooveBallBearingRow(_2021.LoadedBallBearingRow):
    """LoadedDeepGrooveBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2030.LoadedDeepGrooveBallBearingResults":
