...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2078, _2079
...
class MaximumStaticContactStressResultsAbstract(_0.APIBase):
    ...
    class _Cast_MaximumStaticContactStressResultsAbstract:
        ...
        def maximum_static_contact_stress(
            ...
            return self._parent._cast(_2078.MaximumStaticContactStress)
        ...
        def maximum_static_contact_stress_duty_cycle(
            ...
            return self._parent._cast(_2079.MaximumStaticContactStressDutyCycle)
