...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.fitting import _2129, _2128, _2130
...
class RingFittingThermalResults(_0.APIBase):
    ...
    class _Cast_RingFittingThermalResults:
        ...
        def inner_ring_fitting_thermal_results(
            ...
            from mastapy.bearings.bearing_results.rolling.fitting import _2128

            return self._parent._cast(_2128.InnerRingFittingThermalResults)
        ...
        def outer_ring_fitting_thermal_results(
            ...
            return self._parent._cast(_2130.OuterRingFittingThermalResults)
    ...
    @property
    def interference_values(self: Self) -> "List[_2129.InterferenceComponents]":
