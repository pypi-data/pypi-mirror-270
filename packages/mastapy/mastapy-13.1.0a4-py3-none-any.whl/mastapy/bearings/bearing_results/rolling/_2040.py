...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2039, _2043, _2048, _2052
...
class LoadedNeedleRollerBearingRow(_2028.LoadedCylindricalRollerBearingRow):
    """LoadedNeedleRollerBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2039.LoadedNeedleRollerBearingResults":
