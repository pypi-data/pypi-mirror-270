...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2069, _2052
...
class LoadedThreePointContactBallBearingRow(_2021.LoadedBallBearingRow):
    """LoadedThreePointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2069.LoadedThreePointContactBallBearingResults":
