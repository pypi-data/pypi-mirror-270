...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2045, _2046, _2032
...
class LoadedNeedleRollerBearingElement(_2026.LoadedCylindricalRollerBearingElement):
    """LoadedNeedleRollerBearingElement
