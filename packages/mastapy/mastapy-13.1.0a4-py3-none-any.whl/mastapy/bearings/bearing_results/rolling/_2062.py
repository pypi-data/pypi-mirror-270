...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2061, _2052
...
class LoadedSphericalRollerThrustBearingRow(_2048.LoadedRollerBearingRow):
    """LoadedSphericalRollerThrustBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2061.LoadedSphericalRollerThrustBearingResults":
