...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2083
    from mastapy.math_utility.measured_data import _1579, _1580
...
class ISO14179Settings(_1844.NamedDatabaseItem):
    """ISO14179Settings
    ...
    def isotr141792001f1_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_results.rolling._2083",
    ...
    def isotr141792001f1_specification_method(
        self: Self, value: "_2083.PowerRatingF1EstimationMethod"
    ):
