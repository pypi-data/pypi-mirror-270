...
class LoadedFourPointContactBallBearingRaceResults(_2019.LoadedBallBearingRaceResults):
    """LoadedFourPointContactBallBearingRaceResults
    ...
    class _Cast_LoadedFourPointContactBallBearingRaceResults:
        ...
        def loaded_ball_bearing_race_results(
            ...
            return self._parent._cast(_2019.LoadedBallBearingRaceResults)
        ...
        def loaded_rolling_bearing_race_results(
            ...
            return self._parent._cast(_2050.LoadedRollingBearingRaceResults)
