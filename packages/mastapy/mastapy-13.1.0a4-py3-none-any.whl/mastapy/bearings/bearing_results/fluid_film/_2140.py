...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.fluid_film import _2141, _2138, _2142
...
class LoadedPlainJournalBearingResults(_2137.LoadedFluidFilmBearingResults):
    """LoadedPlainJournalBearingResults
    ...
    @property
    def journal_bearing_rows(self: Self) -> "List[_2141.LoadedPlainJournalBearingRow]":
