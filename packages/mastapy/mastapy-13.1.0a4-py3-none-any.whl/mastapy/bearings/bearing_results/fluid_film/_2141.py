...
class LoadedPlainJournalBearingRow(_0.APIBase):
    ...
    class _Cast_LoadedPlainJournalBearingRow:
        ...
        def loaded_plain_oil_fed_journal_bearing_row(
            ...
            return self._parent._cast(_2143.LoadedPlainOilFedJournalBearingRow)
    ...
    @property
    def row(self: Self) -> "_1895.BearingRow":
        ...
        return constructor.new_from_mastapy("mastapy.bearings._1895", "BearingRow")(
            value
        )
