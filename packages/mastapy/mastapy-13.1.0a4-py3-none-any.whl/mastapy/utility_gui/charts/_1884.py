...
if TYPE_CHECKING:
    from mastapy.utility_gui.charts import _1870, _1880, _1869, _1874, _1877, _1879
...
class TwoDChartDefinition(_1876.NDChartDefinition):
    """TwoDChartDefinition
    ...
    @property
    def const_lines(self: Self) -> "List[_1870.ConstantLine]":
    ...
    @property
    def series_list(self: Self) -> "List[_1880.Series2D]":
