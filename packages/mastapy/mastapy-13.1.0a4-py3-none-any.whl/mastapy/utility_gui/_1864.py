...
class ColumnInputOptions(_0.APIBase):
    ...
    class _Cast_ColumnInputOptions:
        ...
        def boost_pressure_input_options(
            ...
            return self._parent._cast(_2573.BoostPressureInputOptions)
        ...
        def input_power_input_options(
            ...
            return self._parent._cast(_2574.InputPowerInputOptions)
        ...
        def pressure_ratio_input_options(
            ...
            return self._parent._cast(_2575.PressureRatioInputOptions)
        ...
        def rotor_speed_input_options(
            ...
            return self._parent._cast(_2578.RotorSpeedInputOptions)
        ...
        def boost_pressure_load_case_input_options(
            ...
            return self._parent._cast(_7016.BoostPressureLoadCaseInputOptions)
        ...
        def design_state_options(
            ...
            return self._parent._cast(_7017.DesignStateOptions)
        ...
        def force_input_options(
            ...
            return self._parent._cast(_7019.ForceInputOptions)
        ...
        def gear_ratio_input_options(
            ...
            return self._parent._cast(_7020.GearRatioInputOptions)
        ...
        def load_case_name_options(
            ...
            return self._parent._cast(_7021.LoadCaseNameOptions)
        ...
        def moment_input_options(
            ...
            return self._parent._cast(_7022.MomentInputOptions)
        ...
        def point_load_input_options(
            ...
            return self._parent._cast(_7024.PointLoadInputOptions)
        ...
        def power_load_input_options(
            ...
            return self._parent._cast(_7025.PowerLoadInputOptions)
        ...
        def ramp_or_steady_state_input_options(
            ...
            return self._parent._cast(_7026.RampOrSteadyStateInputOptions)
        ...
        def speed_input_options(
            ...
            return self._parent._cast(_7027.SpeedInputOptions)
        ...
        def time_step_input_options(
            ...
            return self._parent._cast(_7029.TimeStepInputOptions)
        ...
        def torque_input_options(
            ...
            return self._parent._cast(_7030.TorqueInputOptions)
    ...
    def column(self: Self, value: "_1832.ColumnTitle"):
        wrapper_type = (
    ...
    @unit.setter
    @enforce_parameter_types
    def unit(self: Self, value: "_1623.Unit"):
