...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1285, _1324
...
class CADToothAndSlot(_1254.AbstractToothAndSlot):
    """CADToothAndSlot
    ...
    def individual_conductor_specification_source(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1285", "IndividualConductorSpecificationSource"
        )(value)

    @individual_conductor_specification_source.setter
    @enforce_parameter_types
    def individual_conductor_specification_source(
        self: Self, value: "_1285.IndividualConductorSpecificationSource"
    ):
