...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1307, _1260, _1286, _1302, _1316
...
class Rotor(_0.APIBase):
    ...
    class _Cast_Rotor:
        ...
        @property
        def cad_rotor(self: "Rotor._Cast_Rotor") -> "_1260.CADRotor":
            from mastapy.electric_machines import _1260

            return self._parent._cast(_1260.CADRotor)
    ...
    def d_axis_and_q_axis_convention(
        self: Self,
        value: "Union[_1270.DQAxisConvention, Tuple[_1270.DQAxisConvention, bool]]",
    ):
    ...
    @property
    def skew_slices(self: Self) -> "List[_1307.RotorSkewSlice]":
