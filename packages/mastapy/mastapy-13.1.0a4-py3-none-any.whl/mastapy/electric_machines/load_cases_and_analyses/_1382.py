...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.load_cases_and_analyses import _1370, _1383, _1368
...
class SingleOperatingPointAnalysis(_1364.ElectricMachineAnalysis):
    """SingleOperatingPointAnalysis
    ...
    @property
    def load_case(self: Self) -> "_1370.ElectricMachineLoadCase":
    ...
    def slot_section_details_for_analysis(
        self: Self,
    ) -> "List[_1383.SlotDetailForAnalysis]":
