...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1272, _1277
...
class ElectricMachineAnalysis(_0.APIBase):
    ...
    class _Cast_ElectricMachineAnalysis:
        ...
        def dynamic_force_analysis(
            ...
            return self._parent._cast(_1359.DynamicForceAnalysis)
        ...
        def efficiency_map_analysis(
            ...
            return self._parent._cast(_1362.EfficiencyMapAnalysis)
        ...
        def electric_machine_fe_analysis(
            ...
            return self._parent._cast(_1368.ElectricMachineFEAnalysis)
        ...
        def electric_machine_fe_mechanical_analysis(
            ...
            return self._parent._cast(_1369.ElectricMachineFEMechanicalAnalysis)
        ...
        def speed_torque_curve_analysis(
            ...
            from mastapy.electric_machines.load_cases_and_analyses import _1386

            return self._parent._cast(_1386.SpeedTorqueCurveAnalysis)
    ...
    @property
    def load_case(self: Self) -> "_1371.ElectricMachineLoadCaseBase":
    ...
    @property
    def setup(self: Self) -> "_1277.ElectricMachineSetup":
    ...
    def perform_analysis_with_progress(self: Self, token: "_7585.TaskProgress"):
        """Method does not return.
