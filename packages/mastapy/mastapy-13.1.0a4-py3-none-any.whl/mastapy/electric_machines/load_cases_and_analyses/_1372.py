...
class ElectricMachineLoadCaseGroup(_0.APIBase):
    ...
    @property
    def dynamic_forces_load_cases(self: Self) -> "List[_1360.DynamicForceLoadCase]":
    ...
    def dynamic_forces_load_cases_without_non_linear_dq_model(
        self: Self,
    ) -> "List[_1358.BasicDynamicForceLoadCase]":
    ...
    @property
    def efficiency_map_load_cases(self: Self) -> "List[_1363.EfficiencyMapLoadCase]":
    ...
    def single_operating_point_load_cases_with_non_linear_dq_model(
        self: Self,
    ) -> "List[_1388.SpeedTorqueLoadCase]":
    ...
    def single_operating_point_load_cases_without_non_linear_dq_model(
        self: Self,
    ) -> "List[_1370.ElectricMachineLoadCase]":
    ...
    def speed_torque_curve_load_cases(
        self: Self,
    ) -> "List[_1387.SpeedTorqueCurveLoadCase]":
    ...
    @enforce_parameter_types
    def add_load_case(
        self: Self, load_case_type: "_1376.LoadCaseType"
    ...
    def add_load_case_named(
        self: Self, load_case_type: "_1376.LoadCaseType", name: "str"
    ) -> "_1371.ElectricMachineLoadCaseBase":
        """mastapy.electric_machines.load_cases_and_analyses.ElectricMachineLoadCaseBase
    ...
    def perform_compound_analysis(
        self: Self,
        setup: "_1277.ElectricMachineSetup",
        load_case_type: "_1376.LoadCaseType",
    ) -> "_1603.MethodOutcome":
    ...
    def perform_compound_analysis_with_progress(
        ...
        setup: "_1277.ElectricMachineSetup",
        load_case_type: "_1376.LoadCaseType",
        task_progress: "_7585.TaskProgress",
    ) -> "_1603.MethodOutcome":
        """mastapy.utility.MethodOutcome
    ...
    def try_remove_load_case(
        self: Self, load_case: "_1371.ElectricMachineLoadCaseBase"
    ) -> "bool":
        """bool
