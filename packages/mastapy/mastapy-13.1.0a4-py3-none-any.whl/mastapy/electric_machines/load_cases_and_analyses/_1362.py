...
class EfficiencyMapAnalysis(_1364.ElectricMachineAnalysis):
    """EfficiencyMapAnalysis
    ...
    @property
    def efficiency_map_results(self: Self) -> "_1334.EfficiencyResults":
    ...
    @property
    def load_case(self: Self) -> "_1363.EfficiencyMapLoadCase":
