...
from mastapy.electric_machines.load_cases_and_analyses import _1384, _1358
...
class DynamicForceLoadCase(_1358.BasicDynamicForceLoadCase):
    """DynamicForceLoadCase
    ...
    class _Cast_DynamicForceLoadCase:
        ...
        def electric_machine_load_case_base(
            ...
            return self._parent._cast(_1371.ElectricMachineLoadCaseBase)
    ...
    @property
    def control_strategy(self: Self) -> "_1366.ElectricMachineControlStrategy":
    ...
    def control_strategy(self: Self, value: "_1366.ElectricMachineControlStrategy"):
    ...
    @enforce_parameter_types
    def load_specification(self: Self, value: "_1384.SpecifyTorqueOrCurrent"):
    ...
    @enforce_parameter_types
    def operating_points_specification_method(
        self: Self, value: "_1381.OperatingPointsSpecificationMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.OperatingPointsSpecificationMethod",
    ...
    @property
    def speed_points_distribution(self: Self) -> "_1385.SpeedPointsDistribution":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines.load_cases_and_analyses._1385",
            "SpeedPointsDistribution",
        )(value)

    @speed_points_distribution.setter
    @enforce_parameter_types
    def speed_points_distribution(self: Self, value: "_1385.SpeedPointsDistribution"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.SpeedPointsDistribution",
        )
