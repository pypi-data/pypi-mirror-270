...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1358, _1368
...
class DynamicForceAnalysis(
    _1364.ElectricMachineAnalysis, _1351.IHaveDynamicForceResults
):
    """DynamicForceAnalysis
    ...
    @property
    def load_case(self: Self) -> "_1358.BasicDynamicForceLoadCase":
    ...
    @property
    def results(self: Self) -> "_1333.DynamicForceResults":
    ...
    def single_operating_point_analyses(
        self: Self,
    ) -> "List[_1368.ElectricMachineFEAnalysis]":
