...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1321, _1271
...
class ElectricMachineSetup(_0.APIBase):
    ...
    def two_d_fe_model_for_electromagnetic_analysis(
        self: Self,
    ) -> "_1321.TwoDimensionalFEModelForAnalysis[_1275.ElectricMachineMeshingOptions]":
    ...
    @property
    def eccentricity(self: Self) -> "_1271.Eccentricity":
    ...
    def generate_electromagnetic_mesh(self: Self):
