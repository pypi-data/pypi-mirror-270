...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1354, _1355
...
class ElectricMachineDetail(_0.APIBase):
    ...
    class _Cast_ElectricMachineDetail:
        ...
        def cad_electric_machine_detail(
            ...
            return self._parent._cast(_1257.CADElectricMachineDetail)
        ...
        def non_cad_electric_machine_detail(
            ...
            return self._parent._cast(_1298.NonCADElectricMachineDetail)
    ...
    def core_loss_build_factor_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1267", "CoreLossBuildFactorSpecificationMethod"
        )(value)

    @core_loss_build_factor_specification_method.setter
    @enforce_parameter_types
    def core_loss_build_factor_specification_method(
        self: Self, value: "_1267.CoreLossBuildFactorSpecificationMethod"
    ):
    ...
    @property
    def electric_machine_type(self: Self) -> "_1278.ElectricMachineType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1278", "ElectricMachineType"
        )(value)
    ...
    @select_setup.setter
    @enforce_parameter_types
    def select_setup(self: Self, value: "_1277.ElectricMachineSetup"):
        wrapper_type = (
    ...
    @property
    def non_linear_dq_model(self: Self) -> "_1354.NonLinearDQModel":
    ...
    @property
    def rotor(self: Self) -> "_1305.Rotor":
    ...
    @property
    def selected_setup(self: Self) -> "_1277.ElectricMachineSetup":
    ...
    @property
    def stator(self: Self) -> "_1253.AbstractStator":
    ...
    @property
    def results_locations(self: Self) -> "List[_1534.Named2DLocation]":
    ...
    @property
    def setups(self: Self) -> "List[_1277.ElectricMachineSetup]":
    ...
    def add_setup(self: Self) -> "_1277.ElectricMachineSetup":
        """mastapy.electric_machines.ElectricMachineSetup"""
    ...
    @enforce_parameter_types
    def duplicate_setup(
        self: Self, setup: "_1277.ElectricMachineSetup"
    ...
    def generate_design_without_non_linear_dq_model(
        self: Self,
    ) -> "_1604.MethodOutcomeWithResult[ElectricMachineDetail]":
    ...
    @enforce_parameter_types
    def remove_setup(self: Self, setup: "_1277.ElectricMachineSetup"):
        """Method does not return.
    ...
    @enforce_parameter_types
    def setup_named(self: Self, name: "str") -> "_1277.ElectricMachineSetup":
        """mastapy.electric_machines.ElectricMachineSetup
