...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1378, _1375
...
class OnLoadElectricMachineResults(_1338.ElectricMachineResults):
    """OnLoadElectricMachineResults
    ...
    class _Cast_OnLoadElectricMachineResults:
        ...
        def electric_machine_results(
            ...
            return self._parent._cast(_1338.ElectricMachineResults)
    ...
    @property
    def motoring_or_generating(self: Self) -> "_1378.MotoringOrGenerating":
    ...
    @property
    def power_factor_direction(self: Self) -> "_1375.LeadingOrLagging":
    ...
    @property
    def windings(self: Self) -> "_1328.Windings":
