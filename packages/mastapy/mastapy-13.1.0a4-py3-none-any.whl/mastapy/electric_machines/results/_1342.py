...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1356, _1357
...
class ElectricMachineResultsForOpenCircuitAndOnLoad(_0.APIBase):
    ...
    @property
    def linear_dq_model_chart(self: Self) -> "_1884.TwoDChartDefinition":
    ...
    @property
    def on_load_results(self: Self) -> "_1356.OnLoadElectricMachineResults":
    ...
    @property
    def open_circuit_results(self: Self) -> "_1357.OpenCircuitElectricMachineResults":
    ...
    @property
    def all_on_load_results(self: Self) -> "List[_1356.OnLoadElectricMachineResults]":
    ...
    def all_open_circuit_results(
        self: Self,
    ) -> "List[_1357.OpenCircuitElectricMachineResults]":
    ...
    def on_load_results_for_slices(
        self: Self,
    ) -> "List[_1356.OnLoadElectricMachineResults]":
        """List[mastapy.electric_machines.results.OnLoadElectricMachineResults]
