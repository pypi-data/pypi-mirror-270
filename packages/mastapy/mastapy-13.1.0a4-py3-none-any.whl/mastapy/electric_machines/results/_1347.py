...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1345, _1348, _1346, _1344
...
class ElectricMachineResultsTimeStep(_0.APIBase):
    ...
    @property
    def flux_density_in_air_gap_chart(self: Self) -> "_1884.TwoDChartDefinition":
    ...
    @property
    def force_density_in_air_gap_mst_chart(self: Self) -> "_1884.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    def results_for_stator_teeth(
        self: Self,
    ) -> "List[_1345.ElectricMachineResultsForStatorToothAtTimeStep]":
    ...
    def results_at_locations(
        self: Self,
    ) -> "List[_1348.ElectricMachineResultsTimeStepAtLocation]":
    ...
    def results_for_line_to_line(
        self: Self,
    ) -> "List[_1346.ElectricMachineResultsLineToLineAtTimeStep]":
    ...
    def results_for_phases(
        self: Self,
    ) -> "List[_1344.ElectricMachineResultsForPhaseAtTimeStep]":
