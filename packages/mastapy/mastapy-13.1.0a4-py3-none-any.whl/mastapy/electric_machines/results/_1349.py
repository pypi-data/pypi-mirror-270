...
from mastapy.electric_machines import _1307, _1304
...
class ElectricMachineResultsViewable(_179.ElmerResultsViewable):
    """ElectricMachineResultsViewable
    ...
    class _Cast_ElectricMachineResultsViewable:
        ...
        def elmer_results_viewable(
            ...
            return self._parent._cast(_179.ElmerResultsViewable)
    ...
    @property
    def force_view_options(self: Self) -> "_1350.ElectricMachineForceViewOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines.results._1350", "ElectricMachineForceViewOptions"
        )(value)

    @force_view_options.setter
    @enforce_parameter_types
    def force_view_options(self: Self, value: "_1350.ElectricMachineForceViewOptions"):
    ...
    @results.setter
    @enforce_parameter_types
    def results(self: Self, value: "_1338.ElectricMachineResults"):
        wrapper_type = (
    ...
    @property
    def parts_to_view(self: Self) -> "List[_1860.EnumWithBoolean[_1304.RegionID]]":
