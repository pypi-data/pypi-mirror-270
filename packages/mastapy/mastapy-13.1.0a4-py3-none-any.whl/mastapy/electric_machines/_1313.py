...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1288, _1268
...
class StatorRotorMaterial(_276.Material):
    """StatorRotorMaterial
    ...
    def coefficient_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1288", "IronLossCoefficientSpecificationMethod"
        )(value)

    @coefficient_specification_method.setter
    @enforce_parameter_types
    def coefficient_specification_method(
        self: Self, value: "_1288.IronLossCoefficientSpecificationMethod"
    ):
    ...
    @property
    def loss_curves(self: Self) -> "_1884.TwoDChartDefinition":
    ...
    @property
    def bh_curve_specification(self: Self) -> "_255.BHCurveSpecification":
    ...
    @property
    def core_loss_coefficients(self: Self) -> "_1268.CoreLossCoefficients":
