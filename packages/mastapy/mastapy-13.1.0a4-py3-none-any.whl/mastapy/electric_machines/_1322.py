...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1280, _1289, _1290, _1293
...
class UShapedLayerSpecification(_1306.RotorInternalLayerSpecification):
    """UShapedLayerSpecification
    ...
    class _Cast_UShapedLayerSpecification:
        ...
        def rotor_internal_layer_specification(
            ...
            return self._parent._cast(_1306.RotorInternalLayerSpecification)
    ...
    @property
    def flux_barrier_configuration(self: Self) -> "_1280.FluxBarriers":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1280", "FluxBarriers"
        )(value)

    @flux_barrier_configuration.setter
    @enforce_parameter_types
    def flux_barrier_configuration(self: Self, value: "_1280.FluxBarriers"):
    ...
    @property
    def inner_magnet_clearance(self: Self) -> "_1289.MagnetClearance":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1289", "MagnetClearance"
        )(value)

    @inner_magnet_clearance.setter
    @enforce_parameter_types
    def inner_magnet_clearance(self: Self, value: "_1289.MagnetClearance"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def magnet_configuration(self: Self) -> "_1290.MagnetConfiguration":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1290", "MagnetConfiguration"
        )(value)

    @magnet_configuration.setter
    @enforce_parameter_types
    def magnet_configuration(self: Self, value: "_1290.MagnetConfiguration"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def outer_magnet_lower_clearance(self: Self) -> "_1289.MagnetClearance":
        """mastapy.electric_machines.MagnetClearance"""
    ...
    @enforce_parameter_types
    def outer_magnet_lower_clearance(self: Self, value: "_1289.MagnetClearance"):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.ElectricMachines.MagnetClearance"
        )
    ...
    @property
    def outer_magnets(self: Self) -> "_1293.MagnetForLayer":
