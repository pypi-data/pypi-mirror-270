...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines import _1260, _1261
...
class CADElectricMachineDetail(_1272.ElectricMachineDetail):
    """CADElectricMachineDetail
    ...
    @property
    def rotor(self: Self) -> "_1260.CADRotor":
    ...
    @property
    def stator(self: Self) -> "_1261.CADStator":
