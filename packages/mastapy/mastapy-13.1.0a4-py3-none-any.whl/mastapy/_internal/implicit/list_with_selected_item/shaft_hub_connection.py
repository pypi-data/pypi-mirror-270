...
class ListWithSelectedItem_ShaftHubConnection(
    _2618.ShaftHubConnection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2618.ShaftHubConnection.TYPE":
        ...
        return _2618.ShaftHubConnection.TYPE

    @property
    def selected_value(self: Self) -> "_2618.ShaftHubConnection":
    ...
    @property
    def available_values(self: Self) -> "List[_2618.ShaftHubConnection]":
