...
class ListWithSelectedItem_CylindricalGearMeshLoadDistributionAnalysis(
    _864.CylindricalGearMeshLoadDistributionAnalysis, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_864.CylindricalGearMeshLoadDistributionAnalysis.TYPE":
        ...
        return _864.CylindricalGearMeshLoadDistributionAnalysis.TYPE
