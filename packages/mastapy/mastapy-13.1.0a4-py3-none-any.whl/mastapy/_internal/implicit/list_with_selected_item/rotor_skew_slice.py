...
class ListWithSelectedItem_RotorSkewSlice(
    _1307.RotorSkewSlice, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1307.RotorSkewSlice.TYPE":
        ...
        return _1307.RotorSkewSlice.TYPE

    @property
    def selected_value(self: Self) -> "_1307.RotorSkewSlice":
    ...
    @property
    def available_values(self: Self) -> "List[_1307.RotorSkewSlice]":
