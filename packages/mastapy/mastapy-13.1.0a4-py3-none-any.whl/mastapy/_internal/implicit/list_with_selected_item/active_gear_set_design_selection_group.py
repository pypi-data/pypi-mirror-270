...
class ListWithSelectedItem_ActiveGearSetDesignSelectionGroup(
    _2530.ActiveGearSetDesignSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2530.ActiveGearSetDesignSelectionGroup.TYPE":
        ...
        return _2530.ActiveGearSetDesignSelectionGroup.TYPE

    @property
    def selected_value(self: Self) -> "_2530.ActiveGearSetDesignSelectionGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_2530.ActiveGearSetDesignSelectionGroup]":
