...
class ListWithSelectedItem_Datum(_2466.Datum, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2466.Datum.TYPE":
        ...
        return _2466.Datum.TYPE

    @property
    def selected_value(self: Self) -> "_2466.Datum":
    ...
    @property
    def available_values(self: Self) -> "List[_2466.Datum]":
