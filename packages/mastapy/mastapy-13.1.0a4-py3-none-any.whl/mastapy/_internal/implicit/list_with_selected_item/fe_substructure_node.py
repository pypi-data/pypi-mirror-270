...
class ListWithSelectedItem_FESubstructureNode(
    _2403.FESubstructureNode, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2403.FESubstructureNode.TYPE":
        ...
        return _2403.FESubstructureNode.TYPE

    @property
    def selected_value(self: Self) -> "_2403.FESubstructureNode":
    ...
    @property
    def available_values(self: Self) -> "List[_2403.FESubstructureNode]":
