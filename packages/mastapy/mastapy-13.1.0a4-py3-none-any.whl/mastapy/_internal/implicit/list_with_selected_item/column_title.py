...
class ListWithSelectedItem_ColumnTitle(
    _1832.ColumnTitle, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1832.ColumnTitle.TYPE":
        ...
        return _1832.ColumnTitle.TYPE

    @property
    def selected_value(self: Self) -> "_1832.ColumnTitle":
    ...
    @property
    def available_values(self: Self) -> "List[_1832.ColumnTitle]":
