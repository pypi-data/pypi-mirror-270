...
class ListWithSelectedItem_ElectricMachineResults(
    _1338.ElectricMachineResults, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1338.ElectricMachineResults.TYPE":
        ...
        return _1338.ElectricMachineResults.TYPE

    @property
    def selected_value(self: Self) -> "_1338.ElectricMachineResults":
    ...
    @property
    def available_values(self: Self) -> "List[_1338.ElectricMachineResults]":
