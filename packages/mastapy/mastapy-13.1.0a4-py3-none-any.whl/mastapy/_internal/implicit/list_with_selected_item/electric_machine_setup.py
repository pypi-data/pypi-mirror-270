...
class ListWithSelectedItem_ElectricMachineSetup(
    _1277.ElectricMachineSetup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1277.ElectricMachineSetup.TYPE":
        ...
        return _1277.ElectricMachineSetup.TYPE

    @property
    def selected_value(self: Self) -> "_1277.ElectricMachineSetup":
    ...
    @property
    def available_values(self: Self) -> "List[_1277.ElectricMachineSetup]":
