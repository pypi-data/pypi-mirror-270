...
class ListWithSelectedItem_CylindricalGearSet(
    _2544.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2544.CylindricalGearSet.TYPE":
        ...
        return _2544.CylindricalGearSet.TYPE

    @property
    def selected_value(self: Self) -> "_2544.CylindricalGearSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2544.CylindricalGearSet]":
