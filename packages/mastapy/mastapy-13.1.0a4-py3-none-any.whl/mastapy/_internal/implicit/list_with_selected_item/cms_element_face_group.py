...
class ListWithSelectedItem_CMSElementFaceGroup(
    _231.CMSElementFaceGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_231.CMSElementFaceGroup.TYPE":
        ...
        return _231.CMSElementFaceGroup.TYPE

    @property
    def selected_value(self: Self) -> "_231.CMSElementFaceGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_231.CMSElementFaceGroup]":
