...
class ListWithSelectedItem_ConcentricPartGroup(
    _2505.ConcentricPartGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2505.ConcentricPartGroup.TYPE":
        ...
        return _2505.ConcentricPartGroup.TYPE

    @property
    def selected_value(self: Self) -> "_2505.ConcentricPartGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_2505.ConcentricPartGroup]":
