...
class ListWithSelectedItem_PointLoad(_2489.PointLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2489.PointLoad.TYPE":
        ...
        return _2489.PointLoad.TYPE

    @property
    def selected_value(self: Self) -> "_2489.PointLoad":
    ...
    @property
    def available_values(self: Self) -> "List[_2489.PointLoad]":
