...
class ListWithSelectedItem_Unit(_1623.Unit, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_1623.Unit.TYPE":
        ...
        return _1623.Unit.TYPE

    @property
    def selected_value(self: Self) -> "_1623.Unit":
    ...
    @property
    def available_values(self: Self) -> "List[_1623.Unit]":
