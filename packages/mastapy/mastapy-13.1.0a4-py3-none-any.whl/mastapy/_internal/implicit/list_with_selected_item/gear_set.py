...
class ListWithSelectedItem_GearSet(_2550.GearSet, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2550.GearSet.TYPE":
        ...
        return _2550.GearSet.TYPE

    @property
    def selected_value(self: Self) -> "_2550.GearSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2550.GearSet]":
