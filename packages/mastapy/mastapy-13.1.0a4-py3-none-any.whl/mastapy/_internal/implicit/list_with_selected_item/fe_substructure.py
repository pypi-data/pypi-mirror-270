...
class ListWithSelectedItem_FESubstructure(
    _2401.FESubstructure, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2401.FESubstructure.TYPE":
        ...
        return _2401.FESubstructure.TYPE

    @property
    def selected_value(self: Self) -> "_2401.FESubstructure":
    ...
    @property
    def available_values(self: Self) -> "List[_2401.FESubstructure]":
