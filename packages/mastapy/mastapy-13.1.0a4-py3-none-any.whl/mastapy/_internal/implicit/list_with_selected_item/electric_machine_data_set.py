...
class ListWithSelectedItem_ElectricMachineDataSet(
    _2391.ElectricMachineDataSet, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2391.ElectricMachineDataSet.TYPE":
        ...
        return _2391.ElectricMachineDataSet.TYPE

    @property
    def selected_value(self: Self) -> "_2391.ElectricMachineDataSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2391.ElectricMachineDataSet]":
