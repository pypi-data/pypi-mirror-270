...
class ListWithSelectedItem_PowerLoad(_2490.PowerLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2490.PowerLoad.TYPE":
        ...
        return _2490.PowerLoad.TYPE

    @property
    def selected_value(self: Self) -> "_2490.PowerLoad":
    ...
    @property
    def available_values(self: Self) -> "List[_2490.PowerLoad]":
