...
class ListWithSelectedItem_FELink(_2436.FELink, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2436.FELink.TYPE":
        ...
        return _2436.FELink.TYPE

    @property
    def selected_value(self: Self) -> "_2436.FELink":
    ...
    @property
    def available_values(self: Self) -> "List[_2436.FELink]":
