...
class ListWithSelectedItem_ConicalSetManufacturingConfig(
    _798.ConicalSetManufacturingConfig, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_798.ConicalSetManufacturingConfig.TYPE":
        ...
        return _798.ConicalSetManufacturingConfig.TYPE

    @property
    def selected_value(self: Self) -> "_798.ConicalSetManufacturingConfig":
    ...
    @property
    def available_values(self: Self) -> "List[_798.ConicalSetManufacturingConfig]":
