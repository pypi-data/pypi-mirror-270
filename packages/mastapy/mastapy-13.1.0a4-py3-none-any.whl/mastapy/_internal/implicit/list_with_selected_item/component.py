...
class ListWithSelectedItem_Component(_2462.Component, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2462.Component.TYPE":
        ...
        return _2462.Component.TYPE

    @property
    def selected_value(self: Self) -> "_2462.Component":
    ...
    @property
    def available_values(self: Self) -> "List[_2462.Component]":
