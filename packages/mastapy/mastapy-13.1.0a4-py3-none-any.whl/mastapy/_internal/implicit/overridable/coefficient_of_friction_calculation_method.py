...
class Overridable_CoefficientOfFrictionCalculationMethod(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_326.CoefficientOfFrictionCalculationMethod":
        ...
        return _326.CoefficientOfFrictionCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_326.CoefficientOfFrictionCalculationMethod.type_()":
        ...
        return _326.CoefficientOfFrictionCalculationMethod.type_()

    @property
    def value(self: Self) -> "_326.CoefficientOfFrictionCalculationMethod":
    ...
    @property
    def override_value(self: Self) -> "_326.CoefficientOfFrictionCalculationMethod":
        """mastapy.gears.CoefficientOfFrictionCalculationMethod
    ...
    @property
    def calculated_value(self: Self) -> "_326.CoefficientOfFrictionCalculationMethod":
        """mastapy.gears.CoefficientOfFrictionCalculationMethod
