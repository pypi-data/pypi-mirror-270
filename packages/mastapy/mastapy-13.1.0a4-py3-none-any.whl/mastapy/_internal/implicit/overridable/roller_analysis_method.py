...
from mastapy.bearings.bearing_results.rolling import _2087
...
class Overridable_RollerAnalysisMethod(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2087.RollerAnalysisMethod":
        ...
        return _2087.RollerAnalysisMethod

    @classmethod
    def implicit_type(cls) -> "_2087.RollerAnalysisMethod.type_()":
        ...
        return _2087.RollerAnalysisMethod.type_()

    @property
    def value(self: Self) -> "_2087.RollerAnalysisMethod":
    ...
    @property
    def override_value(self: Self) -> "_2087.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod
    ...
    @property
    def calculated_value(self: Self) -> "_2087.RollerAnalysisMethod":
        """mastapy.bearings.bearing_results.rolling.RollerAnalysisMethod
