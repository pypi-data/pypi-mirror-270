...
from mastapy.system_model.fe import _2420
...
class Overridable_NodeSelectionDepthOption(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2420.NodeSelectionDepthOption":
        ...
        return _2420.NodeSelectionDepthOption

    @classmethod
    def implicit_type(cls) -> "_2420.NodeSelectionDepthOption.type_()":
        ...
        return _2420.NodeSelectionDepthOption.type_()

    @property
    def value(self: Self) -> "_2420.NodeSelectionDepthOption":
    ...
    @property
    def override_value(self: Self) -> "_2420.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
    ...
    @property
    def calculated_value(self: Self) -> "_2420.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
