...
class Overridable_MicroGeometryModel(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_344.MicroGeometryModel":
        ...
        return _344.MicroGeometryModel

    @classmethod
    def implicit_type(cls) -> "_344.MicroGeometryModel.type_()":
        ...
        return _344.MicroGeometryModel.type_()

    @property
    def value(self: Self) -> "_344.MicroGeometryModel":
    ...
    @property
    def override_value(self: Self) -> "_344.MicroGeometryModel":
        """mastapy.gears.MicroGeometryModel
    ...
    @property
    def calculated_value(self: Self) -> "_344.MicroGeometryModel":
        """mastapy.gears.MicroGeometryModel
