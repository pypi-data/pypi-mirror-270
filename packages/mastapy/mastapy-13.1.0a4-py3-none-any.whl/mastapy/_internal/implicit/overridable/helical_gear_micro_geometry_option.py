...
class Overridable_HelicalGearMicroGeometryOption(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_517.HelicalGearMicroGeometryOption":
        ...
        return _517.HelicalGearMicroGeometryOption

    @classmethod
    def implicit_type(cls) -> "_517.HelicalGearMicroGeometryOption.type_()":
        ...
        return _517.HelicalGearMicroGeometryOption.type_()

    @property
    def value(self: Self) -> "_517.HelicalGearMicroGeometryOption":
    ...
    @property
    def override_value(self: Self) -> "_517.HelicalGearMicroGeometryOption":
        """mastapy.gears.rating.cylindrical.iso6336.HelicalGearMicroGeometryOption
    ...
    @property
    def calculated_value(self: Self) -> "_517.HelicalGearMicroGeometryOption":
        """mastapy.gears.rating.cylindrical.iso6336.HelicalGearMicroGeometryOption
