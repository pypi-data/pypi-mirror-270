...
class Overridable_BallBearingContactCalculation(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1985.BallBearingContactCalculation":
        ...
        return _1985.BallBearingContactCalculation

    @classmethod
    def implicit_type(cls) -> "_1985.BallBearingContactCalculation.type_()":
        ...
        return _1985.BallBearingContactCalculation.type_()

    @property
    def value(self: Self) -> "_1985.BallBearingContactCalculation":
    ...
    @property
    def override_value(self: Self) -> "_1985.BallBearingContactCalculation":
        """mastapy.bearings.bearing_results.rolling.BallBearingContactCalculation
    ...
    @property
    def calculated_value(self: Self) -> "_1985.BallBearingContactCalculation":
        """mastapy.bearings.bearing_results.rolling.BallBearingContactCalculation
