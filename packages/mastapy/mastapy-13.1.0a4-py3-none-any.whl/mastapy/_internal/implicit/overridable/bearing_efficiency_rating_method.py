...
class Overridable_BearingEfficiencyRatingMethod(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_299.BearingEfficiencyRatingMethod":
        ...
        return _299.BearingEfficiencyRatingMethod

    @classmethod
    def implicit_type(cls) -> "_299.BearingEfficiencyRatingMethod.type_()":
        ...
        return _299.BearingEfficiencyRatingMethod.type_()

    @property
    def value(self: Self) -> "_299.BearingEfficiencyRatingMethod":
    ...
    @property
    def override_value(self: Self) -> "_299.BearingEfficiencyRatingMethod":
        """mastapy.materials.efficiency.BearingEfficiencyRatingMethod
    ...
    @property
    def calculated_value(self: Self) -> "_299.BearingEfficiencyRatingMethod":
        """mastapy.materials.efficiency.BearingEfficiencyRatingMethod
