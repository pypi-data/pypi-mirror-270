...
class Overridable_CylindricalGearRatingMethods(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_258.CylindricalGearRatingMethods":
        ...
        return _258.CylindricalGearRatingMethods

    @classmethod
    def implicit_type(cls) -> "_258.CylindricalGearRatingMethods.type_()":
        ...
        return _258.CylindricalGearRatingMethods.type_()

    @property
    def value(self: Self) -> "_258.CylindricalGearRatingMethods":
    ...
    @property
    def override_value(self: Self) -> "_258.CylindricalGearRatingMethods":
        """mastapy.materials.CylindricalGearRatingMethods
    ...
    @property
    def calculated_value(self: Self) -> "_258.CylindricalGearRatingMethods":
        """mastapy.materials.CylindricalGearRatingMethods
