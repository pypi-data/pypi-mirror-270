...
class EnumWithSelectedValue_GearMeshStiffnessModel(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5462.GearMeshStiffnessModel":
        ...
        return _5462.GearMeshStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_5462.GearMeshStiffnessModel.type_()":
        ...
        return _5462.GearMeshStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_5462.GearMeshStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_5462.GearMeshStiffnessModel]":
