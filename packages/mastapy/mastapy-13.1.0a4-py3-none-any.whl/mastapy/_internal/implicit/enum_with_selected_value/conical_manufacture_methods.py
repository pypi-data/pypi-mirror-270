...
class EnumWithSelectedValue_ConicalManufactureMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1168.ConicalManufactureMethods":
        ...
        return _1168.ConicalManufactureMethods

    @classmethod
    def implicit_type(cls) -> "_1168.ConicalManufactureMethods.type_()":
        ...
        return _1168.ConicalManufactureMethods.type_()

    @property
    def selected_value(self: Self) -> "_1168.ConicalManufactureMethods":
    ...
    @property
    def available_values(self: Self) -> "List[_1168.ConicalManufactureMethods]":
