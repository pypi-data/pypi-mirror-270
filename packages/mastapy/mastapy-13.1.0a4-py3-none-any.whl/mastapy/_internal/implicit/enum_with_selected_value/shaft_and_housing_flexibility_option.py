...
class EnumWithSelectedValue_ShaftAndHousingFlexibilityOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5508.ShaftAndHousingFlexibilityOption":
        ...
        return _5508.ShaftAndHousingFlexibilityOption

    @classmethod
    def implicit_type(cls) -> "_5508.ShaftAndHousingFlexibilityOption.type_()":
        ...
        return _5508.ShaftAndHousingFlexibilityOption.type_()

    @property
    def selected_value(self: Self) -> "_5508.ShaftAndHousingFlexibilityOption":
    ...
    @property
    def available_values(self: Self) -> "List[_5508.ShaftAndHousingFlexibilityOption]":
