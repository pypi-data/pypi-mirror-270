...
class EnumWithSelectedValue_ComponentOrientationOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2384.ComponentOrientationOption":
        ...
        return _2384.ComponentOrientationOption

    @classmethod
    def implicit_type(cls) -> "_2384.ComponentOrientationOption.type_()":
        ...
        return _2384.ComponentOrientationOption.type_()

    @property
    def selected_value(self: Self) -> "_2384.ComponentOrientationOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2384.ComponentOrientationOption]":
