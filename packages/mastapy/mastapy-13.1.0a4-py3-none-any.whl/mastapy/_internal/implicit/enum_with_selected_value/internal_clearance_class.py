...
class EnumWithSelectedValue_InternalClearanceClass(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1919.InternalClearanceClass":
        ...
        return _1919.InternalClearanceClass

    @classmethod
    def implicit_type(cls) -> "_1919.InternalClearanceClass.type_()":
        ...
        return _1919.InternalClearanceClass.type_()

    @property
    def selected_value(self: Self) -> "_1919.InternalClearanceClass":
    ...
    @property
    def available_values(self: Self) -> "List[_1919.InternalClearanceClass]":
