...
class EnumWithSelectedValue_BearingToleranceClass(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1920.BearingToleranceClass":
        ...
        return _1920.BearingToleranceClass

    @classmethod
    def implicit_type(cls) -> "_1920.BearingToleranceClass.type_()":
        ...
        return _1920.BearingToleranceClass.type_()

    @property
    def selected_value(self: Self) -> "_1920.BearingToleranceClass":
    ...
    @property
    def available_values(self: Self) -> "List[_1920.BearingToleranceClass]":
