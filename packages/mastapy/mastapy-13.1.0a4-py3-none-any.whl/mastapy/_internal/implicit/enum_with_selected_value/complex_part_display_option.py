...
class EnumWithSelectedValue_ComplexPartDisplayOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1507.ComplexPartDisplayOption":
        ...
        return _1507.ComplexPartDisplayOption

    @classmethod
    def implicit_type(cls) -> "_1507.ComplexPartDisplayOption.type_()":
        ...
        return _1507.ComplexPartDisplayOption.type_()

    @property
    def selected_value(self: Self) -> "_1507.ComplexPartDisplayOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1507.ComplexPartDisplayOption]":
