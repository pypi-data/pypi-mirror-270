...
class EnumWithSelectedValue_BearingToleranceDefinitionOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1921.BearingToleranceDefinitionOptions":
        ...
        return _1921.BearingToleranceDefinitionOptions

    @classmethod
    def implicit_type(cls) -> "_1921.BearingToleranceDefinitionOptions.type_()":
        ...
        return _1921.BearingToleranceDefinitionOptions.type_()

    @property
    def selected_value(self: Self) -> "_1921.BearingToleranceDefinitionOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1921.BearingToleranceDefinitionOptions]":
