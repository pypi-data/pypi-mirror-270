...
class EnumWithSelectedValue_TorqueRippleInputType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_7003.TorqueRippleInputType":
        ...
        return _7003.TorqueRippleInputType

    @classmethod
    def implicit_type(cls) -> "_7003.TorqueRippleInputType.type_()":
        ...
        return _7003.TorqueRippleInputType.type_()

    @property
    def selected_value(self: Self) -> "_7003.TorqueRippleInputType":
    ...
    @property
    def available_values(self: Self) -> "List[_7003.TorqueRippleInputType]":
