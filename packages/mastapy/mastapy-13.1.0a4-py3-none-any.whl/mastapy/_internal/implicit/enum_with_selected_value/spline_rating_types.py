...
from mastapy.detailed_rigid_connectors.splines import _1429
...
class EnumWithSelectedValue_SplineRatingTypes(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1429.SplineRatingTypes":
        ...
        return _1429.SplineRatingTypes

    @classmethod
    def implicit_type(cls) -> "_1429.SplineRatingTypes.type_()":
        ...
        return _1429.SplineRatingTypes.type_()

    @property
    def selected_value(self: Self) -> "_1429.SplineRatingTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1429.SplineRatingTypes]":
