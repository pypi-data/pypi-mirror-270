...
class EnumWithSelectedValue_RaceAxialMountingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1981.RaceAxialMountingType":
        ...
        return _1981.RaceAxialMountingType

    @classmethod
    def implicit_type(cls) -> "_1981.RaceAxialMountingType.type_()":
        ...
        return _1981.RaceAxialMountingType.type_()

    @property
    def selected_value(self: Self) -> "_1981.RaceAxialMountingType":
    ...
    @property
    def available_values(self: Self) -> "List[_1981.RaceAxialMountingType]":
