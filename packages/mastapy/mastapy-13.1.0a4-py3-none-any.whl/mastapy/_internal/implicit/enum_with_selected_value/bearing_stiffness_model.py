...
class EnumWithSelectedValue_BearingStiffnessModel(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5410.BearingStiffnessModel":
        ...
        return _5410.BearingStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_5410.BearingStiffnessModel.type_()":
        ...
        return _5410.BearingStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_5410.BearingStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_5410.BearingStiffnessModel]":
