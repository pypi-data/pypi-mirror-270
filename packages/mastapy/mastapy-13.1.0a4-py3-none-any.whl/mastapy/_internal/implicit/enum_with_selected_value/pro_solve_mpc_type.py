...
from mastapy.fe_tools.vfx_tools.vfx_enums import _1249
...
class EnumWithSelectedValue_ProSolveMpcType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1249.ProSolveMpcType":
        ...
        return _1249.ProSolveMpcType

    @classmethod
    def implicit_type(cls) -> "_1249.ProSolveMpcType.type_()":
        ...
        return _1249.ProSolveMpcType.type_()

    @property
    def selected_value(self: Self) -> "_1249.ProSolveMpcType":
    ...
    @property
    def available_values(self: Self) -> "List[_1249.ProSolveMpcType]":
