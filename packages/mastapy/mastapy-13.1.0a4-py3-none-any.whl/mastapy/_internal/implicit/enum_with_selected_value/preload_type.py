...
class EnumWithSelectedValue_PreloadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1979.PreloadType":
        ...
        return _1979.PreloadType

    @classmethod
    def implicit_type(cls) -> "_1979.PreloadType.type_()":
        ...
        return _1979.PreloadType.type_()

    @property
    def selected_value(self: Self) -> "_1979.PreloadType":
    ...
    @property
    def available_values(self: Self) -> "List[_1979.PreloadType]":
