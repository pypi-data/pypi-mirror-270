...
class EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption(
    ...
    def wrapped_type(
        cls,
    ) -> "_1156.CylindricalGearPairCreationOptions.DerivedParameterOption":
        ...
        return _1156.CylindricalGearPairCreationOptions.DerivedParameterOption

    @classmethod
    def implicit_type(
        cls,
    ) -> "_1156.CylindricalGearPairCreationOptions.DerivedParameterOption.type_()":
        ...
        return _1156.CylindricalGearPairCreationOptions.DerivedParameterOption.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_1156.CylindricalGearPairCreationOptions.DerivedParameterOption]":
