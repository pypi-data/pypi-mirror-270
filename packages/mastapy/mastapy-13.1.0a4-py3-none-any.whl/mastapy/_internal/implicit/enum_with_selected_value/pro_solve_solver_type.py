...
from mastapy.fe_tools.vfx_tools.vfx_enums import _1250
...
class EnumWithSelectedValue_ProSolveSolverType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1250.ProSolveSolverType":
        ...
        return _1250.ProSolveSolverType

    @classmethod
    def implicit_type(cls) -> "_1250.ProSolveSolverType.type_()":
        ...
        return _1250.ProSolveSolverType.type_()

    @property
    def selected_value(self: Self) -> "_1250.ProSolveSolverType":
    ...
    @property
    def available_values(self: Self) -> "List[_1250.ProSolveSolverType]":
