...
from mastapy.system_model.fe import _2429
...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2429.ThermalExpansionOption":
        ...
        return _2429.ThermalExpansionOption

    @classmethod
    def implicit_type(cls) -> "_2429.ThermalExpansionOption.type_()":
        ...
        return _2429.ThermalExpansionOption.type_()

    @property
    def selected_value(self: Self) -> "_2429.ThermalExpansionOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2429.ThermalExpansionOption]":
