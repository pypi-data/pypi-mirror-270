...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2614.RigidConnectorToothSpacingType":
        ...
        return _2614.RigidConnectorToothSpacingType

    @classmethod
    def implicit_type(cls) -> "_2614.RigidConnectorToothSpacingType.type_()":
        ...
        return _2614.RigidConnectorToothSpacingType.type_()

    @property
    def selected_value(self: Self) -> "_2614.RigidConnectorToothSpacingType":
    ...
    @property
    def available_values(self: Self) -> "List[_2614.RigidConnectorToothSpacingType]":
