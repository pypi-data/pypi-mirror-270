...
class EnumWithSelectedValue_Flank(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_634.Flank":
    ...
    @classmethod
    def implicit_type(cls) -> "_634.Flank.type_()":
        ...
        return _634.Flank.type_()

    @property
    def selected_value(self: Self) -> "_634.Flank":
    ...
    @property
    def available_values(self: Self) -> "List[_634.Flank]":
