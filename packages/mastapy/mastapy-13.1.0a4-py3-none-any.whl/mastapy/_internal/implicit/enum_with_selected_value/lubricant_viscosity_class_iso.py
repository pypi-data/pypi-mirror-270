...
class EnumWithSelectedValue_LubricantViscosityClassISO(
    ...
    @classmethod
    def wrapped_type(cls) -> "_272.LubricantViscosityClassISO":
        ...
        return _272.LubricantViscosityClassISO

    @classmethod
    def implicit_type(cls) -> "_272.LubricantViscosityClassISO.type_()":
        ...
        return _272.LubricantViscosityClassISO.type_()

    @property
    def selected_value(self: Self) -> "_272.LubricantViscosityClassISO":
    ...
    @property
    def available_values(self: Self) -> "List[_272.LubricantViscosityClassISO]":
