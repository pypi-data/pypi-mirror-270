...
class EnumWithSelectedValue_SplineToleranceClassTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1430.SplineToleranceClassTypes":
        ...
        return _1430.SplineToleranceClassTypes

    @classmethod
    def implicit_type(cls) -> "_1430.SplineToleranceClassTypes.type_()":
        ...
        return _1430.SplineToleranceClassTypes.type_()

    @property
    def selected_value(self: Self) -> "_1430.SplineToleranceClassTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1430.SplineToleranceClassTypes]":
