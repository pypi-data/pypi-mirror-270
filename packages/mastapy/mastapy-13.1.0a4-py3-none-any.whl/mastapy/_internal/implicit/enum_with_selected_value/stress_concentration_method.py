...
class EnumWithSelectedValue_StressConcentrationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2127.StressConcentrationMethod":
        ...
        return _2127.StressConcentrationMethod

    @classmethod
    def implicit_type(cls) -> "_2127.StressConcentrationMethod.type_()":
        ...
        return _2127.StressConcentrationMethod.type_()

    @property
    def selected_value(self: Self) -> "_2127.StressConcentrationMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_2127.StressConcentrationMethod]":
