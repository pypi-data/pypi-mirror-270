...
class EnumWithSelectedValue_ResidualStressCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1078.ResidualStressCalculationMethod":
        ...
        return _1078.ResidualStressCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_1078.ResidualStressCalculationMethod.type_()":
        ...
        return _1078.ResidualStressCalculationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1078.ResidualStressCalculationMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_1078.ResidualStressCalculationMethod]":
