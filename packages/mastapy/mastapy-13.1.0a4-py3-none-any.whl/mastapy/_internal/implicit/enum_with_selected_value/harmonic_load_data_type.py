...
class EnumWithSelectedValue_HarmonicLoadDataType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1394.HarmonicLoadDataType":
        ...
        return _1394.HarmonicLoadDataType

    @classmethod
    def implicit_type(cls) -> "_1394.HarmonicLoadDataType.type_()":
        ...
        return _1394.HarmonicLoadDataType.type_()

    @property
    def selected_value(self: Self) -> "_1394.HarmonicLoadDataType":
    ...
    @property
    def available_values(self: Self) -> "List[_1394.HarmonicLoadDataType]":
