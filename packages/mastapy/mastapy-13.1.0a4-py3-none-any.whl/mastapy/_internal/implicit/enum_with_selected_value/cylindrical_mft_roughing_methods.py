...
class EnumWithSelectedValue_CylindricalMftRoughingMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_631.CylindricalMftRoughingMethods":
        ...
        return _631.CylindricalMftRoughingMethods

    @classmethod
    def implicit_type(cls) -> "_631.CylindricalMftRoughingMethods.type_()":
        ...
        return _631.CylindricalMftRoughingMethods.type_()

    @property
    def selected_value(self: Self) -> "_631.CylindricalMftRoughingMethods":
    ...
    @property
    def available_values(self: Self) -> "List[_631.CylindricalMftRoughingMethods]":
