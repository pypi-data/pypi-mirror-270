...
class EnumWithSelectedValue_ContactResultType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_834.ContactResultType":
        ...
        return _834.ContactResultType

    @classmethod
    def implicit_type(cls) -> "_834.ContactResultType.type_()":
        ...
        return _834.ContactResultType.type_()

    @property
    def selected_value(self: Self) -> "_834.ContactResultType":
    ...
    @property
    def available_values(self: Self) -> "List[_834.ContactResultType]":
