...
class EnumWithSelectedValue_RollerBearingProfileTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1908.RollerBearingProfileTypes":
        ...
        return _1908.RollerBearingProfileTypes

    @classmethod
    def implicit_type(cls) -> "_1908.RollerBearingProfileTypes.type_()":
        ...
        return _1908.RollerBearingProfileTypes.type_()

    @property
    def selected_value(self: Self) -> "_1908.RollerBearingProfileTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1908.RollerBearingProfileTypes]":
