...
class EnumWithSelectedValue_LoadedBallElementPropertyType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1980.LoadedBallElementPropertyType":
        ...
        return _1980.LoadedBallElementPropertyType

    @classmethod
    def implicit_type(cls) -> "_1980.LoadedBallElementPropertyType.type_()":
        ...
        return _1980.LoadedBallElementPropertyType.type_()

    @property
    def selected_value(self: Self) -> "_1980.LoadedBallElementPropertyType":
    ...
    @property
    def available_values(self: Self) -> "List[_1980.LoadedBallElementPropertyType]":
