...
class EnumWithSelectedValue_RollingBearingArrangement(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1909.RollingBearingArrangement":
        ...
        return _1909.RollingBearingArrangement

    @classmethod
    def implicit_type(cls) -> "_1909.RollingBearingArrangement.type_()":
        ...
        return _1909.RollingBearingArrangement.type_()

    @property
    def selected_value(self: Self) -> "_1909.RollingBearingArrangement":
    ...
    @property
    def available_values(self: Self) -> "List[_1909.RollingBearingArrangement]":
