...
class EnumWithSelectedValue_LocationOfTipReliefEvaluation(
    ...
    @classmethod
    def wrapped_type(cls) -> "_583.LocationOfTipReliefEvaluation":
        ...
        return _583.LocationOfTipReliefEvaluation

    @classmethod
    def implicit_type(cls) -> "_583.LocationOfTipReliefEvaluation.type_()":
        ...
        return _583.LocationOfTipReliefEvaluation.type_()

    @property
    def selected_value(self: Self) -> "_583.LocationOfTipReliefEvaluation":
    ...
    @property
    def available_values(self: Self) -> "List[_583.LocationOfTipReliefEvaluation]":
