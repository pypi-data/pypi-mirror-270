...
class EnumWithSelectedValue_ForceDisplayOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1391.ForceDisplayOption":
        ...
        return _1391.ForceDisplayOption

    @classmethod
    def implicit_type(cls) -> "_1391.ForceDisplayOption.type_()":
        ...
        return _1391.ForceDisplayOption.type_()

    @property
    def selected_value(self: Self) -> "_1391.ForceDisplayOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1391.ForceDisplayOption]":
