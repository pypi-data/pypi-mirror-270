...
class EnumWithSelectedValue_ThreeDViewContourOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1836.ThreeDViewContourOption":
        ...
        return _1836.ThreeDViewContourOption

    @classmethod
    def implicit_type(cls) -> "_1836.ThreeDViewContourOption.type_()":
        ...
        return _1836.ThreeDViewContourOption.type_()

    @property
    def selected_value(self: Self) -> "_1836.ThreeDViewContourOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1836.ThreeDViewContourOption]":
