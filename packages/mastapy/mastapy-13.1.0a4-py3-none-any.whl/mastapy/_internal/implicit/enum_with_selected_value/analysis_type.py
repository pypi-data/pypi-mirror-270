...
class EnumWithSelectedValue_AnalysisType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_6844.AnalysisType":
        ...
        return _6844.AnalysisType

    @classmethod
    def implicit_type(cls) -> "_6844.AnalysisType.type_()":
        ...
        return _6844.AnalysisType.type_()

    @property
    def selected_value(self: Self) -> "_6844.AnalysisType":
    ...
    @property
    def available_values(self: Self) -> "List[_6844.AnalysisType]":
