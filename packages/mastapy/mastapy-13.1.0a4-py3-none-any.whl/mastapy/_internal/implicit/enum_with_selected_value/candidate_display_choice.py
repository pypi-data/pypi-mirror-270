...
class EnumWithSelectedValue_CandidateDisplayChoice(
    ...
    @classmethod
    def wrapped_type(cls) -> "_910.CandidateDisplayChoice":
        ...
        return _910.CandidateDisplayChoice

    @classmethod
    def implicit_type(cls) -> "_910.CandidateDisplayChoice.type_()":
        ...
        return _910.CandidateDisplayChoice.type_()

    @property
    def selected_value(self: Self) -> "_910.CandidateDisplayChoice":
    ...
    @property
    def available_values(self: Self) -> "List[_910.CandidateDisplayChoice]":
