...
class EnumWithSelectedValue_ConicalMachineSettingCalculationMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1167.ConicalMachineSettingCalculationMethods":
        ...
        return _1167.ConicalMachineSettingCalculationMethods

    @classmethod
    def implicit_type(cls) -> "_1167.ConicalMachineSettingCalculationMethods.type_()":
        ...
        return _1167.ConicalMachineSettingCalculationMethods.type_()

    @property
    def selected_value(self: Self) -> "_1167.ConicalMachineSettingCalculationMethods":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1167.ConicalMachineSettingCalculationMethods]":
