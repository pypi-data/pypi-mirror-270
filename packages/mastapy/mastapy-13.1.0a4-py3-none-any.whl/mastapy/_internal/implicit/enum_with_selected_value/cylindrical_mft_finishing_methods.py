...
class EnumWithSelectedValue_CylindricalMftFinishingMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_630.CylindricalMftFinishingMethods":
        ...
        return _630.CylindricalMftFinishingMethods

    @classmethod
    def implicit_type(cls) -> "_630.CylindricalMftFinishingMethods.type_()":
        ...
        return _630.CylindricalMftFinishingMethods.type_()

    @property
    def selected_value(self: Self) -> "_630.CylindricalMftFinishingMethods":
    ...
    @property
    def available_values(self: Self) -> "List[_630.CylindricalMftFinishingMethods]":
