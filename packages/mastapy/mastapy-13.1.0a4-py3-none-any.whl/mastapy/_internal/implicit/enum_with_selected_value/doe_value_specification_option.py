...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_4372.DoeValueSpecificationOption":
        ...
        return _4372.DoeValueSpecificationOption

    @classmethod
    def implicit_type(cls) -> "_4372.DoeValueSpecificationOption.type_()":
        ...
        return _4372.DoeValueSpecificationOption.type_()

    @property
    def selected_value(self: Self) -> "_4372.DoeValueSpecificationOption":
    ...
    @property
    def available_values(self: Self) -> "List[_4372.DoeValueSpecificationOption]":
