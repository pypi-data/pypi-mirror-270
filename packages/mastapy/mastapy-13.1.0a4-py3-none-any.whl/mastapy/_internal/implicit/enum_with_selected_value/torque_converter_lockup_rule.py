...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5534.TorqueConverterLockupRule":
        ...
        return _5534.TorqueConverterLockupRule

    @classmethod
    def implicit_type(cls) -> "_5534.TorqueConverterLockupRule.type_()":
        ...
        return _5534.TorqueConverterLockupRule.type_()

    @property
    def selected_value(self: Self) -> "_5534.TorqueConverterLockupRule":
    ...
    @property
    def available_values(self: Self) -> "List[_5534.TorqueConverterLockupRule]":
