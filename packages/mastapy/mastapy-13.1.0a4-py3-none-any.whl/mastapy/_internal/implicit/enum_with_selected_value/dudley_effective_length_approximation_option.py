...
class EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1406.DudleyEffectiveLengthApproximationOption":
        ...
        return _1406.DudleyEffectiveLengthApproximationOption

    @classmethod
    def implicit_type(cls) -> "_1406.DudleyEffectiveLengthApproximationOption.type_()":
        ...
        return _1406.DudleyEffectiveLengthApproximationOption.type_()

    @property
    def selected_value(self: Self) -> "_1406.DudleyEffectiveLengthApproximationOption":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1406.DudleyEffectiveLengthApproximationOption]":
