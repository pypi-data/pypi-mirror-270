...
class EnumWithSelectedValue_LoadDistributionFactorMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1179.LoadDistributionFactorMethods":
        ...
        return _1179.LoadDistributionFactorMethods

    @classmethod
    def implicit_type(cls) -> "_1179.LoadDistributionFactorMethods.type_()":
        ...
        return _1179.LoadDistributionFactorMethods.type_()

    @property
    def selected_value(self: Self) -> "_1179.LoadDistributionFactorMethods":
    ...
    @property
    def available_values(self: Self) -> "List[_1179.LoadDistributionFactorMethods]":
