...
class EnumWithSelectedValue_SplineFitClassType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1424.SplineFitClassType":
        ...
        return _1424.SplineFitClassType

    @classmethod
    def implicit_type(cls) -> "_1424.SplineFitClassType.type_()":
        ...
        return _1424.SplineFitClassType.type_()

    @property
    def selected_value(self: Self) -> "_1424.SplineFitClassType":
    ...
    @property
    def available_values(self: Self) -> "List[_1424.SplineFitClassType]":
