...
from mastapy.system_model.fe import _2416
...
class EnumWithSelectedValue_LinkNodeSource(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2416.LinkNodeSource":
        ...
        return _2416.LinkNodeSource

    @classmethod
    def implicit_type(cls) -> "_2416.LinkNodeSource.type_()":
        ...
        return _2416.LinkNodeSource.type_()

    @property
    def selected_value(self: Self) -> "_2416.LinkNodeSource":
    ...
    @property
    def available_values(self: Self) -> "List[_2416.LinkNodeSource]":
