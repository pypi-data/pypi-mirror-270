...
class EnumWithSelectedValue_ScuffingCoefficientOfFrictionMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1081.ScuffingCoefficientOfFrictionMethods":
        ...
        return _1081.ScuffingCoefficientOfFrictionMethods

    @classmethod
    def implicit_type(cls) -> "_1081.ScuffingCoefficientOfFrictionMethods.type_()":
        ...
        return _1081.ScuffingCoefficientOfFrictionMethods.type_()

    @property
    def selected_value(self: Self) -> "_1081.ScuffingCoefficientOfFrictionMethods":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1081.ScuffingCoefficientOfFrictionMethods]":
