...
class EnumWithSelectedValue_FluidFilmTemperatureOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1901.FluidFilmTemperatureOptions":
        ...
        return _1901.FluidFilmTemperatureOptions

    @classmethod
    def implicit_type(cls) -> "_1901.FluidFilmTemperatureOptions.type_()":
        ...
        return _1901.FluidFilmTemperatureOptions.type_()

    @property
    def selected_value(self: Self) -> "_1901.FluidFilmTemperatureOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1901.FluidFilmTemperatureOptions]":
