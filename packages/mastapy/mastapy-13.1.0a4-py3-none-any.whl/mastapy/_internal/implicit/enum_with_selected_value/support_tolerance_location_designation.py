...
class EnumWithSelectedValue_SupportToleranceLocationDesignation(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1940.SupportToleranceLocationDesignation":
        ...
        return _1940.SupportToleranceLocationDesignation

    @classmethod
    def implicit_type(cls) -> "_1940.SupportToleranceLocationDesignation.type_()":
        ...
        return _1940.SupportToleranceLocationDesignation.type_()

    @property
    def selected_value(self: Self) -> "_1940.SupportToleranceLocationDesignation":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1940.SupportToleranceLocationDesignation]":
