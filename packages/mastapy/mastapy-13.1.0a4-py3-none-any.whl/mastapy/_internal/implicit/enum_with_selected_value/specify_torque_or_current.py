...
class EnumWithSelectedValue_SpecifyTorqueOrCurrent(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1384.SpecifyTorqueOrCurrent":
        ...
        return _1384.SpecifyTorqueOrCurrent

    @classmethod
    def implicit_type(cls) -> "_1384.SpecifyTorqueOrCurrent.type_()":
        ...
        return _1384.SpecifyTorqueOrCurrent.type_()

    @property
    def selected_value(self: Self) -> "_1384.SpecifyTorqueOrCurrent":
    ...
    @property
    def available_values(self: Self) -> "List[_1384.SpecifyTorqueOrCurrent]":
