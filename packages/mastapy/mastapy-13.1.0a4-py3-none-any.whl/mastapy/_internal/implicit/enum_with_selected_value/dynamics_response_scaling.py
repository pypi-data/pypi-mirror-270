...
class EnumWithSelectedValue_DynamicsResponseScaling(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1518.DynamicsResponseScaling":
        ...
        return _1518.DynamicsResponseScaling

    @classmethod
    def implicit_type(cls) -> "_1518.DynamicsResponseScaling.type_()":
        ...
        return _1518.DynamicsResponseScaling.type_()

    @property
    def selected_value(self: Self) -> "_1518.DynamicsResponseScaling":
    ...
    @property
    def available_values(self: Self) -> "List[_1518.DynamicsResponseScaling]":
