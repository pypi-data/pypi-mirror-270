...
from mastapy.utility.model_validation import _1805
...
class EnumWithSelectedValue_Severity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1805.Severity":
        ...
        return _1805.Severity

    @classmethod
    def implicit_type(cls) -> "_1805.Severity.type_()":
        ...
        return _1805.Severity.type_()

    @property
    def selected_value(self: Self) -> "_1805.Severity":
    ...
    @property
    def available_values(self: Self) -> "List[_1805.Severity]":
