...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.measured_data_scaling import _1582
...
class DataScalingOptions(_0.APIBase):
    ...
    def dynamic_scaling(self: Self, value: "_1518.DynamicsResponseScaling"):
    ...
    @property
    def weighting(self: Self) -> "_1502.AcousticWeighting":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility._1502", "AcousticWeighting"
        )(value)

    @weighting.setter
    @enforce_parameter_types
    def weighting(self: Self, value: "_1502.AcousticWeighting"):
    ...
    def acceleration_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1625.Acceleration]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1625.Acceleration](temp)

    @property
    def angle_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1626.Angle]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1626.Angle](temp)

    @property
    def angular_acceleration_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1630.AngularAcceleration]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1630.AngularAcceleration](
            temp
        )
    ...
    def angular_velocity_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1634.AngularVelocity]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1634.AngularVelocity](temp)

    @property
    def damage_rate(self: Self) -> "_1582.DataScalingReferenceValues[_1642.DamageRate]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1642.DamageRate](temp)

    @property
    def energy_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1649.Energy]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1649.Energy](temp)

    @property
    def force_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1655.Force]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1655.Force](temp)

    @property
    def frequency_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1661.Frequency]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1661.Frequency](temp)

    @property
    def linear_stiffness_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1689.LinearStiffness]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1689.LinearStiffness](temp)

    @property
    def mass_per_unit_time_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1697.MassPerUnitTime]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1697.MassPerUnitTime](temp)

    @property
    def medium_length_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1678.LengthMedium]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1678.LengthMedium](temp)

    @property
    def percentage(self: Self) -> "_1582.DataScalingReferenceValues[_1702.Percentage]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1702.Percentage](temp)

    @property
    def power_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1703.Power]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1703.Power](temp)

    @property
    def power_small_per_unit_area_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1707.PowerSmallPerArea]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1707.PowerSmallPerArea](
            temp
        )
    ...
    def power_small_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1706.PowerSmall]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1706.PowerSmall](temp)

    @property
    def pressure_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1712.Pressure]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1712.Pressure](temp)

    @property
    def safety_factor(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1722.SafetyFactor]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1722.SafetyFactor](temp)

    @property
    def short_length_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1680.LengthShort]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1680.LengthShort](temp)

    @property
    def short_time_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1736.TimeShort]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1736.TimeShort](temp)

    @property
    def small_angle_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1628.AngleSmall]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1628.AngleSmall](temp)

    @property
    def small_energy_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1652.EnergySmall]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1652.EnergySmall](temp)

    @property
    def small_velocity_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1745.VelocitySmall]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1745.VelocitySmall](temp)

    @property
    def stress_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1727.Stress]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1727.Stress](temp)

    @property
    def temperature_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1728.Temperature]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1728.Temperature](temp)

    @property
    def torque_converter_inverse_k(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1739.TorqueConverterInverseK]":
    ...
    def torque_converter_k(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1740.TorqueConverterK]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1740.TorqueConverterK](
            temp
        )
    ...
    def torque_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1738.Torque]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1738.Torque](temp)

    @property
    def unmeasureable(self: Self) -> "_1582.DataScalingReferenceValues[_1701.Number]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1701.Number](temp)

    @property
    def velocity_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1744.Velocity]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1744.Velocity](temp)

    @property
    def very_short_length_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1683.LengthVeryShort]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1683.LengthVeryShort](temp)

    @property
    def very_short_time_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1737.TimeVeryShort]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1737.TimeVeryShort](temp)

    @property
    def very_small_angle_reference_values(
        self: Self,
    ) -> "_1582.DataScalingReferenceValues[_1629.AngleVerySmall]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_1629.AngleVerySmall](temp)
