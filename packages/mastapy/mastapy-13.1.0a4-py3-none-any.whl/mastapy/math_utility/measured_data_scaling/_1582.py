...
from mastapy.math_utility.measured_data_scaling import _1583
...
class DataScalingReferenceValues(
    _1583.DataScalingReferenceValuesBase, Generic[TMeasurement]
):
    """DataScalingReferenceValues
    ...
    class _Cast_DataScalingReferenceValues:
        ...
        def data_scaling_reference_values_base(
            ...
            return self._parent._cast(_1583.DataScalingReferenceValuesBase)
