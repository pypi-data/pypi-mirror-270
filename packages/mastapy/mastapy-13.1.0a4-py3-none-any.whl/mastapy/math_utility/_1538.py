...
if TYPE_CHECKING:
    from mastapy.math_utility import _1521, _1536, _1548, _1526
...
class RealVector(_1537.RealMatrix):
    """RealVector
    ...
    class _Cast_RealVector:
        ...
        @property
        def real_matrix(self: "RealVector._Cast_RealVector") -> "_1537.RealMatrix":
        ...
        @property
        def quaternion(self: "RealVector._Cast_RealVector") -> "_1536.Quaternion":
            from mastapy.math_utility import _1536

            return self._parent._cast(_1536.Quaternion)

        @property
        def vector_6d(self: "RealVector._Cast_RealVector") -> "_1548.Vector6D":
