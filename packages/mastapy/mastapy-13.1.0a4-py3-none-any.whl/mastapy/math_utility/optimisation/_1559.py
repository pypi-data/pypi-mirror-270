...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.optimisation import _1569, _1566
...
class ParetoOptimisationInput(_1565.ParetoOptimisationVariable):
    """ParetoOptimisationInput
    ...
    class _Cast_ParetoOptimisationInput:
        ...
        def pareto_optimisation_variable_base(
            ...
            return self._parent._cast(_1566.ParetoOptimisationVariableBase)
