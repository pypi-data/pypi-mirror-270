...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.optimisation import _1556, _1568
...
class OptimizationVariable(_0.APIBase):
    ...
    class _Cast_OptimizationVariable:
        ...
        def optimization_input(
            ...
            return self._parent._cast(_1556.OptimizationInput)
        ...
        def reporting_optimization_input(
            ...
            return self._parent._cast(_1568.ReportingOptimizationInput)
    ...
    @property
    def measurement(self: Self) -> "_1618.MeasurementBase":
    ...
    def measurement(self: Self, value: "_1618.MeasurementBase"):
