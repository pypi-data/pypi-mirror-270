...
if TYPE_CHECKING:
    from mastapy.math_utility.optimisation import _1563, _1559, _1560
...
class ParetoOptimisationStrategy(_1844.NamedDatabaseItem):
    """ParetoOptimisationStrategy
    ...
    @property
    def charts(self: Self) -> "List[_1563.ParetoOptimisationStrategyChartInformation]":
    ...
    @property
    def inputs(self: Self) -> "List[_1559.ParetoOptimisationInput]":
    ...
    @property
    def outputs(self: Self) -> "List[_1560.ParetoOptimisationOutput]":
