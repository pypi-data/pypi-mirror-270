...
class TwodimensionalFunctionLookupTable(
    _1578.LookupTableBase["TwodimensionalFunctionLookupTable"]
):
    """TwodimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: Self) -> "_1577.GriddedSurfaceAccessor":
    ...
    def lookup_table(self: Self, value: "_1577.GriddedSurfaceAccessor"):
