...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2482, _2453
    from mastapy.system_model.connections_and_sockets import _2287, _2305, _2313
...
class AbstractShaftToMountableComponentConnection(_2290.Connection):
    """AbstractShaftToMountableComponentConnection
    ...
    @property
    def mountable_component(self: Self) -> "_2482.MountableComponent":
    ...
    @property
    def shaft(self: Self) -> "_2453.AbstractShaft":
