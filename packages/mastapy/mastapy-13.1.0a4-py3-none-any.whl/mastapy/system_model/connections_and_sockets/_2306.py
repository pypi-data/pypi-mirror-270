...
if TYPE_CHECKING:
    from mastapy.system_model.connections_and_sockets import _2294, _2314
...
class PlanetarySocket(_2307.PlanetarySocketBase):
    """PlanetarySocket
    ...
    class _Cast_PlanetarySocket:
        ...
        @property
        def socket(self: "PlanetarySocket._Cast_PlanetarySocket") -> "_2314.Socket":
