...
if TYPE_CHECKING:
    from mastapy.system_model.connections_and_sockets import _2292, _2314
...
class PulleySocket(_2294.CylindricalSocket):
    """PulleySocket
    ...
    class _Cast_PulleySocket:
        ...
        @property
        def socket(self: "PulleySocket._Cast_PulleySocket") -> "_2314.Socket":
