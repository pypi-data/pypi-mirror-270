...
if TYPE_CHECKING:
    from mastapy.system_model import _2219, _2221
...
class SpringDamperConnection(_2364.CouplingConnection):
    """SpringDamperConnection
    ...
    @property
    def damping_option(self: Self) -> "_2219.ComponentDampingOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2219", "ComponentDampingOption"
        )(value)

    @damping_option.setter
    @enforce_parameter_types
    def damping_option(self: Self, value: "_2219.ComponentDampingOption"):
