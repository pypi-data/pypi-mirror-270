...
from mastapy.bearings.tolerances import _1919, _1921
...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2456, _2491
...
class InternalClearanceTolerance(_0.APIBase):
    ...
    class _Cast_InternalClearanceTolerance:
        ...
        def axial_internal_clearance_tolerance(
            ...
            return self._parent._cast(_2456.AxialInternalClearanceTolerance)
        ...
        def radial_internal_clearance_tolerance(
            ...
            return self._parent._cast(_2491.RadialInternalClearanceTolerance)
    ...
    def clearance_class(self: Self, value: "_1919.InternalClearanceClass"):
