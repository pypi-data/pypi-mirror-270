...
from mastapy.system_model.part_model import _2473, _2453
...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model import _2474, _2482, _2454, _2462, _2486
...
class Shaft(_2453.AbstractShaft):
    """Shaft
    ...
    class _Cast_Shaft:
        ...
        @property
        def abstract_shaft(self: "Shaft._Cast_Shaft") -> "_2453.AbstractShaft":
        ...
        @property
        def component(self: "Shaft._Cast_Shaft") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "Shaft._Cast_Shaft") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "Shaft._Cast_Shaft") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
    ...
    @cad_model.setter
    @enforce_parameter_types
    def cad_model(self: Self, value: "_2473.GuideDxfModel"):
        wrapper_type = (
    ...
    @property
    def guide_image(self: Self) -> "_2474.GuideImage":
    ...
    @property
    def fe_substructure_replacing_this(self: Self) -> "_2401.FESubstructure":
    ...
    @enforce_parameter_types
    def mount_component(
        self: Self, component: "_2482.MountableComponent", offset: "float"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def read_rxf(self: Self, file_name: "str"):
        """Method does not return.
