...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.part_groups import _2505, _2509, _2510
...
class ParallelPartGroup(_2504.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    @property
    def concentric_part_groups(self: Self) -> "List[_2505.ConcentricPartGroup]":
