...
class GuideDxfModel(_2462.Component):
    """GuideDxfModel
    ...
    class _Cast_GuideDxfModel:
        ...
        @property
        def component(self: "GuideDxfModel._Cast_GuideDxfModel") -> "_2462.Component":
            return self._parent._cast(_2462.Component)

        @property
        def part(self: "GuideDxfModel._Cast_GuideDxfModel") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486
