...
from mastapy.materials.efficiency import _307
...
if TYPE_CHECKING:
    ...
    from mastapy.materials.efficiency import _308
...
class OilSeal(_2465.Connector):
    ...
    class _Cast_OilSeal:
        ...
        @property
        def connector(self: "OilSeal._Cast_OilSeal") -> "_2465.Connector":
        ...
        @property
        def component(self: "OilSeal._Cast_OilSeal") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "OilSeal._Cast_OilSeal") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "OilSeal._Cast_OilSeal") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
    ...
    @property
    def drag_torque_vs_rotational_speed(self: Self) -> "_1547.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def oil_seal_loss_calculation_method(
        self: Self, value: "_307.OilSealLossCalculationMethod"
    ):
    ...
    @property
    def oil_seal_material(self: Self) -> "_308.OilSealMaterialType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials.efficiency._308", "OilSealMaterialType"
        )(value)

    @oil_seal_material.setter
    @enforce_parameter_types
    def oil_seal_material(self: Self, value: "_308.OilSealMaterialType"):
    ...
    @property
    def oil_seal_orientation(self: Self) -> "_1978.Orientations":
    ...
    @enforce_parameter_types
    def oil_seal_orientation(self: Self, value: "_1978.Orientations"):
        value = conversion.mp_to_pn_enum(
