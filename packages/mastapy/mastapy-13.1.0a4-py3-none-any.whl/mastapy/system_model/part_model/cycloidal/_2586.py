...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.cycloidal import _2588, _2587
...
class CycloidalAssembly(_2494.SpecialisedAssembly):
    """CycloidalAssembly
    ...
    class _Cast_CycloidalAssembly:
        ...
        @property
        def part(self: "CycloidalAssembly._Cast_CycloidalAssembly") -> "_2486.Part":
    ...
    @property
    def cycloidal_assembly_design(self: Self) -> "_1465.CycloidalAssemblyDesign":
    ...
    @property
    def ring_pins(self: Self) -> "_2588.RingPins":
    ...
    @property
    def known_designs(self: Self) -> "List[_1465.CycloidalAssemblyDesign]":
    ...
    def add_disc(self: Self) -> "_2587.CycloidalDisc":
    ...
    def design_named(self: Self, name: "str") -> "_1465.CycloidalAssemblyDesign":
        """mastapy.cycloidal.CycloidalAssemblyDesign
    ...
    def set_active_cycloidal_assembly_design(
        self: Self, cycloidal_assembly_design: "_1465.CycloidalAssemblyDesign"
    ):
        """Method does not return.
    ...
    def try_remove_design(
        self: Self, design: "_1465.CycloidalAssemblyDesign"
    ) -> "bool":
        """bool
