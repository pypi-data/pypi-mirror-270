...
if TYPE_CHECKING:
    from mastapy.cycloidal import _1474, _1475
...
class RingPins(_2482.MountableComponent):
    """RingPins
    ...
    class _Cast_RingPins:
        ...
        @property
        def component(self: "RingPins._Cast_RingPins") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "RingPins._Cast_RingPins") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "RingPins._Cast_RingPins") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
    ...
    @property
    def ring_pins_design(self: Self) -> "_1474.RingPinsDesign":
    ...
    @property
    def ring_pins_material(self: Self) -> "_1475.RingPinsMaterial":
