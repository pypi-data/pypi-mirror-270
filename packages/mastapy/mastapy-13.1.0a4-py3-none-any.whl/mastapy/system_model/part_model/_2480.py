...
class MassDisc(_2497.VirtualComponent):
    """MassDisc
    ...
    class _Cast_MassDisc:
        ...
        @property
        def component(self: "MassDisc._Cast_MassDisc") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "MassDisc._Cast_MassDisc") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "MassDisc._Cast_MassDisc") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
