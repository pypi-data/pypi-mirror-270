...
from mastapy.bearings.bearing_results import _1960, _1979
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1890, _1903, _1886
...
class Bearing(_2465.Connector):
    ...
    class _Cast_Bearing:
        ...
        @property
        def connector(self: "Bearing._Cast_Bearing") -> "_2465.Connector":
        ...
        @property
        def component(self: "Bearing._Cast_Bearing") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "Bearing._Cast_Bearing") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "Bearing._Cast_Bearing") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
    ...
    @enforce_parameter_types
    def bearing_tolerance_class(self: Self, value: "_1920.BearingToleranceClass"):
    ...
    def bearing_tolerance_definition(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1921", "BearingToleranceDefinitionOptions"
        )(value)

    @bearing_tolerance_definition.setter
    @enforce_parameter_types
    def bearing_tolerance_definition(
        self: Self, value: "_1921.BearingToleranceDefinitionOptions"
    ):
    ...
    @property
    def damping_options(self: Self) -> "_1890.BearingDampingMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1890", "BearingDampingMatrixOption"
        )(value)

    @damping_options.setter
    @enforce_parameter_types
    def damping_options(self: Self, value: "_1890.BearingDampingMatrixOption"):
        value = conversion.mp_to_pn_enum(
    ...
    def efficiency_rating_method(
        self: Self,
        value: "Union[_299.BearingEfficiencyRatingMethod, Tuple[_299.BearingEfficiencyRatingMethod, bool]]",
    ):
        wrapper_type = (
    ...
    def force_at_zero_displacement_input_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model._2458", "BearingF0InputMethod"
        )(value)

    @force_at_zero_displacement_input_method.setter
    @enforce_parameter_types
    def force_at_zero_displacement_input_method(
        self: Self, value: "_2458.BearingF0InputMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def inner_fitting_chart(self: Self) -> "_1799.SimpleChartDefinition":
    ...
    @property
    def journal_bearing_type(self: Self) -> "_1903.JournalBearingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1903", "JournalBearingType"
        )(value)

    @journal_bearing_type.setter
    @enforce_parameter_types
    def journal_bearing_type(self: Self, value: "_1903.JournalBearingType"):
        value = conversion.mp_to_pn_enum(
    ...
    @model.setter
    @enforce_parameter_types
    def model(self: Self, value: "_1894.BearingModel"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def outer_fitting_chart(self: Self) -> "_1799.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    def permissible_axial_load_calculation_method(
        self: Self,
        value: "Union[_1960.CylindricalRollerMaxAxialLoadMethod, Tuple[_1960.CylindricalRollerMaxAxialLoadMethod, bool]]",
    ):
        wrapper_type = (
    ...
    @preload.setter
    @enforce_parameter_types
    def preload(self: Self, value: "_1979.PreloadType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def detail(self: Self) -> "_2148.BearingDesign":
    ...
    @property
    def friction_coefficients(self: Self) -> "_2088.RollingBearingFrictionCoefficients":
    ...
    @property
    def inner_support_detail(self: Self) -> "_1937.SupportDetail":
    ...
    @property
    def left_support_detail(self: Self) -> "_1937.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def outer_support_detail(self: Self) -> "_1937.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def overridden_lubrication_detail(self: Self) -> "_274.LubricationDetail":
    ...
    @property
    def right_support_detail(self: Self) -> "_1937.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def ring_tolerance_inner(self: Self) -> "_1923.InnerRingTolerance":
    ...
    @property
    def ring_tolerance_left(self: Self) -> "_1934.RingTolerance":
    ...
    @property
    def ring_tolerance_outer(self: Self) -> "_1929.OuterRingTolerance":
    ...
    @property
    def ring_tolerance_right(self: Self) -> "_1934.RingTolerance":
        """mastapy.bearings.tolerances.RingTolerance
    ...
    @property
    def simple_bearing_detail_property(self: Self) -> "_2148.BearingDesign":
        """mastapy.bearings.bearing_designs.BearingDesign
    ...
    @property
    def support_tolerance_inner(self: Self) -> "_1924.InnerSupportTolerance":
        """mastapy.bearings.tolerances.InnerSupportTolerance
    ...
    @property
    def support_tolerance_left(self: Self) -> "_1939.SupportTolerance":
    ...
    @property
    def support_tolerance_outer(self: Self) -> "_1930.OuterSupportTolerance":
        """mastapy.bearings.tolerances.OuterSupportTolerance
    ...
    @property
    def support_tolerance_right(self: Self) -> "_1939.SupportTolerance":
        """mastapy.bearings.tolerances.SupportTolerance
    ...
    @property
    def mounting(self: Self) -> "List[_2459.BearingRaceMountingOptions]":
    ...
    @property
    def tolerance_combinations(self: Self) -> "List[_1941.ToleranceCombination]":
    ...
    def set_detail_from_catalogue(
        self: Self, catalogue: "_1886.BearingCatalog", designation: "str"
    ):
    ...
    def try_attach_left_side_to(
        self: Self, shaft: "_2500.Shaft", offset: "float" = float("nan")
