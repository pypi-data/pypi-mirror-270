...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears import _2557, _2559, _2550
...
class KlingelnbergCycloPalloidConicalGearSet(_2542.ConicalGearSet):
    """KlingelnbergCycloPalloidConicalGearSet
    ...
    @property
    def conical_gear_set_design(self: Self) -> "_991.KlingelnbergConicalGearSetDesign":
