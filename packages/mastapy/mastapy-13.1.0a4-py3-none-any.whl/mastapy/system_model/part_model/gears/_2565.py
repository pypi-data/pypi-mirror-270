...
class StraightBevelGear(_2537.BevelGear):
    """StraightBevelGear
    ...
    class _Cast_StraightBevelGear:
        ...
        @property
        def gear(self: "StraightBevelGear._Cast_StraightBevelGear") -> "_2548.Gear":
        ...
        @property
        def part(self: "StraightBevelGear._Cast_StraightBevelGear") -> "_2486.Part":
    ...
    @property
    def bevel_gear_design(self: Self) -> "_969.StraightBevelGearDesign":
    ...
    @property
    def straight_bevel_gear_design(self: Self) -> "_969.StraightBevelGearDesign":
        """mastapy.gears.gear_designs.straight_bevel.StraightBevelGearDesign
