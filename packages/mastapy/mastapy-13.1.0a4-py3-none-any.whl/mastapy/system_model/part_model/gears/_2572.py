...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears import _2571, _2532, _2542, _2550
...
class ZerolBevelGearSet(_2538.BevelGearSet):
    """ZerolBevelGearSet
    ...
    class _Cast_ZerolBevelGearSet:
        ...
        @property
        def part(self: "ZerolBevelGearSet._Cast_ZerolBevelGearSet") -> "_2486.Part":
    ...
    @property
    def conical_gear_set_design(self: Self) -> "_962.ZerolBevelGearSetDesign":
    ...
    @property
    def zerol_bevel_gear_set_design(self: Self) -> "_962.ZerolBevelGearSetDesign":
        """mastapy.gears.gear_designs.zerol_bevel.ZerolBevelGearSetDesign
    ...
    @property
    def zerol_bevel_gears(self: Self) -> "List[_2571.ZerolBevelGear]":
    ...
    @property
    def zerol_bevel_meshes(self: Self) -> "List[_2349.ZerolBevelGearMesh]":
