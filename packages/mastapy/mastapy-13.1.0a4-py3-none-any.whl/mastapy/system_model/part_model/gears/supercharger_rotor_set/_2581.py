...
class SuperchargerRotorSet(_1844.NamedDatabaseItem):
    """SuperchargerRotorSet
    ...
    @property
    def supercharger_map_chart(self: Self) -> "_1882.ThreeDChartDefinition":
    ...
    @property
    def y_variable_for_imported_data(self: Self) -> "_2583.YVariableForImportedData":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model.gears.supercharger_rotor_set._2583",
    ...
    def y_variable_for_imported_data(
        self: Self, value: "_2583.YVariableForImportedData"
    ):
    ...
    @property
    def boost_pressure(self: Self) -> "_2573.BoostPressureInputOptions":
    ...
    @property
    def file(self: Self) -> "_2576.RotorSetDataInputFileOptions":
    ...
    @property
    def input_power(self: Self) -> "_2574.InputPowerInputOptions":
    ...
    @property
    def pressure_ratio(self: Self) -> "_2575.PressureRatioInputOptions":
    ...
    @property
    def rotor_speed(self: Self) -> "_2578.RotorSpeedInputOptions":
    ...
    @property
    def measured_points(self: Self) -> "List[_2577.RotorSetMeasuredPoint]":
