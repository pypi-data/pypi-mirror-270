...
class WormGearSet(_2550.GearSet):
    """WormGearSet
    ...
    class _Cast_WormGearSet:
        ...
        @property
        def gear_set(self: "WormGearSet._Cast_WormGearSet") -> "_2550.GearSet":
        ...
        @property
        def part(self: "WormGearSet._Cast_WormGearSet") -> "_2486.Part":
    ...
    @property
    def active_gear_set_design(self: Self) -> "_967.WormGearSetDesign":
    ...
    @property
    def worm_gear_set_design(self: Self) -> "_967.WormGearSetDesign":
        """mastapy.gears.gear_designs.worm.WormGearSetDesign
    ...
    @property
    def worm_gears(self: Self) -> "List[_2569.WormGear]":
    ...
    @property
    def worm_meshes(self: Self) -> "List[_2347.WormGearMesh]":
