...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.configurations import _2641
...
class ActiveCylindricalGearSetDesignSelection(_2529.ActiveGearSetDesignSelection):
    """ActiveCylindricalGearSetDesignSelection
    ...
    class _Cast_ActiveCylindricalGearSetDesignSelection:
        ...
        def part_detail_selection(
            ...
            return self._parent._cast(_2641.PartDetailSelection)
