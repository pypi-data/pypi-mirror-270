...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.gears import _2543, _2545, _2550
...
class PlanetaryGearSet(_2544.CylindricalGearSet):
    """PlanetaryGearSet
    ...
    class _Cast_PlanetaryGearSet:
        ...
        @property
        def part(self: "PlanetaryGearSet._Cast_PlanetaryGearSet") -> "_2486.Part":
    ...
    @property
    def annuluses(self: Self) -> "List[_2543.CylindricalGear]":
    ...
    @property
    def planets(self: Self) -> "List[_2545.CylindricalPlanetGear]":
    ...
    @property
    def suns(self: Self) -> "List[_2543.CylindricalGear]":
        """List[mastapy.system_model.part_model.gears.CylindricalGear]
    ...
    def add_annulus(self: Self) -> "_2543.CylindricalGear":
    ...
    def add_planet(self: Self) -> "_2543.CylindricalGear":
        """mastapy.system_model.part_model.gears.CylindricalGear"""
    ...
    def add_sun(self: Self) -> "_2543.CylindricalGear":
        """mastapy.system_model.part_model.gears.CylindricalGear"""
