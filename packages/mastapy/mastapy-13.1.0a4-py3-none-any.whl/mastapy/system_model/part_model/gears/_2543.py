...
class CylindricalGear(_2548.Gear):
    """CylindricalGear
    ...
    class _Cast_CylindricalGear:
        ...
        @property
        def gear(self: "CylindricalGear._Cast_CylindricalGear") -> "_2548.Gear":
        ...
        @property
        def part(self: "CylindricalGear._Cast_CylindricalGear") -> "_2486.Part":
    ...
    @property
    def active_gear_design(self: Self) -> "_1020.CylindricalGearDesign":
    ...
    @property
    def cylindrical_gear_design(self: Self) -> "_1020.CylindricalGearDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearDesign
