...
class Gear(_2482.MountableComponent):
    """Gear
    ...
    class _Cast_Gear:
        ...
        @property
        def mountable_component(self: "Gear._Cast_Gear") -> "_2482.MountableComponent":
            return self._parent._cast(_2482.MountableComponent)

        @property
        def component(self: "Gear._Cast_Gear") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "Gear._Cast_Gear") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "Gear._Cast_Gear") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
        ...
        @property
        def bevel_gear(self: "Gear._Cast_Gear") -> "_2537.BevelGear":
            from mastapy.system_model.part_model.gears import _2537

            return self._parent._cast(_2537.BevelGear)

        @property
        def concept_gear(self: "Gear._Cast_Gear") -> "_2539.ConceptGear":
            from mastapy.system_model.part_model.gears import _2539

            return self._parent._cast(_2539.ConceptGear)

        @property
        def conical_gear(self: "Gear._Cast_Gear") -> "_2541.ConicalGear":
            from mastapy.system_model.part_model.gears import _2541

            return self._parent._cast(_2541.ConicalGear)

        @property
        def cylindrical_gear(self: "Gear._Cast_Gear") -> "_2543.CylindricalGear":
        ...
        @property
        def face_gear(self: "Gear._Cast_Gear") -> "_2546.FaceGear":
            from mastapy.system_model.part_model.gears import _2546

            return self._parent._cast(_2546.FaceGear)

        @property
        def hypoid_gear(self: "Gear._Cast_Gear") -> "_2552.HypoidGear":
        ...
        @property
        def spiral_bevel_gear(self: "Gear._Cast_Gear") -> "_2561.SpiralBevelGear":
        ...
        @property
        def straight_bevel_gear(self: "Gear._Cast_Gear") -> "_2565.StraightBevelGear":
        ...
        @property
        def worm_gear(self: "Gear._Cast_Gear") -> "_2569.WormGear":
            from mastapy.system_model.part_model.gears import _2569

            return self._parent._cast(_2569.WormGear)

        @property
        def zerol_bevel_gear(self: "Gear._Cast_Gear") -> "_2571.ZerolBevelGear":
    ...
    @property
    def active_gear_design(self: Self) -> "_955.GearDesign":
    ...
    @property
    def gear_set(self: Self) -> "_2550.GearSet":
    ...
    @property
    def shaft(self: Self) -> "_2500.Shaft":
