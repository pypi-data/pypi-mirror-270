...
class WormGear(_2548.Gear):
    ...
    class _Cast_WormGear:
        ...
        @property
        def gear(self: "WormGear._Cast_WormGear") -> "_2548.Gear":
        ...
        @property
        def component(self: "WormGear._Cast_WormGear") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "WormGear._Cast_WormGear") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "WormGear._Cast_WormGear") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
    ...
    @property
    def active_gear_design(self: Self) -> "_965.WormGearDesign":
    ...
    @property
    def worm_gear_design(self: Self) -> "_965.WormGearDesign":
        """mastapy.gears.gear_designs.worm.WormGearDesign
