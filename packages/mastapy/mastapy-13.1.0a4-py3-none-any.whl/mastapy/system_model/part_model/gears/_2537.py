...
class BevelGear(_2531.AGMAGleasonConicalGear):
    """BevelGear
    ...
    class _Cast_BevelGear:
        ...
        @property
        def conical_gear(self: "BevelGear._Cast_BevelGear") -> "_2541.ConicalGear":
            from mastapy.system_model.part_model.gears import _2541

            return self._parent._cast(_2541.ConicalGear)

        @property
        def gear(self: "BevelGear._Cast_BevelGear") -> "_2548.Gear":
        ...
        @property
        def component(self: "BevelGear._Cast_BevelGear") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "BevelGear._Cast_BevelGear") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "BevelGear._Cast_BevelGear") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
    ...
    @property
    def conical_gear_design(self: Self) -> "_1190.BevelGearDesign":
