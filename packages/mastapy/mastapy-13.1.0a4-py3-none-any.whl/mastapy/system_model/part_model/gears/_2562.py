...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears import _2561, _2532, _2542, _2550
...
class SpiralBevelGearSet(_2538.BevelGearSet):
    """SpiralBevelGearSet
    ...
    class _Cast_SpiralBevelGearSet:
        ...
        @property
        def part(self: "SpiralBevelGearSet._Cast_SpiralBevelGearSet") -> "_2486.Part":
    ...
    @property
    def conical_gear_set_design(self: Self) -> "_979.SpiralBevelGearSetDesign":
    ...
    @property
    def spiral_bevel_gear_set_design(self: Self) -> "_979.SpiralBevelGearSetDesign":
        """mastapy.gears.gear_designs.spiral_bevel.SpiralBevelGearSetDesign
    ...
    @property
    def spiral_bevel_gears(self: Self) -> "List[_2561.SpiralBevelGear]":
    ...
    @property
    def spiral_bevel_meshes(self: Self) -> "List[_2341.SpiralBevelGearMesh]":
