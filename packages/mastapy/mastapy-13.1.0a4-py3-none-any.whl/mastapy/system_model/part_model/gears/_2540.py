...
class ConceptGearSet(_2550.GearSet):
    """ConceptGearSet
    ...
    class _Cast_ConceptGearSet:
        ...
        @property
        def gear_set(self: "ConceptGearSet._Cast_ConceptGearSet") -> "_2550.GearSet":
        ...
        @property
        def part(self: "ConceptGearSet._Cast_ConceptGearSet") -> "_2486.Part":
    ...
    @property
    def active_gear_set_design(self: Self) -> "_1188.ConceptGearSetDesign":
    ...
    @property
    def concept_gear_set_design(self: Self) -> "_1188.ConceptGearSetDesign":
        """mastapy.gears.gear_designs.concept.ConceptGearSetDesign
    ...
    @property
    def concept_gears(self: Self) -> "List[_2539.ConceptGear]":
    ...
    @property
    def concept_meshes(self: Self) -> "List[_2323.ConceptGearMesh]":
