...
from mastapy.bearings.bearing_results import _1981, _1982
...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model import _2476, _2485
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    class _Cast_BearingRaceMountingOptions:
        ...
        def inner_bearing_race_mounting_options(
            ...
            return self._parent._cast(_2476.InnerBearingRaceMountingOptions)
        ...
        def outer_bearing_race_mounting_options(
            ...
            return self._parent._cast(_2485.OuterBearingRaceMountingOptions)
    ...
    def axial_mounting(self: Self, value: "_1981.RaceAxialMountingType"):
    ...
    @enforce_parameter_types
    def simple_radial_mounting(self: Self, value: "_1982.RaceRadialMountingType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def mounting_sleeve_material(self: Self) -> "_252.BearingMaterial":
