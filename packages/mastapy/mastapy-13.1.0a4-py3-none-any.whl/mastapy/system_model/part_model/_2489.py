...
class PointLoad(_2497.VirtualComponent):
    """PointLoad
    ...
    class _Cast_PointLoad:
        ...
        @property
        def component(self: "PointLoad._Cast_PointLoad") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "PointLoad._Cast_PointLoad") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "PointLoad._Cast_PointLoad") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
