...
if TYPE_CHECKING:
    from mastapy.system_model import _2233
...
class PlanetCarrierSettings(_1607.PerMachineSettings):
    """PlanetCarrierSettings
    ...
    def planet_pin_manufacturing_errors_coordinate_system(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2233", "PlanetPinManufacturingErrorsCoordinateSystem"
        )(value)

    @planet_pin_manufacturing_errors_coordinate_system.setter
    @enforce_parameter_types
    def planet_pin_manufacturing_errors_coordinate_system(
        self: Self, value: "_2233.PlanetPinManufacturingErrorsCoordinateSystem"
    ):
