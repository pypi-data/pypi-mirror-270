...
from mastapy.system_model.part_model.couplings import _2611, _2614, _2615
...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.splines import _1422, _1427
...
class ShaftHubConnection(_2465.Connector):
    """ShaftHubConnection
    ...
    class _Cast_ShaftHubConnection:
        ...
        @property
        def part(self: "ShaftHubConnection._Cast_ShaftHubConnection") -> "_2486.Part":
    ...
    @property
    def spline_type(self: Self) -> "_1422.SplineDesignTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1422", "SplineDesignTypes"
        )(value)

    @spline_type.setter
    @enforce_parameter_types
    def spline_type(self: Self, value: "_1422.SplineDesignTypes"):
    ...
    @enforce_parameter_types
    def stiffness_type(self: Self, value: "_2611.RigidConnectorStiffnessType"):
    ...
    @property
    def tilt_stiffness_type(self: Self) -> "_2612.RigidConnectorTiltStiffnessTypes":
    ...
    def tilt_stiffness_type(
        self: Self, value: "_2612.RigidConnectorTiltStiffnessTypes"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.RigidConnectorTiltStiffnessTypes",
    ...
    @enforce_parameter_types
    def tooth_spacing_type(self: Self, value: "_2614.RigidConnectorToothSpacingType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: Self, value: "_2615.RigidConnectorTypes"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def interference_fit_design(self: Self) -> "_1457.InterferenceFitDesign":
    ...
    @property
    def major_fit_options(self: Self) -> "_2619.SplineFitOptions":
    ...
    @property
    def minor_fit_options(self: Self) -> "_2619.SplineFitOptions":
        """mastapy.system_model.part_model.couplings.SplineFitOptions
    ...
    @property
    def spline_joint_design(self: Self) -> "_1427.SplineJointDesign":
    ...
    @property
    def spline_pitch_error_options(self: Self) -> "_2622.SplinePitchErrorOptions":
    ...
    @property
    def fit_options(self: Self) -> "List[_2619.SplineFitOptions]":
    ...
    def tooth_locations_external_spline_half(
        self: Self,
    ) -> "List[_2613.RigidConnectorToothLocation]":
