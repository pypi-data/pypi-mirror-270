...
class ConceptCoupling(_2602.Coupling):
    """ConceptCoupling
    ...
    class _Cast_ConceptCoupling:
        ...
        @property
        def coupling(self: "ConceptCoupling._Cast_ConceptCoupling") -> "_2602.Coupling":
        ...
        @property
        def part(self: "ConceptCoupling._Cast_ConceptCoupling") -> "_2486.Part":
    ...
    @property
    def efficiency_vs_speed_ratio(self: Self) -> "_1547.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def efficiency_vs_speed_ratio(self: Self, value: "_1547.Vector2DListAccessor"):
        self.wrapped.EfficiencyVsSpeedRatio = value.wrapped

    @property
    def half_positioning(self: Self) -> "_2601.ConceptCouplingHalfPositioning":
    ...
    @enforce_parameter_types
    def half_positioning(self: Self, value: "_2601.ConceptCouplingHalfPositioning"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.PartModel.Couplings.ConceptCouplingHalfPositioning",
        )
