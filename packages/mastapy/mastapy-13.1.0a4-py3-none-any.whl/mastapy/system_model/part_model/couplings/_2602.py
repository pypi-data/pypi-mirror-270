...
class Coupling(_2494.SpecialisedAssembly):
    """Coupling
    ...
    class _Cast_Coupling:
        ...
        @property
        def part(self: "Coupling._Cast_Coupling") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "Coupling._Cast_Coupling") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221

            return self._parent._cast(_2221.DesignEntity)

        @property
        def clutch(self: "Coupling._Cast_Coupling") -> "_2596.Clutch":
        ...
        @property
        def spring_damper(self: "Coupling._Cast_Coupling") -> "_2623.SpringDamper":
    ...
    @property
    def halves(self: Self) -> "List[_2603.CouplingHalf]":
    ...
    @property
    def half_a(self: Self) -> "_2603.CouplingHalf":
    ...
    @property
    def half_b(self: Self) -> "_2603.CouplingHalf":
        """mastapy.system_model.part_model.couplings.CouplingHalf
