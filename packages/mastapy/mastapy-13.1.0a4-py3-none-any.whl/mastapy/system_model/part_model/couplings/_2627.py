...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.couplings import _2626, _2603
...
class SynchroniserHalf(_2628.SynchroniserPart):
    """SynchroniserHalf
    ...
    class _Cast_SynchroniserHalf:
        ...
        @property
        def part(self: "SynchroniserHalf._Cast_SynchroniserHalf") -> "_2486.Part":
    ...
    @property
    def cones(self: Self) -> "List[_2626.SynchroniserCone]":
