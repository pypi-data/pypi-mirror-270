...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.couplings import _2631, _2633
...
class TorqueConverter(_2602.Coupling):
    """TorqueConverter
    ...
    class _Cast_TorqueConverter:
        ...
        @property
        def coupling(self: "TorqueConverter._Cast_TorqueConverter") -> "_2602.Coupling":
        ...
        @property
        def part(self: "TorqueConverter._Cast_TorqueConverter") -> "_2486.Part":
    ...
    @property
    def pump(self: Self) -> "_2631.TorqueConverterPump":
    ...
    @property
    def turbine(self: Self) -> "_2633.TorqueConverterTurbine":
