...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2461, _2486
...
class Bolt(_2462.Component):
    ...
    class _Cast_Bolt:
        ...
        @property
        def component(self: "Bolt._Cast_Bolt") -> "_2462.Component":
            return self._parent._cast(_2462.Component)

        @property
        def part(self: "Bolt._Cast_Bolt") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "Bolt._Cast_Bolt") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
    ...
    @property
    def bolted_joint(self: Self) -> "_2461.BoltedJoint":
    ...
    @property
    def loaded_bolt(self: Self) -> "_1494.LoadedBolt":
