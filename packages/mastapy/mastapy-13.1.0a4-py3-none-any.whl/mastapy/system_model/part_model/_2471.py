...
class FEPart(_2454.AbstractShaftOrHousing):
    """FEPart
    ...
    class _Cast_FEPart:
        ...
        @property
        def component(self: "FEPart._Cast_FEPart") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "FEPart._Cast_FEPart") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "FEPart._Cast_FEPart") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
    ...
    @enforce_parameter_types
    def default_fe_substructure(self: Self, value: "_2401.FESubstructure"):
        wrapper_type = (
    ...
    def create_fe_substructure(self: Self) -> "_2401.FESubstructure":
    ...
    def remove_fe_substructure(
        self: Self, fe_substructure: "_2401.FESubstructure"
    ) -> "bool":
        """bool
    ...
    @enforce_parameter_types
    def select_fe_substructure(self: Self, fe_substructure: "_2401.FESubstructure"):
