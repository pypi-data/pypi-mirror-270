...
class Datum(_2462.Component):
    ...
    class _Cast_Datum:
        ...
        @property
        def component(self: "Datum._Cast_Datum") -> "_2462.Component":
            return self._parent._cast(_2462.Component)

        @property
        def part(self: "Datum._Cast_Datum") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "Datum._Cast_Datum") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
