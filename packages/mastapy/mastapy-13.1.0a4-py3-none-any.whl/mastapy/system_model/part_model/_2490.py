...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2467, _2499, _2482, _2462, _2486
...
class PowerLoad(_2497.VirtualComponent):
    """PowerLoad
    ...
    class _Cast_PowerLoad:
        ...
        @property
        def component(self: "PowerLoad._Cast_PowerLoad") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "PowerLoad._Cast_PowerLoad") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "PowerLoad._Cast_PowerLoad") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
    ...
    @enforce_parameter_types
    def electric_machine_detail_selector(
        self: Self, value: "_1272.ElectricMachineDetail"
    ):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def electric_machine_search_region_specification_method(
        self: Self, value: "_2467.ElectricMachineSearchRegionSpecificationMethod"
    ):
    ...
    @property
    def engine_fuel_consumption_grid(self: Self) -> "_1577.GriddedSurfaceAccessor":
    ...
    @enforce_parameter_types
    def engine_fuel_consumption_grid(self: Self, value: "_1577.GriddedSurfaceAccessor"):
        self.wrapped.EngineFuelConsumptionGrid = value.wrapped

    @property
    def engine_torque_grid(self: Self) -> "_1577.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @enforce_parameter_types
    def engine_torque_grid(self: Self, value: "_1577.GriddedSurfaceAccessor"):
    ...
    @enforce_parameter_types
    def power_load_type(self: Self, value: "_2237.PowerLoadType"):
    ...
    @property
    def electric_machine_detail(self: Self) -> "_1272.ElectricMachineDetail":
    ...
    @property
    def oil_pump_detail(self: Self) -> "_305.OilPumpDetail":
    ...
    @property
    def single_blade_details(self: Self) -> "_2499.WindTurbineSingleBladeDetails":
