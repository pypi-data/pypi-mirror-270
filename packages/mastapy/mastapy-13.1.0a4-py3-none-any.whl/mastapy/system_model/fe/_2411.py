...
if TYPE_CHECKING:
    from mastapy.nodal_analysis.dev_tools_analyses import _186, _195
    from mastapy.nodal_analysis import _64
    from mastapy.system_model.fe import _2405, _2378
...
class FESubstructureWithSelectionForModalAnalysis(_2408.FESubstructureWithSelection):
    """FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def modal_draw_style(self: Self) -> "_195.FEModelModalAnalysisDrawStyle":
    ...
    def full_fe_mode_shapes_at_condensation_nodes(
        self: Self,
    ) -> "List[_2405.FESubstructureNodeModeShapes]":
