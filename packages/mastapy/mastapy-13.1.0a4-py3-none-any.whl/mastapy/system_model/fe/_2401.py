...
from mastapy.system_model.part_model import _2462, _2466
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.utility.units_and_measurements import _1623
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.fe import _2429, _2406
...
if TYPE_CHECKING:
    ...
    from mastapy.nodal_analysis.component_mode_synthesis import _240, _233
    from mastapy.materials import _244, _290
    from mastapy.system_model import _2238
    from mastapy.math_utility import _1511
    from mastapy.system_model.part_model import _2471
    from mastapy.nodal_analysis.geometry_modeller_link import _162, _164
...
class FESubstructure(_66.FEStiffness):
    ...
    @property
    def alignment_method(self: Self) -> "_2374.AlignmentMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2374", "AlignmentMethod"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(self: Self, value: "_2374.AlignmentMethod"):
    ...
    @property
    def bearing_node_alignment(self: Self) -> "_2380.BearingNodeAlignmentOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2380", "BearingNodeAlignmentOption"
        )(value)

    @bearing_node_alignment.setter
    @enforce_parameter_types
    def bearing_node_alignment(self: Self, value: "_2380.BearingNodeAlignmentOption"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def component_to_align_to(self: Self, value: "_2462.Component"):
        wrapper_type = (
    ...
    @datum.setter
    @enforce_parameter_types
    def datum(self: Self, value: "_2466.Datum"):
    ...
    @enforce_parameter_types
    def distance_display_unit(self: Self, value: "_1623.Unit"):
    ...
    @enforce_parameter_types
    def force_display_unit(self: Self, value: "_1623.Unit"):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @property
    def reduction_mode_type(self: Self) -> "_240.ReductionModeType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.nodal_analysis.component_mode_synthesis._240", "ReductionModeType"
        )(value)

    @reduction_mode_type.setter
    @enforce_parameter_types
    def reduction_mode_type(self: Self, value: "_240.ReductionModeType"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def thermal_expansion_option(self: Self, value: "_2429.ThermalExpansionOption"):
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: Self, value: "_2406.FESubstructureType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def acoustic_radiation_efficiency(self: Self) -> "_244.AcousticRadiationEfficiency":
    ...
    def alignment_to_component(
        self: Self,
    ) -> "_2238.RelativeComponentAlignment[_2462.Component]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2462.Component](temp)

    @property
    def cms_model(self: Self) -> "_233.CMSModel":
    ...
    @property
    def coordinate_system(self: Self) -> "_1511.CoordinateSystem3D":
    ...
    @property
    def export(self: Self) -> "_2402.FESubstructureExportOptions":
    ...
    @property
    def fe_part(self: Self) -> "_2471.FEPart":
    ...
    @property
    def sound_pressure_enclosure(self: Self) -> "_290.SoundPressureEnclosure":
    ...
    @property
    def gear_meshing_options(self: Self) -> "List[_2413.GearMeshingOptions]":
    ...
    @property
    def geometries(self: Self) -> "List[_2399.FEStiffnessGeometry]":
    ...
    def independent_masta_created_condensation_nodes(
        self: Self,
    ) -> "List[_2414.IndependentMASTACreatedCondensationNode]":
    ...
    @property
    def links(self: Self) -> "List[_2436.FELink]":
    ...
    @property
    def nodes(self: Self) -> "List[_2403.FESubstructureNode]":
    ...
    @property
    def replaced_shafts(self: Self) -> "List[_2500.Shaft]":
    ...
    def shafts_that_can_be_replaced(
        self: Self,
    ) -> "List[_2427.ReplacedShaftSelectionHelper]":
    ...
    def import_fe_mesh(
        ...
        progress: Optional["_7585.TaskProgress"] = None,
    ):
        """Method does not return.
    ...
    def import_node_positions(
        self: Self, file_name: "str", distance_unit: "_1623.Unit"
    ):
        """Method does not return.
    ...
    def import_reduced_stiffness(
        self: Self,
        file_name: "str",
        distance_unit: "_1623.Unit",
        force_unit: "_1623.Unit",
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def links_for(self: Self, node: "_2403.FESubstructureNode") -> "List[_2436.FELink]":
        """List[mastapy.system_model.fe.links.FELink]
    ...
    def load_existing_masta_fe_file_with_progress(
        self: Self, file_name: "str", progress: "_7585.TaskProgress"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def load_stl_geometry(self: Self, length_unit: "_1623.Unit", file_name: "str"):
        """Method does not return.
