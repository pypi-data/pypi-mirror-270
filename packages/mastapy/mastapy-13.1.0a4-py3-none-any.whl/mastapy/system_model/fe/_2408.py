...
if TYPE_CHECKING:
    from mastapy.system_model.fe import _2401, _2393, _2419, _2409, _2410, _2411, _2412
...
class FESubstructureWithSelection(_2378.BaseFEWithSelection):
    """FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self: Self) -> "_2401.FESubstructure":
    ...
    @property
    def element_face_groups(self: Self) -> "List[_2393.ElementFaceGroupWithSelection]":
    ...
    @property
    def node_groups(self: Self) -> "List[_2419.NodeGroupWithSelection]":
