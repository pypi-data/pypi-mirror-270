...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.fe import _2418, _2378
...
class FESubstructureWithSelectionForStaticAnalysis(_2408.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    @enforce_parameter_types
    def contour_option(self: Self, value: "_1836.ThreeDViewContourOption"):
    ...
    @property
    def static_draw_style(self: Self) -> "_198.FEModelStaticAnalysisDrawStyle":
    ...
    def boundary_conditions_all_nodes(
        self: Self,
    ) -> "List[_2418.NodeBoundaryConditionStaticAnalysis]":
    ...
    @property
    def force_results(self: Self) -> "List[_1576.VectorWithLinearAndAngularComponents]":
        """List[mastapy.math_utility.measured_vectors.VectorWithLinearAndAngularComponents]
