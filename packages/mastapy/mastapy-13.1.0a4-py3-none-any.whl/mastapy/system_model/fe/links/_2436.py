...
from mastapy.system_model.fe import _2381, _2416, _2420, _2403
from mastapy.nodal_analysis.dev_tools_analyses import _209
...
class FELink(_0.APIBase):
    ...
    class _Cast_FELink:
        ...
        def electric_machine_stator_fe_link(
            ...
            return self._parent._cast(_2437.ElectricMachineStatorFELink)

        @property
        def gear_mesh_fe_link(self: "FELink._Cast_FELink") -> "_2439.GearMeshFELink":
        ...
        def multi_angle_connection_fe_link(
            ...
            return self._parent._cast(_2441.MultiAngleConnectionFELink)
        ...
        def multi_node_connector_fe_link(
            ...
            return self._parent._cast(_2442.MultiNodeConnectorFELink)

        @property
        def multi_node_fe_link(self: "FELink._Cast_FELink") -> "_2443.MultiNodeFELink":
        ...
        def planet_based_fe_link(
            ...
            return self._parent._cast(_2445.PlanetBasedFELink)
        ...
        @property
        def point_load_fe_link(self: "FELink._Cast_FELink") -> "_2447.PointLoadFELink":
            from mastapy.system_model.fe.links import _2447

            return self._parent._cast(_2447.PointLoadFELink)
        ...
        def shaft_hub_connection_fe_link(
            ...
            return self._parent._cast(_2449.ShaftHubConnectionFELink)
        ...
        def single_node_fe_link(
            ...
            return self._parent._cast(_2450.SingleNodeFELink)
    ...
    @enforce_parameter_types
    def bearing_node_link_option(self: Self, value: "_2381.BearingNodeOption"):
    ...
    def coupling_type(
        self: Self,
        value: "Union[_209.RigidCouplingType, Tuple[_209.RigidCouplingType, bool]]",
    ):
    ...
    @enforce_parameter_types
    def link_node_source(self: Self, value: "_2416.LinkNodeSource"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def node_selection_depth(
        self: Self,
        value: "Union[_2420.NodeSelectionDepthOption, Tuple[_2420.NodeSelectionDepthOption, bool]]",
    ):
    ...
    @property
    def component(self: Self) -> "_2482.MountableComponent":
    ...
    @property
    def socket(self: Self) -> "_2314.Socket":
    ...
    @property
    def support_material(self: Self) -> "_276.Material":
    ...
    def nodes_grouped_by_angle(
        self: Self,
    ) -> "OrderedDict[float, List[_2403.FESubstructureNode]]":
    ...
    @enforce_parameter_types
    def add_or_replace_node(self: Self, node: "_2403.FESubstructureNode"):
