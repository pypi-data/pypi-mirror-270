...
if TYPE_CHECKING:
    from mastapy.math_utility.measured_vectors import _1576, _1574
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def displacement_change(self: Self) -> "_1576.VectorWithLinearAndAngularComponents":
    ...
    @property
    def new_result(self: Self) -> "_1574.NodeResults":
    ...
    @property
    def original_result(self: Self) -> "_1574.NodeResults":
        """mastapy.math_utility.measured_vectors.NodeResults
