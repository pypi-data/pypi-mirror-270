...
class IndependentMASTACreatedCondensationNode(_0.APIBase):
    ...
    @property
    def rigid_coupling_type(self: Self) -> "_209.RigidCouplingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.nodal_analysis.dev_tools_analyses._209", "RigidCouplingType"
        )(value)

    @rigid_coupling_type.setter
    @enforce_parameter_types
    def rigid_coupling_type(self: Self, value: "_209.RigidCouplingType"):
    ...
    @property
    def fe_substructure_node(self: Self) -> "_2403.FESubstructureNode":
