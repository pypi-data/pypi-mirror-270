...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.load_case_groups import _5696, _5695
    from mastapy.system_model.optimization.system_optimiser import _2256, _2255
...
class SystemOptimiserDetails(_0.APIBase):
    ...
    def criteria_for_selecting_configurations_to_keep(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.load_case_groups._5696",
    ...
    @enforce_parameter_types
    def criteria_for_selecting_configurations_to_keep(
        self: Self, value: "_5696.SystemOptimiserTargets"
    ):
    ...
    @property
    def gear_set_optimisation(self: Self) -> "_5695.SystemOptimiserGearSetOptimisation":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.load_case_groups._5695",
    ...
    def gear_set_optimisation(
        self: Self, value: "_5695.SystemOptimiserGearSetOptimisation"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.LoadCaseGroups.SystemOptimiserGearSetOptimisation",
    ...
    @property
    def planet_gear_options(self: Self) -> "List[_2256.PlanetGearOptions]":
