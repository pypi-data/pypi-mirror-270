...
if TYPE_CHECKING:
    from mastapy.system_model.optimization import _2250, _2245, _2248
...
class OptimizationStep(_0.APIBase):
    ...
    class _Cast_OptimizationStep:
        ...
        def conical_gear_optimization_step(
            ...
            from mastapy.system_model.optimization import _2245

            return self._parent._cast(_2245.ConicalGearOptimizationStep)
        ...
        def cylindrical_gear_optimization_step(
            ...
            return self._parent._cast(_2248.CylindricalGearOptimizationStep)
    ...
    @property
    def optimisation_target(self: Self) -> "_2250.MicroGeometryOptimisationTarget":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.optimization._2250", "MicroGeometryOptimisationTarget"
        )(value)

    @optimisation_target.setter
    @enforce_parameter_types
    def optimisation_target(self: Self, value: "_2250.MicroGeometryOptimisationTarget"):
