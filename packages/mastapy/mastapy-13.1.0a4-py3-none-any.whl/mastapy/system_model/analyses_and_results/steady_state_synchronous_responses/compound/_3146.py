...
class AssemblyCompoundSteadyStateSynchronousResponse(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3013.AssemblySteadyStateSynchronousResponse]":
    ...
    def bearings(
        self: Self,
    ) -> "List[_3147.BearingCompoundSteadyStateSynchronousResponse]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_3149.BeltDriveCompoundSteadyStateSynchronousResponse]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_3152.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_3159.BoltedJointCompoundSteadyStateSynchronousResponse]":
    ...
    @property
    def bolts(self: Self) -> "List[_3158.BoltCompoundSteadyStateSynchronousResponse]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3180.CVTCompoundSteadyStateSynchronousResponse]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_3160.ClutchCompoundSteadyStateSynchronousResponse]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_3165.ConceptCouplingCompoundSteadyStateSynchronousResponse]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_3170.ConceptGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_3182.CycloidalAssemblyCompoundSteadyStateSynchronousResponse]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_3184.CycloidalDiscCompoundSteadyStateSynchronousResponse]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_3188.CylindricalGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_3195.FEPartCompoundSteadyStateSynchronousResponse]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_3194.FaceGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_3196.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponse]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_3203.HypoidGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_3210.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3213.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_3214.MassDiscCompoundSteadyStateSynchronousResponse]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_3215.MeasurementComponentCompoundSteadyStateSynchronousResponse]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_3217.OilSealCompoundSteadyStateSynchronousResponse]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_3219.PartToPartShearCouplingCompoundSteadyStateSynchronousResponse]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_3224.PlanetCarrierCompoundSteadyStateSynchronousResponse]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_3225.PointLoadCompoundSteadyStateSynchronousResponse]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_3226.PowerLoadCompoundSteadyStateSynchronousResponse]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_3228.RingPinsCompoundSteadyStateSynchronousResponse]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_3230.RollingRingAssemblyCompoundSteadyStateSynchronousResponse]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_3235.ShaftHubConnectionCompoundSteadyStateSynchronousResponse]":
    ...
    @property
    def shafts(self: Self) -> "List[_3234.ShaftCompoundSteadyStateSynchronousResponse]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3240.SpiralBevelGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_3241.SpringDamperCompoundSteadyStateSynchronousResponse]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_3246.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_3249.StraightBevelGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_3252.SynchroniserCompoundSteadyStateSynchronousResponse]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_3256.TorqueConverterCompoundSteadyStateSynchronousResponse]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_3260.UnbalancedMassCompoundSteadyStateSynchronousResponse]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_3264.WormGearSetCompoundSteadyStateSynchronousResponse]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_3267.ZerolBevelGearSetCompoundSteadyStateSynchronousResponse]":
