...
class AssemblyCompoundHarmonicAnalysis(_5905.AbstractAssemblyCompoundHarmonicAnalysis):
    """AssemblyCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5712.AssemblyHarmonicAnalysis]":
    ...
    @property
    def bearings(self: Self) -> "List[_5913.BearingCompoundHarmonicAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5915.BeltDriveCompoundHarmonicAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_5918.BevelDifferentialGearSetCompoundHarmonicAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_5925.BoltedJointCompoundHarmonicAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_5924.BoltCompoundHarmonicAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5946.CVTCompoundHarmonicAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_5926.ClutchCompoundHarmonicAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_5931.ConceptCouplingCompoundHarmonicAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_5936.ConceptGearSetCompoundHarmonicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5948.CycloidalAssemblyCompoundHarmonicAnalysis]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_5950.CycloidalDiscCompoundHarmonicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5954.CylindricalGearSetCompoundHarmonicAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5961.FEPartCompoundHarmonicAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_5960.FaceGearSetCompoundHarmonicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5962.FlexiblePinAssemblyCompoundHarmonicAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_5969.HypoidGearSetCompoundHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_5976.KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_5979.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysis]"
    ):
    ...
    @property
    def mass_discs(self: Self) -> "List[_5980.MassDiscCompoundHarmonicAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_5981.MeasurementComponentCompoundHarmonicAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5983.OilSealCompoundHarmonicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5985.PartToPartShearCouplingCompoundHarmonicAnalysis]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_5990.PlanetCarrierCompoundHarmonicAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5991.PointLoadCompoundHarmonicAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5992.PowerLoadCompoundHarmonicAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5994.RingPinsCompoundHarmonicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5996.RollingRingAssemblyCompoundHarmonicAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_6001.ShaftHubConnectionCompoundHarmonicAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_6000.ShaftCompoundHarmonicAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6006.SpiralBevelGearSetCompoundHarmonicAnalysis]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_6007.SpringDamperCompoundHarmonicAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6012.StraightBevelDiffGearSetCompoundHarmonicAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6015.StraightBevelGearSetCompoundHarmonicAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6018.SynchroniserCompoundHarmonicAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_6022.TorqueConverterCompoundHarmonicAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_6026.UnbalancedMassCompoundHarmonicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6030.WormGearSetCompoundHarmonicAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_6033.ZerolBevelGearSetCompoundHarmonicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_5712.AssemblyHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.AssemblyHarmonicAnalysis]
