...
class ConceptGearSetCompoundHarmonicAnalysis(_5965.GearSetCompoundHarmonicAnalysis):
    """ConceptGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5737.ConceptGearSetHarmonicAnalysis]":
    ...
    def concept_gears_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5934.ConceptGearCompoundHarmonicAnalysis]":
    ...
    def concept_meshes_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5935.ConceptGearMeshCompoundHarmonicAnalysis]":
