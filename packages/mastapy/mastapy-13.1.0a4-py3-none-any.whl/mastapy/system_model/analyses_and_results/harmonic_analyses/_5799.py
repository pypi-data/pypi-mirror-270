...
class HypoidGearSetHarmonicAnalysis(_5711.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """HypoidGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self: Self) -> "_2787.HypoidGearSetSystemDeflection":
    ...
    def agma_gleason_conical_gears_harmonic_analysis(
        self: Self,
    ) -> "List[_5797.HypoidGearHarmonicAnalysis]":
    ...
    def agma_gleason_conical_meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5798.HypoidGearMeshHarmonicAnalysis]":
