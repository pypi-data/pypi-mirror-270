...
class AssemblyHarmonicAnalysis(_5704.AbstractAssemblyHarmonicAnalysis):
    """AssemblyHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: Self) -> "_4602.AssemblyModalAnalysis":
    ...
    @property
    def bearings(self: Self) -> "List[_5713.BearingHarmonicAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5715.BeltDriveHarmonicAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_5724.BoltedJointHarmonicAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_5725.BoltHarmonicAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5747.CVTHarmonicAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_5728.ClutchHarmonicAnalysis]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_5734.ConceptCouplingHarmonicAnalysis]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_5737.ConceptGearSetHarmonicAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_5751.CycloidalDiscHarmonicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5755.CylindricalGearSetHarmonicAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5776.FEPartHarmonicAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_5775.FaceGearSetHarmonicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5777.FlexiblePinAssemblyHarmonicAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_5799.HypoidGearSetHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_5806.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5809.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysis]":
    ...
    @property
    def loaded_gear_sets(self: Self) -> "List[_5784.GearSetHarmonicAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_5810.MassDiscHarmonicAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5813.OilSealHarmonicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5817.PartToPartShearCouplingHarmonicAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_5821.PlanetCarrierHarmonicAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5822.PointLoadHarmonicAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5823.PowerLoadHarmonicAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5826.RingPinsHarmonicAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_5833.ShaftHubConnectionHarmonicAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_5832.ShaftHarmonicAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5840.SpiralBevelGearSetHarmonicAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_5843.SpringDamperHarmonicAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_5854.SynchroniserHarmonicAnalysis]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_5858.TorqueConverterHarmonicAnalysis]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_5862.UnbalancedMassHarmonicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_5866.WormGearSetHarmonicAnalysis]":
