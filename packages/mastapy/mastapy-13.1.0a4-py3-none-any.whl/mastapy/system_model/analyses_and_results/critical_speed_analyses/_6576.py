...
class AssemblyCriticalSpeedAnalysis(_6569.AbstractAssemblyCriticalSpeedAnalysis):
    """AssemblyCriticalSpeedAnalysis
    ...
    @property
    def bearings(self: Self) -> "List[_6577.BearingCriticalSpeedAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6579.BeltDriveCriticalSpeedAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6589.BoltedJointCriticalSpeedAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_6588.BoltCriticalSpeedAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6613.CVTCriticalSpeedAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_6591.ClutchCriticalSpeedAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_6596.ConceptCouplingCriticalSpeedAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_6617.CycloidalDiscCriticalSpeedAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6628.FEPartCriticalSpeedAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6627.FaceGearSetCriticalSpeedAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6629.FlexiblePinAssemblyCriticalSpeedAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_6636.HypoidGearSetCriticalSpeedAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_6643.KlingelnbergCycloPalloidHypoidGearSetCriticalSpeedAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_6647.MassDiscCriticalSpeedAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6648.MeasurementComponentCriticalSpeedAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6650.OilSealCriticalSpeedAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6653.PartToPartShearCouplingCriticalSpeedAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_6657.PlanetCarrierCriticalSpeedAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6658.PointLoadCriticalSpeedAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_6659.PowerLoadCriticalSpeedAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6661.RingPinsCriticalSpeedAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6663.RollingRingAssemblyCriticalSpeedAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_6667.ShaftCriticalSpeedAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6673.SpiralBevelGearSetCriticalSpeedAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6675.SpringDamperCriticalSpeedAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6685.SynchroniserCriticalSpeedAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_6690.TorqueConverterCriticalSpeedAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_6693.UnbalancedMassCriticalSpeedAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6697.WormGearSetCriticalSpeedAnalysis]":
