...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.critical_speed_analyses import _6697
    from mastapy.system_model.analyses_and_results.critical_speed_analyses.compound import (
        _6824,
        _6825,
        _6799,
...
class WormGearSetCompoundCriticalSpeedAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6697.WormGearSetCriticalSpeedAnalysis]":
    ...
    def worm_gears_compound_critical_speed_analysis(
        self: Self,
    ) -> "List[_6824.WormGearCompoundCriticalSpeedAnalysis]":
    ...
    def worm_meshes_compound_critical_speed_analysis(
        self: Self,
    ) -> "List[_6825.WormGearMeshCompoundCriticalSpeedAnalysis]":
