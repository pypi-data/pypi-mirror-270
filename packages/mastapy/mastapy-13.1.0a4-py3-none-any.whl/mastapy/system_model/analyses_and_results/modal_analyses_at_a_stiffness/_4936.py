...
class FaceGearSetModalAnalysisAtAStiffness(_4941.GearSetModalAnalysisAtAStiffness):
    """FaceGearSetModalAnalysisAtAStiffness
    ...
    def gears_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4935.FaceGearModalAnalysisAtAStiffness]":
    ...
    def meshes_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4934.FaceGearMeshModalAnalysisAtAStiffness]":
