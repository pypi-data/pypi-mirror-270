...
class AssemblyModalAnalysisAtAStiffness(
    ...
    @property
    def bearings(self: Self) -> "List[_4888.BearingModalAnalysisAtAStiffness]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4890.BeltDriveModalAnalysisAtAStiffness]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4899.BoltedJointModalAnalysisAtAStiffness]":
    ...
    @property
    def bolts(self: Self) -> "List[_4900.BoltModalAnalysisAtAStiffness]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4921.CVTModalAnalysisAtAStiffness]":
    ...
    @property
    def clutches(self: Self) -> "List[_4903.ClutchModalAnalysisAtAStiffness]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4937.FEPartModalAnalysisAtAStiffness]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4956.MassDiscModalAnalysisAtAStiffness]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4960.OilSealModalAnalysisAtAStiffness]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4968.PointLoadModalAnalysisAtAStiffness]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4969.PowerLoadModalAnalysisAtAStiffness]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4971.RingPinsModalAnalysisAtAStiffness]":
    ...
    @property
    def shafts(self: Self) -> "List[_4978.ShaftModalAnalysisAtAStiffness]":
