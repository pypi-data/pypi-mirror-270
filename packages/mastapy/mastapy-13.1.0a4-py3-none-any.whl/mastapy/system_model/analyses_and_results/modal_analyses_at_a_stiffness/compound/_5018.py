...
class AssemblyCompoundModalAnalysisAtAStiffness(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4887.AssemblyModalAnalysisAtAStiffness]":
    ...
    @property
    def bearings(self: Self) -> "List[_5019.BearingCompoundModalAnalysisAtAStiffness]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_5021.BeltDriveCompoundModalAnalysisAtAStiffness]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_5024.BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_5031.BoltedJointCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def bolts(self: Self) -> "List[_5030.BoltCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5052.CVTCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def clutches(self: Self) -> "List[_5032.ClutchCompoundModalAnalysisAtAStiffness]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_5037.ConceptCouplingCompoundModalAnalysisAtAStiffness]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_5042.ConceptGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5054.CycloidalAssemblyCompoundModalAnalysisAtAStiffness]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_5056.CycloidalDiscCompoundModalAnalysisAtAStiffness]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5060.CylindricalGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5067.FEPartCompoundModalAnalysisAtAStiffness]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_5066.FaceGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5068.FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_5075.HypoidGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_5082.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5085.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_5086.MassDiscCompoundModalAnalysisAtAStiffness]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_5087.MeasurementComponentCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5089.OilSealCompoundModalAnalysisAtAStiffness]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5091.PartToPartShearCouplingCompoundModalAnalysisAtAStiffness]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_5096.PlanetCarrierCompoundModalAnalysisAtAStiffness]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_5097.PointLoadCompoundModalAnalysisAtAStiffness]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_5098.PowerLoadCompoundModalAnalysisAtAStiffness]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_5100.RingPinsCompoundModalAnalysisAtAStiffness]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5102.RollingRingAssemblyCompoundModalAnalysisAtAStiffness]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_5107.ShaftHubConnectionCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def shafts(self: Self) -> "List[_5106.ShaftCompoundModalAnalysisAtAStiffness]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5112.SpiralBevelGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_5113.SpringDamperCompoundModalAnalysisAtAStiffness]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_5118.StraightBevelDiffGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_5121.StraightBevelGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_5124.SynchroniserCompoundModalAnalysisAtAStiffness]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_5128.TorqueConverterCompoundModalAnalysisAtAStiffness]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_5132.UnbalancedMassCompoundModalAnalysisAtAStiffness]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_5136.WormGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_5139.ZerolBevelGearSetCompoundModalAnalysisAtAStiffness]":
