...
class ConceptGearSetModalAnalysisAtAStiffness(_4941.GearSetModalAnalysisAtAStiffness):
    """ConceptGearSetModalAnalysisAtAStiffness
    ...
    def gears_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4910.ConceptGearModalAnalysisAtAStiffness]":
    ...
    def meshes_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4909.ConceptGearMeshModalAnalysisAtAStiffness]":
