...
class FEPartLoadCase(_6835.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self: Self) -> "_2377.AngleSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2377", "AngleSource"
        )(value)
    ...
    @enforce_parameter_types
    def fe_substructure(self: Self, value: "_2401.FESubstructure"):
        wrapper_type = (
    ...
    def surfaces_for_data_logging(
        self: Self,
    ) -> "List[_6862.CMSElementFaceGroupWithSelectionOption]":
