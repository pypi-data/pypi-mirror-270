...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.static_loads import _6872, _6889
...
class GearManufactureError(_0.APIBase):
    ...
    class _Cast_GearManufactureError:
        ...
        def conical_gear_manufacture_error(
            ...
            return self._parent._cast(_6872.ConicalGearManufactureError)
        ...
        def cylindrical_gear_manufacture_error(
            ...
            return self._parent._cast(_6889.CylindricalGearManufactureError)
