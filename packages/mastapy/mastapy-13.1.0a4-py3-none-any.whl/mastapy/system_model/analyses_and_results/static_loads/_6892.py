...
class CylindricalGearSetLoadCase(_6922.GearSetLoadCase):
    """CylindricalGearSetLoadCase
    ...
    def efficiency_rating_method(
        self: Self,
        value: "Union[_301.EfficiencyRatingMethod, Tuple[_301.EfficiencyRatingMethod, bool]]",
    ):
    ...
    @property
    def reset_micro_geometry(self: Self) -> "_6968.ResetMicroGeometryOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads._6968",
            "ResetMicroGeometryOptions",
        )(value)

    @reset_micro_geometry.setter
    @enforce_parameter_types
    def reset_micro_geometry(self: Self, value: "_6968.ResetMicroGeometryOptions"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.StaticLoads.ResetMicroGeometryOptions",
        )
    ...
    @property
    def ltca(self: Self) -> "_1067.LTCALoadCaseModifiableSettings":
    ...
    @property
    def gears_load_case(self: Self) -> "List[_6888.CylindricalGearLoadCase]":
    ...
    def cylindrical_gears_load_case(
        self: Self,
    ) -> "List[_6888.CylindricalGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.CylindricalGearLoadCase]
    ...
    @property
    def meshes_load_case(self: Self) -> "List[_6890.CylindricalGearMeshLoadCase]":
    ...
    def cylindrical_meshes_load_case(
        self: Self,
    ) -> "List[_6890.CylindricalGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.CylindricalGearMeshLoadCase]
