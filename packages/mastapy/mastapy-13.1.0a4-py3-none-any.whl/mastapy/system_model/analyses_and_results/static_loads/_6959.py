...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6836, _6876
...
class PlanetaryConnectionLoadCase(_6978.ShaftToMountableComponentConnectionLoadCase):
    """PlanetaryConnectionLoadCase
