...
from mastapy.utility_gui import _1865
...
if TYPE_CHECKING:
    from mastapy.utility.file_access_helpers import _1833
...
class MultiTimeSeriesDataInputFileOptions(_1865.DataInputFileOptions):
    """MultiTimeSeriesDataInputFileOptions
    ...
    class _Cast_MultiTimeSeriesDataInputFileOptions:
        ...
        def data_input_file_options(
            ...
            return self._parent._cast(_1865.DataInputFileOptions)
    ...
    @property
    def delimiter_options(self: Self) -> "_1833.TextFileDelimiterOptions":
