...
if TYPE_CHECKING:
    from mastapy.gears import _356
...
class ConicalGearSetHarmonicLoadData(_6921.GearSetHarmonicLoadData):
    """ConicalGearSetHarmonicLoadData
    ...
    @property
    def te_specification_type(self: Self) -> "_356.TESpecificationType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._356", "TESpecificationType"
        )(value)

    @te_specification_type.setter
    @enforce_parameter_types
    def te_specification_type(self: Self, value: "_356.TESpecificationType"):
