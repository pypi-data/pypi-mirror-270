...
class ClutchConnectionLoadCase(_6878.CouplingConnectionLoadCase):
    """ClutchConnectionLoadCase
    ...
    @property
    def clutch_pressures(self: Self) -> "_1547.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def clutch_pressures(self: Self, value: "_1547.Vector2DListAccessor"):
