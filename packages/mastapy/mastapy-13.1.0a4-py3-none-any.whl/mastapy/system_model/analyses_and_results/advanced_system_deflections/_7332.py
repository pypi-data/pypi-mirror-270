...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.conical import _1160, _1170
...
class ConicalGearMeshAdvancedSystemDeflection(_7360.GearMeshAdvancedSystemDeflection):
    """ConicalGearMeshAdvancedSystemDeflection
    ...
    @property
    def active_flank(self: Self) -> "_1160.ActiveConicalFlank":
    ...
    @property
    def inactive_flank(self: Self) -> "_1160.ActiveConicalFlank":
        """mastapy.gears.gear_designs.conical.ActiveConicalFlank
