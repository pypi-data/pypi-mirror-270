...
class AssemblyCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_7306.AssemblyAdvancedSystemDeflection]":
    ...
    @property
    def bearings(self: Self) -> "List[_7440.BearingCompoundAdvancedSystemDeflection]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_7442.BeltDriveCompoundAdvancedSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_7445.BevelDifferentialGearSetCompoundAdvancedSystemDeflection]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_7452.BoltedJointCompoundAdvancedSystemDeflection]":
    ...
    @property
    def bolts(self: Self) -> "List[_7451.BoltCompoundAdvancedSystemDeflection]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_7473.CVTCompoundAdvancedSystemDeflection]":
    ...
    @property
    def clutches(self: Self) -> "List[_7453.ClutchCompoundAdvancedSystemDeflection]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_7458.ConceptCouplingCompoundAdvancedSystemDeflection]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_7463.ConceptGearSetCompoundAdvancedSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_7475.CycloidalAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_7477.CycloidalDiscCompoundAdvancedSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_7481.CylindricalGearSetCompoundAdvancedSystemDeflection]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_7488.FEPartCompoundAdvancedSystemDeflection]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_7487.FaceGearSetCompoundAdvancedSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_7489.FlexiblePinAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_7496.HypoidGearSetCompoundAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_7503.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7506.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_7507.MassDiscCompoundAdvancedSystemDeflection]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_7508.MeasurementComponentCompoundAdvancedSystemDeflection]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_7510.OilSealCompoundAdvancedSystemDeflection]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_7512.PartToPartShearCouplingCompoundAdvancedSystemDeflection]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_7517.PlanetCarrierCompoundAdvancedSystemDeflection]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_7518.PointLoadCompoundAdvancedSystemDeflection]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_7519.PowerLoadCompoundAdvancedSystemDeflection]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_7521.RingPinsCompoundAdvancedSystemDeflection]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_7523.RollingRingAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_7528.ShaftHubConnectionCompoundAdvancedSystemDeflection]":
    ...
    @property
    def shafts(self: Self) -> "List[_7527.ShaftCompoundAdvancedSystemDeflection]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7533.SpiralBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_7534.SpringDamperCompoundAdvancedSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_7539.StraightBevelDiffGearSetCompoundAdvancedSystemDeflection]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_7542.StraightBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_7545.SynchroniserCompoundAdvancedSystemDeflection]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_7549.TorqueConverterCompoundAdvancedSystemDeflection]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_7553.UnbalancedMassCompoundAdvancedSystemDeflection]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_7557.WormGearSetCompoundAdvancedSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_7560.ZerolBevelGearSetCompoundAdvancedSystemDeflection]":
