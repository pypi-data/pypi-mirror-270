...
class CylindricalGearSetAdvancedSystemDeflection(_7361.GearSetAdvancedSystemDeflection):
    """CylindricalGearSetAdvancedSystemDeflection
    ...
    @property
    def gear_set_design(self: Self) -> "_1036.CylindricalGearSetDesign":
    ...
    @property
    def micro_geometry(self: Self) -> "_1117.CylindricalGearSetMicroGeometry":
