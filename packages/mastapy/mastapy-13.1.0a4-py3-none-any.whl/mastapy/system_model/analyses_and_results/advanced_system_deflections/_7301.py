...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results import _2707
...
class AdvancedSystemDeflectionOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def specified_gear_set(self: Self, value: "_2550.GearSet"):
        wrapper_type = (
    ...
    @property
    def use_advanced_ltca(self: Self) -> "_857.UseAdvancedLTCAOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.ltca._857", "UseAdvancedLTCAOptions"
        )(value)

    @use_advanced_ltca.setter
    @enforce_parameter_types
    def use_advanced_ltca(self: Self, value: "_857.UseAdvancedLTCAOptions"):
    ...
    @property
    def time_options(self: Self) -> "_2707.TimeOptions":
