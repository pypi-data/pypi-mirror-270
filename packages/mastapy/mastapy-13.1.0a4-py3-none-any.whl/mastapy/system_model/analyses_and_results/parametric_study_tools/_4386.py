...
class GearSetParametricStudyTool(_4435.SpecialisedAssemblyParametricStudyTool):
    """GearSetParametricStudyTool
    ...
    @property
    def gear_set_duty_cycle_results(self: Self) -> "List[_369.GearSetDutyCycleRating]":
