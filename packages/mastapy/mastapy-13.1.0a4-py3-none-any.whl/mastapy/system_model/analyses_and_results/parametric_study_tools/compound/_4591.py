...
class WormGearSetCompoundParametricStudyTool(_4526.GearSetCompoundParametricStudyTool):
    """WormGearSetCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_7011.WormGearSetLoadCase":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4462.WormGearSetParametricStudyTool]":
    ...
    def worm_gears_compound_parametric_study_tool(
        self: Self,
    ) -> "List[_4589.WormGearCompoundParametricStudyTool]":
    ...
    def worm_meshes_compound_parametric_study_tool(
        self: Self,
    ) -> "List[_4590.WormGearMeshCompoundParametricStudyTool]":
