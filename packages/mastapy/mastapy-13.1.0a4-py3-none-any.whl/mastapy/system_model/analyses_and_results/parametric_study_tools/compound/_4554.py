...
class PulleyCompoundParametricStudyTool(_4505.CouplingHalfCompoundParametricStudyTool):
    """PulleyCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6967.PulleyLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4425.PulleyParametricStudyTool]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4425.PulleyParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.PulleyParametricStudyTool]
