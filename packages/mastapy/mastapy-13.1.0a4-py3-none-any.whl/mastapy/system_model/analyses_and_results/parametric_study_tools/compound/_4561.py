...
class ShaftCompoundParametricStudyTool(_4467.AbstractShaftCompoundParametricStudyTool):
    """ShaftCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6977.ShaftLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4433.ShaftParametricStudyTool]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4433.ShaftParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.ShaftParametricStudyTool]
