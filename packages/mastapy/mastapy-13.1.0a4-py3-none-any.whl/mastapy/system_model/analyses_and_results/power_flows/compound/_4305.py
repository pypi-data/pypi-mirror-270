...
class SynchroniserPartCompoundPowerFlow(_4229.CouplingHalfCompoundPowerFlow):
    """SynchroniserPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4174.SynchroniserPartPowerFlow]":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4174.SynchroniserPartPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SynchroniserPartPowerFlow]
