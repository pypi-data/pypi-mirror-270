...
class StraightBevelGearSetCompoundPowerFlow(_4208.BevelGearSetCompoundPowerFlow):
    """StraightBevelGearSetCompoundPowerFlow
    ...
    def straight_bevel_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4298.StraightBevelGearCompoundPowerFlow]":
    ...
    def straight_bevel_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4299.StraightBevelGearMeshCompoundPowerFlow]":
