...
class ExternalCADModelCompoundPowerFlow(_4215.ComponentCompoundPowerFlow):
    """ExternalCADModelCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4108.ExternalCADModelPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4108.ExternalCADModelPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ExternalCADModelPowerFlow]
