...
class CVTPulleyCompoundPowerFlow(_4278.PulleyCompoundPowerFlow):
    """CVTPulleyCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4097.CVTPulleyPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4097.CVTPulleyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CVTPulleyPowerFlow]
