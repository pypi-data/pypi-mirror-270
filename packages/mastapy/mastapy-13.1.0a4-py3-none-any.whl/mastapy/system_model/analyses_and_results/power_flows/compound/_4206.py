...
class BevelGearCompoundPowerFlow(_4194.AGMAGleasonConicalGearCompoundPowerFlow):
    """BevelGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4072.BevelGearPowerFlow]":
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4072.BevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BevelGearPowerFlow]
