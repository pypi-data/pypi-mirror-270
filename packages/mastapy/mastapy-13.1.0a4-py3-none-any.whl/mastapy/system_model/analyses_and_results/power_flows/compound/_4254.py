...
class HypoidGearSetCompoundPowerFlow(_4196.AGMAGleasonConicalGearSetCompoundPowerFlow):
    """HypoidGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4122.HypoidGearSetPowerFlow]":
    ...
    def hypoid_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4252.HypoidGearCompoundPowerFlow]":
    ...
    def hypoid_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4253.HypoidGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4122.HypoidGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearSetPowerFlow]
