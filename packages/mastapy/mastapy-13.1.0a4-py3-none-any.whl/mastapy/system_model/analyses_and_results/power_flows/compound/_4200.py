...
class BeltDriveCompoundPowerFlow(_4288.SpecialisedAssemblyCompoundPowerFlow):
    """BeltDriveCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4065.BeltDrivePowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4065.BeltDrivePowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BeltDrivePowerFlow]
