...
class RootAssemblyCompoundPowerFlow(_4197.AssemblyCompoundPowerFlow):
    """RootAssemblyCompoundPowerFlow
    ...
    @property
    def compound_static_load(self: Self) -> "_5686.AbstractStaticLoadCaseGroup":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4154.RootAssemblyPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4154.RootAssemblyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.RootAssemblyPowerFlow]
