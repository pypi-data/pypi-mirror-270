...
class CylindricalGearSetCompoundPowerFlow(_4250.GearSetCompoundPowerFlow):
    """CylindricalGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4105.CylindricalGearSetPowerFlow]":
    ...
    def cylindrical_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4237.CylindricalGearCompoundPowerFlow]":
    ...
    def cylindrical_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4238.CylindricalGearMeshCompoundPowerFlow]":
    ...
    def ratings_for_all_designs(
        self: Self,
    ) -> "List[_470.CylindricalGearSetDutyCycleRating]":
