...
class BevelGearSetPowerFlow(_4061.AGMAGleasonConicalGearSetPowerFlow):
    """BevelGearSetPowerFlow
    ...
    @property
    def bevel_gears_power_flow(self: Self) -> "List[_4072.BevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BevelGearPowerFlow]
    ...
    @property
    def bevel_meshes_power_flow(self: Self) -> "List[_4071.BevelGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BevelGearMeshPowerFlow]
