...
class HypoidGearSetPowerFlow(_4061.AGMAGleasonConicalGearSetPowerFlow):
    """HypoidGearSetPowerFlow
    ...
    def agma_gleason_conical_gears_power_flow(
        self: Self,
    ) -> "List[_4121.HypoidGearPowerFlow]":
    ...
    @property
    def hypoid_gears_power_flow(self: Self) -> "List[_4121.HypoidGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearPowerFlow]
    ...
    def agma_gleason_conical_meshes_power_flow(
        self: Self,
    ) -> "List[_4120.HypoidGearMeshPowerFlow]":
    ...
    @property
    def hypoid_meshes_power_flow(self: Self) -> "List[_4120.HypoidGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearMeshPowerFlow]
