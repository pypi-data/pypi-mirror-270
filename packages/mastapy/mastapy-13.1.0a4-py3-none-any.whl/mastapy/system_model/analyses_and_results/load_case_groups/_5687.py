...
from mastapy.system_model.analyses_and_results.load_case_groups import _5691
...
class ClutchEngagementStatus(
    _5691.GenericClutchEngagementStatus["_2360.ClutchConnection"]
):
    """ClutchEngagementStatus
    ...
    class _Cast_ClutchEngagementStatus:
        ...
        def generic_clutch_engagement_status(
            ...
            return self._parent._cast(_5691.GenericClutchEngagementStatus)
