...
class PartStaticLoadCaseGroup(_5701.DesignEntityStaticLoadCaseGroup):
    """PartStaticLoadCaseGroup
    ...
    class _Cast_PartStaticLoadCaseGroup:
        ...
        def abstract_assembly_static_load_case_group(
            ...
            return self._parent._cast(_5698.AbstractAssemblyStaticLoadCaseGroup)
        ...
        def component_static_load_case_group(
            ...
            return self._parent._cast(_5699.ComponentStaticLoadCaseGroup)
        ...
        def gear_set_static_load_case_group(
            ...
            return self._parent._cast(_5702.GearSetStaticLoadCaseGroup)
    ...
    @property
    def part_load_cases(self: Self) -> "List[_6955.PartLoadCase]":
