...
TReal = TypeVar("TReal", bound="_2462.Component")
TComponentStaticLoad = TypeVar("TComponentStaticLoad", bound="_6864.ComponentLoadCase")


class ComponentStaticLoadCaseGroup(
    _5703.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]
):
    """ComponentStaticLoadCaseGroup
