...
TConnection = TypeVar("TConnection", bound="_2290.Connection")
TConnectionStaticLoad = TypeVar(
    "TConnectionStaticLoad", bound="_6876.ConnectionLoadCase"
)


class ConnectionStaticLoadCaseGroup(
    _5701.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]
):
    """ConnectionStaticLoadCaseGroup
