...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.load_case_groups import _5687, _5688
...
T = TypeVar("T", bound="_2221.DesignEntity")
...
class GenericClutchEngagementStatus(_0.APIBase, Generic[T]):
    ...
    class _Cast_GenericClutchEngagementStatus:
        ...
        def clutch_engagement_status(
            ...
            from mastapy.system_model.analyses_and_results.load_case_groups import _5687

            return self._parent._cast(_5687.ClutchEngagementStatus)
        ...
        def concept_synchro_gear_engagement_status(
            ...
            return self._parent._cast(_5688.ConceptSynchroGearEngagementStatus)
