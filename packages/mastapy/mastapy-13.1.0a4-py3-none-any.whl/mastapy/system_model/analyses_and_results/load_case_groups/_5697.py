...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.static_loads import _6832, _6844
    from mastapy.system_model.analyses_and_results import _2698, _2642
...
class TimeSeriesLoadCaseGroup(_5685.AbstractLoadCaseGroup):
    """TimeSeriesLoadCaseGroup
    ...
    @property
    def load_cases(self: Self) -> "List[_6832.TimeSeriesLoadCase]":
