...
class AssemblyDynamicAnalysis(_6303.AbstractAssemblyDynamicAnalysis):
    """AssemblyDynamicAnalysis
    ...
    @property
    def bearings(self: Self) -> "List[_6311.BearingDynamicAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6313.BeltDriveDynamicAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_6316.BevelDifferentialGearSetDynamicAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6323.BoltedJointDynamicAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_6322.BoltDynamicAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6344.CVTDynamicAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_6325.ClutchDynamicAnalysis]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_6330.ConceptCouplingDynamicAnalysis]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_6334.ConceptGearSetDynamicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_6346.CycloidalAssemblyDynamicAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_6348.CycloidalDiscDynamicAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6361.FEPartDynamicAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6360.FaceGearSetDynamicAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_6369.HypoidGearSetDynamicAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_6380.MassDiscDynamicAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6383.OilSealDynamicAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_6390.PlanetCarrierDynamicAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6391.PointLoadDynamicAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_6392.PowerLoadDynamicAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6394.RingPinsDynamicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6396.RollingRingAssemblyDynamicAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_6401.ShaftHubConnectionDynamicAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_6400.ShaftDynamicAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6408.SpringDamperDynamicAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6412.StraightBevelDiffGearSetDynamicAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6418.SynchroniserDynamicAnalysis]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_6423.TorqueConverterDynamicAnalysis]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_6426.UnbalancedMassDynamicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6430.WormGearSetDynamicAnalysis]":
