...
class OilSealCompoundDynamicAnalysis(_6470.ConnectorCompoundDynamicAnalysis):
    """OilSealCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6383.OilSealDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6383.OilSealDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.OilSealDynamicAnalysis]
