...
class ShaftCompoundDynamicAnalysis(_6435.AbstractShaftCompoundDynamicAnalysis):
    """ShaftCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6400.ShaftDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6400.ShaftDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.ShaftDynamicAnalysis]
