...
class ConceptGearSetCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6065.ConceptGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def concept_gears_compound_harmonic_analysis_of_single_excitation(
        self: Self,
    ) -> "List[_6194.ConceptGearCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def concept_meshes_compound_harmonic_analysis_of_single_excitation(
        self: Self,
    ) -> "List[_6195.ConceptGearMeshCompoundHarmonicAnalysisOfSingleExcitation]":
