...
class AssemblyCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6041.AssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    def bearings(
        self: Self,
    ) -> "List[_6173.BearingCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_6175.BeltDriveCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def bevel_differential_gear_sets(
        ...
        "List[_6178.BevelDifferentialGearSetCompoundHarmonicAnalysisOfSingleExcitation]"
    ):
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_6185.BoltedJointCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def bolts(
        self: Self,
    ) -> "List[_6184.BoltCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def cv_ts(
        self: Self,
    ) -> "List[_6206.CVTCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_6186.ClutchCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_6191.ConceptCouplingCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_6196.ConceptGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_6208.CycloidalAssemblyCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_6210.CycloidalDiscCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_6214.CylindricalGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_6221.FEPartCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_6220.FaceGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6222.FlexiblePinAssemblyCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_6229.HypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_6236.KlingelnbergCycloPalloidHypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6239.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_6240.MassDiscCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6241.MeasurementComponentCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_6243.OilSealCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def part_to_part_shear_couplings(
        ...
        "List[_6245.PartToPartShearCouplingCompoundHarmonicAnalysisOfSingleExcitation]"
    ):
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_6250.PlanetCarrierCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_6251.PointLoadCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_6252.PowerLoadCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_6254.RingPinsCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6256.RollingRingAssemblyCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_6261.ShaftHubConnectionCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def shafts(
        self: Self,
    ) -> "List[_6260.ShaftCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6266.SpiralBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_6267.SpringDamperCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def straight_bevel_diff_gear_sets(
        ...
        "List[_6272.StraightBevelDiffGearSetCompoundHarmonicAnalysisOfSingleExcitation]"
    ):
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6275.StraightBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_6278.SynchroniserCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_6282.TorqueConverterCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_6286.UnbalancedMassCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_6290.WormGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_6293.ZerolBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation]":
