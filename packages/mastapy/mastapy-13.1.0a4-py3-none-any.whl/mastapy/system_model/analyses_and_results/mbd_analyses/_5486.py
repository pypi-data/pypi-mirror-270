...
class MBDRunUpAnalysisOptions(
    _7562.AbstractAnalysisOptions["_6832.TimeSeriesLoadCase"]
):
    """MBDRunUpAnalysisOptions
    ...
    class _Cast_MBDRunUpAnalysisOptions:
        ...
        def abstract_analysis_options(
            ...
            return self._parent._cast(_7562.AbstractAnalysisOptions)
    ...
    def initial_speed_for_run_up(self: Self, value: "float"):
    ...
    def input_velocity_processing_type(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5472",
    ...
    @enforce_parameter_types
    def input_velocity_processing_type(
        self: Self, value: "_5472.InputVelocityForRunUpProcessingType"
    ):
    ...
    @property
    def run_up_driving_mode(self: Self) -> "_5507.RunUpDrivingMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5507",
            "RunUpDrivingMode",
        )(value)

    @run_up_driving_mode.setter
    @enforce_parameter_types
    def run_up_driving_mode(self: Self, value: "_5507.RunUpDrivingMode"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.RunUpDrivingMode",
        )
    ...
    @property
    def run_up_speed_profile(self: Self) -> "_1884.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def shape_of_initial_acceleration_period(
        self: Self, value: "_5512.ShapeOfInitialAccelerationPeriodForRunUp"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.ShapeOfInitialAccelerationPeriodForRunUp",
