...
class GearMeshMultibodyDynamicsAnalysis(
    ...
    @property
    def left_flank(self: Self) -> "_138.ExternalForceLineContactEntity":
        """mastapy.nodal_analysis.nodal_entities.ExternalForceLineContactEntity
    ...
    @property
    def right_flank(self: Self) -> "_138.ExternalForceLineContactEntity":
        """mastapy.nodal_analysis.nodal_entities.ExternalForceLineContactEntity
