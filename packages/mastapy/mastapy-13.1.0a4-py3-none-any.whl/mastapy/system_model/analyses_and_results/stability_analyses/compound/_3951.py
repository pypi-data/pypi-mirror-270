...
class ConceptGearSetCompoundStabilityAnalysis(_3980.GearSetCompoundStabilityAnalysis):
    """ConceptGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3816.ConceptGearSetStabilityAnalysis]":
    ...
    def concept_gears_compound_stability_analysis(
        self: Self,
    ) -> "List[_3949.ConceptGearCompoundStabilityAnalysis]":
    ...
    def concept_meshes_compound_stability_analysis(
        self: Self,
    ) -> "List[_3950.ConceptGearMeshCompoundStabilityAnalysis]":
