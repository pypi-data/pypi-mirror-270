...
class CVTCompoundStabilityAnalysis(_3930.BeltDriveCompoundStabilityAnalysis):
    """CVTCompoundStabilityAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_3829.CVTStabilityAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_3829.CVTStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.CVTStabilityAnalysis]
