...
class BearingCompoundStabilityAnalysis(_3956.ConnectorCompoundStabilityAnalysis):
    """BearingCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_3794.BearingStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3794.BearingStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.BearingStabilityAnalysis]
