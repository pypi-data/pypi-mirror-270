...
class WormGearCompoundStabilityAnalysis(_3978.GearCompoundStabilityAnalysis):
    """WormGearCompoundStabilityAnalysis
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3916.WormGearStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.WormGearStabilityAnalysis]
