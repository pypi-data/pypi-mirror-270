...
class RollingRingAssemblySystemDeflection(_2829.SpecialisedAssemblySystemDeflection):
    """RollingRingAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4151.RollingRingAssemblyPowerFlow":
