...
class CylindricalMeshedGearSystemDeflection(_0.APIBase):
    ...
    @property
    def left_flank(self: Self) -> "_2771.CylindricalMeshedGearFlankSystemDeflection":
    ...
    @property
    def right_flank(self: Self) -> "_2771.CylindricalMeshedGearFlankSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalMeshedGearFlankSystemDeflection
    ...
    def compression_side_fillet_results(
        self: Self,
    ) -> "List[_852.GearRootFilletStressResults]":
    ...
    @property
    def flanks(self: Self) -> "List[_2771.CylindricalMeshedGearFlankSystemDeflection]":
    ...
    @property
    def both_flanks(self: Self) -> "_2771.CylindricalMeshedGearFlankSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalMeshedGearFlankSystemDeflection
