...
class PartToPartShearCouplingHalfSystemDeflection(_2753.CouplingHalfSystemDeflection):
    """PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4139.PartToPartShearCouplingHalfPowerFlow":
