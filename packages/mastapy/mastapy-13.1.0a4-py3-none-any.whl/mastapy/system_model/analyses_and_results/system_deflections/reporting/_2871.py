...
class RigidlyConnectedComponentGroupSystemDeflection(_2675.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    class _Cast_RigidlyConnectedComponentGroupSystemDeflection:
        ...
        def design_entity_group_analysis(
            ...
            return self._parent._cast(_2675.DesignEntityGroupAnalysis)
    ...
    @property
    def mass_properties(self: Self) -> "_1530.MassProperties":
    ...
    @property
    def components(self: Self) -> "List[_2738.ComponentSystemDeflection]":
