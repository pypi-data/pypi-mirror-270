...
class ConceptGearSetCompoundSystemDeflection(_2935.GearSetCompoundSystemDeflection):
    """ConceptGearSetCompoundSystemDeflection
    ...
    def concept_gears_compound_system_deflection(
        self: Self,
    ) -> "List[_2903.ConceptGearCompoundSystemDeflection]":
    ...
    def concept_meshes_compound_system_deflection(
        self: Self,
    ) -> "List[_2904.ConceptGearMeshCompoundSystemDeflection]":
