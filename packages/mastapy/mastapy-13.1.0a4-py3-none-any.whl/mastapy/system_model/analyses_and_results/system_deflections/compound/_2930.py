...
class FaceGearSetCompoundSystemDeflection(_2935.GearSetCompoundSystemDeflection):
    """FaceGearSetCompoundSystemDeflection
    ...
    def face_gears_compound_system_deflection(
        self: Self,
    ) -> "List[_2928.FaceGearCompoundSystemDeflection]":
    ...
    def face_meshes_compound_system_deflection(
        self: Self,
    ) -> "List[_2929.FaceGearMeshCompoundSystemDeflection]":
