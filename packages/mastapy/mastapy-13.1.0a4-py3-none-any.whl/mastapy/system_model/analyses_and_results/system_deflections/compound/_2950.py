...
class MassDiscCompoundSystemDeflection(_2998.VirtualComponentCompoundSystemDeflection):
    """MassDiscCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_2802.MassDiscSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2802.MassDiscSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.MassDiscSystemDeflection]
