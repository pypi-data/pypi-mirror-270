...
class BearingCompoundSystemDeflection(_2910.ConnectorCompoundSystemDeflection):
    """BearingCompoundSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_1966.LoadedBearingDutyCycle":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2721.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
