...
class CylindricalGearCompoundSystemDeflection(_2933.GearCompoundSystemDeflection):
    """CylindricalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self: Self) -> "_462.CylindricalGearDutyCycleRating":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_2770.CylindricalGearSystemDeflectionWithLTCAResults]":
