...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model import _2457, _2459
    from mastapy.bearings.bearing_results import _1967, _1959
    from mastapy.system_model.analyses_and_results.static_loads import _6846
    from mastapy.system_model.analyses_and_results.power_flows import _4063
    from mastapy.math_utility.measured_vectors import _1573
...
class BearingSystemDeflection(_2751.ConnectorSystemDeflection):
    """BearingSystemDeflection
    ...
    @property
    def spring_preload_chart(self: Self) -> "_1884.TwoDChartDefinition":
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_1967.LoadedBearingResults":
    ...
    @property
    def power_flow_results(self: Self) -> "_4063.BearingPowerFlow":
    ...
    @property
    def preload_spring_stiffness(self: Self) -> "_1959.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    @property
    def stiffness_between_rings(self: Self) -> "_1959.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    @property
    def stiffness_matrix(self: Self) -> "_1959.BearingStiffnessMatrixReporter":
        """mastapy.bearings.bearing_results.BearingStiffnessMatrixReporter
    ...
    def race_mounting_options_for_analysis(
        self: Self,
    ) -> "List[_2459.BearingRaceMountingOptions]":
    ...
    def stiffness_between_each_ring(
        self: Self,
    ) -> "List[_1959.BearingStiffnessMatrixReporter]":
