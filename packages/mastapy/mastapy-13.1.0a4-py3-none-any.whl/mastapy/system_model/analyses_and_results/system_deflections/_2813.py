...
class PlanetCarrierSystemDeflection(_2805.MountableComponentSystemDeflection):
    """PlanetCarrierSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4143.PlanetCarrierPowerFlow":
    ...
    @property
    def windup(self: Self) -> "List[_2869.PlanetCarrierWindup]":
