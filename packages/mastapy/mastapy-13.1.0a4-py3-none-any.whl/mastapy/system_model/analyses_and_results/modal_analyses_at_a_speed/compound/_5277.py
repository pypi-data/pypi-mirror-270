...
class AssemblyCompoundModalAnalysisAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5147.AssemblyModalAnalysisAtASpeed]":
    ...
    @property
    def bearings(self: Self) -> "List[_5278.BearingCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5280.BeltDriveCompoundModalAnalysisAtASpeed]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_5283.BevelDifferentialGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_5290.BoltedJointCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def bolts(self: Self) -> "List[_5289.BoltCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5311.CVTCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def clutches(self: Self) -> "List[_5291.ClutchCompoundModalAnalysisAtASpeed]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_5296.ConceptCouplingCompoundModalAnalysisAtASpeed]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_5301.ConceptGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5313.CycloidalAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_5315.CycloidalDiscCompoundModalAnalysisAtASpeed]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5319.CylindricalGearSetCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5326.FEPartCompoundModalAnalysisAtASpeed]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_5325.FaceGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5327.FlexiblePinAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_5334.HypoidGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        ...
        "List[_5341.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtASpeed]"
    ):
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5344.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_5345.MassDiscCompoundModalAnalysisAtASpeed]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_5346.MeasurementComponentCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5348.OilSealCompoundModalAnalysisAtASpeed]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5350.PartToPartShearCouplingCompoundModalAnalysisAtASpeed]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_5355.PlanetCarrierCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5356.PointLoadCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5357.PowerLoadCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5359.RingPinsCompoundModalAnalysisAtASpeed]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5361.RollingRingAssemblyCompoundModalAnalysisAtASpeed]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_5366.ShaftHubConnectionCompoundModalAnalysisAtASpeed]":
    ...
    @property
    def shafts(self: Self) -> "List[_5365.ShaftCompoundModalAnalysisAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5371.SpiralBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_5372.SpringDamperCompoundModalAnalysisAtASpeed]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_5377.StraightBevelDiffGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_5380.StraightBevelGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_5383.SynchroniserCompoundModalAnalysisAtASpeed]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_5387.TorqueConverterCompoundModalAnalysisAtASpeed]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_5391.UnbalancedMassCompoundModalAnalysisAtASpeed]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_5395.WormGearSetCompoundModalAnalysisAtASpeed]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_5398.ZerolBevelGearSetCompoundModalAnalysisAtASpeed]":
