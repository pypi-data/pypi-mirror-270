...
class FaceGearSetCompoundModalAnalysis(_4811.GearSetCompoundModalAnalysis):
    """FaceGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4654.FaceGearSetModalAnalysis]":
    ...
    def face_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4804.FaceGearCompoundModalAnalysis]":
    ...
    def face_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4805.FaceGearMeshCompoundModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4654.FaceGearSetModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearSetModalAnalysis]
