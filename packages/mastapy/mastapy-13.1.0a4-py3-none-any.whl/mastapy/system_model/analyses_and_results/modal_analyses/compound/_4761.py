...
class BeltDriveCompoundModalAnalysis(_4849.SpecialisedAssemblyCompoundModalAnalysis):
    """BeltDriveCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4605.BeltDriveModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4605.BeltDriveModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BeltDriveModalAnalysis]
