...
class ConnectorCompoundModalAnalysis(_4828.MountableComponentCompoundModalAnalysis):
    """ConnectorCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4631.ConnectorModalAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4631.ConnectorModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ConnectorModalAnalysis]
