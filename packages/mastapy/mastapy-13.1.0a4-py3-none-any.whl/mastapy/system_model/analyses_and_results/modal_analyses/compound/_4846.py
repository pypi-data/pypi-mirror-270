...
class ShaftCompoundModalAnalysis(_4752.AbstractShaftCompoundModalAnalysis):
    """ShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4702.ShaftModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4702.ShaftModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ShaftModalAnalysis]
