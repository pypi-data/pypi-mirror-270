...
class PartCompoundModalAnalysis(_7572.PartCompoundAnalysis):
    """PartCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4685.PartModalAnalysis]":
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4685.PartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.PartModalAnalysis]
