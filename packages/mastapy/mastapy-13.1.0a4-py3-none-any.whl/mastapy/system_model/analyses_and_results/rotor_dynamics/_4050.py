...
TLinearMeasurement = TypeVar("TLinearMeasurement", bound="_1618.MeasurementBase")
TAngularMeasurement = TypeVar("TAngularMeasurement", bound="_1618.MeasurementBase")
...
class ShaftComplexShape(_0.APIBase, Generic[TLinearMeasurement, TAngularMeasurement]):
    ...
    class _Cast_ShaftComplexShape:
        ...
        def shaft_forced_complex_shape(
            ...
            return self._parent._cast(_4051.ShaftForcedComplexShape)
        ...
        def shaft_modal_complex_shape(
            ...
            return self._parent._cast(_4052.ShaftModalComplexShape)

        @property
        def shaft_modal_complex_shape_at_speeds(
            self: "ShaftComplexShape._Cast_ShaftComplexShape",
        ) -> "_4053.ShaftModalComplexShapeAtSpeeds":
            from mastapy.system_model.analyses_and_results.rotor_dynamics import _4053

            return self._parent._cast(_4053.ShaftModalComplexShapeAtSpeeds)

        @property
        def shaft_modal_complex_shape_at_stiffness(
            self: "ShaftComplexShape._Cast_ShaftComplexShape",
        ) -> "_4054.ShaftModalComplexShapeAtStiffness":
            from mastapy.system_model.analyses_and_results.rotor_dynamics import _4054

            return self._parent._cast(_4054.ShaftModalComplexShapeAtStiffness)
