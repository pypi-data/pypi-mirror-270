...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.rotor_dynamics import _4053, _4054
...
class ShaftModalComplexShape(_4050.ShaftComplexShape["_1701.Number", "_1701.Number"]):
    """ShaftModalComplexShape
    ...
    class _Cast_ShaftModalComplexShape:
        ...
        def shaft_complex_shape(
            ...
            return self._parent._cast(_4050.ShaftComplexShape)
