...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.drawing import _2265, _2275, _2276
...
class RotorDynamicsViewable(_0.APIBase):
    ...
    class _Cast_RotorDynamicsViewable:
        ...
        def critical_speed_analysis_viewable(
            ...
            return self._parent._cast(_2265.CriticalSpeedAnalysisViewable)
        ...
        def stability_analysis_viewable(
            ...
            return self._parent._cast(_2275.StabilityAnalysisViewable)
        ...
        def steady_state_synchronous_response_viewable(
            ...
            return self._parent._cast(_2276.SteadyStateSynchronousResponseViewable)
    ...
    @property
    def rotor_dynamics(self: Self) -> "_4049.RotorDynamicsDrawStyle":
