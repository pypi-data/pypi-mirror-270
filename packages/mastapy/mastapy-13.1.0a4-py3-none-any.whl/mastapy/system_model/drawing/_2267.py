...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5705, _5796
...
from mastapy.system_model.drawing.options import _2280
...
class HarmonicAnalysisViewable(_2266.DynamicAnalysisViewable):
    """HarmonicAnalysisViewable
    ...
    class _Cast_HarmonicAnalysisViewable:
        ...
        def dynamic_analysis_viewable(
            ...
            return self._parent._cast(_2266.DynamicAnalysisViewable)
    ...
    def excitation(self: Self, value: "_5705.AbstractPeriodicExcitationDetail"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def harmonic_analysis_with_varying_stiffness_step(
        self: Self, value: "_5796.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase"
    ):
        wrapper_type = (
    ...
    @order.setter
    @enforce_parameter_types
    def order(self: Self, value: "_1541.RoundedOrder"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def uncoupled_mesh(self: Self, value: "_2782.GearMeshSystemDeflection"):
        wrapper_type = (
    ...
    @view_type.setter
    @enforce_parameter_types
    def view_type(self: Self, value: "_2280.ExcitationAnalysisViewOption"):
    ...
    @property
    def dynamic_analysis_draw_style(self: Self) -> "_6356.DynamicAnalysisDrawStyle":
