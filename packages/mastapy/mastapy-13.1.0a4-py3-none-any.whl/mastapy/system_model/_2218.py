...
from mastapy.system_model.part_model import _2490, _2493
...
if TYPE_CHECKING:
    from mastapy.system_model_gui import _1863
    from mastapy.gears import _329, _335
    from mastapy.system_model import _2241, _2242, _2226, _2223, _2240, _2230
    ...
    from mastapy.utility import _1595, _1596
    ...
    from mastapy.system_model.part_model.configurations import _2638, _2635, _2637
    from mastapy.bearings.bearing_results.rolling import _1994
    from mastapy.system_model.database_access import _2282
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6831, _6830
    from mastapy.utility.model_validation import _1806
    from mastapy.system_model.analyses_and_results.synchroniser_analysis import _3005
    ...
    from mastapy.gears.gear_designs.creation_options import _1156, _1158, _1159
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self: Self) -> "_1863.MASTAGUI":
    ...
    @property
    def axial_contact_ratio_requirement(self: Self) -> "_329.ContactRatioRequirements":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._329", "ContactRatioRequirements"
        )(value)

    @axial_contact_ratio_requirement.setter
    @enforce_parameter_types
    def axial_contact_ratio_requirement(
        self: Self, value: "_329.ContactRatioRequirements"
    ):
    ...
    def efficiency_rating_method_for_bearings(
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials.efficiency._299", "BearingEfficiencyRatingMethod"
        )(value)

    @efficiency_rating_method_for_bearings.setter
    @enforce_parameter_types
    def efficiency_rating_method_for_bearings(
        self: Self, value: "_299.BearingEfficiencyRatingMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def gear_set_configuration(
        self: Self, value: "_2530.ActiveGearSetDesignSelectionGroup"
    ):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def input_power_load(self: Self, value: "_2490.PowerLoad"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def output_power_load(self: Self, value: "_2490.PowerLoad"):
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_PowerLoad.wrapper_type()
        )
        enclosed_type = (
    ...
    @enforce_parameter_types
    def shaft_diameter_modification_due_to_rolling_bearing_rings(
        self: Self, value: "_2493.ShaftDiameterModificationDueToRollingBearingRing"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def thermal_expansion_for_grounded_nodes(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2241", "ThermalExpansionOptionForGroundedNodes"
        )(value)

    @thermal_expansion_for_grounded_nodes.setter
    @enforce_parameter_types
    def thermal_expansion_for_grounded_nodes(
        self: Self, value: "_2241.ThermalExpansionOptionForGroundedNodes"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def unbalanced_mass_inclusion(self: Self) -> "_2496.UnbalancedMassInclusionOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model._2496", "UnbalancedMassInclusionOption"
        )(value)

    @unbalanced_mass_inclusion.setter
    @enforce_parameter_types
    def unbalanced_mass_inclusion(
        self: Self, value: "_2496.UnbalancedMassInclusionOption"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def default_system_temperatures(self: Self) -> "_2242.TransmissionTemperatureSet":
    ...
    @property
    def detailed_spline_settings(self: Self) -> "_1403.DetailedSplineJointSettings":
    ...
    @property
    def electric_machine_group(self: Self) -> "_2226.ElectricMachineGroup":
    ...
    @property
    def fe_batch_operations(self: Self) -> "_2379.BatchOperations":
    ...
    @property
    def file_save_details_all(self: Self) -> "_1595.FileHistory":
    ...
    @property
    def file_save_details_most_recent(self: Self) -> "_1596.FileHistoryItem":
    ...
    @property
    def gear_set_design_group(self: Self) -> "_335.GearSetDesignGroup":
    ...
    @property
    def settings(self: Self) -> "_2223.DesignSettings":
    ...
    @property
    def system(self: Self) -> "_2240.SystemReporting":
    ...
    @property
    def system_optimiser_details(self: Self) -> "_2258.SystemOptimiserDetails":
    ...
    def bearing_detail_configurations(
        self: Self,
    ) -> "List[_2638.BearingDetailConfiguration]":
    ...
    def fe_substructure_configurations(
        self: Self,
    ) -> "List[_2635.ActiveFESubstructureSelectionGroup]":
    ...
    def gear_set_configurations(
        self: Self,
    ) -> "List[_2530.ActiveGearSetDesignSelectionGroup]":
    ...
    def iso14179_settings_per_bearing_type(
        self: Self,
    ) -> "List[_1994.ISO14179SettingsPerBearingType]":
    ...
    def shaft_detail_configurations(
        self: Self,
    ) -> "List[_2637.ActiveShaftDesignSelectionGroup]":
    ...
    @property
    def databases(self: Self) -> "_2282.Databases":
    ...
    @property
    def design_states(self: Self) -> "List[_5689.DesignState]":
    ...
    @property
    def duty_cycles(self: Self) -> "List[_5690.DutyCycle]":
    ...
    @property
    def gear_set_config(self: Self) -> "_2551.GearSetConfiguration":
    ...
    @enforce_parameter_types
    def gear_set_config(self: Self, value: "_2551.GearSetConfiguration"):
        self.wrapped.GearSetConfig = value.wrapped

    @property
    def masta_settings(self: Self) -> "_2230.MASTASettings":
    ...
    @property
    def root_assembly(self: Self) -> "_2492.RootAssembly":
    ...
    @property
    def system_optimiser(self: Self) -> "_2257.SystemOptimiser":
    ...
    def time_series_load_case_groups(
        self: Self,
    ) -> "List[_5697.TimeSeriesLoadCaseGroup]":
    ...
    @enforce_parameter_types
    def add_duty_cycle(self: Self, name: "str" = "New Duty Cycle") -> "_5690.DutyCycle":
    ...
    def add_synchroniser_shift_empty(self: Self) -> "_3005.SynchroniserShift":
    ...
    @enforce_parameter_types
    def add_synchroniser_shift(self: Self, name: "str") -> "_3005.SynchroniserShift":
        """mastapy.system_model.analyses_and_results.synchroniser_analysis.SynchroniserShift
    ...
    @enforce_parameter_types
    def design_state_named(self: Self, name: "str") -> "_5689.DesignState":
        """mastapy.system_model.analyses_and_results.load_case_groups.DesignState
    ...
    @enforce_parameter_types
    def duty_cycle_named(self: Self, name: "str") -> "_5690.DutyCycle":
        """mastapy.system_model.analyses_and_results.load_case_groups.DutyCycle
    ...
    def remove_bearing_from_database(
        self: Self, rolling_bearing: "_2183.RollingBearing"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_synchroniser_shift(self: Self, shift: "_3005.SynchroniserShift"):
        """Method does not return.
    ...
    @enforce_parameter_types
    def save(self: Self, file_name: "str", save_results: "bool") -> "_1806.Status":
        """mastapy.utility.model_validation.Status
    ...
    def save_load_case_results(
        self: Self, file_name: "str", load_cases: "List[_6830.LoadCase]"
    ):
        """Method does not return.
    ...
    def all_parts_of_type_assembly(self: Self) -> "List[_2451.Assembly]":
    ...
    def load(
        file_path: "str",
        load_full_fe_option: "_1594.ExternalFullFEFileOption" = _1594.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS,
    ) -> "Design":
        """mastapy.system_model.Design
