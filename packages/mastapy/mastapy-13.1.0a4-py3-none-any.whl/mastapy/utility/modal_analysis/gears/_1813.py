...
if TYPE_CHECKING:
    from mastapy.utility.modal_analysis.gears import _1814, _1817
...
class GearOrderForTE(_1819.OrderWithRadius):
    """GearOrderForTE
    ...
    class _Cast_GearOrderForTE:
        ...
        def order_for_te(
            ...
            return self._parent._cast(_1817.OrderForTE)
    ...
    @property
    def position(self: Self) -> "_1814.GearPositions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.modal_analysis.gears._1814", "GearPositions"
        )(value)

    @property
    def additional_orders_and_harmonics(self: Self) -> "List[_1817.OrderForTE]":
