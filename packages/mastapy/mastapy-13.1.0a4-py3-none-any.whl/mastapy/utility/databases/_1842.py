...
if TYPE_CHECKING:
    from mastapy.utility.databases import _1840
...
class DatabaseSettings(_1607.PerMachineSettings):
    """DatabaseSettings
    ...
    @property
    def connection_settings(self: Self) -> "_1840.DatabaseConnectionSettings":
