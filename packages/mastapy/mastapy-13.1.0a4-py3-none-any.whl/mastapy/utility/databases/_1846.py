...
if TYPE_CHECKING:
    from mastapy.utility.databases import _1841, _1843
...
class SQLDatabase(_1839.Database[TKey, TValue]):
    """SQLDatabase
    ...
    class _Cast_SQLDatabase:
        ...
        @property
        def database(self: "SQLDatabase._Cast_SQLDatabase") -> "_1839.Database":
