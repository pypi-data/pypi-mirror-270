...
if TYPE_CHECKING:
    from mastapy.html import _311
    from mastapy.utility.report import _1784, _1776
...
class CustomReportText(_1773.CustomReportDefinitionItem):
    """CustomReportText
    ...
    @property
    def heading_type(self: Self) -> "_311.HeadingType":
        ...
        return constructor.new_from_mastapy("mastapy.html._311", "HeadingType")(value)

    @heading_type.setter
    @enforce_parameter_types
    def heading_type(self: Self, value: "_311.HeadingType"):
