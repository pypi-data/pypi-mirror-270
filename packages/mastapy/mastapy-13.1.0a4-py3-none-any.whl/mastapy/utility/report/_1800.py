...
if TYPE_CHECKING:
    from mastapy.utility.report import _1798, _1786
...
class UserTextRow(_1791.CustomRow):
    """UserTextRow
    ...
    class _Cast_UserTextRow:
        ...
        @property
        def custom_row(self: "UserTextRow._Cast_UserTextRow") -> "_1791.CustomRow":
        ...
        def custom_report_property_item(
            ...
            return self._parent._cast(_1786.CustomReportPropertyItem)
    ...
    @property
    def heading_size(self: Self) -> "_1798.HeadingSize":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1798", "HeadingSize"
        )(value)

    @heading_size.setter
    @enforce_parameter_types
    def heading_size(self: Self, value: "_1798.HeadingSize"):
