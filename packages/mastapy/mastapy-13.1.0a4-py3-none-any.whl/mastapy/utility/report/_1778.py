...
if TYPE_CHECKING:
    from mastapy.utility.report import _1780, _1772, _1789, _1776
...
T = TypeVar("T", bound="_1780.CustomReportItemContainerCollectionItem")


class CustomReportItemContainerCollection(
    _1779.CustomReportItemContainerCollectionBase, Generic[T]
):
    """CustomReportItemContainerCollection
