...
class Unit(_0.APIBase):
    ...
    class _Cast_Unit:
        ...
        def degrees_minutes_seconds(
            ...
            return self._parent._cast(_1615.DegreesMinutesSeconds)

        @property
        def enum_unit(self: "Unit._Cast_Unit") -> "_1616.EnumUnit":
            from mastapy.utility.units_and_measurements import _1616

            return self._parent._cast(_1616.EnumUnit)

        @property
        def inverse_unit(self: "Unit._Cast_Unit") -> "_1617.InverseUnit":
            from mastapy.utility.units_and_measurements import _1617

            return self._parent._cast(_1617.InverseUnit)

        @property
        def safety_factor_unit(self: "Unit._Cast_Unit") -> "_1621.SafetyFactorUnit":
            from mastapy.utility.units_and_measurements import _1621

            return self._parent._cast(_1621.SafetyFactorUnit)

        @property
        def time_unit(self: "Unit._Cast_Unit") -> "_1622.TimeUnit":
            from mastapy.utility.units_and_measurements import _1622

            return self._parent._cast(_1622.TimeUnit)

        @property
        def unit_gradient(self: "Unit._Cast_Unit") -> "_1624.UnitGradient":
            from mastapy.utility.units_and_measurements import _1624

            return self._parent._cast(_1624.UnitGradient)
