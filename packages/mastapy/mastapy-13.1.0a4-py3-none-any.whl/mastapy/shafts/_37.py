...
class ShaftSectionEndDamageResults(_0.APIBase):
    ...
    @property
    def sn_curve(self: Self) -> "_288.SNCurve":
    ...
    @property
    def sn_curve_axial(self: Self) -> "_288.SNCurve":
        """mastapy.materials.SNCurve
    ...
    @property
    def sn_curve_bending_x(self: Self) -> "_288.SNCurve":
        """mastapy.materials.SNCurve
    ...
    @property
    def sn_curve_bending_y(self: Self) -> "_288.SNCurve":
        """mastapy.materials.SNCurve
    ...
    @property
    def sn_curve_torsional(self: Self) -> "_288.SNCurve":
        """mastapy.materials.SNCurve
