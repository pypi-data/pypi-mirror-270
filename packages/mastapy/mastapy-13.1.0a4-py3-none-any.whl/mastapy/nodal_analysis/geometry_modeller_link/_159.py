...
if TYPE_CHECKING:
    from mastapy.nodal_analysis.geometry_modeller_link import _160, _161, _166, _168
...
class BaseGeometryModellerDimension(_0.APIBase):
    ...
    class _Cast_BaseGeometryModellerDimension:
        ...
        def geometry_modeller_angle_dimension(
            ...
            return self._parent._cast(_160.GeometryModellerAngleDimension)
        ...
        def geometry_modeller_count_dimension(
            ...
            return self._parent._cast(_161.GeometryModellerCountDimension)

        @property
        def geometry_modeller_length_dimension(
            self: "BaseGeometryModellerDimension._Cast_BaseGeometryModellerDimension",
        ) -> "_166.GeometryModellerLengthDimension":
            from mastapy.nodal_analysis.geometry_modeller_link import _166

            return self._parent._cast(_166.GeometryModellerLengthDimension)

        @property
        def geometry_modeller_unitless_dimension(
            self: "BaseGeometryModellerDimension._Cast_BaseGeometryModellerDimension",
        ) -> "_168.GeometryModellerUnitlessDimension":
            from mastapy.nodal_analysis.geometry_modeller_link import _168

            return self._parent._cast(_168.GeometryModellerUnitlessDimension)
