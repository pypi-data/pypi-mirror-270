...
if TYPE_CHECKING:
    from mastapy.nodal_analysis.dev_tools_analyses import _206, _196
...
class FEModel(_0.APIBase):
    ...
    @property
    def model_splitting_method(self: Self) -> "_206.ModelSplittingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.nodal_analysis.dev_tools_analyses._206", "ModelSplittingMethod"
        )(value)

    @model_splitting_method.setter
    @enforce_parameter_types
    def model_splitting_method(self: Self, value: "_206.ModelSplittingMethod"):
    ...
    @property
    def beam_element_properties(self: Self) -> "List[_216.ElementPropertiesBeam]":
    ...
    @property
    def contact_pairs(self: Self) -> "List[_210.ContactPairReporting]":
    ...
    @property
    def coordinate_systems(self: Self) -> "List[_211.CoordinateSystemReporting]":
    ...
    def interface_element_properties(
        self: Self,
    ) -> "List[_217.ElementPropertiesInterface]":
    ...
    @property
    def mass_element_properties(self: Self) -> "List[_218.ElementPropertiesMass]":
    ...
    @property
    def materials(self: Self) -> "List[_224.MaterialPropertiesReporting]":
    ...
    @property
    def model_parts(self: Self) -> "List[_196.FEModelPart]":
    ...
    @property
    def other_element_properties(self: Self) -> "List[_215.ElementPropertiesBase]":
    ...
    @property
    def rigid_element_properties(self: Self) -> "List[_219.ElementPropertiesRigid]":
    ...
    @property
    def shell_element_properties(self: Self) -> "List[_220.ElementPropertiesShell]":
    ...
    @property
    def solid_element_properties(self: Self) -> "List[_221.ElementPropertiesSolid]":
    ...
    def spring_dashpot_element_properties(
        self: Self,
    ) -> "List[_222.ElementPropertiesSpringDashpot]":
    ...
    def get_all_element_details(self: Self) -> "_214.ElementDetailsForFEModel":
    ...
    def get_all_node_details(self: Self) -> "_225.NodeDetailsForFEModel":
