...
class NodeGroup(_190.FEEntityGroupInteger):
    """NodeGroup
    ...
    class _Cast_NodeGroup:
        ...
        @property
        def fe_entity_group(self: "NodeGroup._Cast_NodeGroup") -> "_189.FEEntityGroup":
            from mastapy.nodal_analysis.dev_tools_analyses import _189

            return self._parent._cast(_189.FEEntityGroup)

        @property
        def cms_node_group(self: "NodeGroup._Cast_NodeGroup") -> "_234.CMSNodeGroup":
            from mastapy.nodal_analysis.component_mode_synthesis import _234
