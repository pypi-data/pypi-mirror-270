...
if TYPE_CHECKING:
    from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _227
...
class ElementPropertiesRigid(_215.ElementPropertiesBase):
    """ElementPropertiesRigid
    ...
    def degrees_of_freedom_list(
        self: Self,
    ) -> "List[_227.RigidElementNodeDegreesOfFreedom]":
