...
if TYPE_CHECKING:
    from mastapy.fe_tools.enums import _1251
...
class ElementPropertiesBase(_0.APIBase):
    ...
    class _Cast_ElementPropertiesBase:
        ...
        def element_properties_beam(
            ...
            return self._parent._cast(_216.ElementPropertiesBeam)
        ...
        def element_properties_interface(
            ...
            return self._parent._cast(_217.ElementPropertiesInterface)
        ...
        def element_properties_mass(
            ...
            return self._parent._cast(_218.ElementPropertiesMass)
        ...
        def element_properties_rigid(
            ...
            return self._parent._cast(_219.ElementPropertiesRigid)
        ...
        def element_properties_shell(
            ...
            return self._parent._cast(_220.ElementPropertiesShell)

        @property
        def element_properties_solid(
            self: "ElementPropertiesBase._Cast_ElementPropertiesBase",
        ) -> "_221.ElementPropertiesSolid":
            from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _221

            return self._parent._cast(_221.ElementPropertiesSolid)

        @property
        def element_properties_spring_dashpot(
            self: "ElementPropertiesBase._Cast_ElementPropertiesBase",
        ) -> "_222.ElementPropertiesSpringDashpot":
            from mastapy.nodal_analysis.dev_tools_analyses.full_fe_reporting import _222

            return self._parent._cast(_222.ElementPropertiesSpringDashpot)
        ...
        def element_properties_with_material(
            ...
            return self._parent._cast(_223.ElementPropertiesWithMaterial)
    ...
    @property
    def class_(self: Self) -> "_1251.ElementPropertyClass":
        ...
        return constructor.new_from_mastapy(
            "mastapy.fe_tools.enums._1251", "ElementPropertyClass"
        )(value)
