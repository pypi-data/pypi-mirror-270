...
if TYPE_CHECKING:
    from mastapy.nodal_analysis.dev_tools_analyses import _205, _186
    from mastapy.math_utility import _1515
    from mastapy.fe_tools.vfx_tools import _1248
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def mass_matrix_type(self: Self) -> "_205.MassMatrixType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.nodal_analysis.dev_tools_analyses._205", "MassMatrixType"
        )(value)

    @mass_matrix_type.setter
    @enforce_parameter_types
    def mass_matrix_type(self: Self, value: "_205.MassMatrixType"):
    ...
    @property
    def precision_when_saving_expansion_vectors(self: Self) -> "_1515.DataPrecision":
    ...
    @property
    def internal_mode_options(self: Self) -> "_186.EigenvalueOptions":
    ...
    @property
    def solver_options(self: Self) -> "_1248.ProSolveOptions":
