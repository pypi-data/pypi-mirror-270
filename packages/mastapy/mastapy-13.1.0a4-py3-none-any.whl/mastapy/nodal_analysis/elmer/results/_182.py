...
if TYPE_CHECKING:
    from mastapy.nodal_analysis.elmer.results import _183, _184
...
class Data(_0.APIBase):
    ...
    class _Cast_Data:
        ...
        @property
        def data_1d(self: "Data._Cast_Data") -> "_183.Data1D":
            from mastapy.nodal_analysis.elmer.results import _183

            return self._parent._cast(_183.Data1D)

        @property
        def data_3d(self: "Data._Cast_Data") -> "_184.Data3D":
            from mastapy.nodal_analysis.elmer.results import _184

            return self._parent._cast(_184.Data3D)
