...
class CylindricalGearMeshLoadedContactLine(_850.GearMeshLoadedContactLine):
    """CylindricalGearMeshLoadedContactLine
    ...
    class _Cast_CylindricalGearMeshLoadedContactLine:
        ...
        def gear_mesh_loaded_contact_line(
            ...
            return self._parent._cast(_850.GearMeshLoadedContactLine)
    ...
    def loaded_contact_strip_end_points(
        self: Self,
    ) -> "List[_866.CylindricalGearMeshLoadedContactPoint]":
