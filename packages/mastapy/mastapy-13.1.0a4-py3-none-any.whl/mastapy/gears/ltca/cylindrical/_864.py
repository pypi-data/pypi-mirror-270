...
if TYPE_CHECKING:
    ...
    from mastapy.gears.analysis import _1233, _1232, _1226
...
class CylindricalGearMeshLoadDistributionAnalysis(
    ...
    @property
    def cylindrical_mesh_load_case(self: Self) -> "_891.CylindricalMeshLoadCase":
    ...
    @property
    def mesh_micro_geometry(self: Self) -> "_1108.CylindricalGearMeshMicroGeometry":
    ...
    def load_distribution_analyses_at_single_rotation(
        self: Self,
    ) -> "List[_868.CylindricalMeshLoadDistributionAtRotation]":
    ...
    def meshed_gears(
        self: Self,
    ) -> "List[_839.CylindricalMeshedGearLoadDistributionAnalysis]":
