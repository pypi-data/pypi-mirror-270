...
if TYPE_CHECKING:
    from mastapy.gears.ltca import _844, _836
...
class GearFilletNodeStressResultsColumn(_0.APIBase):
    ...
    class _Cast_GearFilletNodeStressResultsColumn:
        ...
        def cylindrical_gear_fillet_node_stress_results_column(
            ...
            return self._parent._cast(_836.CylindricalGearFilletNodeStressResultsColumn)
    ...
    @property
    def node_results(self: Self) -> "List[_844.GearFilletNodeStressResults]":
