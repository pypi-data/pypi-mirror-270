...
from mastapy.gears.micro_geometry import _580, _581, _582, _583, _586
...
if TYPE_CHECKING:
    from mastapy.gears.micro_geometry import _584, _585, _587, _588
    from mastapy.math_utility import _1547
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1115, _1116
...
class ProfileModification(_586.Modification):
    """ProfileModification
    ...
    class _Cast_ProfileModification:
        ...
        def modification(
            ...
            return self._parent._cast(_586.Modification)
    ...
    @property
    def measured_data(self: Self) -> "_1547.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def measured_data(self: Self, value: "_1547.Vector2DListAccessor"):
