...
class PocketingPowerLossCoefficients(_1844.NamedDatabaseItem):
    """PocketingPowerLossCoefficients
    ...
    def extrapolation_options(self: Self, value: "_1522.ExtrapolationOptions"):
    ...
    def specifications_for_the_effect_of_oil_kinematic_viscosity(
        self: Self,
    ) -> "List[_353.SpecificationForTheEffectOfOilKinematicViscosity]":
