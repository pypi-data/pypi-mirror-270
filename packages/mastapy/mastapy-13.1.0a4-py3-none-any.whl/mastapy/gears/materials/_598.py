...
if TYPE_CHECKING:
    from mastapy.gears.materials import _609, _590, _604, _610
...
class CylindricalGearMaterial(_601.GearMaterial):
    """CylindricalGearMaterial
    ...
    @property
    def heat_treatment_distortion_control(self: Self) -> "_609.ManufactureRating":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.materials._609", "ManufactureRating"
        )(value)

    @heat_treatment_distortion_control.setter
    @enforce_parameter_types
    def heat_treatment_distortion_control(self: Self, value: "_609.ManufactureRating"):
    ...
    @property
    def heat_treatment_process_development(self: Self) -> "_609.ManufactureRating":
        """mastapy.gears.materials.ManufactureRating"""
    ...
    @enforce_parameter_types
    def heat_treatment_process_development(self: Self, value: "_609.ManufactureRating"):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.Gears.Materials.ManufactureRating"
        )
    ...
    @property
    def machine_process_development(self: Self) -> "_609.ManufactureRating":
        """mastapy.gears.materials.ManufactureRating"""
    ...
    @enforce_parameter_types
    def machine_process_development(self: Self, value: "_609.ManufactureRating"):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.Gears.Materials.ManufactureRating"
        )
    ...
    @property
    def manufacturability(self: Self) -> "_609.ManufactureRating":
        """mastapy.gears.materials.ManufactureRating"""
    ...
    @enforce_parameter_types
    def manufacturability(self: Self, value: "_609.ManufactureRating"):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.Gears.Materials.ManufactureRating"
        )
