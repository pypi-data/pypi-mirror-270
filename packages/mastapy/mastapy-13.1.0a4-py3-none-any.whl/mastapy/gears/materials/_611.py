...
if TYPE_CHECKING:
    from mastapy.materials import _295, _292, _293
...
class PlasticSNCurve(_0.APIBase):
    ...
    @property
    def lubricant(self: Self) -> "_295.VDI2736LubricantType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._295", "VDI2736LubricantType"
        )(value)

    @lubricant.setter
    @enforce_parameter_types
    def lubricant(self: Self, value: "_295.VDI2736LubricantType"):
    ...
    @property
    def material(self: Self) -> "_610.PlasticCylindricalGearMaterial":
    ...
    def bending_stress_cycle_data_for_damage_tables(
        self: Self,
    ) -> "List[_292.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]":
    ...
    def contact_stress_cycle_data_for_damage_tables(
        self: Self,
    ) -> "List[_293.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]":
