...
if TYPE_CHECKING:
    from mastapy.gears.gear_two_d_fe_analysis import _907
...
class CylindricalGearTIFFAnalysisDutyCycle(_1228.GearDesignAnalysis):
    """CylindricalGearTIFFAnalysisDutyCycle
    ...
    @property
    def analysis(self: Self) -> "_907.CylindricalGearTwoDimensionalFEAnalysis":
