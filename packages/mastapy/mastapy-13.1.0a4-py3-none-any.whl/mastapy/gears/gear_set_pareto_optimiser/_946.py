...
class SpiralBevelGearSetParetoOptimiser(_919.GearSetParetoOptimiser):
    """SpiralBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: Self) -> "_979.SpiralBevelGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: Self) -> "List[_979.SpiralBevelGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: Self) -> "List[_979.SpiralBevelGearSetDesign]":
        """List[mastapy.gears.gear_designs.spiral_bevel.SpiralBevelGearSetDesign]
