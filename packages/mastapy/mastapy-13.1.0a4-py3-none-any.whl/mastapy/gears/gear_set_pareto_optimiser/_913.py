...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.optimisation import _1561, _1558, _1553
...
TAnalysis = TypeVar("TAnalysis", bound="_1227.AbstractGearSetAnalysis")
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    class _Cast_DesignSpaceSearchBase:
        ...
        def cylindrical_gear_set_pareto_optimiser(
            ...
            return self._parent._cast(_912.CylindricalGearSetParetoOptimiser)
        ...
        def face_gear_set_pareto_optimiser(
            ...
            return self._parent._cast(_915.FaceGearSetParetoOptimiser)
        ...
        def gear_set_pareto_optimiser(
            ...
            return self._parent._cast(_919.GearSetParetoOptimiser)
        ...
        def hypoid_gear_set_pareto_optimiser(
            ...
            return self._parent._cast(_920.HypoidGearSetParetoOptimiser)
        ...
        def micro_geometry_design_space_search(
            ...
            return self._parent._cast(_923.MicroGeometryDesignSpaceSearch)
        ...
        def micro_geometry_gear_set_design_space_search(
            ...
            return self._parent._cast(_927.MicroGeometryGearSetDesignSpaceSearch)

        @property
        def spiral_bevel_gear_set_pareto_optimiser(
            self: "DesignSpaceSearchBase._Cast_DesignSpaceSearchBase",
        ) -> "_946.SpiralBevelGearSetParetoOptimiser":
            from mastapy.gears.gear_set_pareto_optimiser import _946

            return self._parent._cast(_946.SpiralBevelGearSetParetoOptimiser)

        @property
        def straight_bevel_gear_set_pareto_optimiser(
            self: "DesignSpaceSearchBase._Cast_DesignSpaceSearchBase",
        ) -> "_947.StraightBevelGearSetParetoOptimiser":
            from mastapy.gears.gear_set_pareto_optimiser import _947

            return self._parent._cast(_947.StraightBevelGearSetParetoOptimiser)
    ...
    @enforce_parameter_types
    def display_candidates(self: Self, value: "_910.CandidateDisplayChoice"):
    ...
    @property
    def remove_candidates_with(self: Self) -> "_922.LargerOrSmaller":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_set_pareto_optimiser._922", "LargerOrSmaller"
        )(value)

    @remove_candidates_with.setter
    @enforce_parameter_types
    def remove_candidates_with(self: Self, value: "_922.LargerOrSmaller"):
    ...
    @property
    def chart_details(self: Self) -> "List[_911.ChartInfoBase[TAnalysis, TCandidate]]":
    ...
    @property
    def filters(self: Self) -> "List[_1558.ParetoOptimisationFilter]":
    ...
    @property
    def input_setters(self: Self) -> "List[_1553.InputSetter[TAnalysis]]":
    ...
    @property
    def optimisation_targets(self: Self) -> "List[_930.OptimisationTarget[TAnalysis]]":
    ...
    def reasons_for_invalid_candidates(
        self: Self,
    ) -> "List[_945.ReasonsForInvalidDesigns]":
