...
class MicroGeometryDesignSpaceSearchCandidate(
    ...
    class _Cast_MicroGeometryDesignSpaceSearchCandidate:
        ...
        def design_space_search_candidate_base(
            ...
            return self._parent._cast(_914.DesignSpaceSearchCandidateBase)
    ...
    @property
    def candidate(self: Self) -> "_867.CylindricalGearSetLoadDistributionAnalysis":
    ...
    @property
    def candidate_for_slider(self: Self) -> "_1117.CylindricalGearSetMicroGeometry":
