...
from mastapy.gears.ltca.cylindrical import _863, _864, _867
...
class MicroGeometryDesignSpaceSearch(
    ...
    @select_gear.setter
    @enforce_parameter_types
    def select_gear(self: Self, value: "_863.CylindricalGearLoadDistributionAnalysis"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def select_mesh(
        self: Self, value: "_864.CylindricalGearMeshLoadDistributionAnalysis"
    ):
        wrapper_type = (
    ...
    def all_candidate_gear_sets(
        self: Self,
    ) -> "List[_1117.CylindricalGearSetMicroGeometry]":
