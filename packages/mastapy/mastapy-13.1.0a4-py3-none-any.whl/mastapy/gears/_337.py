...
class GearSetOptimisationResult(_0.APIBase):
    ...
    @property
    def gear_set(self: Self) -> "_958.GearSetDesign":
    ...
    @property
    def optimisation_history(self: Self) -> "_1555.OptimisationHistory":
    ...
    def optimisation_history(self: Self, value: "_1555.OptimisationHistory"):
        self.wrapped.OptimisationHistory = value.wrapped

    @property
    def rating(self: Self) -> "_362.AbstractGearSetRating":
