...
from mastapy.gears.manufacturing.cylindrical import _630, _631
...
if TYPE_CHECKING:
    ...
    from mastapy.gears.manufacturing.cylindrical.process_simulation import _646
...
class CylindricalGearManufacturingConfig(_1231.GearImplementationDetail):
    """CylindricalGearManufacturingConfig
    ...
    @enforce_parameter_types
    def finishing_method(self: Self, value: "_630.CylindricalMftFinishingMethods"):
    ...
    @enforce_parameter_types
    def roughing_method(self: Self, value: "_631.CylindricalMftRoughingMethods"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def design(self: Self) -> "_1020.CylindricalGearDesign":
    ...
    @property
    def finish_cutter(self: Self) -> "_720.CylindricalGearRealCutterDesign":
    ...
    @property
    def finish_cutter_simulation(self: Self) -> "_746.GearCutterSimulation":
    ...
    @property
    def finish_process_simulation(self: Self) -> "_646.CutterProcessSimulation":
    ...
    @property
    def finished_gear_specification(self: Self) -> "_740.CylindricalGearSpecification":
    ...
    @property
    def gear_blank(self: Self) -> "_618.CylindricalGearBlank":
    ...
    @property
    def rough_cutter(self: Self) -> "_720.CylindricalGearRealCutterDesign":
        """mastapy.gears.manufacturing.cylindrical.cutters.CylindricalGearRealCutterDesign
    ...
    @property
    def rough_cutter_simulation(self: Self) -> "_746.GearCutterSimulation":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.GearCutterSimulation
    ...
    @property
    def rough_gear_specification(self: Self) -> "_740.CylindricalGearSpecification":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CylindricalGearSpecification
    ...
    @property
    def rough_process_simulation(self: Self) -> "_646.CutterProcessSimulation":
        """mastapy.gears.manufacturing.cylindrical.process_simulation.CutterProcessSimulation
