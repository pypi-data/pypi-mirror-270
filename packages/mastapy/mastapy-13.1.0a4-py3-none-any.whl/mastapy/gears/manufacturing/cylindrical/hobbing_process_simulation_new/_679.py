...
class HobbingProcessSimulationInput(_692.ProcessSimulationInput):
    ...
    class _Cast_HobbingProcessSimulationInput:
        ...
        def process_simulation_input(
            ...
            return self._parent._cast(_692.ProcessSimulationInput)
    ...
    def process_method(self: Self, value: "_665.ActiveProcessMethod"):
    ...
    @property
    def hob_manufacture_error(self: Self) -> "_683.HobManufactureError":
    ...
    @property
    def hob_resharpening_error(self: Self) -> "_684.HobResharpeningError":
