...
class HobbingProcessLeadCalculation(_673.HobbingProcessCalculation):
    """HobbingProcessLeadCalculation
    ...
    @property
    def left_flank(self: Self) -> "_667.CalculateLeadDeviationAccuracy":
    ...
    @property
    def right_flank(self: Self) -> "_667.CalculateLeadDeviationAccuracy":
        """mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculateLeadDeviationAccuracy
