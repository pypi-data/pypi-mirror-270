...
class HobbingProcessProfileCalculation(_673.HobbingProcessCalculation):
    """HobbingProcessProfileCalculation
    ...
    @property
    def left_flank(self: Self) -> "_669.CalculateProfileDeviationAccuracy":
    ...
    @property
    def right_flank(self: Self) -> "_669.CalculateProfileDeviationAccuracy":
        """mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculateProfileDeviationAccuracy
