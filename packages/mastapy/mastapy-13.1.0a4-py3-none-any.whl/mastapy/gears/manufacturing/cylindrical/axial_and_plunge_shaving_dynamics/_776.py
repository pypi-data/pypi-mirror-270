...
class ShavingDynamicsConfiguration(_0.APIBase):
    ...
    def conventional_shaving_dynamics(
        self: Self,
    ) -> "_773.ShavingDynamicsCalculation[_758.ConventionalShavingDynamics]":
    ...
    def plunge_shaving_dynamics(
        self: Self,
    ) -> "_773.ShavingDynamicsCalculation[_762.PlungeShaverDynamics]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_762.PlungeShaverDynamics](
            temp
        )
