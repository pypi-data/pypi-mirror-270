...
class GearCutterSimulation(_0.APIBase):
    ...
    class _Cast_GearCutterSimulation:
        ...
        def finish_cutter_simulation(
            ...
            return self._parent._cast(_743.FinishCutterSimulation)
        ...
        def rough_cutter_simulation(
            ...
            return self._parent._cast(_751.RoughCutterSimulation)
    ...
    @property
    def average_thickness(self: Self) -> "_738.CutterSimulationCalc":
    ...
    @property
    def average_thickness_virtual(self: Self) -> "_754.VirtualSimulationCalculator":
    ...
    @property
    def maximum_thickness(self: Self) -> "_738.CutterSimulationCalc":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc
    ...
    @property
    def maximum_thickness_virtual(self: Self) -> "_754.VirtualSimulationCalculator":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.VirtualSimulationCalculator
    ...
    @property
    def minimum_thickness(self: Self) -> "_738.CutterSimulationCalc":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc
    ...
    @property
    def minimum_thickness_virtual(self: Self) -> "_754.VirtualSimulationCalculator":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.VirtualSimulationCalculator
    ...
    @property
    def smallest_active_profile(self: Self) -> "_738.CutterSimulationCalc":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc
    ...
    def gear_mesh_cutter_simulations(
        self: Self,
    ) -> "List[_741.CylindricalManufacturedRealGearInMesh]":
    ...
    def gear_mesh_cutter_simulations_virtual(
        self: Self,
    ) -> "List[_742.CylindricalManufacturedVirtualGearInMesh]":
    ...
    @property
    def thickness_calculators(self: Self) -> "List[_738.CutterSimulationCalc]":
    ...
    def virtual_thickness_calculators(
        self: Self,
    ) -> "List[_754.VirtualSimulationCalculator]":
