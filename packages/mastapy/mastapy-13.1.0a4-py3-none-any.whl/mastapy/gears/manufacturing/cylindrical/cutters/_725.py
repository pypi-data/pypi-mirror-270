...
if TYPE_CHECKING:
    ...
    from mastapy.gears.manufacturing.cylindrical.cutters import _717, _721, _722, _713
...
class InvoluteCutterDesign(_720.CylindricalGearRealCutterDesign):
    """InvoluteCutterDesign
    ...
    @property
    def tooth_thickness(self: Self) -> "_1096.ToothThicknessSpecificationBase":
