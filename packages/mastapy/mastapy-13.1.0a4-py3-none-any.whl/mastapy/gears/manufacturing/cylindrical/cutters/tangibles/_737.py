...
if TYPE_CHECKING:
    ...
    from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _732, _735
...
class RackShape(_730.CutterShapeDefinition):
    """RackShape
    ...
    class _Cast_RackShape:
        ...
        def cutter_shape_definition(
            ...
            return self._parent._cast(_730.CutterShapeDefinition)
    ...
    @property
    def design(self: Self) -> "_719.CylindricalGearRackDesign":
