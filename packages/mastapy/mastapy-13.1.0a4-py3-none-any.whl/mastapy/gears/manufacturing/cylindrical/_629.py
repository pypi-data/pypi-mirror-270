...
class CylindricalMeshManufacturingConfig(_1235.GearMeshImplementationDetail):
    """CylindricalMeshManufacturingConfig
    ...
    @property
    def gear_a_as_manufactured(self: Self) -> "List[_738.CutterSimulationCalc]":
    ...
    @property
    def gear_b_as_manufactured(self: Self) -> "List[_738.CutterSimulationCalc]":
        """List[mastapy.gears.manufacturing.cylindrical.cutter_simulation.CutterSimulationCalc]
