...
class MicroGeometryInputsLead(_640.MicroGeometryInputs["_639.LeadModificationSegment"]):
    """MicroGeometryInputsLead
    ...
    class _Cast_MicroGeometryInputsLead:
        ...
        def micro_geometry_inputs(
            ...
            return self._parent._cast(_640.MicroGeometryInputs)
    ...
    @property
    def lead_micro_geometry_range(self: Self) -> "_1501.Range":
