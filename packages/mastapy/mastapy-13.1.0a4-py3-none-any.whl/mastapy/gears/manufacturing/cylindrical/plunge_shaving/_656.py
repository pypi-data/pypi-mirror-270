...
if TYPE_CHECKING:
    ...
    from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _649, _663
...
class PlungeShaverGeneration(_0.APIBase):
    ...
    @property
    def calculated_conjugate_face_width(self: Self) -> "_1501.Range":
    ...
    @property
    def calculation_errors(self: Self) -> "List[_649.CalculationError]":
    ...
    def points_of_interest_on_the_shaver(
        self: Self,
    ) -> "List[_663.ShaverPointOfInterest]":
