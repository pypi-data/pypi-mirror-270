...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _652, _653
...
class PlungeShaverInputsAndMicroGeometry(_0.APIBase):
    ...
    @enforce_parameter_types
    def lead_measurement_method(
        self: Self, value: "_652.MicroGeometryDefinitionMethod"
    ):
    ...
    @enforce_parameter_types
    def micro_geometry_source(self: Self, value: "_653.MicroGeometryDefinitionType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def points_of_interest_left_flank(self: Self) -> "List[_660.PointOfInterest]":
    ...
    @property
    def points_of_interest_right_flank(self: Self) -> "List[_660.PointOfInterest]":
        """List[mastapy.gears.manufacturing.cylindrical.plunge_shaving.PointOfInterest]
