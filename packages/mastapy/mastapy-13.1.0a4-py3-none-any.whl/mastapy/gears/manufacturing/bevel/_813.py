...
if TYPE_CHECKING:
    ...
    from mastapy.gears.manufacturing.bevel import _808, _809, _811, _814, _815, _816
...
class PinionFinishMachineSettings(_327.ConicalGearToothSurface):
    """PinionFinishMachineSettings
    ...
    class _Cast_PinionFinishMachineSettings:
        ...
        def conical_gear_tooth_surface(
            ...
            return self._parent._cast(_327.ConicalGearToothSurface)
    ...
    @property
    def toprem_letter(self: Self) -> "_1181.TopremLetter":
