...
if TYPE_CHECKING:
    ...
    from mastapy.gears.manufacturing.bevel import _798, _799
...
class ConicalSetMicroGeometryConfigBase(_1241.GearSetImplementationDetail):
    """ConicalSetMicroGeometryConfigBase
    ...
    def deflection_from_bending_option(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._332", "DeflectionFromBendingOption"
        )(value)

    @deflection_from_bending_option.setter
    @enforce_parameter_types
    def deflection_from_bending_option(
        self: Self, value: "_332.DeflectionFromBendingOption"
    ):
