...
class CylindricalGearMeshFEModel(_1208.GearMeshFEModel):
    """CylindricalGearMeshFEModel
    ...
    def stiffness_wrt_contacts_for(
        self: Self, gear: "_1207.GearFEModel", flank: "_333.GearFlanks"
    ) -> "List[_842.GearContactStiffness]":
    ...
    @enforce_parameter_types
    def generate_stiffness_wrt_contacts_for(self: Self, progress: "_7585.TaskProgress"):
    ...
    def generate_stiffness_wrt_contacts_for_flank(
        self: Self, flank: "_333.GearFlanks", progress: "_7585.TaskProgress"
    ):
        """Method does not return.
