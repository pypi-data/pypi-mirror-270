...
if TYPE_CHECKING:
    from mastapy.gears.fe_model import _1209
...
class GearFEModel(_1231.GearImplementationDetail):
    """GearFEModel
    ...
    @property
    def element_settings(self: Self) -> "_1209.GearMeshingElementOptions":
    ...
    @enforce_parameter_types
    def get_stress_influence_coefficients_from_fe(self: Self, flank: "_333.GearFlanks"):
        """Method does not return.
