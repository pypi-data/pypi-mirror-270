...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.worm import _381, _380
...
class WormGearSetRating(_370.GearSetRating):
    """WormGearSetRating
    ...
    @property
    def worm_gear_set(self: Self) -> "_967.WormGearSetDesign":
    ...
    @property
    def gear_ratings(self: Self) -> "List[_381.WormGearRating]":
    ...
    @property
    def worm_gear_ratings(self: Self) -> "List[_381.WormGearRating]":
        """List[mastapy.gears.rating.worm.WormGearRating]
    ...
    @property
    def gear_mesh_ratings(self: Self) -> "List[_380.WormGearMeshRating]":
