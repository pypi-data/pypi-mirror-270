...
if TYPE_CHECKING:
    from mastapy.gears import _330, _348
    ...
    from mastapy.gears.rating.cylindrical import _474, _471, _467
    from mastapy.gears.rating.cylindrical.iso6336 import _527
    from mastapy.gears.load_case.cylindrical import _891
    from mastapy.gears.rating.cylindrical.vdi import _496
...
class CylindricalGearMeshRating(_367.GearMeshRating):
    """CylindricalGearMeshRating
    ...
    @property
    def active_flank(self: Self) -> "_330.CylindricalFlanks":
        ...
        return constructor.new_from_mastapy("mastapy.gears._330", "CylindricalFlanks")(
            value
        )
    ...
    @property
    def cylindrical_gear_mesh(self: Self) -> "_1026.CylindricalGearMeshDesign":
    ...
    @property
    def gear_set_rating(self: Self) -> "_471.CylindricalGearSetRating":
    ...
    @property
    def mesh_load_case(self: Self) -> "_891.CylindricalMeshLoadCase":
    ...
    @property
    def mesh_single_flank_rating(self: Self) -> "_474.CylindricalMeshSingleFlankRating":
        """mastapy.gears.rating.cylindrical.CylindricalMeshSingleFlankRating
    ...
    def vdi_cylindrical_gear_single_flank_rating(
        self: Self,
    ) -> "_496.VDI2737InternalGearSingleFlankRating":
    ...
    @property
    def cylindrical_gear_ratings(self: Self) -> "List[_467.CylindricalGearRating]":
