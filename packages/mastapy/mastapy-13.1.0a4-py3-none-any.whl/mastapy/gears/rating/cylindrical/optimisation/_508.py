...
if TYPE_CHECKING:
    from mastapy.gears.rating.cylindrical.optimisation import _509, _510
...
class CylindricalGearSetRatingOptimisationHelper(_0.APIBase):
    ...
    def helix_angle_optimisation_results(
        self: Self,
    ) -> "_509.OptimisationResultsPair[_512.SafetyFactorOptimisationStepResultAngle]":
    ...
    def maximum_transverse_contact_ratio_optimisation_results(
        self: Self,
    ) -> "_509.OptimisationResultsPair[_513.SafetyFactorOptimisationStepResultNumber]":
    ...
    def normal_module_optimisation_results(
        self: Self,
    ) -> "_509.OptimisationResultsPair[_514.SafetyFactorOptimisationStepResultShortLength]":
    ...
    def all_helix_angle_optimisation_results(
        self: Self,
    ) -> "List[_510.SafetyFactorOptimisationResults[_512.SafetyFactorOptimisationStepResultAngle]]":
    ...
    def all_normal_module_optimisation_results(
        self: Self,
    ) -> "List[_510.SafetyFactorOptimisationResults[_514.SafetyFactorOptimisationStepResultShortLength]]":
    ...
    def all_profile_shift_optimisation_results(
        self: Self,
    ) -> "List[_510.SafetyFactorOptimisationResults[_513.SafetyFactorOptimisationStepResultNumber]]":
