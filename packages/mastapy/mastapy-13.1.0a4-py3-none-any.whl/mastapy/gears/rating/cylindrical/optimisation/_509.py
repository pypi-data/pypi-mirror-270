...
if TYPE_CHECKING:
    from mastapy.gears.rating.cylindrical.optimisation import _510, _511
...
T = TypeVar("T", bound="_511.SafetyFactorOptimisationStepResult")
...
class OptimisationResultsPair(_0.APIBase, Generic[T]):
    ...
    @property
    def results(self: Self) -> "_510.SafetyFactorOptimisationResults[T]":
    ...
    def results_without_warnings(
        self: Self,
    ) -> "_510.SafetyFactorOptimisationResults[T]":
        """mastapy.gears.rating.cylindrical.optimisation.SafetyFactorOptimisationResults[T]
