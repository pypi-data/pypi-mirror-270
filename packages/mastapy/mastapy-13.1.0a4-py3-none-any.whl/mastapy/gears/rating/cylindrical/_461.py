...
from mastapy.gears.rating.cylindrical import _488, _489
...
if TYPE_CHECKING:
    from mastapy.gears import _351, _322
...
class CylindricalGearDesignAndRatingSettingsItem(_1844.NamedDatabaseItem):
    """CylindricalGearDesignAndRatingSettingsItem
    ...
    @property
    def agma_quality_grade_type(self: Self) -> "_351.QualityGradeTypes":
        ...
        return constructor.new_from_mastapy("mastapy.gears._351", "QualityGradeTypes")(
            value
        )

    @agma_quality_grade_type.setter
    @enforce_parameter_types
    def agma_quality_grade_type(self: Self, value: "_351.QualityGradeTypes"):
    ...
    @property
    def agma_tolerances_standard(self: Self) -> "_322.AGMAToleranceStandard":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._322", "AGMAToleranceStandard"
        )(value)

    @agma_tolerances_standard.setter
    @enforce_parameter_types
    def agma_tolerances_standard(self: Self, value: "_322.AGMAToleranceStandard"):
    ...
    def chosen_tooth_thickness_for_bending_strength(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._494", "ToothThicknesses"
        )(value)

    @chosen_tooth_thickness_for_bending_strength.setter
    @enforce_parameter_types
    def chosen_tooth_thickness_for_bending_strength(
        self: Self, value: "_494.ToothThicknesses"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def cylindrical_gear_profile_measurement(
        self: Self, value: "_1034.CylindricalGearProfileMeasurementType"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CylindricalGearProfileMeasurementType",
    ...
    @property
    def dynamic_factor_method(self: Self) -> "_479.DynamicFactorMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._479", "DynamicFactorMethods"
        )(value)

    @dynamic_factor_method.setter
    @enforce_parameter_types
    def dynamic_factor_method(self: Self, value: "_479.DynamicFactorMethods"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def film_thickness_equation_for_scuffing(self: Self) -> "_490.ScuffingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._490", "ScuffingMethods"
        )(value)

    @film_thickness_equation_for_scuffing.setter
    @enforce_parameter_types
    def film_thickness_equation_for_scuffing(self: Self, value: "_490.ScuffingMethods"):
        value = conversion.mp_to_pn_enum(
    ...
    def gear_blank_factor_calculation_option(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._480", "GearBlankFactorCalculationOptions"
        )(value)

    @gear_blank_factor_calculation_option.setter
    @enforce_parameter_types
    def gear_blank_factor_calculation_option(
        self: Self, value: "_480.GearBlankFactorCalculationOptions"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Cylindrical.GearBlankFactorCalculationOptions",
    ...
    def iso_tolerances_standard(
        self: Self,
        value: "Union[_341.ISOToleranceStandard, Tuple[_341.ISOToleranceStandard, bool]]",
    ):
    ...
    @property
    def micropitting_rating_method(self: Self) -> "_483.MicropittingRatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._483", "MicropittingRatingMethod"
        )(value)

    @micropitting_rating_method.setter
    @enforce_parameter_types
    def micropitting_rating_method(self: Self, value: "_483.MicropittingRatingMethod"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def permissible_bending_stress_method(self: Self) -> "_486.RatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._486", "RatingMethod"
        )(value)

    @permissible_bending_stress_method.setter
    @enforce_parameter_types
    def permissible_bending_stress_method(self: Self, value: "_486.RatingMethod"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def rating_method(self: Self, value: "_258.CylindricalGearRatingMethods"):
    ...
    @enforce_parameter_types
    def scuffing_rating_method_flash_temperature_method(
        self: Self, value: "_488.ScuffingFlashTemperatureRatingMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def scuffing_rating_method_integral_temperature_method(
        self: Self, value: "_489.ScuffingIntegralTemperatureRatingMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def tip_relief_in_scuffing_calculation(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._493", "TipReliefScuffingOptions"
        )(value)

    @tip_relief_in_scuffing_calculation.setter
    @enforce_parameter_types
    def tip_relief_in_scuffing_calculation(
        self: Self, value: "_493.TipReliefScuffingOptions"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def tolerance_rounding_system(self: Self) -> "_1620.MeasurementSystem":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.units_and_measurements._1620", "MeasurementSystem"
        )(value)

    @tolerance_rounding_system.setter
    @enforce_parameter_types
    def tolerance_rounding_system(self: Self, value: "_1620.MeasurementSystem"):
        value = conversion.mp_to_pn_enum(
    ...
    def vdi_rating_geometry_calculation_method(
        self: Self,
        value: "Union[_258.CylindricalGearRatingMethods, Tuple[_258.CylindricalGearRatingMethods, bool]]",
    ):
        wrapper_type = (
