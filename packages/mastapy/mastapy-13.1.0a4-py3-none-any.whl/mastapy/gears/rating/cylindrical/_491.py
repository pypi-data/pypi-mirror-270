...
if TYPE_CHECKING:
    from mastapy.gears.rating.cylindrical import _492, _458, _481
...
class ScuffingResultsRow(_0.APIBase):
    ...
    class _Cast_ScuffingResultsRow:
        ...
        def agma_scuffing_results_row(
            ...
            return self._parent._cast(_458.AGMAScuffingResultsRow)
        ...
        def iso_scuffing_results_row(
            ...
            return self._parent._cast(_481.ISOScuffingResultsRow)
    ...
    @property
    def pinion(self: Self) -> "_492.ScuffingResultsRowGear":
