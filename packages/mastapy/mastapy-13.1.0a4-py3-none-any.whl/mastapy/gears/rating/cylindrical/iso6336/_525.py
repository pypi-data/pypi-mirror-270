...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.cylindrical.iso6336 import _524, _519, _521, _523, _527
...
class ISO6336AbstractMeshSingleFlankRating(_474.CylindricalMeshSingleFlankRating):
    """ISO6336AbstractMeshSingleFlankRating
    ...
    def gear_single_flank_ratings(
        self: Self,
    ) -> "List[_524.ISO6336AbstractGearSingleFlankRating]":
