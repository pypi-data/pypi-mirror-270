...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.cylindrical.iso6336 import _537, _534
...
class CylindricalGearToothFatigueFractureResultsN1457(_0.APIBase):
    ...
    @property
    def fatigue_damage_chart(self: Self) -> "_1882.ThreeDChartDefinition":
    ...
    @property
    def critical_section(self: Self) -> "_537.ToothFlankFractureAnalysisRowN1457":
    ...
    @property
    def analysis_rows(self: Self) -> "List[_537.ToothFlankFractureAnalysisRowN1457]":
    ...
    def contact_points(
        self: Self,
    ) -> "List[_534.ToothFlankFractureAnalysisContactPointN1457]":
