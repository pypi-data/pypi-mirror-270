...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1035, _1082
    from mastapy.gears.rating.cylindrical.agma import _544, _541
...
class AGMA2101MeshSingleFlankRating(_474.CylindricalMeshSingleFlankRating):
    """AGMA2101MeshSingleFlankRating
    ...
    def gear_single_flank_ratings(
        self: Self,
    ) -> "List[_541.AGMA2101GearSingleFlankRating]":
