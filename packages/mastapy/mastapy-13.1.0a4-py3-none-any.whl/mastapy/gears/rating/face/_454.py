...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.face import _457, _455
...
class FaceGearMeshRating(_367.GearMeshRating):
    """FaceGearMeshRating
    ...
    @property
    def active_flank(self: Self) -> "_333.GearFlanks":
        ...
        return constructor.new_from_mastapy("mastapy.gears._333", "GearFlanks")(value)

    @property
    def face_gear_mesh(self: Self) -> "_999.FaceGearMeshDesign":
    ...
    @property
    def gear_set_rating(self: Self) -> "_457.FaceGearSetRating":
    ...
    @property
    def mesh_load_case(self: Self) -> "_888.FaceMeshLoadCase":
    ...
    @property
    def mesh_single_flank_rating(self: Self) -> "_521.ISO63362006MeshSingleFlankRating":
    ...
    @property
    def face_gear_ratings(self: Self) -> "List[_455.FaceGearRating]":
