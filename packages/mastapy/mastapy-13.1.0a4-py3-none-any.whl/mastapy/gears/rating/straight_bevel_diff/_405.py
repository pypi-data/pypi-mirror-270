...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.straight_bevel_diff import _408, _406
...
class StraightBevelDiffGearMeshRating(_546.ConicalGearMeshRating):
    """StraightBevelDiffGearMeshRating
    ...
    @property
    def meshed_gears(self: Self) -> "List[_408.StraightBevelDiffMeshedGearRating]":
    ...
    @property
    def gears_in_mesh(self: Self) -> "List[_408.StraightBevelDiffMeshedGearRating]":
        """List[mastapy.gears.rating.straight_bevel_diff.StraightBevelDiffMeshedGearRating]
