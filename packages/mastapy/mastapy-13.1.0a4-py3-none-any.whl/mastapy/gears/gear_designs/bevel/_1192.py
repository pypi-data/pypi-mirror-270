...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.conical import _1161, _1166
    from mastapy.math_utility import _1531
    from mastapy.gears.gear_designs.bevel import _1201, _1199
...
class BevelGearSetDesign(_1205.AGMAGleasonConicalGearSetDesign):
    """BevelGearSetDesign
    ...
    @property
    def backlash_distribution_rule(self: Self) -> "_1161.BacklashDistributionRule":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1161", "BacklashDistributionRule"
        )(value)

    @backlash_distribution_rule.setter
    @enforce_parameter_types
    def backlash_distribution_rule(self: Self, value: "_1161.BacklashDistributionRule"):
    ...
    @property
    def backlash_used_for_tooth_thickness_calculation(self: Self) -> "_1531.MaxMinMean":
        ...
        return constructor.new_from_mastapy("mastapy.math_utility._1531", "MaxMinMean")(
            value
        )
    ...
    def backlash_used_for_tooth_thickness_calculation(
        self: Self, value: "_1531.MaxMinMean"
    ):
    ...
    def round_cutter_specifications(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.bevel._1201",
    ...
    @enforce_parameter_types
    def round_cutter_specifications(
        self: Self, value: "_1201.WheelFinishCutterPointWidthRestrictionMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Bevel.WheelFinishCutterPointWidthRestrictionMethod",
    ...
    def tooth_proportions_input_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.bevel._1199", "ToothProportionsInputMethod"
        )(value)

    @tooth_proportions_input_method.setter
    @enforce_parameter_types
    def tooth_proportions_input_method(
        self: Self, value: "_1199.ToothProportionsInputMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def tooth_taper_root_line_tilt_method(self: Self) -> "_354.SpiralBevelRootLineTilt":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._354", "SpiralBevelRootLineTilt"
        )(value)

    @tooth_taper_root_line_tilt_method.setter
    @enforce_parameter_types
    def tooth_taper_root_line_tilt_method(
        self: Self, value: "_354.SpiralBevelRootLineTilt"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def tooth_thickness_specification_method(
        self: Self, value: "_1200.ToothThicknessSpecificationMethod"
    ):
