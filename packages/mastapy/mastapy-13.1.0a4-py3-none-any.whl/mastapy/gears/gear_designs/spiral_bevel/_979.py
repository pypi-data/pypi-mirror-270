...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.spiral_bevel import _977, _978
...
class SpiralBevelGearSetDesign(_1192.BevelGearSetDesign):
    """SpiralBevelGearSetDesign
    ...
    @property
    def gears(self: Self) -> "List[_977.SpiralBevelGearDesign]":
    ...
    @property
    def spiral_bevel_gears(self: Self) -> "List[_977.SpiralBevelGearDesign]":
        """List[mastapy.gears.gear_designs.spiral_bevel.SpiralBevelGearDesign]
    ...
    @property
    def spiral_bevel_meshes(self: Self) -> "List[_978.SpiralBevelGearMeshDesign]":
