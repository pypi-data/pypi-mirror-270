...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.spiral_bevel import _979, _977, _980
...
class SpiralBevelGearMeshDesign(_1191.BevelGearMeshDesign):
    """SpiralBevelGearMeshDesign
    ...
    def spiral_bevel_meshed_gears(
        self: Self,
    ) -> "List[_980.SpiralBevelMeshedGearDesign]":
