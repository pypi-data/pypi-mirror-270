...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.straight_bevel import _971, _969, _972
...
class StraightBevelGearMeshDesign(_1191.BevelGearMeshDesign):
    """StraightBevelGearMeshDesign
    ...
    def straight_bevel_meshed_gears(
        self: Self,
    ) -> "List[_972.StraightBevelMeshedGearDesign]":
