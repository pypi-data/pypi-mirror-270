...
if TYPE_CHECKING:
    from mastapy.gears import _357
...
class WormDesign(_965.WormGearDesign):
    """WormDesign
    ...
    class _Cast_WormDesign:
        ...
        @property
        def gear_design(self: "WormDesign._Cast_WormDesign") -> "_955.GearDesign":
    ...
    @property
    def addendum_factor(self: Self) -> "_357.WormAddendumFactor":
        ...
        return constructor.new_from_mastapy("mastapy.gears._357", "WormAddendumFactor")(
            value
        )

    @addendum_factor.setter
    @enforce_parameter_types
    def addendum_factor(self: Self, value: "_357.WormAddendumFactor"):
