...
class BevelHypoidGearDesignSettingsItem(_1844.NamedDatabaseItem):
    """BevelHypoidGearDesignSettingsItem
    ...
    @property
    def quality_grade_type(self: Self) -> "_351.QualityGradeTypes":
    ...
    @enforce_parameter_types
    def quality_grade_type(self: Self, value: "_351.QualityGradeTypes"):
