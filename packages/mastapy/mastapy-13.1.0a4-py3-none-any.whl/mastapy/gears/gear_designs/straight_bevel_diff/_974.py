...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.straight_bevel_diff import _975, _973, _976
...
class StraightBevelDiffGearMeshDesign(_1191.BevelGearMeshDesign):
    """StraightBevelDiffGearMeshDesign
    ...
    def straight_bevel_diff_meshed_gears(
        self: Self,
    ) -> "List[_976.StraightBevelDiffMeshedGearDesign]":
