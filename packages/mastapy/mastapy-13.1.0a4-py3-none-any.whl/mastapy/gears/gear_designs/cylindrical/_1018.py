...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1014, _1039
...
class CylindricalGearCuttingOptions(_0.APIBase):
    ...
    def geometry_specification_type(
        self: Self, value: "_1058.GeometrySpecificationType"
    ):
    ...
    @property
    def cylindrical_gear_cutter(self: Self) -> "_1014.CylindricalGearAbstractRack":
