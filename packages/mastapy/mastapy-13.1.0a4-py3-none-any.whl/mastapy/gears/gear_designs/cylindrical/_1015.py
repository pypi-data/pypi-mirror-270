...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1014, _1020, _1017, _1032, _1087
...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    class _Cast_CylindricalGearAbstractRackFlank:
        ...
        def cylindrical_gear_basic_rack_flank(
            ...
            return self._parent._cast(_1017.CylindricalGearBasicRackFlank)
        ...
        def cylindrical_gear_pinion_type_cutter_flank(
            ...
            return self._parent._cast(_1032.CylindricalGearPinionTypeCutterFlank)
        ...
        def standard_rack_flank(
            ...
            return self._parent._cast(_1087.StandardRackFlank)
    ...
    @property
    def cutter(self: Self) -> "_1014.CylindricalGearAbstractRack":
