...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1093, _1076
...
class CylindricalMeshAngularBacklash(_1048.CylindricalMeshLinearBacklashSpecification):
    """CylindricalMeshAngularBacklash
    ...
    class _Cast_CylindricalMeshAngularBacklash:
        ...
        def relative_measurement_view_model(
            ...
            return self._parent._cast(_1076.RelativeMeasurementViewModel)
