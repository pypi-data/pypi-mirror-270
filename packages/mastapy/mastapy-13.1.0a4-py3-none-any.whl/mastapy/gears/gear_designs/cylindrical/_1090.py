...
class TiffAnalysisSettings(
    _1599.IndependentReportablePropertiesBase["TiffAnalysisSettings"]
):
    """TiffAnalysisSettings
    ...
    @property
    def core_material_properties(self: Self) -> "_1059.HardenedMaterialProperties":
    ...
    @property
    def surface_material_properties(self: Self) -> "_1059.HardenedMaterialProperties":
        """mastapy.gears.gear_designs.cylindrical.HardenedMaterialProperties
