...
class FinishStockSpecification(
    _1077.RelativeValuesSpecification["FinishStockSpecification"]
):
    """FinishStockSpecification
    ...
    def finish_stock_rough_thickness_specification_method(
        self: Self, value: "_1100.FinishStockType"
    ):
    ...
    def normal(
        self: Self,
    ) -> "_1093.TolerancedValueSpecification[FinishStockSpecification]":
