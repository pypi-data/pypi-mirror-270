...
class CylindricalPlanetGearDesign(_1020.CylindricalGearDesign):
    """CylindricalPlanetGearDesign
    ...
    @property
    def planet_assembly_indices(self: Self) -> "List[_1073.NamedPlanetAssemblyIndex]":
    ...
    def planetary_sidebands_amplitude_factors(
        self: Self,
    ) -> "List[_1074.NamedPlanetSideBandAmplitudeFactor]":
