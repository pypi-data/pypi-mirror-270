...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1036, _1049, _1020
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1111, _1108
...
class CylindricalGearSetMicroGeometry(_1241.GearSetImplementationDetail):
    """CylindricalGearSetMicroGeometry
    ...
    def cylindrical_mesh_micro_geometries(
        self: Self,
    ) -> "List[_1108.CylindricalGearMeshMicroGeometry]":
    ...
    def duplicate_and_add_to(
        self: Self, gear_set_design: "_1036.CylindricalGearSetDesign"
    ) -> "CylindricalGearSetMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry
    ...
    def duplicate_specifying_separate_micro_geometry_for_each_planet_and_add_to(
        self: Self, gear_set_design: "_1049.CylindricalPlanetaryGearSetDesign"
    ) -> "_1241.GearSetImplementationDetail":
        """mastapy.gears.analysis.GearSetImplementationDetail
