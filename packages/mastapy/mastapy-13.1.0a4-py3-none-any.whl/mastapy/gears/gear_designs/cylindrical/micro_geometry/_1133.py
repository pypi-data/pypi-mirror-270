...
class MicroGeometryViewingOptions(_0.APIBase):
    ...
    def contact_results(self: Self, value: "_834.ContactResultType"):
    ...
    @property
    def gear_option(self: Self) -> "_1122.DrawDefiningGearOrBoth":
    ...
    @gear_option.setter
    @enforce_parameter_types
    def gear_option(self: Self, value: "_1122.DrawDefiningGearOrBoth"):
