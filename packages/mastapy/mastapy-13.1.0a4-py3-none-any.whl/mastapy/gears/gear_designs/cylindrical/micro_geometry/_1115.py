...
if TYPE_CHECKING:
    ...
    from mastapy.gears.micro_geometry import _586
...
class CylindricalGearProfileModification(_589.ProfileModification):
    """CylindricalGearProfileModification
    ...
    @property
    def profile_modification_chart(self: Self) -> "_1884.TwoDChartDefinition":
    ...
    @property
    def barrelling_peak_point(self: Self) -> "_1033.CylindricalGearProfileMeasurement":
    ...
    @property
    def evaluation_lower_limit(self: Self) -> "_1033.CylindricalGearProfileMeasurement":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement
    ...
    @property
    def evaluation_upper_limit(self: Self) -> "_1033.CylindricalGearProfileMeasurement":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement
