...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1010, _1056
...
class GearSetManufacturingConfigurationSetup(_0.APIBase):
    ...
    def create_new_suitable_cutters(
        self: Self, value: "_1010.CreateNewSuitableCutterOption"
    ):
    ...
    @property
    def gears(self: Self) -> "List[_1056.GearManufacturingConfigSetupViewModel]":
