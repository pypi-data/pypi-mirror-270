...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.worm import _964, _965, _968
    ...
    from mastapy.gears.gear_designs.face import _997, _1002, _1005
    from mastapy.gears.gear_designs.cylindrical import _1020, _1050
...
class GearDesign(_956.GearDesignComponent):
    ...
    class _Cast_GearDesign:
        ...
        @property
        def worm_design(self: "GearDesign._Cast_GearDesign") -> "_964.WormDesign":
    ...
    @property
    def tifffe_model(self: Self) -> "_1207.GearFEModel":
