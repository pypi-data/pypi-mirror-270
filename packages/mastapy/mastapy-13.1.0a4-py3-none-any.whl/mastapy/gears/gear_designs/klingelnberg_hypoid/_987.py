...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.klingelnberg_hypoid import _985, _986
...
class KlingelnbergCycloPalloidHypoidGearSetDesign(
    ...
    @property
    def gears(self: Self) -> "List[_985.KlingelnbergCycloPalloidHypoidGearDesign]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears(
        self: Self,
    ) -> "List[_985.KlingelnbergCycloPalloidHypoidGearDesign]":
        """List[mastapy.gears.gear_designs.klingelnberg_hypoid.KlingelnbergCycloPalloidHypoidGearDesign]
    ...
    def klingelnberg_conical_meshes(
        self: Self,
    ) -> "List[_986.KlingelnbergCycloPalloidHypoidGearMeshDesign]":
