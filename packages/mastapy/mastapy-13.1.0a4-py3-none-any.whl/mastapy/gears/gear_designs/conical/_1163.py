...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.conical import _1171, _1172, _1181, _1180, _1173
    from mastapy.gears.manufacturing.bevel.cutters import _820, _821, _822, _823
...
class ConicalGearCutter(_0.APIBase):
    ...
    class _Cast_ConicalGearCutter:
        ...
        def pinion_finish_cutter(
            ...
            from mastapy.gears.manufacturing.bevel.cutters import _820

            return self._parent._cast(_820.PinionFinishCutter)

        @property
        def pinion_rough_cutter(
            self: "ConicalGearCutter._Cast_ConicalGearCutter",
        ) -> "_821.PinionRoughCutter":
            from mastapy.gears.manufacturing.bevel.cutters import _821

            return self._parent._cast(_821.PinionRoughCutter)

        @property
        def wheel_finish_cutter(
            self: "ConicalGearCutter._Cast_ConicalGearCutter",
        ) -> "_822.WheelFinishCutter":
            from mastapy.gears.manufacturing.bevel.cutters import _822

            return self._parent._cast(_822.WheelFinishCutter)

        @property
        def wheel_rough_cutter(
            self: "ConicalGearCutter._Cast_ConicalGearCutter",
        ) -> "_823.WheelRoughCutter":
            from mastapy.gears.manufacturing.bevel.cutters import _823

            return self._parent._cast(_823.WheelRoughCutter)
        ...
        def dummy_conical_gear_cutter(
            ...
            return self._parent._cast(_1173.DummyConicalGearCutter)
    ...
    @property
    def cutter_blade_type(self: Self) -> "_1171.CutterBladeType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1171", "CutterBladeType"
        )(value)

    @cutter_blade_type.setter
    @enforce_parameter_types
    def cutter_blade_type(self: Self, value: "_1171.CutterBladeType"):
    ...
    @property
    def cutter_gauge_length(self: Self) -> "_1172.CutterGaugeLengths":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1172", "CutterGaugeLengths"
        )(value)

    @cutter_gauge_length.setter
    @enforce_parameter_types
    def cutter_gauge_length(self: Self, value: "_1172.CutterGaugeLengths"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def inner_toprem_letter_convex(self: Self) -> "_1181.TopremLetter":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1181", "TopremLetter"
        )(value)

    @inner_toprem_letter_convex.setter
    @enforce_parameter_types
    def inner_toprem_letter_convex(self: Self, value: "_1181.TopremLetter"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def input_toprem_as(self: Self) -> "_1180.TopremEntryType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1180", "TopremEntryType"
        )(value)

    @input_toprem_as.setter
    @enforce_parameter_types
    def input_toprem_as(self: Self, value: "_1180.TopremEntryType"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def outer_toprem_letter_concave(self: Self) -> "_1181.TopremLetter":
        """mastapy.gears.gear_designs.conical.TopremLetter"""
    ...
    @enforce_parameter_types
    def outer_toprem_letter_concave(self: Self, value: "_1181.TopremLetter"):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.Gears.GearDesigns.Conical.TopremLetter"
        )
