...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.hypoid import _995, _993, _996
...
class HypoidGearMeshDesign(_1204.AGMAGleasonConicalGearMeshDesign):
    """HypoidGearMeshDesign
    ...
    @property
    def hypoid_meshed_gears(self: Self) -> "List[_996.HypoidMeshedGearDesign]":
