...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.face import _1003, _1001, _1000
...
class FaceGearSetMicroGeometry(_1241.GearSetImplementationDetail):
    """FaceGearSetMicroGeometry
    ...
    def face_mesh_micro_geometries(
        self: Self,
    ) -> "List[_1000.FaceGearMeshMicroGeometry]":
