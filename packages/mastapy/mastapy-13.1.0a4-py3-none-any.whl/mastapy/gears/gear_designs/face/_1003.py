...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.face import _1004, _1005, _1002, _997, _999
...
class FaceGearSetDesign(_958.GearSetDesign):
    """FaceGearSetDesign
    ...
    @property
    def face_gear(self: Self) -> "_1005.FaceGearWheelDesign":
    ...
    @property
    def pinion(self: Self) -> "_1002.FaceGearPinionDesign":
    ...
    @property
    def gears(self: Self) -> "List[_997.FaceGearDesign]":
    ...
    @property
    def face_gears(self: Self) -> "List[_997.FaceGearDesign]":
        """List[mastapy.gears.gear_designs.face.FaceGearDesign]
    ...
    @property
    def face_meshes(self: Self) -> "List[_999.FaceGearMeshDesign]":
