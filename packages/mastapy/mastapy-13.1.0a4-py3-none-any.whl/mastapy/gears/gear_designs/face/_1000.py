...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.face import _1004, _999, _1001
...
class FaceGearMeshMicroGeometry(_1235.GearMeshImplementationDetail):
    """FaceGearMeshMicroGeometry
    ...
    @property
    def face_gear_set_micro_geometry(self: Self) -> "_1004.FaceGearSetMicroGeometry":
    ...
    @property
    def face_mesh(self: Self) -> "_999.FaceGearMeshDesign":
    ...
    @property
    def face_gear_micro_geometries(self: Self) -> "List[_1001.FaceGearMicroGeometry]":
