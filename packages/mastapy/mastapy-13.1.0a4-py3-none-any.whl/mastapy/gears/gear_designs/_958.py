...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1036, _1049
...
class GearSetDesign(_956.GearDesignComponent):
    ...
    @property
    def active_ltcafe_model(self: Self) -> "_1210.GearSetFEModel":
    ...
    @property
    def tifffe_model(self: Self) -> "_1210.GearSetFEModel":
        """mastapy.gears.fe_model.GearSetFEModel
    ...
    @property
    def gears(self: Self) -> "List[_955.GearDesign]":
    ...
    @property
    def ltcafe_models(self: Self) -> "List[_1210.GearSetFEModel]":
    ...
    def create_new_fe_model(self: Self) -> "_1210.GearSetFEModel":
        """mastapy.gears.fe_model.GearSetFEModel"""
