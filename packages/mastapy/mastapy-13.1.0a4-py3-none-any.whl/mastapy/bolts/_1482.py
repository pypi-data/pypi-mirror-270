...
if TYPE_CHECKING:
    from mastapy.bolts import _1497
...
class BoltMaterial(_1478.BoltedJointMaterial):
    """BoltMaterial
    ...
    class _Cast_BoltMaterial:
        ...
        @property
        def material(self: "BoltMaterial._Cast_BoltMaterial") -> "_276.Material":
            from mastapy.materials import _276
    ...
    @property
    def strength_grade(self: Self) -> "_1497.StrengthGrades":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1497", "StrengthGrades")(
            value
        )

    @strength_grade.setter
    @enforce_parameter_types
    def strength_grade(self: Self, value: "_1497.StrengthGrades"):
