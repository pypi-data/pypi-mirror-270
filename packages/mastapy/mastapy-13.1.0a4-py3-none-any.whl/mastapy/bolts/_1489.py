...
if TYPE_CHECKING:
    from mastapy.bolts import _1487, _1492, _1495, _1480, _1482, _1478
...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def clamped_parts(self: Self) -> "List[_1487.ClampedSection]":
    ...
    @enforce_parameter_types
    def clamped_parts(self: Self, value: "List[_1487.ClampedSection]"):
    ...
    @property
    def joint_geometry(self: Self) -> "_1492.JointGeometries":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1492", "JointGeometries")(
            value
        )

    @joint_geometry.setter
    @enforce_parameter_types
    def joint_geometry(self: Self, value: "_1492.JointGeometries"):
    ...
    def rolled_before_or_after_heat_treatment(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bolts._1495", "RolledBeforeOrAfterHeatTreatment"
        )(value)

    @rolled_before_or_after_heat_treatment.setter
    @enforce_parameter_types
    def rolled_before_or_after_heat_treatment(
        self: Self, value: "_1495.RolledBeforeOrAfterHeatTreatment"
    ):
    ...
    @property
    def bolt_geometry(self: Self) -> "_1480.BoltGeometry":
    ...
    @property
    def material_of_bolt(self: Self) -> "_1482.BoltMaterial":
    ...
    @property
    def material_of_nut(self: Self) -> "_1478.BoltedJointMaterial":
    ...
    @property
    def material_of_tapped_thread(self: Self) -> "_1478.BoltedJointMaterial":
        """mastapy.bolts.BoltedJointMaterial
    ...
    @property
    def clamped_sections(self: Self) -> "List[_1487.ClampedSection]":
        """List[mastapy.bolts.ClampedSection]
