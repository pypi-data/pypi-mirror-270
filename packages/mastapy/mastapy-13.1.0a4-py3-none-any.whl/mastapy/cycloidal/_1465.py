...
if TYPE_CHECKING:
    from mastapy.cycloidal import _1474, _1473, _1466
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self: Self) -> "_1474.RingPinsDesign":
    ...
    @property
    def disc_phases(self: Self) -> "List[_1473.NamedDiscPhase]":
    ...
    @property
    def discs(self: Self) -> "List[_1466.CycloidalDiscDesign]":
