...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.splines import _1423, _1414, _1426
...
class DIN5480SplineHalfDesign(_1431.StandardSplineHalfDesign):
    """DIN5480SplineHalfDesign
    ...
    @property
    def finishing_method(self: Self) -> "_1423.FinishingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1423", "FinishingMethods"
        )(value)

    @finishing_method.setter
    @enforce_parameter_types
    def finishing_method(self: Self, value: "_1423.FinishingMethods"):
    ...
    @property
    def manufacturing_type(self: Self) -> "_1414.ManufacturingTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1414", "ManufacturingTypes"
        )(value)

    @manufacturing_type.setter
    @enforce_parameter_types
    def manufacturing_type(self: Self, value: "_1414.ManufacturingTypes"):
        value = conversion.mp_to_pn_enum(
