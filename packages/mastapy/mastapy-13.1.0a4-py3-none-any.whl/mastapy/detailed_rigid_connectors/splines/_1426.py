...
class SplineHalfDesign(_1400.DetailedRigidConnectorHalfDesign):
    """SplineHalfDesign
    ...
    class _Cast_SplineHalfDesign:
        ...
        def custom_spline_half_design(
            ...
            return self._parent._cast(_1401.CustomSplineHalfDesign)
    ...
    @property
    def heat_treatment(self: Self) -> "_1410.HeatTreatmentTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1410", "HeatTreatmentTypes"
        )(value)

    @heat_treatment.setter
    @enforce_parameter_types
    def heat_treatment(self: Self, value: "_1410.HeatTreatmentTypes"):
    ...
    @property
    def fit_and_tolerance(self: Self) -> "_1433.FitAndTolerance":
