...
from mastapy.detailed_rigid_connectors.splines import _1406, _1429
...
class SplineJointDesign(_1399.DetailedRigidConnectorDesign):
    """SplineJointDesign
    ...
    @enforce_parameter_types
    def dudley_maximum_effective_length_option(
        self: Self, value: "_1406.DudleyEffectiveLengthApproximationOption"
    ):
    ...
    @property
    def fatigue_life_factor_type(self: Self) -> "_1418.SAEFatigueLifeFactorTypes":
    ...
    @enforce_parameter_types
    def fatigue_life_factor_type(self: Self, value: "_1418.SAEFatigueLifeFactorTypes"):
    ...
    @property
    def root_type(self: Self) -> "_1417.RootTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1417", "RootTypes"
        )(value)

    @root_type.setter
    @enforce_parameter_types
    def root_type(self: Self, value: "_1417.RootTypes"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def spline_fixture_type(self: Self) -> "_1425.SplineFixtureTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1425", "SplineFixtureTypes"
        )(value)

    @spline_fixture_type.setter
    @enforce_parameter_types
    def spline_fixture_type(self: Self, value: "_1425.SplineFixtureTypes"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def spline_rating_type(self: Self, value: "_1429.SplineRatingTypes"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def torque_cycles(self: Self) -> "_1421.SAETorqueCycles":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1421", "SAETorqueCycles"
        )(value)

    @torque_cycles.setter
    @enforce_parameter_types
    def torque_cycles(self: Self, value: "_1421.SAETorqueCycles"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def external_half(self: Self) -> "_1426.SplineHalfDesign":
    ...
    @property
    def internal_half(self: Self) -> "_1426.SplineHalfDesign":
        """mastapy.detailed_rigid_connectors.splines.SplineHalfDesign
