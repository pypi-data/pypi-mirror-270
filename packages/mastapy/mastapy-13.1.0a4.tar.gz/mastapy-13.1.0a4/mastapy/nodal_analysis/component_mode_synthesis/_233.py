...
if TYPE_CHECKING:
    from mastapy.nodal_analysis.component_mode_synthesis import _241, _235, _231
...
class CMSModel(_0.APIBase):
    ...
    @property
    def software_used_for_reduction(self: Self) -> "_241.SoftwareUsedForReductionType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.nodal_analysis.component_mode_synthesis._241",
    ...
    @property
    def fe_model(self: Self) -> "_191.FEModel":
    ...
    @property
    def reduction_information(self: Self) -> "_1591.AnalysisRunInformation":
    ...
    @property
    def reduction_options(self: Self) -> "_235.CMSOptions":
    ...
    @property
    def element_face_groups(self: Self) -> "List[_231.CMSElementFaceGroup]":
