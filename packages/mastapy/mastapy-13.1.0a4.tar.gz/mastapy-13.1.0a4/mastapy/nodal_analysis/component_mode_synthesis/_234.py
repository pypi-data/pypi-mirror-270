...
if TYPE_CHECKING:
    from mastapy.nodal_analysis.dev_tools_analyses import _190, _189
...
class CMSNodeGroup(_207.NodeGroup):
    """CMSNodeGroup
    ...
    class _Cast_CMSNodeGroup:
        ...
        @property
        def node_group(self: "CMSNodeGroup._Cast_CMSNodeGroup") -> "_207.NodeGroup":
