...
if TYPE_CHECKING:
    from mastapy.nodal_analysis.component_mode_synthesis import _237, _238, _239, _242
...
class CMSResults(_0.APIBase):
    ...
    class _Cast_CMSResults:
        ...
        def harmonic_cms_results(
            ...
            from mastapy.nodal_analysis.component_mode_synthesis import _237

            return self._parent._cast(_237.HarmonicCMSResults)
        ...
        def modal_cms_results(
            ...
            return self._parent._cast(_238.ModalCMSResults)
        ...
        def static_cms_results(
            ...
            return self._parent._cast(_242.StaticCMSResults)
