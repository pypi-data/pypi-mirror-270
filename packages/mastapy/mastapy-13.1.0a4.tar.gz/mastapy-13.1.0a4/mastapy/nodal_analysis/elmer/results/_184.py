...
from mastapy.nodal_analysis.elmer.results import _182
...
class Data3D(_182.Data):
    ...
    class _Cast_Data3D:
        ...
        @property
        def data(self: "Data3D._Cast_Data3D") -> "_182.Data":
            return self._parent._cast(_182.Data)
