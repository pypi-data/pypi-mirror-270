...
if TYPE_CHECKING:
    ...
    from mastapy.nodal_analysis.states import _121, _122, _124, _125
...
class EntityVectorState(_0.APIBase):
    ...
    class _Cast_EntityVectorState:
        ...
        def element_scalar_state(
            ...
            return self._parent._cast(_121.ElementScalarState)
        ...
        def element_vector_state(
            ...
            return self._parent._cast(_122.ElementVectorState)
        ...
        def node_scalar_state(
            ...
            return self._parent._cast(_124.NodeScalarState)
        ...
        def node_vector_state(
            ...
            return self._parent._cast(_125.NodeVectorState)
    ...
    @property
    def vector(self: Self) -> "_1538.RealVector":
