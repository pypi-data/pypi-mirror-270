...
if TYPE_CHECKING:
    from mastapy.nodal_analysis.geometry_modeller_link import _165
...
class GeometryModellerDimension(_0.APIBase):
    ...
    def type_(self: Self) -> "_165.GeometryModellerDimensionType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.nodal_analysis.geometry_modeller_link._165",
            "GeometryModellerDimensionType",
        )(value)

    @type_.setter
    @enforce_parameter_types
    def type_(self: Self, value: "_165.GeometryModellerDimensionType"):
