...
class MeshRequestResult(_0.APIBase):
    ...
    @property
    def cad_face_group(self: Self) -> "_318.CADFaceGroup":
    ...
    @enforce_parameter_types
    def cad_face_group(self: Self, value: "_318.CADFaceGroup"):
    ...
    @property
    def faceted_body(self: Self) -> "_1523.FacetedBody":
    ...
    @faceted_body.setter
    @enforce_parameter_types
    def faceted_body(self: Self, value: "_1523.FacetedBody"):
