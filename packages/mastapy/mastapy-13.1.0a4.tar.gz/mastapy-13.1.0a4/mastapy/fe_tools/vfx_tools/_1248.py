...
from mastapy.fe_tools.vfx_tools.vfx_enums import _1249, _1250
...
class ProSolveOptions(_0.APIBase):
    ...
    @mpc_type.setter
    @enforce_parameter_types
    def mpc_type(self: Self, value: "_1249.ProSolveMpcType"):
    ...
    @enforce_parameter_types
    def type_of_solver(self: Self, value: "_1250.ProSolveSolverType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
