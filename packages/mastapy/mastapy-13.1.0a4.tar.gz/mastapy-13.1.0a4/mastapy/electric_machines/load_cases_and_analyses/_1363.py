...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1367, _1362, _1371
...
class EfficiencyMapLoadCase(_1379.NonLinearDQModelMultipleOperatingPointsLoadCase):
    """EfficiencyMapLoadCase
