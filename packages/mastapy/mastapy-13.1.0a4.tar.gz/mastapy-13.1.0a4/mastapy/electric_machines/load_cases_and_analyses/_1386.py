...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1353
...
class SpeedTorqueCurveAnalysis(_1364.ElectricMachineAnalysis):
    """SpeedTorqueCurveAnalysis
    ...
    @property
    def load_case(self: Self) -> "_1387.SpeedTorqueCurveLoadCase":
    ...
    @property
    def results_points(self: Self) -> "List[_1353.MaximumTorqueResultsPoints]":
