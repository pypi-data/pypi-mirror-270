...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1374, _1368, _1388
...
class ElectricMachineLoadCase(_1371.ElectricMachineLoadCaseBase):
    """ElectricMachineLoadCase
    ...
    def analysis_period(self: Self, value: "_176.ElectricMachineAnalysisPeriod"):
