...
class ElectricMachineLoadCaseBase(_0.APIBase):
    ...
    class _Cast_ElectricMachineLoadCaseBase:
        ...
        def basic_dynamic_force_load_case(
            ...
            return self._parent._cast(_1358.BasicDynamicForceLoadCase)
        ...
        def dynamic_force_load_case(
            ...
            return self._parent._cast(_1360.DynamicForceLoadCase)
        ...
        def efficiency_map_load_case(
            ...
            return self._parent._cast(_1363.EfficiencyMapLoadCase)
        ...
        def electric_machine_load_case(
            ...
            return self._parent._cast(_1370.ElectricMachineLoadCase)
        ...
        def electric_machine_mechanical_load_case(
            ...
            return self._parent._cast(_1373.ElectricMachineMechanicalLoadCase)
        ...
        def speed_torque_curve_load_case(
            ...
            from mastapy.electric_machines.load_cases_and_analyses import _1387

            return self._parent._cast(_1387.SpeedTorqueCurveLoadCase)
        ...
        def speed_torque_load_case(
            ...
            return self._parent._cast(_1388.SpeedTorqueLoadCase)
    ...
    @property
    def temperatures(self: Self) -> "_1389.Temperatures":
    ...
    @property
    def analyses(self: Self) -> "List[_1364.ElectricMachineAnalysis]":
    ...
    @enforce_parameter_types
    def copy_to(
        self: Self, another_group: "_1372.ElectricMachineLoadCaseGroup"
    ) -> "ElectricMachineLoadCaseBase":
    ...
    @enforce_parameter_types
    def remove_analysis(
        self: Self, electric_machine_analysis: "_1364.ElectricMachineAnalysis"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_analysis_for(self: Self, setup: "_1277.ElectricMachineSetup"):
        """Method does not return.
