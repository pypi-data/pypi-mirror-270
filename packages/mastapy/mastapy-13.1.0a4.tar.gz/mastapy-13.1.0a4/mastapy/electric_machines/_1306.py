...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1293, _1322, _1323
...
class RotorInternalLayerSpecification(_0.APIBase):
    ...
    class _Cast_RotorInternalLayerSpecification:
        ...
        def u_shaped_layer_specification(
            ...
            return self._parent._cast(_1322.UShapedLayerSpecification)
        ...
        def v_shaped_magnet_layer_specification(
            ...
            return self._parent._cast(_1323.VShapedMagnetLayerSpecification)
    ...
    @property
    def magnets(self: Self) -> "_1293.MagnetForLayer":
