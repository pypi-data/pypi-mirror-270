...
class InteriorPermanentMagnetAndSynchronousReluctanceRotor(_1302.PermanentMagnetRotor):
    """InteriorPermanentMagnetAndSynchronousReluctanceRotor
    ...
    class _Cast_InteriorPermanentMagnetAndSynchronousReluctanceRotor:
        ...
        def permanent_magnet_rotor(
            ...
            return self._parent._cast(_1302.PermanentMagnetRotor)
    ...
    @property
    def flux_barrier_style(self: Self) -> "_1282.FluxBarrierStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1282", "FluxBarrierStyle"
        )(value)

    @flux_barrier_style.setter
    @enforce_parameter_types
    def flux_barrier_style(self: Self, value: "_1282.FluxBarrierStyle"):
    ...
    @property
    def rotor_type(self: Self) -> "_1308.RotorType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1308", "RotorType"
        )(value)

    @rotor_type.setter
    @enforce_parameter_types
    def rotor_type(self: Self, value: "_1308.RotorType"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def cooling_duct_layers(self: Self) -> "List[_1265.CoolingDuctLayerSpecification]":
    ...
    @property
    def notch_specifications(self: Self) -> "List[_1300.NotchSpecification]":
    ...
    @property
    def u_shape_layers(self: Self) -> "List[_1322.UShapedLayerSpecification]":
    ...
    def v_shape_magnet_layers(
        self: Self,
    ) -> "List[_1323.VShapedMagnetLayerSpecification]":
