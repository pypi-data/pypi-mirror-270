...
if TYPE_CHECKING:
    from mastapy.utility_gui.charts import _1882, _1884
...
class NonLinearDQModel(_1335.ElectricMachineDQModel):
    """NonLinearDQModel
    ...
    class _Cast_NonLinearDQModel:
        ...
        def electric_machine_dq_model(
            ...
            return self._parent._cast(_1335.ElectricMachineDQModel)
    ...
    @property
    def d_axis_armature_flux_linkage_map(self: Self) -> "_1882.ThreeDChartDefinition":
        """mastapy.utility_gui.charts.ThreeDChartDefinition
    ...
    @property
    def q_axis_armature_flux_linkage_map(self: Self) -> "_1882.ThreeDChartDefinition":
        """mastapy.utility_gui.charts.ThreeDChartDefinition
