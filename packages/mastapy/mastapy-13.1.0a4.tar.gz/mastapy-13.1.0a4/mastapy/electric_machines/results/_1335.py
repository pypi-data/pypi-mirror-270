...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1325
    from mastapy.electric_machines.results import _1352, _1354
...
class ElectricMachineDQModel(_0.APIBase):
    ...
    class _Cast_ElectricMachineDQModel:
        ...
        def linear_dq_model(
            ...
            return self._parent._cast(_1352.LinearDQModel)

        @property
        def non_linear_dq_model(
            self: "ElectricMachineDQModel._Cast_ElectricMachineDQModel",
        ) -> "_1354.NonLinearDQModel":
            from mastapy.electric_machines.results import _1354

            return self._parent._cast(_1354.NonLinearDQModel)
