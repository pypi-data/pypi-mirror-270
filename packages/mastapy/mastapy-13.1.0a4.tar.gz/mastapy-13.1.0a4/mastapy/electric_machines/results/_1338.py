...
class ElectricMachineResults(_0.APIBase):
    ...
    class _Cast_ElectricMachineResults:
        ...
        def on_load_electric_machine_results(
            ...
            return self._parent._cast(_1356.OnLoadElectricMachineResults)
        ...
        def open_circuit_electric_machine_results(
            ...
            return self._parent._cast(_1357.OpenCircuitElectricMachineResults)
    ...
    @property
    def results_timesteps(self: Self) -> "List[_1347.ElectricMachineResultsTimeStep]":
    ...
    def results_for_conductor_turns(
        self: Self,
    ) -> "List[_1339.ElectricMachineResultsForConductorTurn]":
    ...
    def results_for_line_to_line(
        self: Self,
    ) -> "List[_1341.ElectricMachineResultsForLineToLine]":
    ...
    @property
    def results_for_phases(self: Self) -> "List[_1343.ElectricMachineResultsForPhase]":
