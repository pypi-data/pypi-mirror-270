...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1254, _1328, _1261, _1311
...
class AbstractStator(_0.APIBase):
    ...
    class _Cast_AbstractStator:
        ...
        def cad_stator(
            ...
            return self._parent._cast(_1261.CADStator)

        @property
        def stator(self: "AbstractStator._Cast_AbstractStator") -> "_1311.Stator":
            from mastapy.electric_machines import _1311

            return self._parent._cast(_1311.Stator)
    ...
    @property
    def tooth_and_slot(self: Self) -> "_1254.AbstractToothAndSlot":
