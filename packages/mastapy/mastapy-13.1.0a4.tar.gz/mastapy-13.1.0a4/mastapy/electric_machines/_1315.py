...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1316, _1272
...
class SurfacePermanentMagnetMachine(_1298.NonCADElectricMachineDetail):
    """SurfacePermanentMagnetMachine
    ...
    @property
    def rotor(self: Self) -> "_1316.SurfacePermanentMagnetRotor":
