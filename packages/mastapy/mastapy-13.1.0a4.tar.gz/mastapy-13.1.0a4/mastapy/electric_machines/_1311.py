...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1312, _1318
...
class Stator(_1253.AbstractStator):
    """Stator
    ...
    class _Cast_Stator:
        ...
        @property
        def abstract_stator(self: "Stator._Cast_Stator") -> "_1253.AbstractStator":
            return self._parent._cast(_1253.AbstractStator)
    ...
    def stator_cut_out_specifications(
        self: Self,
    ) -> "List[_1312.StatorCutOutSpecification]":
    ...
    @property
    def tooth_and_slot(self: Self) -> "_1318.ToothAndSlot":
