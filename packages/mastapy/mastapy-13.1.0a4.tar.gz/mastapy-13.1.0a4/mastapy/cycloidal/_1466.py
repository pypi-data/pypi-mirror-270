...
if TYPE_CHECKING:
    ...
    from mastapy.cycloidal import _1467, _1470
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def crowning_chart(self: Self) -> "_1884.TwoDChartDefinition":
    ...
    @property
    def exporter(self: Self) -> "_1467.CycloidalDiscDesignExporter":
