...
if TYPE_CHECKING:
    from mastapy.materials import _261, _287
...
class CompositeFatigueSafetyFactorItem(_260.FatigueSafetyFactorItem):
    """CompositeFatigueSafetyFactorItem
    ...
    class _Cast_CompositeFatigueSafetyFactorItem:
        ...
        def fatigue_safety_factor_item(
            ...
            return self._parent._cast(_260.FatigueSafetyFactorItem)
