...
if TYPE_CHECKING:
    from mastapy.materials import _266, _298, _262, _294, _297, _250, _274, _296
...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    def bearing_iso762006_static_safety_factor_limit(
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._266", "ISO76StaticSafetyFactorLimits"
        )(value)

    @bearing_iso762006_static_safety_factor_limit.setter
    @enforce_parameter_types
    def bearing_iso762006_static_safety_factor_limit(
        self: Self, value: "_266.ISO76StaticSafetyFactorLimits"
    ):
    ...
    @property
    def driven_machine_characteristics(self: Self) -> "_298.WorkingCharacteristics":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._298", "WorkingCharacteristics"
        )(value)

    @driven_machine_characteristics.setter
    @enforce_parameter_types
    def driven_machine_characteristics(
        self: Self, value: "_298.WorkingCharacteristics"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def driving_machine_characteristics(self: Self) -> "_298.WorkingCharacteristics":
        """mastapy.materials.WorkingCharacteristics"""
    ...
    @property
    def gearing_type(self: Self) -> "_262.GearingTypes":
        ...
        return constructor.new_from_mastapy("mastapy.materials._262", "GearingTypes")(
            value
        )

    @gearing_type.setter
    @enforce_parameter_types
    def gearing_type(self: Self, value: "_262.GearingTypes"):
    ...
    @property
    def transmission_application(self: Self) -> "_294.TransmissionApplications":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._294", "TransmissionApplications"
        )(value)

    @transmission_application.setter
    @enforce_parameter_types
    def transmission_application(self: Self, value: "_294.TransmissionApplications"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def wind_turbine_standard(self: Self) -> "_297.WindTurbineStandards":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._297", "WindTurbineStandards"
        )(value)

    @wind_turbine_standard.setter
    @enforce_parameter_types
    def wind_turbine_standard(self: Self, value: "_297.WindTurbineStandards"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def air_properties(self: Self) -> "_250.AirProperties":
    ...
    @property
    def vehicle_dynamics(self: Self) -> "_296.VehicleDynamicsProperties":
