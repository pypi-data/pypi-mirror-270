...
if TYPE_CHECKING:
    from mastapy.materials import _257, _287
...
class FatigueSafetyFactorItem(_261.FatigueSafetyFactorItemBase):
    """FatigueSafetyFactorItem
    ...
    class _Cast_FatigueSafetyFactorItem:
        ...
        def fatigue_safety_factor_item_base(
            ...
            return self._parent._cast(_261.FatigueSafetyFactorItemBase)
        ...
        def safety_factor_item(
            ...
            return self._parent._cast(_287.SafetyFactorItem)
        ...
        def composite_fatigue_safety_factor_item(
            ...
            return self._parent._cast(_257.CompositeFatigueSafetyFactorItem)
