...
if TYPE_CHECKING:
    from mastapy.materials.efficiency import _300, _303
...
class ResistiveTorque(_0.APIBase):
    ...
    class _Cast_ResistiveTorque:
        ...
        def combined_resistive_torque(
            ...
            return self._parent._cast(_300.CombinedResistiveTorque)
        ...
        def independent_resistive_torque(
            ...
            return self._parent._cast(_303.IndependentResistiveTorque)
