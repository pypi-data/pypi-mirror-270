...
class SoundPressureEnclosure(_0.APIBase):
    ...
    @property
    def enclosure_type(self: Self) -> "_291.SoundPressureEnclosureType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._291", "SoundPressureEnclosureType"
        )(value)

    @enclosure_type.setter
    @enforce_parameter_types
    def enclosure_type(self: Self, value: "_291.SoundPressureEnclosureType"):
