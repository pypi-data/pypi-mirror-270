...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def input_type(self: Self) -> "_245.AcousticRadiationEfficiencyInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._245", "AcousticRadiationEfficiencyInputType"
        )(value)

    @input_type.setter
    @enforce_parameter_types
    def input_type(self: Self, value: "_245.AcousticRadiationEfficiencyInputType"):
    ...
    @property
    def radiation_efficiency_curve(self: Self) -> "_1547.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def radiation_efficiency_curve(self: Self, value: "_1547.Vector2DListAccessor"):
