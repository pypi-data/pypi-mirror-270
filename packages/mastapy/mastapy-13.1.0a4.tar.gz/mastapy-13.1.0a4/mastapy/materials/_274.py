...
from mastapy.materials import _268, _272
...
class LubricationDetail(_1844.NamedDatabaseItem):
    """LubricationDetail
    ...
    @property
    def agma925a03_lubricant_type(self: Self) -> "_246.AGMALubricantType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._246", "AGMALubricantType"
        )(value)

    @agma925a03_lubricant_type.setter
    @enforce_parameter_types
    def agma925a03_lubricant_type(self: Self, value: "_246.AGMALubricantType"):
    ...
    @property
    def delivery(self: Self) -> "_269.LubricantDelivery":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._269", "LubricantDelivery"
        )(value)
    ...
    @property
    def density_specification_method(self: Self) -> "_259.DensitySpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._259", "DensitySpecificationMethod"
        )(value)

    @density_specification_method.setter
    @enforce_parameter_types
    def density_specification_method(
        self: Self, value: "_259.DensitySpecificationMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def density_vs_temperature(self: Self) -> "_1547.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def density_vs_temperature(self: Self, value: "_1547.Vector2DListAccessor"):
    ...
    @property
    def grease_contamination_level(self: Self) -> "_264.GreaseContaminationOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._264", "GreaseContaminationOptions"
        )(value)

    @grease_contamination_level.setter
    @enforce_parameter_types
    def grease_contamination_level(
        self: Self, value: "_264.GreaseContaminationOptions"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def iso_lubricant_type(self: Self) -> "_267.ISOLubricantType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._267", "ISOLubricantType"
        )(value)

    @iso_lubricant_type.setter
    @enforce_parameter_types
    def iso_lubricant_type(self: Self, value: "_267.ISOLubricantType"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def lubricant_definition(self: Self, value: "_268.LubricantDefinition"):
    ...
    @property
    def lubricant_grade_agma(self: Self) -> "_270.LubricantViscosityClassAGMA":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._270", "LubricantViscosityClassAGMA"
        )(value)

    @lubricant_grade_agma.setter
    @enforce_parameter_types
    def lubricant_grade_agma(self: Self, value: "_270.LubricantViscosityClassAGMA"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def lubricant_grade_iso(self: Self, value: "_272.LubricantViscosityClassISO"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def lubricant_grade_sae(self: Self) -> "_273.LubricantViscosityClassSAE":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._273", "LubricantViscosityClassSAE"
        )(value)

    @lubricant_grade_sae.setter
    @enforce_parameter_types
    def lubricant_grade_sae(self: Self, value: "_273.LubricantViscosityClassSAE"):
        value = conversion.mp_to_pn_enum(
    ...
    def lubricant_type_ampersand_supply(
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._251", "BearingLubricationCondition"
        )(value)

    @lubricant_type_ampersand_supply.setter
    @enforce_parameter_types
    def lubricant_type_ampersand_supply(
        self: Self, value: "_251.BearingLubricationCondition"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    def lubricant_viscosity_classification(
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._271", "LubricantViscosityClassification"
        )(value)

    @lubricant_viscosity_classification.setter
    @enforce_parameter_types
    def lubricant_viscosity_classification(
        self: Self, value: "_271.LubricantViscosityClassification"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def oil_filtration_and_contamination(self: Self) -> "_283.OilFiltrationOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._283", "OilFiltrationOptions"
        )(value)

    @oil_filtration_and_contamination.setter
    @enforce_parameter_types
    def oil_filtration_and_contamination(
        self: Self, value: "_283.OilFiltrationOptions"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    def pressure_viscosity_coefficient_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._284", "PressureViscosityCoefficientMethod"
        )(value)

    @pressure_viscosity_coefficient_method.setter
    @enforce_parameter_types
    def pressure_viscosity_coefficient_method(
        self: Self, value: "_284.PressureViscosityCoefficientMethod"
    ):
        value = conversion.mp_to_pn_enum(
