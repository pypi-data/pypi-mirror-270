...
if TYPE_CHECKING:
    from mastapy.system_model import _2218, _2221
    from mastapy.utility.operation_modes import _1803
    from mastapy.geometry.two_d import _318
    from mastapy.nodal_analysis.geometry_modeller_link import _162, _169, _170
    from mastapy.math_utility import _1523, _1505
...
class MASTAGUI(_0.APIBase):
    ...
    @property
    def active_design(self: Self) -> "_2218.Design":
    ...
    @enforce_parameter_types
    def active_design(self: Self, value: "_2218.Design"):
    ...
    @property
    def open_designs(self: Self) -> "List[_2218.Design]":
    ...
    @property
    def operation_mode(self: Self) -> "_1803.OperationMode":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.operation_modes._1803", "OperationMode"
        )(value)

    @operation_mode.setter
    @enforce_parameter_types
    def operation_mode(self: Self, value: "_1803.OperationMode"):
    ...
    @property
    def selected_design_entity(self: Self) -> "_2221.DesignEntity":
    ...
    @enforce_parameter_types
    def selected_design_entity(self: Self, value: "_2221.DesignEntity"):
    ...
    def add_electric_machine_from_cad_face_group(
        self: Self,
        cad_face_group: "_318.CADFaceGroup",
    ...
    def add_fe_substructure_from_data(
        self: Self,
        vertices_and_facets: "_1523.FacetedBody",
        geometry_modeller_design_information: "_162.GeometryModellerDesignInformation",
        dimensions: "Dict[str, _163.GeometryModellerDimension]",
        body_moniker: "str",
    ):
    ...
    def add_line_from_geometry_modeller(
        self: Self, circles_on_axis: "_1505.CirclesOnAxis"
    ):
        """Method does not return.
    ...
    def circle_pairs_from_geometry_modeller(
        self: Self,
        preselection_circles: "_1505.CirclesOnAxis",
        selected_circles: "List[_1505.CirclesOnAxis]",
    ):
        """Method does not return.
    ...
    def create_new_cad_face_group(self: Self) -> "_318.CADFaceGroup":
    ...
    def create_new_circles_on_axis(self: Self) -> "_1505.CirclesOnAxis":
    ...
    def create_new_faceted_body(self: Self) -> "_1523.FacetedBody":
    ...
    @enforce_parameter_types
    def open_design_in_new_tab(self: Self, design: "_2218.Design"):
        """Method does not return.
