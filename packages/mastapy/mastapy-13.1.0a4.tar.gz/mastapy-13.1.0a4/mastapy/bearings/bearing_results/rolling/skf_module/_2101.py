...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2103, _2102
...
class Friction(_2114.SKFCalculationResult):
    """Friction
    ...
    @property
    def friction_sources(self: Self) -> "_2103.FrictionSources":
    ...
    @property
    def frictional_moment(self: Self) -> "_2102.FrictionalMoment":
