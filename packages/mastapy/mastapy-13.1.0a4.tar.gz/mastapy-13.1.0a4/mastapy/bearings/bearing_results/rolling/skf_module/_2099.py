...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2100, _2112
...
class Frequencies(_2114.SKFCalculationResult):
    """Frequencies
    ...
    @property
    def frequency_of_over_rolling(self: Self) -> "_2100.FrequencyOfOverRolling":
    ...
    @property
    def rotational_frequency(self: Self) -> "_2112.RotationalFrequency":
