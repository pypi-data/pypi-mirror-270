...
class LoadedBallBearingRow(_2052.LoadedRollingBearingRow):
    """LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2020.LoadedBallBearingResults":
    ...
    @property
    def race_results(self: Self) -> "List[_2019.LoadedBallBearingRaceResults]":
