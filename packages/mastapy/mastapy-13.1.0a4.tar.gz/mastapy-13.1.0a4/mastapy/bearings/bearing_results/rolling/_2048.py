...
class LoadedRollerBearingRow(_2052.LoadedRollingBearingRow):
    """LoadedRollerBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2047.LoadedRollerBearingResults":
    ...
    def lamina_dynamic_equivalent_loads(
        self: Self,
    ) -> "List[_1988.ForceAtLaminaGroupReportable]":
