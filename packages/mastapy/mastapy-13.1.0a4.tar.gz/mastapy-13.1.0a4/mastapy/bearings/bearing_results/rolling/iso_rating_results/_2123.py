...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_results.rolling.abma import _2133, _2134, _2135
...
class ISOResults(_0.APIBase):
    ...
    class _Cast_ISOResults:
        ...
        def ball_iso2812007_results(
            ...
            return self._parent._cast(_2119.BallISO2812007Results)
        ...
        def ball_isots162812008_results(
            ...
            return self._parent._cast(_2120.BallISOTS162812008Results)
        ...
        def iso2812007_results(
            ...
            return self._parent._cast(_2121.ISO2812007Results)
        ...
        def isots162812008_results(
            ...
            return self._parent._cast(_2124.ISOTS162812008Results)
        ...
        def roller_iso2812007_results(
            ...
            return self._parent._cast(_2125.RollerISO2812007Results)
        ...
        def roller_isots162812008_results(
            ...
            return self._parent._cast(_2126.RollerISOTS162812008Results)

        @property
        def ansiabma112014_results(
            self: "ISOResults._Cast_ISOResults",
        ) -> "_2133.ANSIABMA112014Results":
            from mastapy.bearings.bearing_results.rolling.abma import _2133

            return self._parent._cast(_2133.ANSIABMA112014Results)

        @property
        def ansiabma92015_results(
            self: "ISOResults._Cast_ISOResults",
        ) -> "_2134.ANSIABMA92015Results":
            from mastapy.bearings.bearing_results.rolling.abma import _2134

            return self._parent._cast(_2134.ANSIABMA92015Results)
        ...
        def ansiabma_results(
            ...
            return self._parent._cast(_2135.ANSIABMAResults)
