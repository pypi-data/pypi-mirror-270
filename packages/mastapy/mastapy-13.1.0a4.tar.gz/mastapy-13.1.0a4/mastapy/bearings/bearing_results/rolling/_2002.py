...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2001, _2005, _2052
...
class LoadedAngularContactBallBearingRow(_2021.LoadedBallBearingRow):
    """LoadedAngularContactBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2001.LoadedAngularContactBallBearingResults":
