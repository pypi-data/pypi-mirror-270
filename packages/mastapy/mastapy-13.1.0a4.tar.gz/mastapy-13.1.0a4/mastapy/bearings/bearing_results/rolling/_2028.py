...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2027, _2040, _2048, _2052
...
class LoadedCylindricalRollerBearingRow(_2043.LoadedNonBarrelRollerBearingRow):
    """LoadedCylindricalRollerBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2027.LoadedCylindricalRollerBearingResults":
