...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2023, _2052
...
class LoadedCrossedRollerBearingRow(_2048.LoadedRollerBearingRow):
    """LoadedCrossedRollerBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2023.LoadedCrossedRollerBearingResults":
