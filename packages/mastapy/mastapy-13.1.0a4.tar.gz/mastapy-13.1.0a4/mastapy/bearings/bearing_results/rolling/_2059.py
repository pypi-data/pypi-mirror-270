...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2058, _2052
...
class LoadedSphericalRollerRadialBearingRow(_2048.LoadedRollerBearingRow):
    """LoadedSphericalRollerRadialBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2058.LoadedSphericalRollerRadialBearingResults":
