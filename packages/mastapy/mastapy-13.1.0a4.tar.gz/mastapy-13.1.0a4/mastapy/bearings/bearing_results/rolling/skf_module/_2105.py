...
from mastapy.bearings.bearing_results.rolling.skf_module import _2114
...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2104, _2106, _2107
...
class GreaseLifeAndRelubricationInterval(_2114.SKFCalculationResult):
    """GreaseLifeAndRelubricationInterval
    ...
    class _Cast_GreaseLifeAndRelubricationInterval:
        ...
        def skf_calculation_result(
            ...
            return self._parent._cast(_2114.SKFCalculationResult)
    ...
    @property
    def grease(self: Self) -> "_2104.Grease":
    ...
    @property
    def grease_quantity(self: Self) -> "_2106.GreaseQuantity":
    ...
    @property
    def initial_fill(self: Self) -> "_2107.InitialFill":
