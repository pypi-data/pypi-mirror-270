...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2035, _2034, _2052
...
class LoadedFourPointContactBallBearingRow(_2021.LoadedBallBearingRow):
    """LoadedFourPointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2035.LoadedFourPointContactBallBearingResults":
    ...
    def race_results(
        self: Self,
    ) -> "List[_2034.LoadedFourPointContactBallBearingRaceResults]":
