...
if TYPE_CHECKING:
    from mastapy.utility.vectors import _1850, _1849
...
class LoadedBallBearingElement(_2032.LoadedElement):
    """LoadedBallBearingElement
    ...
    @property
    def contact_patch_sliding_speed_inner(self: Self) -> "_1850.PlaneScalarFieldData":
        """mastapy.utility.vectors.PlaneScalarFieldData
    ...
    @property
    def contact_patch_sliding_speed_outer(self: Self) -> "_1850.PlaneScalarFieldData":
        """mastapy.utility.vectors.PlaneScalarFieldData
    ...
    def inner_race_contact_geometries(
        self: Self,
    ) -> "List[_1986.BallBearingRaceContactGeometry]":
