...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2072, _2052
...
class LoadedThrustBallBearingRow(_2021.LoadedBallBearingRow):
    """LoadedThrustBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2072.LoadedThrustBallBearingResults":
