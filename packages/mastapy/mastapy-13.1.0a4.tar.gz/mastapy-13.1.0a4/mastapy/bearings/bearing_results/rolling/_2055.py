...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2054, _2052
...
class LoadedSelfAligningBallBearingRow(_2021.LoadedBallBearingRow):
    """LoadedSelfAligningBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2054.LoadedSelfAligningBallBearingResults":
