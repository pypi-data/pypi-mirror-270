...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_results import _1967, _1974, _1977
...
class LoadedBearingDutyCycle(_0.APIBase):
    ...
    @property
    def bearing_design(self: Self) -> "_2148.BearingDesign":
    ...
    @property
    def bearing_load_case_results(self: Self) -> "List[_1967.LoadedBearingResults]":
