...
if TYPE_CHECKING:
    from mastapy.utility.property import _1855, _1858, _1856, _1857
...
class LoadedRollingBearingDutyCycle(_1974.LoadedNonLinearBearingDutyCycleResults):
    """LoadedRollingBearingDutyCycle
    ...
    class _Cast_LoadedRollingBearingDutyCycle:
        ...
        def loaded_ball_bearing_duty_cycle(
            ...
            return self._parent._cast(_2017.LoadedBallBearingDutyCycle)
    ...
    def ansiabma_dynamic_equivalent_load_summary(
        self: Self,
    ) -> "_1855.DutyCyclePropertySummaryForce[_1892.BearingLoadCaseResultsLightweight]":
    ...
    def maximum_element_normal_stress_inner_summary(
        ...
        "_1858.DutyCyclePropertySummaryStress[_1892.BearingLoadCaseResultsLightweight]"
    ):
    ...
    def maximum_truncation_summary(
        self: Self,
    ) -> "_1856.DutyCyclePropertySummaryPercentage[_1892.BearingLoadCaseResultsLightweight]":
    ...
    def misalignment_summary(
        self: Self,
    ) -> "_1857.DutyCyclePropertySummarySmallAngle[_1892.BearingLoadCaseResultsLightweight]":
