...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.fluid_film import _2144, _2147
...
class LoadedFluidFilmBearingPad(_0.APIBase):
    ...
    class _Cast_LoadedFluidFilmBearingPad:
        ...
        def loaded_tilting_journal_pad(
            ...
            return self._parent._cast(_2144.LoadedTiltingJournalPad)
        ...
        def loaded_tilting_thrust_pad(
            ...
            return self._parent._cast(_2147.LoadedTiltingThrustPad)
