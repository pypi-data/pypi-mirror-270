...
from mastapy.bearings.bearing_designs.fluid_film import _2210
...
class CylindricalHousingJournalBearing(_2210.PlainJournalHousing):
    """CylindricalHousingJournalBearing
    ...
    class _Cast_CylindricalHousingJournalBearing:
        ...
        def plain_journal_housing(
            ...
            return self._parent._cast(_2210.PlainJournalHousing)
