...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_designs.fluid_film import _2203, _2204, _2206
...
class PlainJournalHousing(_0.APIBase):
    ...
    class _Cast_PlainJournalHousing:
        ...
        def cylindrical_housing_journal_bearing(
            ...
            return self._parent._cast(_2203.CylindricalHousingJournalBearing)

        @property
        def machinery_encased_journal_bearing(
            self: "PlainJournalHousing._Cast_PlainJournalHousing",
        ) -> "_2204.MachineryEncasedJournalBearing":
            from mastapy.bearings.bearing_designs.fluid_film import _2204

            return self._parent._cast(_2204.MachineryEncasedJournalBearing)
        ...
        def pedestal_journal_bearing(
            ...
            return self._parent._cast(_2206.PedestalJournalBearing)
    ...
    @property
    def heat_emitting_area_method(self: Self) -> "_1961.DefaultOrUserInput":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_results._1961", "DefaultOrUserInput"
        )(value)

    @heat_emitting_area_method.setter
    @enforce_parameter_types
    def heat_emitting_area_method(self: Self, value: "_1961.DefaultOrUserInput"):
