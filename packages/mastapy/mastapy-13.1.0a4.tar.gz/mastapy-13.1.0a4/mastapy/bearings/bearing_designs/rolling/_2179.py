...
class NonBarrelRollerBearing(_2180.RollerBearing):
    """NonBarrelRollerBearing
    ...
    @property
    def roller_end_shape(self: Self) -> "_2181.RollerEndShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.rolling._2181", "RollerEndShape"
        )(value)

    @roller_end_shape.setter
    @enforce_parameter_types
    def roller_end_shape(self: Self, value: "_2181.RollerEndShape"):
    ...
    @property
    def ribs(self: Self) -> "List[_2182.RollerRibDetail]":
