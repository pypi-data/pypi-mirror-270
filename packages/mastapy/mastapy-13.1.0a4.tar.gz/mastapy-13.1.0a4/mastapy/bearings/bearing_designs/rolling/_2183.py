...
from mastapy.bearings import _1909, _1887, _1888, _1912
from mastapy.bearings.bearing_designs.rolling import _2169, _2170, _2176, _2193
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1889, _1886
    ...
    from mastapy.bearings.bearing_designs import _2152, _2148
...
class RollingBearing(_2149.DetailedBearing):
    """RollingBearing
    ...
    @arrangement.setter
    @enforce_parameter_types
    def arrangement(self: Self, value: "_1909.RollingBearingArrangement"):
    ...
    @enforce_parameter_types
    def basic_dynamic_load_rating_calculation(
        self: Self, value: "_1887.BasicDynamicLoadRatingCalculationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def basic_static_load_rating_calculation(
        self: Self, value: "_1888.BasicStaticLoadRatingCalculationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def cage_bridge_shape(self: Self) -> "_2165.CageBridgeShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.rolling._2165", "CageBridgeShape"
        )(value)

    @cage_bridge_shape.setter
    @enforce_parameter_types
    def cage_bridge_shape(self: Self, value: "_2165.CageBridgeShape"):
    ...
    @property
    def cage_material(self: Self) -> "_1889.BearingCageMaterial":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1889", "BearingCageMaterial"
        )(value)

    @cage_material.setter
    @enforce_parameter_types
    def cage_material(self: Self, value: "_1889.BearingCageMaterial"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def catalogue(self: Self) -> "_1886.BearingCatalog":
        ...
        return constructor.new_from_mastapy("mastapy.bearings._1886", "BearingCatalog")(
            value
        )
    ...
    def diameter_series(
        self: Self,
        value: "Union[_2169.DiameterSeries, Tuple[_2169.DiameterSeries, bool]]",
    ):
    ...
    @enforce_parameter_types
    def fatigue_load_limit_calculation_method(
        self: Self, value: "_2170.FatigueLoadLimitCalculationMethodEnum"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def height_series(
        self: Self, value: "Union[_2176.HeightSeries, Tuple[_2176.HeightSeries, bool]]"
    ):
    ...
    @enforce_parameter_types
    def inner_race_type(self: Self, value: "_1912.RollingBearingRaceType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def outer_race_type(self: Self, value: "_1912.RollingBearingRaceType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
            enum_with_selected_value.EnumWithSelectedValue_RollingBearingRaceType.implicit_type()
        )
    ...
    @property
    def sleeve_type(self: Self) -> "_2186.SleeveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.rolling._2186", "SleeveType"
        )(value)
    ...
    @property
    def type_information(self: Self) -> "_2164.BearingTypeExtraInformation":
    ...
    @enforce_parameter_types
    def width_series(
        self: Self, value: "Union[_2193.WidthSeries, Tuple[_2193.WidthSeries, bool]]"
    ):
    ...
    @property
    def element_material(self: Self) -> "_252.BearingMaterial":
    ...
    @property
    def geometric_constants(self: Self) -> "_2173.GeometricConstants":
    ...
    @property
    def iso153122018(self: Self) -> "_1995.ISO153122018Results":
    ...
    @property
    def inner_ring_material(self: Self) -> "_252.BearingMaterial":
        """mastapy.materials.BearingMaterial
    ...
    @property
    def outer_ring_material(self: Self) -> "_252.BearingMaterial":
        """mastapy.materials.BearingMaterial
    ...
    @property
    def protection(self: Self) -> "_2161.BearingProtection":
