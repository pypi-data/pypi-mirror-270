...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1913, _1886, _1902
...
class RollingBearingDatabase(
    _1846.SQLDatabase["_1911.RollingBearingKey", "_2183.RollingBearing"]
):
    """RollingBearingDatabase
    ...
    def add_to_database(self: Self, bearing: "_2183.RollingBearing"):
    ...
    @enforce_parameter_types
    def create_bearing(
        self: Self, type_: "_1913.RollingBearingType", designation: "str" = "None"
    ...
    @enforce_parameter_types
    def remove_from_database(self: Self, bearing: "_2183.RollingBearing"):
        """Method does not return.
    ...
    def search_for_rolling_bearing_with_catalog(
        self: Self, catalog: "_1886.BearingCatalog"
    ) -> "List[_2183.RollingBearing]":
    ...
    def search_for_rolling_bearing_with_name_and_catalog(
        self: Self, designation: "str", catalog: "_1886.BearingCatalog"
    ) -> "_2183.RollingBearing":
        """mastapy.bearings.bearing_designs.rolling.RollingBearing
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(
        self: Self,
        designation: "str",
        catalog: "_1886.BearingCatalog",
        type_: "_1913.RollingBearingType",
    ) -> "List[_2183.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
    ...
    def search_for_rolling_bearing(
        ...
        catalog: "_1886.BearingCatalog",
        type_: "_1913.RollingBearingType",
        bore_range: "_1501.Range",
        outer_diameter_range: "_1501.Range",
        width_range: "_1501.Range",
        dynamic_capacity_range: "_1501.Range",
        number_of_rows: "int",
        material_type: "_1902.HybridSteelAll",
    ) -> "List[_2183.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
