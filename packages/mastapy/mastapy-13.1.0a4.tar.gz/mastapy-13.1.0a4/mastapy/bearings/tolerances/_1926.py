...
class InterferenceTolerance(_1918.BearingConnectionComponent):
    """InterferenceTolerance
    ...
    @property
    def definition_option(self: Self) -> "_1921.BearingToleranceDefinitionOptions":
    ...
    def definition_option(self: Self, value: "_1921.BearingToleranceDefinitionOptions"):
    ...
    def mounting_point_surface_finish(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1905", "MountingPointSurfaceFinishes"
        )(value)

    @mounting_point_surface_finish.setter
    @enforce_parameter_types
    def mounting_point_surface_finish(
        self: Self, value: "_1905.MountingPointSurfaceFinishes"
    ):
        value = conversion.mp_to_pn_enum(
