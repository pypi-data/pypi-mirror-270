...
if TYPE_CHECKING:
    from mastapy.bearings.tolerances import _1935, _1923, _1929, _1918
...
class RingTolerance(_1926.InterferenceTolerance):
    """RingTolerance
    ...
    @property
    def roundness_specification(self: Self) -> "_1935.RoundnessSpecification":
