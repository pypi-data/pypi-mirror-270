...
if TYPE_CHECKING:
    from mastapy.utility import _1606, _1592
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self: Self) -> "_1606.NumberFormatInfoSummary":
    ...
    @property
    def dispatchers(self: Self) -> "List[_1592.DispatcherHelper]":
