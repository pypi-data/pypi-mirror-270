...
from mastapy.utility.property import _1854
...
class DutyCyclePropertySummaryStress(_1854.DutyCyclePropertySummary["_1727.Stress", T]):
    """DutyCyclePropertySummaryStress
    ...
    class _Cast_DutyCyclePropertySummaryStress:
        ...
        def duty_cycle_property_summary(
            ...
            return self._parent._cast(_1854.DutyCyclePropertySummary)
