...
if TYPE_CHECKING:
    ...
    from mastapy.utility.property import _1855, _1856, _1857, _1858, _1859
...
TMeasurement = TypeVar("TMeasurement", bound="_1618.MeasurementBase")
T = TypeVar("T")
...
class DutyCyclePropertySummary(_0.APIBase, Generic[TMeasurement, T]):
    ...
    class _Cast_DutyCyclePropertySummary:
        ...
        def duty_cycle_property_summary_force(
            ...
            from mastapy.utility.property import _1855

            return self._parent._cast(_1855.DutyCyclePropertySummaryForce)
        ...
        def duty_cycle_property_summary_percentage(
            ...
            return self._parent._cast(_1856.DutyCyclePropertySummaryPercentage)
        ...
        def duty_cycle_property_summary_small_angle(
            ...
            return self._parent._cast(_1857.DutyCyclePropertySummarySmallAngle)
        ...
        def duty_cycle_property_summary_stress(
            ...
            return self._parent._cast(_1858.DutyCyclePropertySummaryStress)
        ...
        def duty_cycle_property_summary_very_short_length(
            ...
            return self._parent._cast(_1859.DutyCyclePropertySummaryVeryShortLength)
