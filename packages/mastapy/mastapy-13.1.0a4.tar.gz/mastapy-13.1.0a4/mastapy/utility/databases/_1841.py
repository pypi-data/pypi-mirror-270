...
if TYPE_CHECKING:
    from mastapy.utility.scripting import _1753
...
class DatabaseKey(_0.APIBase):
    ...
    class _Cast_DatabaseKey:
        ...
        def user_defined_property_key(
            ...
            return self._parent._cast(_1753.UserDefinedPropertyKey)
        ...
        def custom_report_key(
            ...
            return self._parent._cast(_1781.CustomReportKey)

        @property
        def named_key(self: "DatabaseKey._Cast_DatabaseKey") -> "_1845.NamedKey":
            from mastapy.utility.databases import _1845

            return self._parent._cast(_1845.NamedKey)
        ...
        def rolling_bearing_key(
            ...
            return self._parent._cast(_1911.RollingBearingKey)
