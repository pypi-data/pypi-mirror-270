...
from mastapy.utility.databases import _1841
...
class NamedKey(_1841.DatabaseKey):
    """NamedKey
    ...
    class _Cast_NamedKey:
        ...
        @property
        def database_key(self: "NamedKey._Cast_NamedKey") -> "_1841.DatabaseKey":
            return self._parent._cast(_1841.DatabaseKey)
