...
class Stress(_1618.MeasurementBase):
    """Stress
    ...
    class _Cast_Stress:
        ...
        @property
        def measurement_base(self: "Stress._Cast_Stress") -> "_1618.MeasurementBase":
            return self._parent._cast(_1618.MeasurementBase)

        @property
        def pressure(self: "Stress._Cast_Stress") -> "_1712.Pressure":
            from mastapy.utility.units_and_measurements.measurements import _1712
