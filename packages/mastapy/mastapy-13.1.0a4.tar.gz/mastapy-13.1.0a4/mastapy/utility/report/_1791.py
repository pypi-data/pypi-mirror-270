...
if TYPE_CHECKING:
    from mastapy.utility.report import _1757, _1800
...
class CustomRow(_1786.CustomReportPropertyItem):
    """CustomRow
    ...
    class _Cast_CustomRow:
        ...
        @property
        def blank_row(self: "CustomRow._Cast_CustomRow") -> "_1757.BlankRow":
            from mastapy.utility.report import _1757

            return self._parent._cast(_1757.BlankRow)

        @property
        def user_text_row(self: "CustomRow._Cast_CustomRow") -> "_1800.UserTextRow":
