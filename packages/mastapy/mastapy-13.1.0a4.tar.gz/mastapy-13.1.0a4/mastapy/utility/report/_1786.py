...
if TYPE_CHECKING:
    from mastapy.utility.report import _1796, _1797, _1757, _1770, _1791, _1800
    from mastapy.utility.reporting_property_framework import _1801
...
class CustomReportPropertyItem(_0.APIBase):
    ...
    class _Cast_CustomReportPropertyItem:
        ...
        def blank_row(
            ...
            return self._parent._cast(_1757.BlankRow)
        ...
        def custom_report_chart_item(
            ...
            return self._parent._cast(_1770.CustomReportChartItem)
        ...
        def custom_row(
            ...
            return self._parent._cast(_1791.CustomRow)
        ...
        def user_text_row(
            ...
            return self._parent._cast(_1800.UserTextRow)
    ...
    @property
    def font_style(self: Self) -> "_1796.FontStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1796", "FontStyle"
        )(value)

    @font_style.setter
    @enforce_parameter_types
    def font_style(self: Self, value: "_1796.FontStyle"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.Utility.Report.FontStyle")
        self.wrapped.FontStyle = value

    @property
    def font_weight(self: Self) -> "_1797.FontWeight":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1797", "FontWeight"
        )(value)

    @font_weight.setter
    @enforce_parameter_types
    def font_weight(self: Self, value: "_1797.FontWeight"):
    ...
    @property
    def horizontal_position(self: Self) -> "_1801.CellValuePosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.reporting_property_framework._1801", "CellValuePosition"
        )(value)

    @horizontal_position.setter
    @enforce_parameter_types
    def horizontal_position(self: Self, value: "_1801.CellValuePosition"):
        value = conversion.mp_to_pn_enum(
