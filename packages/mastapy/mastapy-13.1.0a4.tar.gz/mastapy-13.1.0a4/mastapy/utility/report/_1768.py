...
if TYPE_CHECKING:
    from mastapy.utility.cad_export import _1848
...
class CustomReportCadDrawing(_1784.CustomReportNameableItem):
    """CustomReportCadDrawing
    ...
    @property
    def stock_drawing(self: Self) -> "_1848.StockDrawings":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.cad_export._1848", "StockDrawings"
        )(value)

    @stock_drawing.setter
    @enforce_parameter_types
    def stock_drawing(self: Self, value: "_1848.StockDrawings"):
