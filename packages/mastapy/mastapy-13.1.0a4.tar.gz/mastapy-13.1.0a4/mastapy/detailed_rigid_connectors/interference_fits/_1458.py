...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.interference_fits import _1459
    from mastapy.bearings.tolerances import _1939
    from mastapy.detailed_rigid_connectors.keyed_joints import _1451
...
class InterferenceFitHalfDesign(_1400.DetailedRigidConnectorHalfDesign):
    """InterferenceFitHalfDesign
    ...
    class _Cast_InterferenceFitHalfDesign:
        ...
        def keyway_joint_half_design(
            ...
            return self._parent._cast(_1451.KeywayJointHalfDesign)
    ...
    @property
    def stress_region(self: Self) -> "_1459.StressRegions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.interference_fits._1459", "StressRegions"
        )(value)
    ...
    @property
    def tolerance(self: Self) -> "_1939.SupportTolerance":
