...
from mastapy.detailed_rigid_connectors.interference_fits import _1460
...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.interference_fits import _1455, _1456
...
class InterferenceFitDesign(_1399.DetailedRigidConnectorDesign):
    """InterferenceFitDesign
    ...
    @property
    def assembly_method(self: Self) -> "_1455.AssemblyMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.interference_fits._1455",
            "AssemblyMethods",
        )(value)

    @assembly_method.setter
    @enforce_parameter_types
    def assembly_method(self: Self, value: "_1455.AssemblyMethods"):
    ...
    @property
    def calculation_method(self: Self) -> "_1456.CalculationMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.interference_fits._1456",
            "CalculationMethods",
        )(value)

    @calculation_method.setter
    @enforce_parameter_types
    def calculation_method(self: Self, value: "_1456.CalculationMethods"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.DetailedRigidConnectors.InterferenceFits.CalculationMethods",
        )
    ...
    @enforce_parameter_types
    def joint_interface_type(self: Self, value: "_1460.Table4JointInterfaceTypes"):
