...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.keyed_joints import _1450, _1452
...
class KeyedJointDesign(_1457.InterferenceFitDesign):
    """KeyedJointDesign
    ...
    @property
    def geometry_type(self: Self) -> "_1450.KeyTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.keyed_joints._1450", "KeyTypes"
        )(value)

    @geometry_type.setter
    @enforce_parameter_types
    def geometry_type(self: Self, value: "_1450.KeyTypes"):
    ...
    @property
    def number_of_keys(self: Self) -> "_1452.NumberOfKeys":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.keyed_joints._1452", "NumberOfKeys"
        )(value)

    @number_of_keys.setter
    @enforce_parameter_types
    def number_of_keys(self: Self, value: "_1452.NumberOfKeys"):
        value = conversion.mp_to_pn_enum(
