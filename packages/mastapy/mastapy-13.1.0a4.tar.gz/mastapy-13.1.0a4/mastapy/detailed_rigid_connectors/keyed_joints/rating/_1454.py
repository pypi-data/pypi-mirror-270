...
if TYPE_CHECKING:
    ...
    from mastapy.detailed_rigid_connectors.keyed_joints.rating import _1453
...
class KeywayRating(_1461.InterferenceFitRating):
    """KeywayRating
    ...
    @property
    def keyed_joint_design(self: Self) -> "_1449.KeyedJointDesign":
    ...
    @property
    def keyway_half_ratings(self: Self) -> "List[_1453.KeywayHalfRating]":
