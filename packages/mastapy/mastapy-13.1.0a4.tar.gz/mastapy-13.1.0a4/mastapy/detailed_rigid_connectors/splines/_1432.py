...
from mastapy.detailed_rigid_connectors.splines import _1415, _1416, _1427
...
class StandardSplineJointDesign(_1427.SplineJointDesign):
    """StandardSplineJointDesign
    ...
    @enforce_parameter_types
    def module_preferred(self: Self, value: "_1415.Modules"):
    ...
    @enforce_parameter_types
    def pressure_angle_preferred(self: Self, value: "_1416.PressureAngleTypes"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
