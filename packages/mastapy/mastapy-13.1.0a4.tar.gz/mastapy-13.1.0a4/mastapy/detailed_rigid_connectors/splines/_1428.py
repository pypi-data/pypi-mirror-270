...
class SplineMaterial(_276.Material):
    """SplineMaterial
    ...
    class _Cast_SplineMaterial:
        ...
        @property
        def material(self: "SplineMaterial._Cast_SplineMaterial") -> "_276.Material":
    ...
    @property
    def heat_treatment_type(self: Self) -> "_1410.HeatTreatmentTypes":
    ...
    @enforce_parameter_types
    def heat_treatment_type(self: Self, value: "_1410.HeatTreatmentTypes"):
