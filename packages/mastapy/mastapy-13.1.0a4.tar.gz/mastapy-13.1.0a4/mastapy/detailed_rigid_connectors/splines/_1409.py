...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.splines import _1432, _1427
...
class GBT3478SplineJointDesign(_1412.ISO4156SplineJointDesign):
    """GBT3478SplineJointDesign
    ...
    def major_diameter_standard_tolerance_grade(
        self: Self, value: "_1927.ITDesignation"
    ):
