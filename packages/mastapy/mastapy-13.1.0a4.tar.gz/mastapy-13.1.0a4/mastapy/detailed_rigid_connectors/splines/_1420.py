...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.splines import _1407, _1427
...
class SAESplineJointDesign(_1432.StandardSplineJointDesign):
    """SAESplineJointDesign
    ...
    @property
    def fit_type(self: Self) -> "_1407.FitTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1407", "FitTypes"
        )(value)

    @fit_type.setter
    @enforce_parameter_types
    def fit_type(self: Self, value: "_1407.FitTypes"):
