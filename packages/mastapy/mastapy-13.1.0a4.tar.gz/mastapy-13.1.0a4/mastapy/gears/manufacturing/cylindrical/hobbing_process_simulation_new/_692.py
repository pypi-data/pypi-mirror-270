...
class ProcessSimulationInput(_0.APIBase):
    ...
    class _Cast_ProcessSimulationInput:
        ...
        def hobbing_process_simulation_input(
            ...
            return self._parent._cast(_679.HobbingProcessSimulationInput)
        ...
        def worm_grinding_process_simulation_input(
            ...
            return self._parent._cast(_706.WormGrindingProcessSimulationInput)
    ...
    @property
    def analysis_setting(self: Self) -> "_666.AnalysisMethod":
    ...
    def analysis_setting(self: Self, value: "_666.AnalysisMethod"):
    ...
    @enforce_parameter_types
    def centre_distance_offset_specification_method(
        self: Self, value: "_670.CentreDistanceOffsetMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Manufacturing.Cylindrical.HobbingProcessSimulationNew.CentreDistanceOffsetMethod",
    ...
    @property
    def cutter_head_slide_error(self: Self) -> "_671.CutterHeadSlideError":
    ...
    @property
    def cutter_mounting_error(self: Self) -> "_697.RackMountingError":
    ...
    @property
    def gear_mounting_error(self: Self) -> "_672.GearMountingError":
