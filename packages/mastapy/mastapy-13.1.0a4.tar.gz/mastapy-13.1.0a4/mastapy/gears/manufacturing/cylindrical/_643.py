...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.cylindrical import _639, _644
...
class ModificationSegment(_0.APIBase):
    ...
    class _Cast_ModificationSegment:
        ...
        def lead_modification_segment(
            ...
            return self._parent._cast(_639.LeadModificationSegment)

        @property
        def profile_modification_segment(
            self: "ModificationSegment._Cast_ModificationSegment",
        ) -> "_644.ProfileModificationSegment":
            from mastapy.gears.manufacturing.cylindrical import _644

            return self._parent._cast(_644.ProfileModificationSegment)
