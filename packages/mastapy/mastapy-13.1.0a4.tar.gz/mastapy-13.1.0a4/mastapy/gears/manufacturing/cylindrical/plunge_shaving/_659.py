...
class PlungeShaverSettings(_0.APIBase):
    ...
    @property
    def lead_display_method(self: Self) -> "_652.MicroGeometryDefinitionMethod":
    ...
    @enforce_parameter_types
    def lead_display_method(self: Self, value: "_652.MicroGeometryDefinitionMethod"):
    ...
    @property
    def profile_display_method(self: Self) -> "_652.MicroGeometryDefinitionMethod":
        """mastapy.gears.manufacturing.cylindrical.plunge_shaving.MicroGeometryDefinitionMethod"""
    ...
    @enforce_parameter_types
    def profile_display_method(self: Self, value: "_652.MicroGeometryDefinitionMethod"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Manufacturing.Cylindrical.PlungeShaving.MicroGeometryDefinitionMethod",
        )
