...
class CylindricalGearSpecifiedMicroGeometry(_0.APIBase):
    ...
    @property
    def lead_measurement_method(self: Self) -> "_652.MicroGeometryDefinitionMethod":
    ...
    @property
    def profile_measurement_method(self: Self) -> "_652.MicroGeometryDefinitionMethod":
        """mastapy.gears.manufacturing.cylindrical.plunge_shaving.MicroGeometryDefinitionMethod"""
    ...
    @property
    def lead_micro_geometry(self: Self) -> "_641.MicroGeometryInputsLead":
    ...
    @property
    def profile_micro_geometry(self: Self) -> "List[_642.MicroGeometryInputsProfile]":
