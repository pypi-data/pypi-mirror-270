...
if TYPE_CHECKING:
    ...
    from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _736
...
class CutterSimulationCalc(_0.APIBase):
    ...
    class _Cast_CutterSimulationCalc:
        ...
        def form_wheel_grinding_simulation_calculator(
            ...
            return self._parent._cast(_745.FormWheelGrindingSimulationCalculator)
        ...
        def hob_simulation_calculator(
            ...
            return self._parent._cast(_747.HobSimulationCalculator)
        ...
        def rack_simulation_calculator(
            ...
            return self._parent._cast(_750.RackSimulationCalculator)

        @property
        def shaper_simulation_calculator(
            self: "CutterSimulationCalc._Cast_CutterSimulationCalc",
        ) -> "_752.ShaperSimulationCalculator":
            from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _752

            return self._parent._cast(_752.ShaperSimulationCalculator)

        @property
        def shaving_simulation_calculator(
            self: "CutterSimulationCalc._Cast_CutterSimulationCalc",
        ) -> "_753.ShavingSimulationCalculator":
            from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _753

            return self._parent._cast(_753.ShavingSimulationCalculator)
        ...
        def virtual_simulation_calculator(
            ...
            return self._parent._cast(_754.VirtualSimulationCalculator)
        ...
        def worm_grinder_simulation_calculator(
            ...
            return self._parent._cast(_755.WormGrinderSimulationCalculator)
    ...
    @property
    def gear(self: Self) -> "_739.CylindricalCutterSimulatableGear":
    ...
    @property
    def stock_removed_at_designed_sap(self: Self) -> "_744.FinishStockPoint":
    ...
    @property
    def stock_removed_at_reference_diameter(self: Self) -> "_744.FinishStockPoint":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint
    ...
    @property
    def stock_removed_at_rough_tip_form(self: Self) -> "_744.FinishStockPoint":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint
    ...
    @property
    def finish_stock_indexed_arcs(self: Self) -> "List[_744.FinishStockPoint]":
    ...
    @property
    def gear_fillet_points(self: Self) -> "List[_736.NamedPoint]":
    ...
    @property
    def main_profile_finish_stock(self: Self) -> "List[_744.FinishStockPoint]":
        """List[mastapy.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint]
