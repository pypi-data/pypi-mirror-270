...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    class _Cast_ProcessSimulationNew:
        ...
        def hobbing_process_simulation_new(
            ...
            return self._parent._cast(_680.HobbingProcessSimulationNew)
        ...
        def worm_grinding_process_simulation_new(
            ...
            return self._parent._cast(_707.WormGrindingProcessSimulationNew)
    ...
    @property
    def gear_tooth_shape_calculation(self: Self) -> "_688.ProcessGearShape":
    ...
    @property
    def lead_calculation(self: Self) -> "_689.ProcessLeadCalculation":
    ...
    @property
    def pitch_calculation(self: Self) -> "_690.ProcessPitchCalculation":
    ...
    @property
    def profile_calculation(self: Self) -> "_691.ProcessProfileCalculation":
