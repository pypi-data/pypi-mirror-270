...
T = TypeVar("T", bound="_772.ShavingDynamics")
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    class _Cast_ShavingDynamicsCalculation:
        ...
        def shaving_dynamics_calculation_for_designed_gears(
            ...
            return self._parent._cast(_774.ShavingDynamicsCalculationForDesignedGears)
        ...
        def shaving_dynamics_calculation_for_hobbed_gears(
            ...
            return self._parent._cast(_775.ShavingDynamicsCalculationForHobbedGears)
    ...
    @property
    def accuracy_level_iso6(self: Self) -> "_769.RollAngleRangeRelativeToAccuracy":
    ...
    @property
    def accuracy_level_iso7(self: Self) -> "_769.RollAngleRangeRelativeToAccuracy":
        """mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics.RollAngleRangeRelativeToAccuracy
    ...
    @property
    def designed_gear(self: Self) -> "_739.CylindricalCutterSimulatableGear":
    ...
    @property
    def life_shaver(self: Self) -> "_722.CylindricalGearShaver":
    ...
    @property
    def shaver(self: Self) -> "_722.CylindricalGearShaver":
        """mastapy.gears.manufacturing.cylindrical.cutters.CylindricalGearShaver
    ...
    @property
    def redressing_settings(self: Self) -> "List[_768.RedressingSettings[T]]":
