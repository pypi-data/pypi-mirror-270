...
class ShavingDynamicsCalculationForDesignedGears(_773.ShavingDynamicsCalculation[T]):
    """ShavingDynamicsCalculationForDesignedGears
    ...
    class _Cast_ShavingDynamicsCalculationForDesignedGears:
        ...
        def shaving_dynamics_calculation(
            ...
            return self._parent._cast(_773.ShavingDynamicsCalculation)
    ...
    @property
    def end_of_shaving_profile(self: Self) -> "_1033.CylindricalGearProfileMeasurement":
    ...
    @property
    def redressing(self: Self) -> "_771.ShaverRedressing[T]":
