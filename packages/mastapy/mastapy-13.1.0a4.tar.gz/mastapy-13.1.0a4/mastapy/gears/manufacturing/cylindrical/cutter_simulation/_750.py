...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _747, _755
...
class RackSimulationCalculator(_738.CutterSimulationCalc):
    """RackSimulationCalculator
    ...
    class _Cast_RackSimulationCalculator:
        ...
        def cutter_simulation_calc(
            ...
            return self._parent._cast(_738.CutterSimulationCalc)
