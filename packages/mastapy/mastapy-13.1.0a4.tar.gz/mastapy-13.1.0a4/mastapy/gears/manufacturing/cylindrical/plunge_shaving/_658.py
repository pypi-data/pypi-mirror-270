...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _656, _661, _664
...
class PlungeShaverOutputs(_0.APIBase):
    ...
    class _Cast_PlungeShaverOutputs:
        ...
        def real_plunge_shaver_outputs(
            ...
            from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _661

            return self._parent._cast(_661.RealPlungeShaverOutputs)

        @property
        def virtual_plunge_shaver_outputs(
            self: "PlungeShaverOutputs._Cast_PlungeShaverOutputs",
        ) -> "_664.VirtualPlungeShaverOutputs":
            from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _664

            return self._parent._cast(_664.VirtualPlungeShaverOutputs)
    ...
    def chart(self: Self, value: "_650.ChartType"):
    ...
    @enforce_parameter_types
    def selected_flank(self: Self, value: "_634.Flank"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def calculation_details(self: Self) -> "_656.PlungeShaverGeneration":
