...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.cylindrical import _619, _629
...
class CylindricalSetManufacturingConfig(_1241.GearSetImplementationDetail):
    """CylindricalSetManufacturingConfig
    ...
    def cylindrical_mesh_manufacturing_configurations(
        self: Self,
    ) -> "List[_629.CylindricalMeshManufacturingConfig]":
