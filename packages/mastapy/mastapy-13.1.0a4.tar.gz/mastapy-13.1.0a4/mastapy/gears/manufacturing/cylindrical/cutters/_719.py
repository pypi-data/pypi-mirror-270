...
if TYPE_CHECKING:
    from mastapy.gears import _340, _358
    from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _737
    from mastapy.gears.manufacturing.cylindrical.cutters import _715, _716, _713
...
class CylindricalGearRackDesign(_720.CylindricalGearRealCutterDesign):
    """CylindricalGearRackDesign
    ...
    @property
    def worm_type(self: Self) -> "_358.WormType":
        ...
        return constructor.new_from_mastapy("mastapy.gears._358", "WormType")(value)

    @worm_type.setter
    @enforce_parameter_types
    def worm_type(self: Self, value: "_358.WormType"):
