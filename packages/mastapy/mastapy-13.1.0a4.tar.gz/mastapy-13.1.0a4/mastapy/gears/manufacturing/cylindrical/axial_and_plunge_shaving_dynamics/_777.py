...
class ShavingDynamicsViewModel(_778.ShavingDynamicsViewModelBase, Generic[T]):
    """ShavingDynamicsViewModel
    ...
    def active_profile_range_calculation_source(
        self: Self, value: "_756.ActiveProfileRangeCalculationSource"
    ):
    ...
    @property
    def redressing_chart(self: Self) -> "_1884.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def selected_measurement_method(self: Self, value: "_1089.ThicknessType"):
    ...
    @property
    def calculation(self: Self) -> "_773.ShavingDynamicsCalculation[T]":
