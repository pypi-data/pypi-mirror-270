...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.cylindrical.cutters import _727, _728
...
class MutableCommon(_710.CurveInLinkedList):
    """MutableCommon
    ...
    class _Cast_MutableCommon:
        ...
        def curve_in_linked_list(
            ...
            return self._parent._cast(_710.CurveInLinkedList)

        @property
        def mutable_curve(
            self: "MutableCommon._Cast_MutableCommon",
        ) -> "_727.MutableCurve":
            from mastapy.gears.manufacturing.cylindrical.cutters import _727

            return self._parent._cast(_727.MutableCurve)
        ...
        def mutable_fillet(
            ...
            return self._parent._cast(_728.MutableFillet)
    ...
    @section.setter
    @enforce_parameter_types
    def section(self: Self, value: "_616.CutterFlankSections"):
