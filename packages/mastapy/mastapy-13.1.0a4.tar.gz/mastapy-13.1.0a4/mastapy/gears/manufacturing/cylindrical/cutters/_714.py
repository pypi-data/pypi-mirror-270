...
class CylindricalGearFormGrindingWheel(_720.CylindricalGearRealCutterDesign):
    """CylindricalGearFormGrindingWheel
    ...
    @property
    def right_hand_cutting_edge_shape(self: Self) -> "_1547.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def right_hand_cutting_edge_shape(self: Self, value: "_1547.Vector2DListAccessor"):
