...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.cylindrical.process_simulation import _647, _648
...
class CutterProcessSimulation(_0.APIBase):
    ...
    class _Cast_CutterProcessSimulation:
        ...
        def form_wheel_grinding_process_simulation(
            ...
            return self._parent._cast(_647.FormWheelGrindingProcessSimulation)

        @property
        def shaping_process_simulation(
            self: "CutterProcessSimulation._Cast_CutterProcessSimulation",
        ) -> "_648.ShapingProcessSimulation":
            from mastapy.gears.manufacturing.cylindrical.process_simulation import _648

            return self._parent._cast(_648.ShapingProcessSimulation)
