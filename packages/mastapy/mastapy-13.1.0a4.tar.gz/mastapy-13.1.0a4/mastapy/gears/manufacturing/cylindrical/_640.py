...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.cylindrical import _643, _641, _642
...
T = TypeVar("T", bound="_643.ModificationSegment")
...
class MicroGeometryInputs(_0.APIBase, Generic[T]):
    ...
    class _Cast_MicroGeometryInputs:
        ...
        def micro_geometry_inputs_lead(
            ...
            from mastapy.gears.manufacturing.cylindrical import _641

            return self._parent._cast(_641.MicroGeometryInputsLead)
        ...
        def micro_geometry_inputs_profile(
            ...
            return self._parent._cast(_642.MicroGeometryInputsProfile)
