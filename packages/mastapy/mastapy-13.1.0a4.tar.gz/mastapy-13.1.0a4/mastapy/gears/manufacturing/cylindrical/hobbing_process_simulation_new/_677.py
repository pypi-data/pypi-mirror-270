...
class HobbingProcessPitchCalculation(_673.HobbingProcessCalculation):
    """HobbingProcessPitchCalculation
    ...
    @property
    def pitch_modification_chart(self: Self) -> "_1884.TwoDChartDefinition":
    ...
    @property
    def left_flank(self: Self) -> "_668.CalculatePitchDeviationAccuracy":
    ...
    @property
    def right_flank(self: Self) -> "_668.CalculatePitchDeviationAccuracy":
        """mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculatePitchDeviationAccuracy
