...
class HobbingProcessTotalModificationCalculation(_673.HobbingProcessCalculation):
    """HobbingProcessTotalModificationCalculation
    ...
    @property
    def total_errors_chart_left_flank(self: Self) -> "_1882.ThreeDChartDefinition":
    ...
    @property
    def total_errors_chart_right_flank(self: Self) -> "_1882.ThreeDChartDefinition":
        """mastapy.utility_gui.charts.ThreeDChartDefinition
