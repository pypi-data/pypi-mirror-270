...
from mastapy.gears.gear_designs.conical import _1167, _1168
...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.bevel import _783, _792
...
class ConicalSetManufacturingConfig(_800.ConicalSetMicroGeometryConfigBase):
    """ConicalSetManufacturingConfig
    ...
    def gear_manufacturing_configurations(
        self: Self,
    ) -> "List[_783.ConicalGearManufacturingConfig]":
    ...
    @property
    def meshes(self: Self) -> "List[_792.ConicalMeshManufacturingConfig]":
