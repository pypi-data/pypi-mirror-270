...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.bevel import _805, _819
...
class ManufacturingMachine(_1844.NamedDatabaseItem):
    """ManufacturingMachine
    ...
    @property
    def machine_type(self: Self) -> "_805.MachineTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.manufacturing.bevel._805", "MachineTypes"
        )(value)

    @machine_type.setter
    @enforce_parameter_types
    def machine_type(self: Self, value: "_805.MachineTypes"):
    ...
    @property
    def wheel_formate_machine_type(self: Self) -> "_819.WheelFormatMachineTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.manufacturing.bevel._819", "WheelFormatMachineTypes"
        )(value)

    @wheel_formate_machine_type.setter
    @enforce_parameter_types
    def wheel_formate_machine_type(self: Self, value: "_819.WheelFormatMachineTypes"):
        value = conversion.mp_to_pn_enum(
