...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.bevel.control_parameters import _824
    from mastapy.gears.manufacturing.bevel.basic_machine_settings import _831, _830
...
class ConicalMeshFlankManufacturingConfig(_789.ConicalMeshFlankMicroGeometryConfig):
    """ConicalMeshFlankManufacturingConfig
    ...
    class _Cast_ConicalMeshFlankManufacturingConfig:
        ...
        def conical_mesh_flank_micro_geometry_config(
            ...
            return self._parent._cast(_789.ConicalMeshFlankMicroGeometryConfig)
