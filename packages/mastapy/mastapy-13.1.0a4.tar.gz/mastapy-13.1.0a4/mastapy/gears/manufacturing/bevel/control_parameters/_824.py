...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.bevel.control_parameters import _825, _826, _827
...
class ConicalGearManufacturingControlParameters(_0.APIBase):
    ...
    class _Cast_ConicalGearManufacturingControlParameters:
        ...
        def conical_manufacturing_sgm_control_parameters(
            ...
            from mastapy.gears.manufacturing.bevel.control_parameters import _825

            return self._parent._cast(_825.ConicalManufacturingSGMControlParameters)

        @property
        def conical_manufacturing_sgt_control_parameters(
            self: "ConicalGearManufacturingControlParameters._Cast_ConicalGearManufacturingControlParameters",
        ) -> "_826.ConicalManufacturingSGTControlParameters":
            from mastapy.gears.manufacturing.bevel.control_parameters import _826

            return self._parent._cast(_826.ConicalManufacturingSGTControlParameters)

        @property
        def conical_manufacturing_smt_control_parameters(
            self: "ConicalGearManufacturingControlParameters._Cast_ConicalGearManufacturingControlParameters",
        ) -> "_827.ConicalManufacturingSMTControlParameters":
            from mastapy.gears.manufacturing.bevel.control_parameters import _827

            return self._parent._cast(_827.ConicalManufacturingSMTControlParameters)
