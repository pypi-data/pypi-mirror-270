...
if TYPE_CHECKING:
    ...
    from mastapy.gears.manufacturing.bevel import _788, _790
...
class ConicalMeshFlankMicroGeometryConfig(_0.APIBase):
    ...
    class _Cast_ConicalMeshFlankMicroGeometryConfig:
        ...
        def conical_mesh_flank_manufacturing_config(
            ...
            return self._parent._cast(_788.ConicalMeshFlankManufacturingConfig)
        ...
        def conical_mesh_flank_nurbs_micro_geometry_config(
            ...
            return self._parent._cast(_790.ConicalMeshFlankNURBSMicroGeometryConfig)
    ...
    @property
    def specified_ease_off_surface(self: Self) -> "_1183.ConicalGearFlankMicroGeometry":
