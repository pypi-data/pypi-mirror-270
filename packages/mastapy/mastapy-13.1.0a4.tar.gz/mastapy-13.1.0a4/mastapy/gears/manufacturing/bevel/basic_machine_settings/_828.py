...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.bevel.basic_machine_settings import _829, _830
...
class BasicConicalGearMachineSettings(_0.APIBase):
    ...
    class _Cast_BasicConicalGearMachineSettings:
        ...
        def basic_conical_gear_machine_settings_formate(
            ...
            from mastapy.gears.manufacturing.bevel.basic_machine_settings import _829

            return self._parent._cast(_829.BasicConicalGearMachineSettingsFormate)

        @property
        def basic_conical_gear_machine_settings_generated(
            self: "BasicConicalGearMachineSettings._Cast_BasicConicalGearMachineSettings",
        ) -> "_830.BasicConicalGearMachineSettingsGenerated":
            from mastapy.gears.manufacturing.bevel.basic_machine_settings import _830

            return self._parent._cast(_830.BasicConicalGearMachineSettingsGenerated)
