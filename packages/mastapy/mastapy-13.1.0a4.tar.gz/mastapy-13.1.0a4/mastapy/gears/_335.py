...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1092, _1022
    from mastapy.gears.rating.cylindrical import _485, _461
...
class GearSetDesignGroup(_0.APIBase):
    ...
    def default_rough_toleranced_metal_measurement(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1092",
    ...
    @enforce_parameter_types
    def default_rough_toleranced_metal_measurement(
        self: Self, value: "_1092.TolerancedMetalMeasurements"
    ):
    ...
    @enforce_parameter_types
    def micro_geometry_model_in_system_deflection(
        self: Self, value: "_344.MicroGeometryModel"
    ):
    ...
    @enforce_parameter_types
    def misalignment_contact_pattern_enhancement(
        self: Self, value: "_485.MisalignmentContactPatternEnhancements"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Cylindrical.MisalignmentContactPatternEnhancements",
    ...
    @property
    def settings(self: Self) -> "_461.CylindricalGearDesignAndRatingSettingsItem":
