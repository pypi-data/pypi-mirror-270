...
if TYPE_CHECKING:
    from mastapy.gears.ltca import _832, _835
...
class GearFilletNodeStressResults(_0.APIBase):
    ...
    class _Cast_GearFilletNodeStressResults:
        ...
        def conical_gear_fillet_stress_results(
            ...
            return self._parent._cast(_832.ConicalGearFilletStressResults)
        ...
        def cylindrical_gear_fillet_node_stress_results(
            ...
            return self._parent._cast(_835.CylindricalGearFilletNodeStressResults)
