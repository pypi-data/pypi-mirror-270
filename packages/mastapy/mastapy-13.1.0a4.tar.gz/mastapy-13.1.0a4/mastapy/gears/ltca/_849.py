...
if TYPE_CHECKING:
    from mastapy.gears.ltca import _856, _850
    from mastapy.gears.ltca.cylindrical import _868
    from mastapy.gears.ltca.conical import _878
...
class GearMeshLoadDistributionAtRotation(_0.APIBase):
    ...
    class _Cast_GearMeshLoadDistributionAtRotation:
        ...
        def cylindrical_mesh_load_distribution_at_rotation(
            ...
            return self._parent._cast(_868.CylindricalMeshLoadDistributionAtRotation)
        ...
        def conical_mesh_load_distribution_at_rotation(
            ...
            return self._parent._cast(_878.ConicalMeshLoadDistributionAtRotation)
    ...
    @property
    def loaded_contact_lines(self: Self) -> "List[_850.GearMeshLoadedContactLine]":
    ...
    def meshed_gears(
        self: Self,
    ) -> "List[_856.MeshedGearLoadDistributionAnalysisAtRotation]":
