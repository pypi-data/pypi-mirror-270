...
if TYPE_CHECKING:
    from mastapy.gears.ltca import _845, _846, _833, _838
...
class GearRootFilletStressResults(_0.APIBase):
    ...
    class _Cast_GearRootFilletStressResults:
        ...
        def conical_gear_root_fillet_stress_results(
            ...
            return self._parent._cast(_833.ConicalGearRootFilletStressResults)
        ...
        def cylindrical_gear_root_fillet_stress_results(
            ...
            return self._parent._cast(_838.CylindricalGearRootFilletStressResults)
    ...
    @property
    def columns(self: Self) -> "List[_845.GearFilletNodeStressResultsColumn]":
    ...
    @property
    def rows(self: Self) -> "List[_846.GearFilletNodeStressResultsRow]":
