...
if TYPE_CHECKING:
    ...
    from mastapy.gears.cylindrical import _1221, _1220, _1219, _1218
...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self: Self) -> "List[_1219.CylindricalGearLTCAContactCharts]":
    ...
    def contact_charts_as_text_files(
        self: Self,
    ) -> "List[_1218.CylindricalGearLTCAContactChartDataAsTextFile]":
    ...
    def contact_patch_as_text(
        self: Self,
        result_type: "_834.ContactResultType",
