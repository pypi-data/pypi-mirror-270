...
if TYPE_CHECKING:
    ...
    from mastapy.gears.ltca import _849, _847
...
class GearMeshLoadDistributionAnalysis(_1233.GearMeshImplementationAnalysis):
    """GearMeshLoadDistributionAnalysis
    ...
    @property
    def moment_about_centre_fourier_series(self: Self) -> "_1525.FourierSeries":
    ...
    @property
    def transmission_error_fourier_series(self: Self) -> "_1525.FourierSeries":
        """mastapy.math_utility.FourierSeries
    ...
    def load_distribution_analyses_at_single_rotation(
        self: Self,
    ) -> "List[_849.GearMeshLoadDistributionAtRotation]":
    ...
    def maximum_root_stress_with_flanks(
        self: Self,
        gear: "_847.GearLoadDistributionAnalysis",
        flank: "_333.GearFlanks",
