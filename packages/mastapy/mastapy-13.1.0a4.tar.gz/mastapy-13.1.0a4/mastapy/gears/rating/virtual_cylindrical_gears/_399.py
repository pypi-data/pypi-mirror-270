...
T = TypeVar("T", bound="_396.VirtualCylindricalGearBasic")
...
class VirtualCylindricalGearSet(_0.APIBase, Generic[T]):
    ...
    class _Cast_VirtualCylindricalGearSet:
        ...
        def klingelnberg_virtual_cylindrical_gear_set(
            ...
            return self._parent._cast(_394.KlingelnbergVirtualCylindricalGearSet)

        @property
        def virtual_cylindrical_gear_set_iso10300_method_b1(
            self: "VirtualCylindricalGearSet._Cast_VirtualCylindricalGearSet",
        ) -> "_400.VirtualCylindricalGearSetISO10300MethodB1":
            from mastapy.gears.rating.virtual_cylindrical_gears import _400

            return self._parent._cast(_400.VirtualCylindricalGearSetISO10300MethodB1)
        ...
        def virtual_cylindrical_gear_set_iso10300_method_b2(
            ...
            return self._parent._cast(_401.VirtualCylindricalGearSetISO10300MethodB2)
