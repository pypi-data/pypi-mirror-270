...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.klingelnberg_hypoid import _416, _415
...
class KlingelnbergCycloPalloidHypoidGearSetRating(
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_ratings(
        self: Self,
    ) -> "List[_416.KlingelnbergCycloPalloidHypoidGearRating]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_mesh_ratings(
        self: Self,
    ) -> "List[_415.KlingelnbergCycloPalloidHypoidGearMeshRating]":
