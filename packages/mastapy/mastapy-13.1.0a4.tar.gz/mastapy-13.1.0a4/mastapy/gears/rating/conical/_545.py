...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.conical import _548, _547
...
class ConicalGearDutyCycleRating(_365.GearDutyCycleRating):
    """ConicalGearDutyCycleRating
    ...
    @property
    def gear_set_design_duty_cycle(self: Self) -> "_548.ConicalGearSetDutyCycleRating":
    ...
    @property
    def gear_ratings(self: Self) -> "List[_547.ConicalGearRating]":
    ...
    @property
    def conical_gear_ratings(self: Self) -> "List[_547.ConicalGearRating]":
        """List[mastapy.gears.rating.conical.ConicalGearRating]
