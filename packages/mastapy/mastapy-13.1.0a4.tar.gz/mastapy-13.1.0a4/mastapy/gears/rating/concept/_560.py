...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.concept import _558, _557
...
class ConceptGearSetRating(_370.GearSetRating):
    """ConceptGearSetRating
    ...
    @property
    def concept_gear_set(self: Self) -> "_1188.ConceptGearSetDesign":
    ...
    @property
    def gear_ratings(self: Self) -> "List[_558.ConceptGearRating]":
    ...
    @property
    def concept_gear_ratings(self: Self) -> "List[_558.ConceptGearRating]":
        """List[mastapy.gears.rating.concept.ConceptGearRating]
    ...
    @property
    def gear_mesh_ratings(self: Self) -> "List[_557.ConceptGearMeshRating]":
    ...
    @property
    def concept_mesh_ratings(self: Self) -> "List[_557.ConceptGearMeshRating]":
        """List[mastapy.gears.rating.concept.ConceptGearMeshRating]
