...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.face import _455, _454
...
class FaceGearSetRating(_370.GearSetRating):
    """FaceGearSetRating
    ...
    @property
    def face_gear_set(self: Self) -> "_1003.FaceGearSetDesign":
    ...
    @property
    def gear_ratings(self: Self) -> "List[_455.FaceGearRating]":
    ...
    @property
    def gear_mesh_ratings(self: Self) -> "List[_454.FaceGearMeshRating]":
    ...
    @property
    def face_mesh_ratings(self: Self) -> "List[_454.FaceGearMeshRating]":
        """List[mastapy.gears.rating.face.FaceGearMeshRating]
