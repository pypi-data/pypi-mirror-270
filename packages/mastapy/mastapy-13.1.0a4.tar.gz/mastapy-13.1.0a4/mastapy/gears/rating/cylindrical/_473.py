...
class CylindricalMeshDutyCycleRating(_372.MeshDutyCycleRating):
    """CylindricalMeshDutyCycleRating
    ...
    @property
    def highest_torque_load_case(self: Self) -> "_465.CylindricalGearMeshRating":
    ...
    def loaded_cylindrical_mesh_ratings(
        self: Self,
    ) -> "List[_465.CylindricalGearMeshRating]":
        """List[mastapy.gears.rating.cylindrical.CylindricalGearMeshRating]
