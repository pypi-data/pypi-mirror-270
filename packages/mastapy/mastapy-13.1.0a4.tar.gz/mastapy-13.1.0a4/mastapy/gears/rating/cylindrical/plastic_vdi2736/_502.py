...
if TYPE_CHECKING:
    from mastapy.materials import _295
...
class PlasticSNCurveForTheSpecifiedOperatingConditions(_611.PlasticSNCurve):
    """PlasticSNCurveForTheSpecifiedOperatingConditions
    ...
    class _Cast_PlasticSNCurveForTheSpecifiedOperatingConditions:
        ...
        def plastic_sn_curve(
            ...
            return self._parent._cast(_611.PlasticSNCurve)
