...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.cylindrical import _487, _473
...
class CylindricalGearSetDutyCycleRating(_369.GearSetDutyCycleRating):
    """CylindricalGearSetDutyCycleRating
    ...
    def gear_mesh_duty_cycle_ratings(
        self: Self,
    ) -> "List[_473.CylindricalMeshDutyCycleRating]":
