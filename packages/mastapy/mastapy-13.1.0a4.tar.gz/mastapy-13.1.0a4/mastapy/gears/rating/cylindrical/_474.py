...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1081, _1080
    from mastapy.gears import _328
    from mastapy.materials import _274
    from mastapy.gears.rating.cylindrical import _461, _469, _472
...
class CylindricalMeshSingleFlankRating(_373.MeshSingleFlankRating):
    """CylindricalMeshSingleFlankRating
    ...
    @property
    def contact_ratio_source(self: Self) -> "_328.ContactRatioDataSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._328", "ContactRatioDataSource"
        )(value)
    ...
    @property
    def sorted_scuffing_results(self: Self) -> "_469.CylindricalGearScuffingResults":
    ...
    def gear_single_flank_ratings(
        self: Self,
    ) -> "List[_472.CylindricalGearSingleFlankRating]":
