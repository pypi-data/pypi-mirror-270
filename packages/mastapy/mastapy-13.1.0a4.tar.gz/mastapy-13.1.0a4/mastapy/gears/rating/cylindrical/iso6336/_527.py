...
if TYPE_CHECKING:
    from mastapy.gears.rating.cylindrical import _483, _488, _489, _466, _474
    from mastapy.gears.gear_designs.cylindrical import _1083
    from mastapy.gears.rating.cylindrical.iso6336 import _521, _526, _519, _523
...
class ISO6336AbstractMetalMeshSingleFlankRating(
    ...
    def scuffing_rating_method_integral_temperature_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._489",
    ...
    def isodin_cylindrical_gear_single_flank_ratings(
        self: Self,
    ) -> "List[_526.ISO6336AbstractMetalGearSingleFlankRating]":
