...
class CylindricalGearSingleFlankRating(_371.GearSingleFlankRating):
    """CylindricalGearSingleFlankRating
    ...
    @property
    def is_gear_driving_or_driven(self: Self) -> "_364.FlankLoadingState":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating._364", "FlankLoadingState"
        )(value)
    ...
    @property
    def metal_plastic(self: Self) -> "_282.MetalPlasticType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._282", "MetalPlasticType"
        )(value)
