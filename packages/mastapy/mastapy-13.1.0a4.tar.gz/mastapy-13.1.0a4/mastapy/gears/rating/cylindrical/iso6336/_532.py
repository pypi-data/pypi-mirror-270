...
if TYPE_CHECKING:
    from mastapy.gears.rating.cylindrical.iso6336 import _535, _531, _533
...
class ToothFlankFractureAnalysisContactPointCommon(_0.APIBase):
    ...
    class _Cast_ToothFlankFractureAnalysisContactPointCommon:
        ...
        def tooth_flank_fracture_analysis_contact_point(
            ...
            return self._parent._cast(_531.ToothFlankFractureAnalysisContactPoint)
    ...
    @property
    def watch_points(self: Self) -> "List[_535.ToothFlankFractureAnalysisPoint]":
