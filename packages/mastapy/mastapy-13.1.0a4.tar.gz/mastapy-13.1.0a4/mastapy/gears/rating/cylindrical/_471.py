...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.cylindrical import _461, _467, _465
...
class CylindricalGearSetRating(_370.GearSetRating):
    """CylindricalGearSetRating
    ...
    @property
    def rating_method(self: Self) -> "_258.CylindricalGearRatingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._258", "CylindricalGearRatingMethods"
        )(value)
    ...
    @property
    def optimisations(self: Self) -> "_508.CylindricalGearSetRatingOptimisationHelper":
    ...
    @property
    def gear_ratings(self: Self) -> "List[_467.CylindricalGearRating]":
    ...
    @property
    def gear_mesh_ratings(self: Self) -> "List[_465.CylindricalGearMeshRating]":
    ...
    @property
    def cylindrical_mesh_ratings(self: Self) -> "List[_465.CylindricalGearMeshRating]":
        """List[mastapy.gears.rating.cylindrical.CylindricalGearMeshRating]
    ...
    def vdi_cylindrical_gear_single_flank_ratings(
        self: Self,
    ) -> "List[_496.VDI2737InternalGearSingleFlankRating]":
