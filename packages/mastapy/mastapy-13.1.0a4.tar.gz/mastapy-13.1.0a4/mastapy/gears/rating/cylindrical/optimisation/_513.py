...
from mastapy.gears.rating.cylindrical.optimisation import _511
...
class SafetyFactorOptimisationStepResultNumber(_511.SafetyFactorOptimisationStepResult):
    """SafetyFactorOptimisationStepResultNumber
    ...
    class _Cast_SafetyFactorOptimisationStepResultNumber:
        ...
        def safety_factor_optimisation_step_result(
            ...
            return self._parent._cast(_511.SafetyFactorOptimisationStepResult)
