...
if TYPE_CHECKING:
    from mastapy.gears.rating.cylindrical import _470, _482, _467
...
class CylindricalGearDutyCycleRating(_365.GearDutyCycleRating):
    """CylindricalGearDutyCycleRating
    ...
    @property
    def cylindrical_gear_mesh_ratings(self: Self) -> "List[_482.MeshRatingForReports]":
