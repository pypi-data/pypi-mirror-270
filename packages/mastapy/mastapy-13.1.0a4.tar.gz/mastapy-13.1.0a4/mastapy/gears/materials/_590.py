...
if TYPE_CHECKING:
    from mastapy.materials import _249, _247, _248, _276
...
class AGMACylindricalGearMaterial(_598.CylindricalGearMaterial):
    """AGMACylindricalGearMaterial
    ...
    @property
    def grade(self: Self) -> "_249.AGMAMaterialGrade":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._249", "AGMAMaterialGrade"
        )(value)

    @grade.setter
    @enforce_parameter_types
    def grade(self: Self, value: "_249.AGMAMaterialGrade"):
    ...
    @property
    def material_application(self: Self) -> "_247.AGMAMaterialApplications":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._247", "AGMAMaterialApplications"
        )(value)

    @material_application.setter
    @enforce_parameter_types
    def material_application(self: Self, value: "_247.AGMAMaterialApplications"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def material_class(self: Self) -> "_248.AGMAMaterialClasses":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._248", "AGMAMaterialClasses"
        )(value)

    @material_class.setter
    @enforce_parameter_types
    def material_class(self: Self, value: "_248.AGMAMaterialClasses"):
        value = conversion.mp_to_pn_enum(
