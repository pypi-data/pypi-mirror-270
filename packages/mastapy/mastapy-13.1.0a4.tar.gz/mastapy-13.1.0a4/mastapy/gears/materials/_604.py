...
if TYPE_CHECKING:
    from mastapy.materials import _285, _276
...
class ISOCylindricalGearMaterial(_598.CylindricalGearMaterial):
    """ISOCylindricalGearMaterial
    ...
    @property
    def quality_grade(self: Self) -> "_285.QualityGrade":
        ...
        return constructor.new_from_mastapy("mastapy.materials._285", "QualityGrade")(
            value
        )

    @quality_grade.setter
    @enforce_parameter_types
    def quality_grade(self: Self, value: "_285.QualityGrade"):
