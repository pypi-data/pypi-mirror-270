...
if TYPE_CHECKING:
    from mastapy.gears import _358
    from mastapy.gears.gear_designs.worm import _965, _966
...
class WormGearSetDesign(_958.GearSetDesign):
    """WormGearSetDesign
    ...
    @property
    def gears(self: Self) -> "List[_965.WormGearDesign]":
    ...
    @property
    def worm_gears(self: Self) -> "List[_965.WormGearDesign]":
        """List[mastapy.gears.gear_designs.worm.WormGearDesign]
    ...
    @property
    def worm_meshes(self: Self) -> "List[_966.WormGearMeshDesign]":
