...
class FaceGearMicroGeometry(_1231.GearImplementationDetail):
    """FaceGearMicroGeometry
    ...
    @property
    def face_gear(self: Self) -> "_997.FaceGearDesign":
    ...
    @property
    def micro_geometry(self: Self) -> "_1111.CylindricalGearMicroGeometryBase":
