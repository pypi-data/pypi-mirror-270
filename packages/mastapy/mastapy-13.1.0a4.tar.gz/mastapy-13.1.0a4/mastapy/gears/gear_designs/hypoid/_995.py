...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.hypoid import _993, _994
...
class HypoidGearSetDesign(_1205.AGMAGleasonConicalGearSetDesign):
    """HypoidGearSetDesign
    ...
    @property
    def gears(self: Self) -> "List[_993.HypoidGearDesign]":
    ...
    @property
    def hypoid_gears(self: Self) -> "List[_993.HypoidGearDesign]":
        """List[mastapy.gears.gear_designs.hypoid.HypoidGearDesign]
    ...
    @property
    def meshes(self: Self) -> "List[_994.HypoidGearMeshDesign]":
    ...
    @property
    def hypoid_meshes(self: Self) -> "List[_994.HypoidGearMeshDesign]":
        """List[mastapy.gears.gear_designs.hypoid.HypoidGearMeshDesign]
