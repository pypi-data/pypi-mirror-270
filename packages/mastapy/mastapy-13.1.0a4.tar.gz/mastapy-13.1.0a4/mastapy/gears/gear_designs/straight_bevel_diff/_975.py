...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.straight_bevel_diff import _973, _974
...
class StraightBevelDiffGearSetDesign(_1192.BevelGearSetDesign):
    """StraightBevelDiffGearSetDesign
    ...
    @property
    def gears(self: Self) -> "List[_973.StraightBevelDiffGearDesign]":
    ...
    def straight_bevel_diff_gears(
        self: Self,
    ) -> "List[_973.StraightBevelDiffGearDesign]":
        """List[mastapy.gears.gear_designs.straight_bevel_diff.StraightBevelDiffGearDesign]
    ...
    def straight_bevel_diff_meshes(
        self: Self,
    ) -> "List[_974.StraightBevelDiffGearMeshDesign]":
