...
class ConicalGearFlankMicroGeometry(_577.FlankMicroGeometry):
    """ConicalGearFlankMicroGeometry
    ...
    @property
    def micro_geometry_input_type(self: Self) -> "_343.MicroGeometryInputTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._343", "MicroGeometryInputTypes"
        )(value)

    @micro_geometry_input_type.setter
    @enforce_parameter_types
    def micro_geometry_input_type(self: Self, value: "_343.MicroGeometryInputTypes"):
    ...
    @property
    def bias(self: Self) -> "_1182.ConicalGearBiasModification":
    ...
    @property
    def lead_relief(self: Self) -> "_1184.ConicalGearLeadModification":
    ...
    @property
    def profile_relief(self: Self) -> "_1185.ConicalGearProfileModification":
    ...
    @property
    def gear_design(self: Self) -> "_1164.ConicalGearDesign":
