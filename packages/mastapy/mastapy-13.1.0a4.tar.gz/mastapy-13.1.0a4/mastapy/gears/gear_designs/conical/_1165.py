...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.bevel import _1197, _1194, _1198, _1191
...
class ConicalGearMeshDesign(_957.GearMeshDesign):
    ...
    def driven_machine_characteristic(
        self: Self, value: "_1197.MachineCharacteristicAGMAKlingelnberg"
    ):
    ...
    def driven_machine_characteristic_gleason(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.bevel._1194",
    ...
    @enforce_parameter_types
    def driven_machine_characteristic_gleason(
        self: Self, value: "_1194.DrivenMachineCharacteristicGleason"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Bevel.DrivenMachineCharacteristicGleason",
    ...
    def prime_mover_characteristic_gleason(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.bevel._1198", "PrimeMoverCharacteristicGleason"
        )(value)

    @prime_mover_characteristic_gleason.setter
    @enforce_parameter_types
    def prime_mover_characteristic_gleason(
        self: Self, value: "_1198.PrimeMoverCharacteristicGleason"
    ):
        value = conversion.mp_to_pn_enum(
            value,
