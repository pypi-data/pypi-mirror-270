...
if TYPE_CHECKING:
    from mastapy.gears import _359
    from mastapy.gears.gear_designs.zerol_bevel import _960, _961
...
class ZerolBevelGearSetDesign(_1192.BevelGearSetDesign):
    """ZerolBevelGearSetDesign
    ...
    @property
    def tooth_taper_zerol(self: Self) -> "_359.ZerolBevelGleasonToothTaperOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._359", "ZerolBevelGleasonToothTaperOption"
        )(value)

    @tooth_taper_zerol.setter
    @enforce_parameter_types
    def tooth_taper_zerol(self: Self, value: "_359.ZerolBevelGleasonToothTaperOption"):
    ...
    @property
    def gears(self: Self) -> "List[_960.ZerolBevelGearDesign]":
    ...
    @property
    def zerol_bevel_meshes(self: Self) -> "List[_961.ZerolBevelGearMeshDesign]":
