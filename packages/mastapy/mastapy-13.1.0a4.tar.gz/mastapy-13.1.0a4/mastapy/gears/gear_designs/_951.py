...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.iso_10300 import _427, _442, _435
    from mastapy.gears.rating.hypoid import _448
...
class BevelHypoidGearRatingSettingsItem(_1844.NamedDatabaseItem):
    """BevelHypoidGearRatingSettingsItem
    ...
    @property
    def bevel_gear_rating_method(self: Self) -> "_612.RatingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.materials._612", "RatingMethods"
        )(value)

    @bevel_gear_rating_method.setter
    @enforce_parameter_types
    def bevel_gear_rating_method(self: Self, value: "_612.RatingMethods"):
    ...
    def bevel_general_load_factors_k_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating._427", "GeneralLoadFactorCalculationMethod"
        )(value)

    @bevel_general_load_factors_k_method.setter
    @enforce_parameter_types
    def bevel_general_load_factors_k_method(
        self: Self, value: "_427.GeneralLoadFactorCalculationMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Iso10300.GeneralLoadFactorCalculationMethod",
    ...
    def bevel_pitting_factor_calculation_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating._442", "PittingFactorCalculationMethod"
        )(value)

    @bevel_pitting_factor_calculation_method.setter
    @enforce_parameter_types
    def bevel_pitting_factor_calculation_method(
        self: Self, value: "_442.PittingFactorCalculationMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def hypoid_gear_rating_method(self: Self) -> "_448.HypoidRatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.hypoid._448", "HypoidRatingMethod"
        )(value)

    @hypoid_gear_rating_method.setter
    @enforce_parameter_types
    def hypoid_gear_rating_method(self: Self, value: "_448.HypoidRatingMethod"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def iso_rating_method_for_bevel_gears(self: Self) -> "_435.ISO10300RatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating._435", "ISO10300RatingMethod"
        )(value)

    @iso_rating_method_for_bevel_gears.setter
    @enforce_parameter_types
    def iso_rating_method_for_bevel_gears(
        self: Self, value: "_435.ISO10300RatingMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def iso_rating_method_for_hypoid_gears(self: Self) -> "_435.ISO10300RatingMethod":
        """mastapy.gears.rating.isoISO10300RatingMethod"""
