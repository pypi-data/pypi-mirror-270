...
from mastapy.gears.gear_designs.creation_options import _1157
...
class CylindricalGearPairCreationOptions(
    _1157.GearSetCreationOptions["_1036.CylindricalGearSetDesign"]
):
    """CylindricalGearPairCreationOptions
    ...
    class _Cast_CylindricalGearPairCreationOptions:
        ...
        def gear_set_creation_options(
            ...
            return self._parent._cast(_1157.GearSetCreationOptions)
