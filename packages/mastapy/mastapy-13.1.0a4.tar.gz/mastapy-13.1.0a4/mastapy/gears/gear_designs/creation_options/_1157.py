...
T = TypeVar("T", bound="_958.GearSetDesign")
...
class GearSetCreationOptions(_0.APIBase, Generic[T]):
    ...
    class _Cast_GearSetCreationOptions:
        ...
        def cylindrical_gear_pair_creation_options(
            ...
            from mastapy.gears.gear_designs.creation_options import _1156

            return self._parent._cast(_1156.CylindricalGearPairCreationOptions)

        @property
        def hypoid_gear_set_creation_options(
            self: "GearSetCreationOptions._Cast_GearSetCreationOptions",
        ) -> "_1158.HypoidGearSetCreationOptions":
            from mastapy.gears.gear_designs.creation_options import _1158

            return self._parent._cast(_1158.HypoidGearSetCreationOptions)

        @property
        def spiral_bevel_gear_set_creation_options(
            self: "GearSetCreationOptions._Cast_GearSetCreationOptions",
        ) -> "_1159.SpiralBevelGearSetCreationOptions":
            from mastapy.gears.gear_designs.creation_options import _1159

            return self._parent._cast(_1159.SpiralBevelGearSetCreationOptions)
