...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.concept import _1186, _1187
...
class ConceptGearSetDesign(_958.GearSetDesign):
    """ConceptGearSetDesign
    ...
    @property
    def gears(self: Self) -> "List[_1186.ConceptGearDesign]":
    ...
    @property
    def concept_gears(self: Self) -> "List[_1186.ConceptGearDesign]":
        """List[mastapy.gears.gear_designs.concept.ConceptGearDesign]
    ...
    @property
    def concept_meshes(self: Self) -> "List[_1187.ConceptGearMeshDesign]":
