...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.klingelnberg_spiral_bevel import _981, _982
...
class KlingelnbergCycloPalloidSpiralBevelGearSetDesign(
    ...
    @property
    def gears(self: Self) -> "List[_981.KlingelnbergCycloPalloidSpiralBevelGearDesign]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gears(
        self: Self,
    ) -> "List[_981.KlingelnbergCycloPalloidSpiralBevelGearDesign]":
        """List[mastapy.gears.gear_designs.klingelnberg_spiral_bevel.KlingelnbergCycloPalloidSpiralBevelGearDesign]
    ...
    def klingelnberg_conical_meshes(
        self: Self,
    ) -> "List[_982.KlingelnbergCycloPalloidSpiralBevelGearMeshDesign]":
