...
if TYPE_CHECKING:
    from mastapy.utility.property import _1853
...
class DesignConstraintsCollection(_1844.NamedDatabaseItem):
    """DesignConstraintsCollection
    ...
    def design_constraints(
        self: Self,
    ) -> "List[_1853.DeletableCollectionMember[_952.DesignConstraint]]":
