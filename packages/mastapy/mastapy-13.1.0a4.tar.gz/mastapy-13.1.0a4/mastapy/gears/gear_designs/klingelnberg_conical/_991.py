...
class KlingelnbergConicalGearSetDesign(_1166.ConicalGearSetDesign):
    """KlingelnbergConicalGearSetDesign
    ...
    @property
    def gear_finish(self: Self) -> "_1178.KlingelnbergFinishingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1178", "KlingelnbergFinishingMethods"
        )(value)

    @gear_finish.setter
    @enforce_parameter_types
    def gear_finish(self: Self, value: "_1178.KlingelnbergFinishingMethods"):
    ...
    @property
    def conical_meshes(self: Self) -> "List[_990.KlingelnbergConicalGearMeshDesign]":
    ...
    def klingelnberg_conical_meshes(
        self: Self,
    ) -> "List[_990.KlingelnbergConicalGearMeshDesign]":
        """List[mastapy.gears.gear_designs.klingelnberg_conical.KlingelnbergConicalGearMeshDesign]
