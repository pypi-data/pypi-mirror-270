...
from mastapy.gears.gear_designs.conical import _1179, _1165
...
if TYPE_CHECKING:
    from mastapy.gears.rating.iso_10300 import _428, _441, _443, _444
...
class AGMAGleasonConicalGearMeshDesign(_1165.ConicalGearMeshDesign):
    """AGMAGleasonConicalGearMeshDesign
    ...
    def iso10300_gear_set_finishing_methods(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating._428", "Iso10300FinishingMethods"
        )(value)

    @iso10300_gear_set_finishing_methods.setter
    @enforce_parameter_types
    def iso10300_gear_set_finishing_methods(
        self: Self, value: "_428.Iso10300FinishingMethods"
    ):
    ...
    @enforce_parameter_types
    def load_distribution_factor_method(
        self: Self, value: "_1179.LoadDistributionFactorMethods"
    ):
    ...
    def mounting_conditions_of_pinion_and_wheel(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating._441", "MountingConditionsOfPinionAndWheel"
        )(value)

    @mounting_conditions_of_pinion_and_wheel.setter
    @enforce_parameter_types
    def mounting_conditions_of_pinion_and_wheel(
        self: Self, value: "_441.MountingConditionsOfPinionAndWheel"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Iso10300.MountingConditionsOfPinionAndWheel",
    ...
    @property
    def profile_crowning_setting(self: Self) -> "_443.ProfileCrowningSetting":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating._443", "ProfileCrowningSetting"
        )(value)

    @profile_crowning_setting.setter
    @enforce_parameter_types
    def profile_crowning_setting(self: Self, value: "_443.ProfileCrowningSetting"):
        value = conversion.mp_to_pn_enum(
    ...
    def verification_of_contact_pattern(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating._444", "VerificationOfContactPattern"
        )(value)

    @verification_of_contact_pattern.setter
    @enforce_parameter_types
    def verification_of_contact_pattern(
        self: Self, value: "_444.VerificationOfContactPattern"
    ):
        value = conversion.mp_to_pn_enum(
