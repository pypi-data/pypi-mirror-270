...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1105, _1131
...
class CylindricalGearMicroGeometry(_1111.CylindricalGearMicroGeometryBase):
    """CylindricalGearMicroGeometry
    ...
    @property
    def left_flank(self: Self) -> "_1105.CylindricalGearFlankMicroGeometry":
    ...
    @property
    def right_flank(self: Self) -> "_1105.CylindricalGearFlankMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearFlankMicroGeometry
    ...
    @property
    def flanks(self: Self) -> "List[_1105.CylindricalGearFlankMicroGeometry]":
    ...
    @property
    def meshed_gears(self: Self) -> "List[_1131.MeshedCylindricalGearMicroGeometry]":
    ...
    @property
    def both_flanks(self: Self) -> "_1105.CylindricalGearFlankMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearFlankMicroGeometry
