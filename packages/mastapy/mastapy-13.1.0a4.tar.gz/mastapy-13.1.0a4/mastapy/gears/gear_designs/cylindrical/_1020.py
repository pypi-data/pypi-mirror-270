...
if TYPE_CHECKING:
    ...
    from mastapy.geometry.two_d import _319
...
class CylindricalGearDesign(_955.GearDesign):
    """CylindricalGearDesign
    ...
    def hand(self: Self) -> "_340.Hand":
        ...
        return constructor.new_from_mastapy("mastapy.gears._340", "Hand")(value)

    @hand.setter
    @enforce_parameter_types
    def hand(self: Self, value: "_340.Hand"):
    ...
    @property
    def internal_external(self: Self) -> "_319.InternalExternalType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.geometry.two_d._319", "InternalExternalType"
        )(value)

    @internal_external.setter
    @enforce_parameter_types
    def internal_external(self: Self, value: "_319.InternalExternalType"):
    ...
    @property
    def agma_accuracy_grade(self: Self) -> "_1144.AGMA20151AccuracyGrades":
    ...
    @property
    def case_hardening_properties(self: Self) -> "_1009.CaseHardeningProperties":
    ...
    @property
    def cylindrical_gear_set(self: Self) -> "_1036.CylindricalGearSetDesign":
    ...
    @property
    def finish_stock_specification(self: Self) -> "_1099.FinishStockSpecification":
    ...
    @property
    def iso6336_geometry(self: Self) -> "_1063.ISO6336GeometryBase":
    ...
    @property
    def iso_accuracy_grade(self: Self) -> "_1154.ISO1328AccuracyGrades":
    ...
    @property
    def left_flank(self: Self) -> "_1025.CylindricalGearFlankDesign":
    ...
    @property
    def material(self: Self) -> "_601.GearMaterial":
    ...
    @property
    def right_flank(self: Self) -> "_1025.CylindricalGearFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearFlankDesign
    ...
    @property
    def surface_roughness(self: Self) -> "_1088.SurfaceRoughness":
    ...
    @property
    def system_of_gear_fits(self: Self) -> "_1150.DIN3967SystemOfGearFits":
    ...
    @property
    def tff_analysis_settings(self: Self) -> "_1094.ToothFlankFractureAnalysisSettings":
    ...
    @property
    def tiff_analysis_settings(self: Self) -> "_1090.TiffAnalysisSettings":
    ...
    @property
    def flanks(self: Self) -> "List[_1025.CylindricalGearFlankDesign]":
    ...
    @property
    def both_flanks(self: Self) -> "_1025.CylindricalGearFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearFlankDesign
    ...
    def manufacturing_configurations(
        self: Self,
    ) -> "List[_619.CylindricalGearManufacturingConfig]":
    ...
    @property
    def micro_geometries(self: Self) -> "List[_1111.CylindricalGearMicroGeometryBase]":
