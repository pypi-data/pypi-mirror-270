...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1008, _1091, _1031, _1086
...
class CylindricalGearBasicRack(_1014.CylindricalGearAbstractRack):
    """CylindricalGearBasicRack
    ...
    class _Cast_CylindricalGearBasicRack:
        ...
        def cylindrical_gear_abstract_rack(
            ...
            return self._parent._cast(_1014.CylindricalGearAbstractRack)
    ...
    @property
    def basic_rack_profile(self: Self) -> "_1008.BasicRackProfiles":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1008", "BasicRackProfiles"
        )(value)

    @basic_rack_profile.setter
    @enforce_parameter_types
    def basic_rack_profile(self: Self, value: "_1008.BasicRackProfiles"):
    ...
    def proportional_method_for_tip_clearance(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1091",
    ...
    @enforce_parameter_types
    def proportional_method_for_tip_clearance(
        self: Self, value: "_1091.TipAlterationCoefficientMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.TipAlterationCoefficientMethod",
