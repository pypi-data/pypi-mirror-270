...
class Usage(_1599.IndependentReportablePropertiesBase["Usage"]):
    """Usage
    ...
    @property
    def safety_requirement(self: Self) -> "_352.SafetyRequirementsAGMA":
    ...
    @enforce_parameter_types
    def safety_requirement(self: Self, value: "_352.SafetyRequirementsAGMA"):
    ...
    @property
    def spur_gear_load_sharing_code(self: Self) -> "_1085.SpurGearLoadSharingCodes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1085", "SpurGearLoadSharingCodes"
        )(value)

    @spur_gear_load_sharing_code.setter
    @enforce_parameter_types
    def spur_gear_load_sharing_code(
        self: Self, value: "_1085.SpurGearLoadSharingCodes"
    ):
        value = conversion.mp_to_pn_enum(
