...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1033, _1020
...
class CylindricalGearFlankMicroGeometry(_577.FlankMicroGeometry):
    """CylindricalGearFlankMicroGeometry
    ...
    class _Cast_CylindricalGearFlankMicroGeometry:
        ...
        def flank_micro_geometry(
            ...
            return self._parent._cast(_577.FlankMicroGeometry)
    ...
    @property
    def micro_geometry_matrix(self: Self) -> "_1577.GriddedSurfaceAccessor":
    ...
    def micro_geometry_matrix(self: Self, value: "_1577.GriddedSurfaceAccessor"):
    ...
    @property
    def bias(self: Self) -> "_1103.CylindricalGearBiasModification":
    ...
    @property
    def lead_relief(self: Self) -> "_1106.CylindricalGearLeadModification":
    ...
    @property
    def micro_geometry_map(self: Self) -> "_1113.CylindricalGearMicroGeometryMap":
    ...
    @property
    def profile_relief(self: Self) -> "_1115.CylindricalGearProfileModification":
    ...
    def lead_form_deviation_points(
        self: Self,
    ) -> "List[_1124.LeadFormReliefWithDeviation]":
    ...
    def lead_slope_deviation_points(
        self: Self,
    ) -> "List[_1126.LeadSlopeReliefWithDeviation]":
    ...
    def profile_form_deviation_points(
        self: Self,
    ) -> "List[_1135.ProfileFormReliefWithDeviation]":
    ...
    def profile_slope_deviation_at_10_percent_face_width(
        self: Self,
    ) -> "List[_1137.ProfileSlopeReliefWithDeviation]":
    ...
    def total_lead_relief_points(
        self: Self,
    ) -> "List[_1140.TotalLeadReliefWithDeviation]":
    ...
    def total_profile_relief_points(
        self: Self,
    ) -> "List[_1141.TotalProfileReliefWithDeviation]":
    ...
    @property
    def gear_design(self: Self) -> "_1020.CylindricalGearDesign":
