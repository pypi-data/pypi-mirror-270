...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1020, _1015, _1016, _1031, _1086
...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    class _Cast_CylindricalGearAbstractRack:
        ...
        def cylindrical_gear_basic_rack(
            ...
            return self._parent._cast(_1016.CylindricalGearBasicRack)
        ...
        def cylindrical_gear_pinion_type_cutter(
            ...
            return self._parent._cast(_1031.CylindricalGearPinionTypeCutter)
        ...
        def standard_rack(
            ...
            return self._parent._cast(_1086.StandardRack)
    ...
    @property
    def gear(self: Self) -> "_1020.CylindricalGearDesign":
    ...
    @property
    def left_flank(self: Self) -> "_1015.CylindricalGearAbstractRackFlank":
    ...
    @property
    def right_flank(self: Self) -> "_1015.CylindricalGearAbstractRackFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank
    ...
    @property
    def shaper_for_agma_rating(self: Self) -> "_721.CylindricalGearShaper":
    ...
    @property
    def flanks(self: Self) -> "List[_1015.CylindricalGearAbstractRackFlank]":
    ...
    @property
    def both_flanks(self: Self) -> "_1015.CylindricalGearAbstractRackFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank
