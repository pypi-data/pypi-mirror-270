...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1082, _1083
...
class Scuffing(_1599.IndependentReportablePropertiesBase["Scuffing"]):
    """Scuffing
    ...
    @enforce_parameter_types
    def coefficient_of_friction_method_flash_temperature_method(
        self: Self, value: "_1081.ScuffingCoefficientOfFrictionMethods"
    ):
    ...
    @enforce_parameter_types
    def scuffing_temperature_method_agma(
        self: Self, value: "_1082.ScuffingTemperatureMethodsAGMA"
    ):
    ...
    @enforce_parameter_types
    def scuffing_temperature_method_iso(
        self: Self, value: "_1083.ScuffingTemperatureMethodsISO"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.ScuffingTemperatureMethodsISO",
