...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.cylindrical import _461, _470
...
class CylindricalGearSetDesign(_958.GearSetDesign):
    """CylindricalGearSetDesign
    ...
    def coefficient_of_friction_calculation_method(
        self: Self,
        value: "Union[_326.CoefficientOfFrictionCalculationMethod, Tuple[_326.CoefficientOfFrictionCalculationMethod, bool]]",
    ):
        wrapper_type = (
    ...
    @property
    def gear_fit_system(self: Self) -> "_1055.GearFitSystems":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1055", "GearFitSystems"
        )(value)

    @gear_fit_system.setter
    @enforce_parameter_types
    def gear_fit_system(self: Self, value: "_1055.GearFitSystems"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def helical_gear_micro_geometry_option(
        self: Self, value: "_517.HelicalGearMicroGeometryOption"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Cylindrical.ISO6336.HelicalGearMicroGeometryOption",
    ...
    @enforce_parameter_types
    def profile_shift_distribution_rule(
        self: Self, value: "_1006.AddendumModificationDistributionRule"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.AddendumModificationDistributionRule",
    ...
    @property
    def ltca_settings(self: Self) -> "_1068.LTCASettings":
    ...
    @property
    def left_flank(self: Self) -> "_1037.CylindricalGearSetFlankDesign":
    ...
    @property
    def micropitting(self: Self) -> "_1071.Micropitting":
    ...
    @property
    def right_flank(self: Self) -> "_1037.CylindricalGearSetFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearSetFlankDesign
    ...
    @property
    def scuffing(self: Self) -> "_1080.Scuffing":
    ...
    @property
    def usage(self: Self) -> "_1098.Usage":
    ...
    @property
    def gears(self: Self) -> "List[_1020.CylindricalGearDesign]":
    ...
    @property
    def cylindrical_gears(self: Self) -> "List[_1020.CylindricalGearDesign]":
        """List[mastapy.gears.gear_designs.cylindrical.CylindricalGearDesign]
    ...
    @property
    def cylindrical_meshes(self: Self) -> "List[_1026.CylindricalGearMeshDesign]":
    ...
    @property
    def flanks(self: Self) -> "List[_1037.CylindricalGearSetFlankDesign]":
    ...
    @property
    def both_flanks(self: Self) -> "_1037.CylindricalGearSetFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearSetFlankDesign
    ...
    @property
    def micro_geometries(self: Self) -> "List[_1117.CylindricalGearSetMicroGeometry]":
    ...
    def manufacturing_configurations(
        self: Self,
    ) -> "List[_632.CylindricalSetManufacturingConfig]":
    ...
    def add_new_micro_geometry(self: Self) -> "_1117.CylindricalGearSetMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry"""
    ...
    def add_new_micro_geometry_specifying_separate_micro_geometry_per_tooth_for(
        self: Self, gears: "List[_1020.CylindricalGearDesign]"
    ) -> "_1117.CylindricalGearSetMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry
    ...
    def create_optimiser(
        self: Self, duty_cycle: "_470.CylindricalGearSetDutyCycleRating"
    ...
    def delete_manufacturing_configuration(
        self: Self, config: "_632.CylindricalSetManufacturingConfig"
    ):
        """Method does not return.
    ...
    def delete_micro_geometry(
        self: Self, micro_geometry: "_1117.CylindricalGearSetMicroGeometry"
    ):
        """Method does not return.
    ...
    def set_active_manufacturing_configuration(
        self: Self, value: "_632.CylindricalSetManufacturingConfig"
    ):
        """Method does not return.
    ...
    def set_active_micro_geometry(
        self: Self, value: "_1117.CylindricalGearSetMicroGeometry"
    ):
        """Method does not return.
