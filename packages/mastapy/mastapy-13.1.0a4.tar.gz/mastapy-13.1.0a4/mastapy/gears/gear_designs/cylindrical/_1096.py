...
from mastapy.utility.units_and_measurements.measurements import _1680, _1701
...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1044, _1054, _1075, _1095
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    class _Cast_ToothThicknessSpecificationBase:
        ...
        def finish_tooth_thickness_design_specification(
            ...
            return self._parent._cast(_1054.FinishToothThicknessDesignSpecification)
        ...
        def readonly_tooth_thickness_specification(
            ...
            return self._parent._cast(_1075.ReadonlyToothThicknessSpecification)
        ...
        def tooth_thickness_specification(
            ...
            return self._parent._cast(_1095.ToothThicknessSpecification)
    ...
    def chordal_span(
        self: Self,
    ) -> "_1044.CylindricalGearToothThicknessSpecification[_1680.LengthShort]":
    ...
    def profile_shift_coefficient(
        self: Self,
    ) -> "_1044.CylindricalGearToothThicknessSpecification[_1701.Number]":
    ...
    def tooth_thickness(
        self: Self,
    ) -> "List[_1044.CylindricalGearToothThicknessSpecification[_1680.LengthShort]]":
