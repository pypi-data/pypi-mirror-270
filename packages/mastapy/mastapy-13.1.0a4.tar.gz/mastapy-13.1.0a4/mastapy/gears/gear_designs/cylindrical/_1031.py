...
class CylindricalGearPinionTypeCutter(_1014.CylindricalGearAbstractRack):
    """CylindricalGearPinionTypeCutter
    ...
    @property
    def left_flank(self: Self) -> "_1032.CylindricalGearPinionTypeCutterFlank":
    ...
    @property
    def right_flank(self: Self) -> "_1032.CylindricalGearPinionTypeCutterFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearPinionTypeCutterFlank
