...
class CylindricalGearMicroGeometrySettings(
    _1599.IndependentReportablePropertiesBase["CylindricalGearMicroGeometrySettings"]
):
    """CylindricalGearMicroGeometrySettings
    ...
    @property
    def flank_side_with_zero_face_width(self: Self) -> "_578.FlankSide":
    ...
    def flank_side_with_zero_face_width(self: Self, value: "_578.FlankSide"):
