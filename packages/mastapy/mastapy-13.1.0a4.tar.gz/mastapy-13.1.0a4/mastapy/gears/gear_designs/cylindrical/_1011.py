...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1012, _1013
...
class CrossedAxisCylindricalGearPair(_0.APIBase):
    ...
    class _Cast_CrossedAxisCylindricalGearPair:
        ...
        def crossed_axis_cylindrical_gear_pair_line_contact(
            ...
            return self._parent._cast(_1012.CrossedAxisCylindricalGearPairLineContact)
        ...
        def crossed_axis_cylindrical_gear_pair_point_contact(
            ...
            return self._parent._cast(_1013.CrossedAxisCylindricalGearPairPointContact)
    ...
    @property
    def shaver(self: Self) -> "_739.CylindricalCutterSimulatableGear":
