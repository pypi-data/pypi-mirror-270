...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances import _1150
...
class CylindricalGearDefaults(_1607.PerMachineSettings):
    """CylindricalGearDefaults
    ...
    class _Cast_CylindricalGearDefaults:
        ...
        def per_machine_settings(
            ...
            return self._parent._cast(_1607.PerMachineSettings)
    ...
    @property
    def finish_stock_type(self: Self) -> "_1100.FinishStockType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical.thickness_stock_and_backlash._1100",
            "FinishStockType",
        )(value)

    @finish_stock_type.setter
    @enforce_parameter_types
    def finish_stock_type(self: Self, value: "_1100.FinishStockType"):
    ...
    @property
    def system_of_fits_defaults(self: Self) -> "_1150.DIN3967SystemOfGearFits":
