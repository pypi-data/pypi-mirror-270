...
class CylindricalGearTableWithMGCharts(_1793.CustomTable):
    """CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self: Self) -> "_1042.CylindricalGearTableMGItemDetail":
    ...
    @item_detail.setter
    @enforce_parameter_types
    def item_detail(self: Self, value: "_1042.CylindricalGearTableMGItemDetail"):
