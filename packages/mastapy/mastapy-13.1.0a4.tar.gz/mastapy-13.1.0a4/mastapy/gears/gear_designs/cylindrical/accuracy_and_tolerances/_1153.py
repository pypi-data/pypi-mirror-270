...
class ISO1328AccuracyGraderCommon(
    ...
    class _Cast_ISO1328AccuracyGraderCommon:
        ...
        def iso132811995_accuracy_grader(
            ...
            return self._parent._cast(_1151.ISO132811995AccuracyGrader)
        ...
        def iso132812013_accuracy_grader(
            ...
            return self._parent._cast(_1152.ISO132812013AccuracyGrader)
    ...
    @property
    def base_pitch_deviation(self: Self) -> "_1155.OverridableTolerance":
    ...
    @property
    def total_radial_composite_deviation(self: Self) -> "_1155.OverridableTolerance":
        """mastapy.gears.gear_designs.cylindrical.accuracy_and_tolerances.OverridableTolerance
