...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1047, _1020, _1026
...
class CylindricalMeshedGear(_0.APIBase):
    ...
    @property
    def left_flank(self: Self) -> "_1047.CylindricalMeshedGearFlank":
    ...
    @property
    def right_flank(self: Self) -> "_1047.CylindricalMeshedGearFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalMeshedGearFlank
    ...
    @property
    def flanks(self: Self) -> "List[_1047.CylindricalMeshedGearFlank]":
    ...
    @property
    def both_flanks(self: Self) -> "_1047.CylindricalMeshedGearFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalMeshedGearFlank
    ...
    @property
    def mesh(self: Self) -> "_1026.CylindricalGearMeshDesign":
