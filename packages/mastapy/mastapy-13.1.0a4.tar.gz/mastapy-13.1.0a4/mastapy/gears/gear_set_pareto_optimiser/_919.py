...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_set_pareto_optimiser import _912, _915, _920, _946, _947
...
class GearSetParetoOptimiser(
    _913.DesignSpaceSearchBase[
        "_362.AbstractGearSetRating", "_918.GearSetOptimiserCandidate"
    ]
):
    """GearSetParetoOptimiser
    ...
    class _Cast_GearSetParetoOptimiser:
        ...
        def design_space_search_base(
            ...
            return self._parent._cast(_913.DesignSpaceSearchBase)
    ...
    @property
    def selected_candidate_geometry(self: Self) -> "_958.GearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: Self) -> "List[_958.GearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: Self) -> "List[_958.GearSetDesign]":
        """List[mastapy.gears.gear_designs.GearSetDesign]
