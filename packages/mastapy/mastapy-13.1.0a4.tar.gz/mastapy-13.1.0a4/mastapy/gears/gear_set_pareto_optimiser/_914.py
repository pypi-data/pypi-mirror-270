...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_set_pareto_optimiser import _918, _924
...
class DesignSpaceSearchCandidateBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    class _Cast_DesignSpaceSearchCandidateBase:
        ...
        def gear_set_optimiser_candidate(
            ...
            return self._parent._cast(_918.GearSetOptimiserCandidate)
        ...
        def micro_geometry_design_space_search_candidate(
            ...
            return self._parent._cast(_924.MicroGeometryDesignSpaceSearchCandidate)
