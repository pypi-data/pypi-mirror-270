...
class CylindricalGearSetParetoOptimiser(_919.GearSetParetoOptimiser):
    """CylindricalGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: Self) -> "_1036.CylindricalGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: Self) -> "List[_1036.CylindricalGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: Self) -> "List[_1036.CylindricalGearSetDesign]":
        """List[mastapy.gears.gear_designs.cylindrical.CylindricalGearSetDesign]
