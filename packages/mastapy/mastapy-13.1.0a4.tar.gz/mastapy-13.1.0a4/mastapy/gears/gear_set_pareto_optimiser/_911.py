...
if TYPE_CHECKING:
    from mastapy.utility.reporting_property_framework import _1802
    from mastapy.math_utility.optimisation import _1563
    from mastapy.gears.gear_set_pareto_optimiser import _913, _909, _921, _925, _940
...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    class _Cast_ChartInfoBase:
        ...
        def pareto_optimiser_chart_information(
            ...
            return self._parent._cast(_940.ParetoOptimiserChartInformation)
    ...
    @property
    def chart_type(self: Self) -> "_1802.CustomChartType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.reporting_property_framework._1802", "CustomChartType"
        )(value)
    ...
    def select_chart_type(
        self: Self,
    ) -> "_1563.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation.ParetoOptimisationStrategyChartInformation._1563",
    ...
    def select_chart_type(
        self: Self,
        value: "_1563.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart",
    ):
    ...
    @property
    def optimiser(self: Self) -> "_913.DesignSpaceSearchBase[TAnalysis, TCandidate]":
    ...
    @property
    def bars(self: Self) -> "List[_909.BarForPareto[TAnalysis, TCandidate]]":
    ...
    def input_sliders(
        self: Self,
    ) -> "List[_921.InputSliderForPareto[TAnalysis, TCandidate]]":
