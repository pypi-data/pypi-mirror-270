...
if TYPE_CHECKING:
    from mastapy.utility_gui.charts import _1881, _1875
...
class ConstantLine(_0.APIBase):
    ...
    class _Cast_ConstantLine:
        ...
        def mode_constant_line(
            ...
            return self._parent._cast(_1875.ModeConstantLine)
    ...
    @property
    def axis(self: Self) -> "_1881.SMTAxis":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility_gui.charts._1881", "SMTAxis"
        )(value)
