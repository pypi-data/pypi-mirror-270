...
if TYPE_CHECKING:
    from mastapy.utility_gui import _1866
...
class DataLoggerWithCharts(_1588.DataLogger):
    """DataLoggerWithCharts
    ...
    class _Cast_DataLoggerWithCharts:
        ...
        def data_logger(
            ...
            return self._parent._cast(_1588.DataLogger)
    ...
    @property
    def logged_items(self: Self) -> "List[_1866.DataLoggerItem]":
