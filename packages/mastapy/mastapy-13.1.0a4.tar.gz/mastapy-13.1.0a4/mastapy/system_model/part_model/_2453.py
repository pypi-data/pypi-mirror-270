...
class AbstractShaft(_2454.AbstractShaftOrHousing):
    """AbstractShaft
    ...
    class _Cast_AbstractShaft:
        ...
        @property
        def component(self: "AbstractShaft._Cast_AbstractShaft") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "AbstractShaft._Cast_AbstractShaft") -> "_2486.Part":
        ...
        @property
        def shaft(self: "AbstractShaft._Cast_AbstractShaft") -> "_2500.Shaft":
            from mastapy.system_model.part_model.shaft_model import _2500
