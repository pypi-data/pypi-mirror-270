...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2462, _2451, _2461, _2472, _2492, _2494
...
class AbstractAssembly(_2486.Part):
    """AbstractAssembly
    ...
    class _Cast_AbstractAssembly:
        ...
        @property
        def part(self: "AbstractAssembly._Cast_AbstractAssembly") -> "_2486.Part":
        ...
        @property
        def clutch(self: "AbstractAssembly._Cast_AbstractAssembly") -> "_2596.Clutch":
        ...
        @property
        def cvt(self: "AbstractAssembly._Cast_AbstractAssembly") -> "_2605.CVT":
    ...
    @property
    def components_with_unknown_mass_properties(self: Self) -> "List[_2462.Component]":
    ...
    @property
    def components_with_zero_mass_properties(self: Self) -> "List[_2462.Component]":
        """List[mastapy.system_model.part_model.Component]
