...
class CylindricalGearFromCAD(_2522.MountableComponentFromCAD):
    """CylindricalGearFromCAD
    ...
    class _Cast_CylindricalGearFromCAD:
        ...
        def component_from_cad(
            ...
            return self._parent._cast(_2513.ComponentFromCAD)
    ...
    @enforce_parameter_types
    def existing_gear_set(self: Self, value: "_2544.CylindricalGearSet"):
        wrapper_type = (
    ...
    @meshing_gear.setter
    @enforce_parameter_types
    def meshing_gear(self: Self, value: "_2543.CylindricalGear"):
        wrapper_type = (
