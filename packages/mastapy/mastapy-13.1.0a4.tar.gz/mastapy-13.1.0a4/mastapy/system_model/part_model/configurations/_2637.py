...
from mastapy.system_model.part_model.configurations import _2640
...
class ActiveShaftDesignSelectionGroup(
    _2640.PartDetailConfiguration[
        "_2636.ActiveShaftDesignSelection", "_2500.Shaft", "_43.SimpleShaftDefinition"
    ]
):
    """ActiveShaftDesignSelectionGroup
    ...
    class _Cast_ActiveShaftDesignSelectionGroup:
        ...
        def part_detail_configuration(
            ...
            return self._parent._cast(_2640.PartDetailConfiguration)
