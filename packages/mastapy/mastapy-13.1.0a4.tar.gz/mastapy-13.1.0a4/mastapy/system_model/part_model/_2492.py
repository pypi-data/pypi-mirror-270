...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.projections import _2503
...
class RootAssembly(_2451.Assembly):
    """RootAssembly
    ...
    class _Cast_RootAssembly:
        ...
        @property
        def assembly(self: "RootAssembly._Cast_RootAssembly") -> "_2451.Assembly":
        ...
        @property
        def part(self: "RootAssembly._Cast_RootAssembly") -> "_2486.Part":
    ...
    @property
    def packaging_limits(self: Self) -> "_316.PackagingLimits":
    ...
    @property
    def parallel_part_groups(self: Self) -> "List[_2508.ParallelPartGroup]":
    ...
    def parallel_part_groups_drawing_order(
        self: Self,
    ) -> "List[_2503.SpecifiedParallelPartGroupDrawingOrder]":
