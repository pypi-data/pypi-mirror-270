...
class ConceptGear(_2548.Gear):
    ...
    class _Cast_ConceptGear:
        ...
        @property
        def gear(self: "ConceptGear._Cast_ConceptGear") -> "_2548.Gear":
        ...
        @property
        def component(self: "ConceptGear._Cast_ConceptGear") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "ConceptGear._Cast_ConceptGear") -> "_2486.Part":
    ...
    @property
    def active_gear_design(self: Self) -> "_1186.ConceptGearDesign":
    ...
    @property
    def concept_gear_design(self: Self) -> "_1186.ConceptGearDesign":
        """mastapy.gears.gear_designs.concept.ConceptGearDesign
