...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears import _2543, _2560
...
class CylindricalGearSet(_2550.GearSet):
    """CylindricalGearSet
    ...
    class _Cast_CylindricalGearSet:
        ...
        @property
        def part(self: "CylindricalGearSet._Cast_CylindricalGearSet") -> "_2486.Part":
    ...
    def axial_contact_ratio_requirement(
        self: Self,
        value: "Union[_329.ContactRatioRequirements, Tuple[_329.ContactRatioRequirements, bool]]",
    ):
    ...
    @property
    def active_gear_set_design(self: Self) -> "_1036.CylindricalGearSetDesign":
    ...
    @property
    def cylindrical_gear_set_design(self: Self) -> "_1036.CylindricalGearSetDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearSetDesign
    ...
    @property
    def supercharger_rotor_set(self: Self) -> "_2581.SuperchargerRotorSet":
    ...
    @property
    def cylindrical_meshes(self: Self) -> "List[_2327.CylindricalGearMesh]":
    ...
    @property
    def gear_set_designs(self: Self) -> "List[_1036.CylindricalGearSetDesign]":
    ...
    def add_gear(self: Self) -> "_2543.CylindricalGear":
