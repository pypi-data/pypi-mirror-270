...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.couplings import _2595, _2610, _2605
...
class BeltDrive(_2494.SpecialisedAssembly):
    """BeltDrive
    ...
    class _Cast_BeltDrive:
        ...
        @property
        def part(self: "BeltDrive._Cast_BeltDrive") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "BeltDrive._Cast_BeltDrive") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221

            return self._parent._cast(_2221.DesignEntity)

        @property
        def cvt(self: "BeltDrive._Cast_BeltDrive") -> "_2605.CVT":
    ...
    @property
    def type_of_belt(self: Self) -> "_2595.BeltDriveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model.couplings._2595", "BeltDriveType"
        )(value)

    @type_of_belt.setter
    @enforce_parameter_types
    def type_of_belt(self: Self, value: "_2595.BeltDriveType"):
    ...
    @property
    def belt_connections(self: Self) -> "List[_2286.BeltConnection]":
    ...
    @property
    def pulleys(self: Self) -> "List[_2610.Pulley]":
