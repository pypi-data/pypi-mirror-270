...
class CVT(_2594.BeltDrive):
    ...
    class _Cast_CVT:
        ...
        @property
        def belt_drive(self: "CVT._Cast_CVT") -> "_2594.BeltDrive":
            return self._parent._cast(_2594.BeltDrive)

        @property
        def specialised_assembly(self: "CVT._Cast_CVT") -> "_2494.SpecialisedAssembly":
            from mastapy.system_model.part_model import _2494

            return self._parent._cast(_2494.SpecialisedAssembly)

        @property
        def abstract_assembly(self: "CVT._Cast_CVT") -> "_2452.AbstractAssembly":
            from mastapy.system_model.part_model import _2452

            return self._parent._cast(_2452.AbstractAssembly)

        @property
        def part(self: "CVT._Cast_CVT") -> "_2486.Part":
            from mastapy.system_model.part_model import _2486

            return self._parent._cast(_2486.Part)

        @property
        def design_entity(self: "CVT._Cast_CVT") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
