...
class RollingRing(_2603.CouplingHalf):
    """RollingRing
    ...
    class _Cast_RollingRing:
        ...
        @property
        def component(self: "RollingRing._Cast_RollingRing") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "RollingRing._Cast_RollingRing") -> "_2486.Part":
    ...
    @property
    def largest_end(self: Self) -> "_340.Hand":
        """mastapy.gears.Hand"""
    ...
    @largest_end.setter
    @enforce_parameter_types
    def largest_end(self: Self, value: "_340.Hand"):
