...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.part_groups import _2506, _2510
...
class ConcentricPartGroup(_2504.ConcentricOrParallelPartGroup):
    """ConcentricPartGroup
    ...
    @property
    def parallel_groups(self: Self) -> "List[_2506.ConcentricPartGroupParallelToThis]":
