...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model import _2479, _2454, _2462, _2486
...
class CycloidalDisc(_2453.AbstractShaft):
    """CycloidalDisc
    ...
    class _Cast_CycloidalDisc:
        ...
        @property
        def component(self: "CycloidalDisc._Cast_CycloidalDisc") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "CycloidalDisc._Cast_CycloidalDisc") -> "_2486.Part":
    ...
    @property
    def cycloidal_disc_design(self: Self) -> "_1466.CycloidalDiscDesign":
    ...
    @property
    def disc_material(self: Self) -> "_276.Material":
    ...
    @property
    def load_sharing_settings(self: Self) -> "_2479.LoadSharingSettings":
    ...
    def planetary_bearing_sockets(
        self: Self,
    ) -> "List[_2357.CycloidalDiscPlanetaryBearingSocket]":
