...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2479, _2462, _2486
...
class PlanetCarrier(_2482.MountableComponent):
    """PlanetCarrier
    ...
    class _Cast_PlanetCarrier:
        ...
        @property
        def component(self: "PlanetCarrier._Cast_PlanetCarrier") -> "_2462.Component":
            from mastapy.system_model.part_model import _2462

            return self._parent._cast(_2462.Component)

        @property
        def part(self: "PlanetCarrier._Cast_PlanetCarrier") -> "_2486.Part":
    ...
    @property
    def planetary_sockets(self: Self) -> "List[_2306.PlanetarySocket]":
