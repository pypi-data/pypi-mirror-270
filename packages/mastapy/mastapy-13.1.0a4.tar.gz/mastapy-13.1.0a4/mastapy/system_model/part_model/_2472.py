...
class FlexiblePinAssembly(_2494.SpecialisedAssembly):
    """FlexiblePinAssembly
    ...
    class _Cast_FlexiblePinAssembly:
        ...
        @property
        def part(self: "FlexiblePinAssembly._Cast_FlexiblePinAssembly") -> "_2486.Part":
    ...
    @property
    def planet_gear(self: Self) -> "_2543.CylindricalGear":
