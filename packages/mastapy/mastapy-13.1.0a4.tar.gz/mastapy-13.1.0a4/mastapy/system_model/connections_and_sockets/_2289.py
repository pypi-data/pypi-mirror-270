...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.connections_and_sockets import _2288, _2293, _2295
...
class ComponentMeasurer(_0.APIBase):
    ...
    class _Cast_ComponentMeasurer:
        ...
        def component_connection(
            ...
            return self._parent._cast(_2288.ComponentConnection)
        ...
        def cylindrical_component_connection(
            ...
            return self._parent._cast(_2293.CylindricalComponentConnection)
        ...
        def datum_measurement(
            ...
            return self._parent._cast(_2295.DatumMeasurement)
    ...
    @property
    def component(self: Self) -> "_2462.Component":
