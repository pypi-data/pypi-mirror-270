...
class ConceptGearMesh(_2331.GearMesh):
    """ConceptGearMesh
    ...
    @property
    def active_gear_mesh_design(self: Self) -> "_1187.ConceptGearMeshDesign":
    ...
    @property
    def concept_gear_mesh_design(self: Self) -> "_1187.ConceptGearMeshDesign":
        """mastapy.gears.gear_designs.concept.ConceptGearMeshDesign
