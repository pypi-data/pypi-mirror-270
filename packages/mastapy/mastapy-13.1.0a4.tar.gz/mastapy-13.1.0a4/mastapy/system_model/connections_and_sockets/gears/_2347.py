...
class WormGearMesh(_2331.GearMesh):
    """WormGearMesh
    ...
    class _Cast_WormGearMesh:
        ...
        @property
        def gear_mesh(self: "WormGearMesh._Cast_WormGearMesh") -> "_2331.GearMesh":
        ...
        @property
        def connection(self: "WormGearMesh._Cast_WormGearMesh") -> "_2290.Connection":
    ...
    @property
    def active_gear_mesh_design(self: Self) -> "_966.WormGearMeshDesign":
    ...
    @property
    def worm_gear_mesh_design(self: Self) -> "_966.WormGearMeshDesign":
        """mastapy.gears.gear_designs.worm.WormGearMeshDesign
