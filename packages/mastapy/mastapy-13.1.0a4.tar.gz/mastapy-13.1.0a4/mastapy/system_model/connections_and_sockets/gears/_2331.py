...
class GearMesh(_2299.InterMountableComponentConnection):
    """GearMesh
    ...
    class _Cast_GearMesh:
        ...
        @property
        def connection(self: "GearMesh._Cast_GearMesh") -> "_2290.Connection":
            from mastapy.system_model.connections_and_sockets import _2290

            return self._parent._cast(_2290.Connection)

        @property
        def design_entity(self: "GearMesh._Cast_GearMesh") -> "_2221.DesignEntity":
            from mastapy.system_model import _2221
        ...
        @property
        def bevel_gear_mesh(self: "GearMesh._Cast_GearMesh") -> "_2321.BevelGearMesh":
        ...
        @property
        def face_gear_mesh(self: "GearMesh._Cast_GearMesh") -> "_2329.FaceGearMesh":
            from mastapy.system_model.connections_and_sockets.gears import _2329

            return self._parent._cast(_2329.FaceGearMesh)

        @property
        def hypoid_gear_mesh(self: "GearMesh._Cast_GearMesh") -> "_2333.HypoidGearMesh":
        ...
        @property
        def worm_gear_mesh(self: "GearMesh._Cast_GearMesh") -> "_2347.WormGearMesh":
    ...
    @property
    def active_gear_mesh_design(self: Self) -> "_957.GearMeshDesign":
