...
if TYPE_CHECKING:
    from mastapy.system_model.connections_and_sockets import _2312, _2294, _2314
...
class InnerShaftSocket(_2298.InnerShaftSocketBase):
    """InnerShaftSocket
    ...
    class _Cast_InnerShaftSocket:
        ...
        @property
        def socket(self: "InnerShaftSocket._Cast_InnerShaftSocket") -> "_2314.Socket":
