...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1896, _1897, _1910, _1916
    from mastapy.bolts import _1481, _1483, _1488
    from mastapy.cycloidal import _1469, _1476
    from mastapy.electric_machines import _1296, _1314, _1327
    from mastapy.gears import _323, _324, _350
    from mastapy.gears.gear_designs import _948, _950, _953, _959
    from mastapy.gears.gear_designs.cylindrical import _1019, _1023, _1024, _1029, _1040
    ...
    from mastapy.gears.rating.cylindrical import _459, _460, _475, _476
    ...
    from mastapy.materials import _253, _256, _275, _278, _279
...
class MASTASettings(_0.APIBase):
    ...
    @property
    def iso14179_settings_database(self: Self) -> "_1993.ISO14179SettingsDatabase":
    ...
    @property
    def bearing_settings(self: Self) -> "_1896.BearingSettings":
    ...
    @property
    def bearing_settings_database(self: Self) -> "_1897.BearingSettingsDatabase":
    ...
    @property
    def rolling_bearing_database(self: Self) -> "_1910.RollingBearingDatabase":
    ...
    @property
    def skf_settings(self: Self) -> "_1916.SKFSettings":
    ...
    @property
    def bolt_geometry_database(self: Self) -> "_1481.BoltGeometryDatabase":
    ...
    @property
    def bolt_material_database(self: Self) -> "_1483.BoltMaterialDatabase":
    ...
    @property
    def ring_pins_material_database(self: Self) -> "_1476.RingPinsMaterialDatabase":
    ...
    @property
    def magnet_material_database(self: Self) -> "_1296.MagnetMaterialDatabase":
    ...
    @property
    def winding_material_database(self: Self) -> "_1327.WindingMaterialDatabase":
    ...
    @property
    def cylindrical_gear_defaults(self: Self) -> "_1019.CylindricalGearDefaults":
    ...
    @property
    def cylindrical_gear_fe_settings(self: Self) -> "_862.CylindricalGearFESettings":
    ...
    @property
    def cylindrical_hob_database(self: Self) -> "_622.CylindricalHobDatabase":
    ...
    @property
    def cylindrical_shaper_database(self: Self) -> "_633.CylindricalShaperDatabase":
    ...
    @property
    def bevel_gear_material_database(self: Self) -> "_595.BevelGearMaterialDatabase":
    ...
    @property
    def raw_material_database(self: Self) -> "_614.RawMaterialDatabase":
    ...
    @property
    def harmonic_analysis_draw_style(self: Self) -> "_5788.HarmonicAnalysisDrawStyle":
    ...
    @property
    def mbd_analysis_draw_style(self: Self) -> "_5484.MBDAnalysisDrawStyle":
    ...
    @property
    def modal_analysis_draw_style(self: Self) -> "_4679.ModalAnalysisDrawStyle":
    ...
    @property
    def power_flow_draw_style(self: Self) -> "_4146.PowerFlowDrawStyle":
    ...
    @property
    def stability_analysis_draw_style(self: Self) -> "_3894.StabilityAnalysisDrawStyle":
    ...
    @property
    def model_view_options_draw_style(self: Self) -> "_2270.ModelViewOptionsDrawStyle":
    ...
    @property
    def planet_carrier_settings(self: Self) -> "_2488.PlanetCarrierSettings":
    ...
    @property
    def bearing_material_database(self: Self) -> "_253.BearingMaterialDatabase":
    ...
    @property
    def component_material_database(self: Self) -> "_256.ComponentMaterialDatabase":
    ...
    @property
    def lubrication_detail_database(self: Self) -> "_275.LubricationDetailDatabase":
    ...
    @property
    def materials_settings(self: Self) -> "_278.MaterialsSettings":
    ...
    @property
    def materials_settings_database(self: Self) -> "_279.MaterialsSettingsDatabase":
    ...
    @property
    def cad_export_settings(self: Self) -> "_1847.CADExportSettings":
    ...
    @property
    def database_settings(self: Self) -> "_1842.DatabaseSettings":
    ...
    @property
    def program_settings(self: Self) -> "_1609.ProgramSettings":
    ...
    @property
    def pushbullet_settings(self: Self) -> "_1610.PushbulletSettings":
    ...
    @property
    def scripting_setup(self: Self) -> "_1752.ScriptingSetup":
    ...
    @property
    def measurement_settings(self: Self) -> "_1619.MeasurementSettings":
