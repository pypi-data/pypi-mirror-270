...
T = TypeVar("T", bound="_2462.Component")
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self: Self) -> "_1503.AlignmentAxis":
    ...
    def alignment_axis(self: Self, value: "_1503.AlignmentAxis"):
    ...
    @property
    def axial_offset(self: Self) -> "_2239.RelativeOffsetOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2239", "RelativeOffsetOption"
        )(value)

    @axial_offset.setter
    @enforce_parameter_types
    def axial_offset(self: Self, value: "_2239.RelativeOffsetOption"):
        value = conversion.mp_to_pn_enum(
