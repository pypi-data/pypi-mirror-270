...
from mastapy.system_model.part_model import _2489, _2490
...
if TYPE_CHECKING:
    from mastapy.system_model import _2225, _2229
...
class DutyCycleImporter(_0.APIBase):
    ...
    def design_state_destinations(
        self: Self,
    ) -> "List[_2225.DutyCycleImporterDesignEntityMatch[_5689.DesignState]]":
    ...
    @property
    def duty_cycles_to_import(self: Self) -> "List[_2229.IncludeDutyCycleOption]":
    ...
    def point_load_destinations(
        self: Self,
    ) -> "List[_2225.DutyCycleImporterDesignEntityMatch[_2489.PointLoad]]":
    ...
    def power_load_destinations(
        self: Self,
    ) -> "List[_2225.DutyCycleImporterDesignEntityMatch[_2490.PowerLoad]]":
