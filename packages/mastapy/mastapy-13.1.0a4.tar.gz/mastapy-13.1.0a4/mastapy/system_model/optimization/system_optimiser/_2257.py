...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.optimization.system_optimiser import _2258, _2259, _2255
    from mastapy.utility.logging import _1823
    from mastapy.system_model.part_model.gears import _2544, _2550
    from mastapy.gears.rating import _369
    from mastapy.system_model.analyses_and_results.load_case_groups import _5694
...
class SystemOptimiser(_0.APIBase):
    ...
    def selected_duty_cycle_for_system_optimiser(self: Self, value: "_5690.DutyCycle"):
        wrapper_type = (
    ...
    @property
    def design(self: Self) -> "_2218.Design":
    ...
    @property
    def details(self: Self) -> "_2258.SystemOptimiserDetails":
    ...
    @property
    def log(self: Self) -> "_1823.Logger":
    ...
    @property
    def tooth_number_finder(self: Self) -> "_2259.ToothNumberFinder":
    ...
    def gear_set_ratings_fast_power_flow(
        self: Self,
    ) -> "List[_369.GearSetDutyCycleRating]":
    ...
    def system_optimisation_gear_sets(
        self: Self,
    ) -> "List[_5694.SystemOptimisationGearSet]":
    ...
    @property
    def target_ratios(self: Self) -> "List[_2255.DesignStateTargetRatio]":
    ...
    @property
    def system_optimiser_duty_cycle(self: Self) -> "_5690.DutyCycle":
    ...
    @enforce_parameter_types
    def system_optimiser_duty_cycle(self: Self, value: "_5690.DutyCycle"):
