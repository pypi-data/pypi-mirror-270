...
class AssemblyCompoundMultibodyDynamicsAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5407.AssemblyMultibodyDynamicsAnalysis]":
    ...
    @property
    def bearings(self: Self) -> "List[_5563.BearingCompoundMultibodyDynamicsAnalysis]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_5565.BeltDriveCompoundMultibodyDynamicsAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_5568.BevelDifferentialGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_5575.BoltedJointCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_5574.BoltCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5596.CVTCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_5576.ClutchCompoundMultibodyDynamicsAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_5581.ConceptCouplingCompoundMultibodyDynamicsAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_5586.ConceptGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5598.CycloidalAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_5600.CycloidalDiscCompoundMultibodyDynamicsAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5604.CylindricalGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5611.FEPartCompoundMultibodyDynamicsAnalysis]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_5610.FaceGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5612.FlexiblePinAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_5619.HypoidGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_5626.KlingelnbergCycloPalloidHypoidGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5629.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_5630.MassDiscCompoundMultibodyDynamicsAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_5631.MeasurementComponentCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5633.OilSealCompoundMultibodyDynamicsAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5635.PartToPartShearCouplingCompoundMultibodyDynamicsAnalysis]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_5640.PlanetCarrierCompoundMultibodyDynamicsAnalysis]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_5641.PointLoadCompoundMultibodyDynamicsAnalysis]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_5642.PowerLoadCompoundMultibodyDynamicsAnalysis]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_5644.RingPinsCompoundMultibodyDynamicsAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5646.RollingRingAssemblyCompoundMultibodyDynamicsAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_5651.ShaftHubConnectionCompoundMultibodyDynamicsAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_5650.ShaftCompoundMultibodyDynamicsAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5656.SpiralBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_5657.SpringDamperCompoundMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_5662.StraightBevelDiffGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_5665.StraightBevelGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_5668.SynchroniserCompoundMultibodyDynamicsAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_5672.TorqueConverterCompoundMultibodyDynamicsAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_5676.UnbalancedMassCompoundMultibodyDynamicsAnalysis]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_5680.WormGearSetCompoundMultibodyDynamicsAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_5683.ZerolBevelGearSetCompoundMultibodyDynamicsAnalysis]":
