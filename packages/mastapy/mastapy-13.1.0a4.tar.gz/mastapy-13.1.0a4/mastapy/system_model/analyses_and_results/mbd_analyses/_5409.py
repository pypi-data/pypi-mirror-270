...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses.reporting import _5550
...
class BearingMultibodyDynamicsAnalysis(_5439.ConnectorMultibodyDynamicsAnalysis):
    """BearingMultibodyDynamicsAnalysis
    ...
    @property
    def peak_dynamic_force(self: Self) -> "_5550.DynamicForceVector3DResult":
