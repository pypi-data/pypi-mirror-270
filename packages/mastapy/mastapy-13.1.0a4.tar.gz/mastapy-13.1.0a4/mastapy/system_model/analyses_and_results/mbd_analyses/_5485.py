...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5410, _5462, _5508
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self: Self) -> "_5406.AnalysisTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5406",
            "AnalysisTypes",
        )(value)

    @analysis_type.setter
    @enforce_parameter_types
    def analysis_type(self: Self, value: "_5406.AnalysisTypes"):
    ...
    @property
    def bearing_element_orbit_model(self: Self) -> "_5408.BearingElementOrbitModel":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5408",
    ...
    def bearing_element_orbit_model(
        self: Self, value: "_5408.BearingElementOrbitModel"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.BearingElementOrbitModel",
    ...
    @enforce_parameter_types
    def include_shaft_and_housing_flexibilities(
        self: Self, value: "_5508.ShaftAndHousingFlexibilityOption"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def method_to_define_period(
        self: Self, value: "_5469.InertiaAdjustedLoadCasePeriodMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCasePeriodMethod",
    ...
    @enforce_parameter_types
    def reference_power_load_to_define_period(self: Self, value: "_2490.PowerLoad"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def static_load_case_used_to_set_initial_speeds(self: Self, value: "str"):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_str.wrapper_type()
        enclosed_type = list_with_selected_item.ListWithSelectedItem_str.implicit_type()
        value = wrapper_type[enclosed_type](
            enclosed_type(value) if value is not None else ""
    ...
    def static_load_cases_to_create(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5470",
    ...
    @enforce_parameter_types
    def static_load_cases_to_create(
        self: Self, value: "_5470.InertiaAdjustedLoadCaseResultsToCreate"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCaseResultsToCreate",
    ...
    @enforce_parameter_types
    def use_static_load_case_to_set_initial_speeds(self: Self, value: "bool"):
    ...
    def external_interface_options(
        self: Self,
    ) -> "_5554.DynamicExternalInterfaceOptions":
    ...
    @property
    def run_up_analysis_options(self: Self) -> "_5486.MBDRunUpAnalysisOptions":
    ...
    @property
    def spline_damping_options(self: Self) -> "_5517.SplineDampingOptions":
