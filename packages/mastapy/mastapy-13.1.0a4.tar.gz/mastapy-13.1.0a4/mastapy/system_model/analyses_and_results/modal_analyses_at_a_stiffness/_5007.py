...
class WormGearSetModalAnalysisAtAStiffness(_4941.GearSetModalAnalysisAtAStiffness):
    """WormGearSetModalAnalysisAtAStiffness
    ...
    def gears_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_5006.WormGearModalAnalysisAtAStiffness]":
    ...
    def meshes_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_5005.WormGearMeshModalAnalysisAtAStiffness]":
