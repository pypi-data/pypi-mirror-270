...
class KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtAStiffness(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4952.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_compound_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_5080.KlingelnbergCycloPalloidHypoidGearCompoundModalAnalysisAtAStiffness]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_compound_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_5081.KlingelnbergCycloPalloidHypoidGearMeshCompoundModalAnalysisAtAStiffness]":
