...
class ExcitationSourceSelectionGroup(_5872.ExcitationSourceSelectionBase):
    """ExcitationSourceSelectionGroup
    ...
    class _Cast_ExcitationSourceSelectionGroup:
        ...
        def excitation_source_selection_base(
            ...
            return self._parent._cast(_5872.ExcitationSourceSelectionBase)
    ...
    @property
    def sub_items(self: Self) -> "List[_5872.ExcitationSourceSelectionBase]":
    ...
    @enforce_parameter_types
    def include_only_harmonics_with_order(self: Self, order: "_1541.RoundedOrder"):
