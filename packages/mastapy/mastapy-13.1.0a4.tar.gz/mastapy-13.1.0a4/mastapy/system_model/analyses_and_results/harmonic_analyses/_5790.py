...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5778, _5837
...
class HarmonicAnalysisFEExportOptions(
    _5789.HarmonicAnalysisExportOptions[
        "_2677.IHaveFEPartHarmonicAnalysisResults", "_2471.FEPart"
    ]
):
    """HarmonicAnalysisFEExportOptions
    ...
    class _Cast_HarmonicAnalysisFEExportOptions:
        ...
        def harmonic_analysis_export_options(
            ...
            return self._parent._cast(_5789.HarmonicAnalysisExportOptions)
    ...
    @enforce_parameter_types
    def distance_unit(self: Self, value: "_1623.Unit"):
    ...
    @enforce_parameter_types
    def element_face_group_to_export(self: Self, value: "_231.CMSElementFaceGroup"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def fe_export_format(self: Self, value: "_173.FEExportFormat"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @force_unit.setter
    @enforce_parameter_types
    def force_unit(self: Self, value: "_1623.Unit"):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @property
    def eigenvalue_options(self: Self) -> "_186.EigenvalueOptions":
