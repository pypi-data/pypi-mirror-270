...
class ExcitationSourceSelection(_5872.ExcitationSourceSelectionBase):
    """ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self: Self) -> "List[_5874.HarmonicSelection]":
    ...
    def include_only_harmonic_with_order(
        self: Self, order: "_1541.RoundedOrder"
    ) -> "bool":
        """bool
