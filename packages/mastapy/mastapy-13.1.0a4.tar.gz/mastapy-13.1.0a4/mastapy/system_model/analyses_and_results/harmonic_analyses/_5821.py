...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5731, _5814
...
class PlanetCarrierHarmonicAnalysis(_5812.MountableComponentHarmonicAnalysis):
    """PlanetCarrierHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self: Self) -> "_2813.PlanetCarrierSystemDeflection":
