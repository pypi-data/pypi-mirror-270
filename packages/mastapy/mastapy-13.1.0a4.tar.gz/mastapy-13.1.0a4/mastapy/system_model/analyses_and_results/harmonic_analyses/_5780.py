...
class GearMeshExcitationDetail(_5705.AbstractPeriodicExcitationDetail):
    """GearMeshExcitationDetail
    ...
    class _Cast_GearMeshExcitationDetail:
        ...
        def gear_mesh_misalignment_excitation_detail(
            ...
            return self._parent._cast(_5782.GearMeshMisalignmentExcitationDetail)
        ...
        def gear_mesh_te_excitation_detail(
            ...
            return self._parent._cast(_5783.GearMeshTEExcitationDetail)
    ...
    @property
    def gear_mesh(self: Self) -> "_2782.GearMeshSystemDeflection":
    ...
    def get_compliance_and_force_data(self: Self) -> "_5730.ComplianceAndForceData":
