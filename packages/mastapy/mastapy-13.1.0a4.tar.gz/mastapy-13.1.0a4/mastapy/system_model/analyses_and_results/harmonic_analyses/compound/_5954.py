...
class CylindricalGearSetCompoundHarmonicAnalysis(_5965.GearSetCompoundHarmonicAnalysis):
    """CylindricalGearSetCompoundHarmonicAnalysis
    ...
    def cylindrical_gears_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5952.CylindricalGearCompoundHarmonicAnalysis]":
    ...
    def cylindrical_meshes_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5953.CylindricalGearMeshCompoundHarmonicAnalysis]":
