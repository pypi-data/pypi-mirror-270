...
class FaceGearSetCompoundHarmonicAnalysis(_5965.GearSetCompoundHarmonicAnalysis):
    """FaceGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5775.FaceGearSetHarmonicAnalysis]":
    ...
    def face_gears_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5958.FaceGearCompoundHarmonicAnalysis]":
    ...
    def face_meshes_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5959.FaceGearMeshCompoundHarmonicAnalysis]":
