...
class CylindricalGearSetCompoundAdvancedSystemDeflection(
    ...
    @property
    def gear_duty_cycle_rating(self: Self) -> "_470.CylindricalGearSetDutyCycleRating":
    ...
    def cylindrical_gears_compound_advanced_system_deflection(
        self: Self,
    ) -> "List[_7479.CylindricalGearCompoundAdvancedSystemDeflection]":
    ...
    def cylindrical_meshes_compound_advanced_system_deflection(
        self: Self,
    ) -> "List[_7480.CylindricalGearMeshCompoundAdvancedSystemDeflection]":
