...
class PointLoadCompoundDynamicAnalysis(_6556.VirtualComponentCompoundDynamicAnalysis):
    """PointLoadCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6391.PointLoadDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6391.PointLoadDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.PointLoadDynamicAnalysis]
