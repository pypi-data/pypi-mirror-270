...
class FaceGearCompoundDynamicAnalysis(_6492.GearCompoundDynamicAnalysis):
    """FaceGearCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6358.FaceGearDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6358.FaceGearDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.FaceGearDynamicAnalysis]
