...
class MassDiscCompoundDynamicAnalysis(_6556.VirtualComponentCompoundDynamicAnalysis):
    """MassDiscCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6380.MassDiscDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6380.MassDiscDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.MassDiscDynamicAnalysis]
