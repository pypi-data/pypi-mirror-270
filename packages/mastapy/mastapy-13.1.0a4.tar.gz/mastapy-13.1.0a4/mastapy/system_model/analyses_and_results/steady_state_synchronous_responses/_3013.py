...
class AssemblySteadyStateSynchronousResponse(
    ...
    @property
    def bearings(self: Self) -> "List[_3014.BearingSteadyStateSynchronousResponse]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_3018.BevelDifferentialGearSetSteadyStateSynchronousResponse]":
    ...
    @property
    def bolts(self: Self) -> "List[_3026.BoltSteadyStateSynchronousResponse]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3048.CVTSteadyStateSynchronousResponse]":
    ...
    @property
    def clutches(self: Self) -> "List[_3029.ClutchSteadyStateSynchronousResponse]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_3036.ConceptGearSetSteadyStateSynchronousResponse]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_3052.CycloidalDiscSteadyStateSynchronousResponse]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_3063.FEPartSteadyStateSynchronousResponse]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_3061.FaceGearSetSteadyStateSynchronousResponse]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_3064.FlexiblePinAssemblySteadyStateSynchronousResponse]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_3082.MassDiscSteadyStateSynchronousResponse]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_3083.MeasurementComponentSteadyStateSynchronousResponse]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_3085.OilSealSteadyStateSynchronousResponse]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_3096.RingPinsSteadyStateSynchronousResponse]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_3102.ShaftHubConnectionSteadyStateSynchronousResponse]":
    ...
    @property
    def shafts(self: Self) -> "List[_3103.ShaftSteadyStateSynchronousResponse]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3107.SpiralBevelGearSetSteadyStateSynchronousResponse]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_3111.SpringDamperSteadyStateSynchronousResponse]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_3116.StraightBevelDiffGearSetSteadyStateSynchronousResponse]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_3119.StraightBevelGearSetSteadyStateSynchronousResponse]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_3126.SynchroniserSteadyStateSynchronousResponse]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_3129.TorqueConverterSteadyStateSynchronousResponse]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_3134.WormGearSetSteadyStateSynchronousResponse]":
