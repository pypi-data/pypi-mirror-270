...
class RootAssemblySystemDeflection(_2715.AssemblySystemDeflection):
    """RootAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4154.RootAssemblyPowerFlow":
    ...
    @property
    def system_deflection_inputs(self: Self) -> "_2848.SystemDeflection":
    ...
    def shaft_deflection_results(
        self: Self,
    ) -> "List[_2739.ConcentricPartGroupCombinationSystemDeflectionResults]":
