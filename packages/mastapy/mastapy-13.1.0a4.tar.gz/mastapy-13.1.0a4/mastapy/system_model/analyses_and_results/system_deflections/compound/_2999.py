...
class WormGearCompoundSystemDeflection(_2933.GearCompoundSystemDeflection):
    """WormGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self: Self) -> "_379.WormGearDutyCycleRating":
    ...
    @property
    def worm_duty_cycle_rating(self: Self) -> "_379.WormGearDutyCycleRating":
        """mastapy.gears.rating.worm.WormGearDutyCycleRating
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2861.WormGearSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.WormGearSystemDeflection]
