...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.cylindrical import _470, _471
...
class CylindricalGearSetCompoundSystemDeflection(_2935.GearSetCompoundSystemDeflection):
    """CylindricalGearSetCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_2767.CylindricalGearSetSystemDeflectionWithLTCAResults]":
    ...
    def cylindrical_gears_compound_system_deflection(
        self: Self,
    ) -> "List[_2921.CylindricalGearCompoundSystemDeflection]":
    ...
    def cylindrical_meshes_compound_system_deflection(
        self: Self,
    ) -> "List[_2922.CylindricalGearMeshCompoundSystemDeflection]":
