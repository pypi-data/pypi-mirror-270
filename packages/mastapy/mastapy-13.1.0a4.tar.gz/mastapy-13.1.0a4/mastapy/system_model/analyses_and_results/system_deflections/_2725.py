...
class BevelDifferentialGearSetSystemDeflection(_2730.BevelGearSetSystemDeflection):
    """BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4068.BevelDifferentialGearSetPowerFlow":
