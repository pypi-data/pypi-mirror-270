...
class SystemDeflection(_7570.FEAnalysis):
    """SystemDeflection
    ...
    class _Cast_SystemDeflection:
        ...
        @property
        def context(self: "SystemDeflection._Cast_SystemDeflection") -> "_2673.Context":
            from mastapy.system_model.analyses_and_results import _2673
    ...
    @property
    def analysis_options(self: Self) -> "_2850.SystemDeflectionOptions":
