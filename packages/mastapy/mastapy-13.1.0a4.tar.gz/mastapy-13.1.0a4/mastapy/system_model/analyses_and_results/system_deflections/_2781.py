...
class FlexiblePinAssemblySystemDeflection(_2829.SpecialisedAssemblySystemDeflection):
    """FlexiblePinAssemblySystemDeflection
    ...
    @property
    def flexible_pin_shaft_details(self: Self) -> "_2827.ShaftSystemDeflection":
    ...
    @property
    def pin_analysis(self: Self) -> "_2827.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4115.FlexiblePinAssemblyPowerFlow":
    ...
    @property
    def spindle_analyses(self: Self) -> "_2827.ShaftSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.ShaftSystemDeflection
    ...
    @property
    def bearing_static_analyses(self: Self) -> "List[_2721.BearingSystemDeflection]":
    ...
    def observed_pin_stiffness_reporters(
        self: Self,
    ) -> "List[_2806.ObservedPinStiffnessReporter]":
