...
class AssemblyPowerFlow(_4055.AbstractAssemblyPowerFlow):
    """AssemblyPowerFlow
    ...
    @property
    def bearings(self: Self) -> "List[_4063.BearingPowerFlow]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4065.BeltDrivePowerFlow]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_4068.BevelDifferentialGearSetPowerFlow]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4074.BoltedJointPowerFlow]":
    ...
    @property
    def bolts(self: Self) -> "List[_4075.BoltPowerFlow]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4096.CVTPowerFlow]":
    ...
    @property
    def clutches(self: Self) -> "List[_4078.ClutchPowerFlow]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_4083.ConceptCouplingPowerFlow]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_4086.ConceptGearSetPowerFlow]":
    ...
    @property
    def cycloidal_assemblies(self: Self) -> "List[_4098.CycloidalAssemblyPowerFlow]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4101.CycloidalDiscPowerFlow]":
    ...
    @property
    def cylindrical_gear_sets(self: Self) -> "List[_4105.CylindricalGearSetPowerFlow]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4114.FEPartPowerFlow]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4111.FaceGearSetPowerFlow]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_4115.FlexiblePinAssemblyPowerFlow]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_4122.HypoidGearSetPowerFlow]":
    ...
    @property
    def loaded_gear_sets(self: Self) -> "List[_4118.GearSetPowerFlow]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4133.MassDiscPowerFlow]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4136.OilSealPowerFlow]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_4140.PartToPartShearCouplingPowerFlow]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4143.PlanetCarrierPowerFlow]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4144.PointLoadPowerFlow]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4147.PowerLoadPowerFlow]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4149.RingPinsPowerFlow]":
    ...
    @property
    def shaft_hub_connections(self: Self) -> "List[_4155.ShaftHubConnectionPowerFlow]":
    ...
    @property
    def shafts(self: Self) -> "List[_4156.ShaftPowerFlow]":
    ...
    @property
    def spiral_bevel_gear_sets(self: Self) -> "List[_4161.SpiralBevelGearSetPowerFlow]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4164.SpringDamperPowerFlow]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4170.StraightBevelGearSetPowerFlow]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4175.SynchroniserPowerFlow]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_4179.TorqueConverterPowerFlow]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_4182.UnbalancedMassPowerFlow]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4186.WormGearSetPowerFlow]":
    ...
    @property
    def zerol_bevel_gear_sets(self: Self) -> "List[_4189.ZerolBevelGearSetPowerFlow]":
