...
class PowerFlow(_7576.StaticLoadAnalysisCase):
    """PowerFlow
    ...
    class _Cast_PowerFlow:
        ...
        @property
        def analysis_case(self: "PowerFlow._Cast_PowerFlow") -> "_7561.AnalysisCase":
            from mastapy.system_model.analyses_and_results.analysis_cases import _7561

            return self._parent._cast(_7561.AnalysisCase)

        @property
        def context(self: "PowerFlow._Cast_PowerFlow") -> "_2673.Context":
            from mastapy.system_model.analyses_and_results import _2673
    ...
    @property
    def torsional_system_deflection(self: Self) -> "_2855.TorsionalSystemDeflection":
