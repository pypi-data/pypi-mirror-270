...
class CycloidalDiscCompoundPowerFlow(_4191.AbstractShaftCompoundPowerFlow):
    """CycloidalDiscCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4101.CycloidalDiscPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4101.CycloidalDiscPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CycloidalDiscPowerFlow]
