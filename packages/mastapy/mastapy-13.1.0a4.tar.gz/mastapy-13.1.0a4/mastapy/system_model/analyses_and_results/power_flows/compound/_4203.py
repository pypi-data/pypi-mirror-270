...
class BevelDifferentialGearSetCompoundPowerFlow(_4208.BevelGearSetCompoundPowerFlow):
    """BevelDifferentialGearSetCompoundPowerFlow
    ...
    def bevel_differential_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4201.BevelDifferentialGearCompoundPowerFlow]":
    ...
    def bevel_differential_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4202.BevelDifferentialGearMeshCompoundPowerFlow]":
