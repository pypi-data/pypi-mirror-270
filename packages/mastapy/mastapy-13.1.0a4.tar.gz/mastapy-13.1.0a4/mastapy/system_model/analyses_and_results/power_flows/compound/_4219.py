...
class ConceptGearCompoundPowerFlow(_4248.GearCompoundPowerFlow):
    """ConceptGearCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4085.ConceptGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4085.ConceptGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptGearPowerFlow]
