...
class HypoidGearCompoundPowerFlow(_4194.AGMAGleasonConicalGearCompoundPowerFlow):
    """HypoidGearCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4121.HypoidGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4121.HypoidGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.HypoidGearPowerFlow]
