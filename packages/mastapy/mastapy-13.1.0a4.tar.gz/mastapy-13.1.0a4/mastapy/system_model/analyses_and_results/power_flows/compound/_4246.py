...
class FEPartCompoundPowerFlow(_4192.AbstractShaftOrHousingCompoundPowerFlow):
    """FEPartCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4114.FEPartPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4114.FEPartPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FEPartPowerFlow]
