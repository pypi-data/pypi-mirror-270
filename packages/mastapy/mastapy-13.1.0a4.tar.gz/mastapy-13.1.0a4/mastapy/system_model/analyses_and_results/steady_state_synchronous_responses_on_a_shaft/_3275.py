...
class AssemblySteadyStateSynchronousResponseOnAShaft(
    ...
    @property
    def bolts(self: Self) -> "List[_3288.BoltSteadyStateSynchronousResponseOnAShaft]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3310.CVTSteadyStateSynchronousResponseOnAShaft]":
    ...
    @property
    def shafts(self: Self) -> "List[_3364.ShaftSteadyStateSynchronousResponseOnAShaft]":
