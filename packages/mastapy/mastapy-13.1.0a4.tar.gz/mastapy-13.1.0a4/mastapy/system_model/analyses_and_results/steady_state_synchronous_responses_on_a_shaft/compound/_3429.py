...
class ConceptGearSetCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3298.ConceptGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def concept_gears_compound_steady_state_synchronous_response_on_a_shaft(
        self: Self,
    ) -> "List[_3427.ConceptGearCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def concept_meshes_compound_steady_state_synchronous_response_on_a_shaft(
        self: Self,
    ) -> "List[_3428.ConceptGearMeshCompoundSteadyStateSynchronousResponseOnAShaft]":
