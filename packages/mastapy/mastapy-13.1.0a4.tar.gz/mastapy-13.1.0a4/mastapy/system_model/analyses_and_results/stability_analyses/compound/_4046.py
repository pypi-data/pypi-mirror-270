...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.stability_analyses import _3919
...
class ZerolBevelGearCompoundStabilityAnalysis(_3936.BevelGearCompoundStabilityAnalysis):
    """ZerolBevelGearCompoundStabilityAnalysis
