...
class AssemblyCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3793.AssemblyStabilityAnalysis]":
    ...
    @property
    def bearings(self: Self) -> "List[_3928.BearingCompoundStabilityAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_3930.BeltDriveCompoundStabilityAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_3933.BevelDifferentialGearSetCompoundStabilityAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_3940.BoltedJointCompoundStabilityAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_3939.BoltCompoundStabilityAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3961.CVTCompoundStabilityAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_3941.ClutchCompoundStabilityAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_3946.ConceptCouplingCompoundStabilityAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_3951.ConceptGearSetCompoundStabilityAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_3963.CycloidalAssemblyCompoundStabilityAnalysis]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_3965.CycloidalDiscCompoundStabilityAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_3969.CylindricalGearSetCompoundStabilityAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_3976.FEPartCompoundStabilityAnalysis]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_3975.FaceGearSetCompoundStabilityAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_3977.FlexiblePinAssemblyCompoundStabilityAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_3984.HypoidGearSetCompoundStabilityAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_3991.KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3994.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundStabilityAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_3995.MassDiscCompoundStabilityAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_3996.MeasurementComponentCompoundStabilityAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_3998.OilSealCompoundStabilityAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_4000.PartToPartShearCouplingCompoundStabilityAnalysis]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_4005.PlanetCarrierCompoundStabilityAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4006.PointLoadCompoundStabilityAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4007.PowerLoadCompoundStabilityAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4009.RingPinsCompoundStabilityAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_4011.RollingRingAssemblyCompoundStabilityAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_4016.ShaftHubConnectionCompoundStabilityAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_4015.ShaftCompoundStabilityAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4021.SpiralBevelGearSetCompoundStabilityAnalysis]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_4022.SpringDamperCompoundStabilityAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_4027.StraightBevelDiffGearSetCompoundStabilityAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4030.StraightBevelGearSetCompoundStabilityAnalysis]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_4033.SynchroniserCompoundStabilityAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_4037.TorqueConverterCompoundStabilityAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_4041.UnbalancedMassCompoundStabilityAnalysis]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_4045.WormGearSetCompoundStabilityAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_4048.ZerolBevelGearSetCompoundStabilityAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_3793.AssemblyStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.AssemblyStabilityAnalysis]
