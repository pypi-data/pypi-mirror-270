...
class AssemblyStabilityAnalysis(_3786.AbstractAssemblyStabilityAnalysis):
    """AssemblyStabilityAnalysis
    ...
    @property
    def bearings(self: Self) -> "List[_3794.BearingStabilityAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_3796.BeltDriveStabilityAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_3798.BevelDifferentialGearSetStabilityAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_3805.BoltedJointStabilityAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_3806.BoltStabilityAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3829.CVTStabilityAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_3809.ClutchStabilityAnalysis]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_3814.ConceptCouplingStabilityAnalysis]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_3816.ConceptGearSetStabilityAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_3830.CycloidalAssemblyStabilityAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_3833.CycloidalDiscStabilityAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_3844.FEPartStabilityAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_3842.FaceGearSetStabilityAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_3851.HypoidGearSetStabilityAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_3863.MassDiscStabilityAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_3866.OilSealStabilityAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_3870.PartToPartShearCouplingStabilityAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_3873.PlanetCarrierStabilityAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_3874.PointLoadStabilityAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_3875.PowerLoadStabilityAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_3877.RingPinsStabilityAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_3883.ShaftHubConnectionStabilityAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_3884.ShaftStabilityAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3888.SpiralBevelGearSetStabilityAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_3892.SpringDamperStabilityAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_3900.StraightBevelGearSetStabilityAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_3907.SynchroniserStabilityAnalysis]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_3910.TorqueConverterStabilityAnalysis]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_3912.UnbalancedMassStabilityAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_3915.WormGearSetStabilityAnalysis]":
