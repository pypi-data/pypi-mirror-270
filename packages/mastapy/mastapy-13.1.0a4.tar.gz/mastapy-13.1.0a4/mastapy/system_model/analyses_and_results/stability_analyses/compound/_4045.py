...
class WormGearSetCompoundStabilityAnalysis(_3980.GearSetCompoundStabilityAnalysis):
    """WormGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3915.WormGearSetStabilityAnalysis]":
    ...
    def worm_gears_compound_stability_analysis(
        self: Self,
    ) -> "List[_4043.WormGearCompoundStabilityAnalysis]":
    ...
    def worm_meshes_compound_stability_analysis(
        self: Self,
    ) -> "List[_4044.WormGearMeshCompoundStabilityAnalysis]":
