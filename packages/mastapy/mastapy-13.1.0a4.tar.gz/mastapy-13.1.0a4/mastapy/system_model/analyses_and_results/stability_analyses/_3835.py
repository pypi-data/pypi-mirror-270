...
class CylindricalGearSetStabilityAnalysis(_3847.GearSetStabilityAnalysis):
    """CylindricalGearSetStabilityAnalysis
    ...
    def gears_stability_analysis(
        self: Self,
    ) -> "List[_3836.CylindricalGearStabilityAnalysis]":
    ...
    def meshes_stability_analysis(
        self: Self,
    ) -> "List[_3834.CylindricalGearMeshStabilityAnalysis]":
