...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears import _2550, _2548
...
TGearSet = TypeVar("TGearSet", bound="_2550.GearSet")
TGear = TypeVar("TGear", bound="_2548.Gear")
TGearStaticLoad = TypeVar("TGearStaticLoad", bound="_6917.GearLoadCase")
TGearMesh = TypeVar("TGearMesh", bound="_2331.GearMesh")
TGearMeshStaticLoad = TypeVar("TGearMeshStaticLoad", bound="_6919.GearMeshLoadCase")
TGearSetStaticLoad = TypeVar("TGearSetStaticLoad", bound="_6922.GearSetLoadCase")
...
class GearSetStaticLoadCaseGroup(
    ...
    class _Cast_GearSetStaticLoadCaseGroup:
        ...
        def part_static_load_case_group(
            ...
            return self._parent._cast(_5703.PartStaticLoadCaseGroup)
        ...
        def design_entity_static_load_case_group(
            ...
            return self._parent._cast(_5701.DesignEntityStaticLoadCaseGroup)
    ...
    def gears_load_cases(
        self: Self,
    ) -> "List[_5699.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]":
    ...
    def meshes_load_cases(
        self: Self,
    ) -> "List[_5700.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]":
