...
class DesignState(_5684.AbstractDesignStateLoadCaseGroup):
    """DesignState
    ...
    @property
    def clutches(self: Self) -> "List[_5687.ClutchEngagementStatus]":
    ...
    def clutch_engagement_status_for(
        self: Self, clutch_connection: "_2360.ClutchConnection"
    ...
    def concept_synchro_gear_engagement_status_for(
        self: Self, gear: "_2543.CylindricalGear"
