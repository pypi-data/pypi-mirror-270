...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6975, _6830
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    class _Cast_AbstractLoadCaseGroup:
        ...
        def abstract_static_load_case_group(
            ...
            return self._parent._cast(_5686.AbstractStaticLoadCaseGroup)
        ...
        def time_series_load_case_group(
            ...
            from mastapy.system_model.analyses_and_results.load_case_groups import _5697

            return self._parent._cast(_5697.TimeSeriesLoadCaseGroup)
    ...
    @property
    def model(self: Self) -> "_2218.Design":
    ...
    @property
    def load_case_root_assemblies(self: Self) -> "List[_6975.RootAssemblyLoadCase]":
    ...
    def create_load_cases(
        self: Self, number_of_load_cases: "int", token: "_7585.TaskProgress"
    ) -> "List[_6830.LoadCase]":
    ...
    @enforce_parameter_types
    def perform_pst_with_progress(self: Self, progress: "_7585.TaskProgress"):
        """Method does not return.
