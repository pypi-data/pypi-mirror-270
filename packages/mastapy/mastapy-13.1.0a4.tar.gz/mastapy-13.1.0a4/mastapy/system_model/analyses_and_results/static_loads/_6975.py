...
class RootAssemblyLoadCase(_6845.AssemblyLoadCase):
    """RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self: Self) -> "_1589.PIDControlSettings":
    ...
    @property
    def supercharger_rotor_sets(self: Self) -> "List[_6892.CylindricalGearSetLoadCase]":
