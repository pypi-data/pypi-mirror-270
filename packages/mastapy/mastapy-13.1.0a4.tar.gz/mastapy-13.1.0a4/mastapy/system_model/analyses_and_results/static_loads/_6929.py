...
T = TypeVar("T", bound="_6907.ElectricMachineHarmonicLoadImportOptionsBase")


class HarmonicLoadDataImportFromMotorPackages(_6928.HarmonicLoadDataImportBase[T]):
    """HarmonicLoadDataImportFromMotorPackages
    ...
    class _Cast_HarmonicLoadDataImportFromMotorPackages:
        ...
        def harmonic_load_data_import_base(
            ...
            return self._parent._cast(_6928.HarmonicLoadDataImportBase)
        ...
        def harmonic_load_data_csv_import(
            ...
            return self._parent._cast(_6925.HarmonicLoadDataCSVImport)
        ...
        def harmonic_load_data_flux_import(
            ...
            return self._parent._cast(_6927.HarmonicLoadDataFluxImport)
        ...
        def harmonic_load_data_jmag_import(
            ...
            return self._parent._cast(_6930.HarmonicLoadDataJMAGImport)
        ...
        def harmonic_load_data_motor_cad_import(
            ...
            return self._parent._cast(_6931.HarmonicLoadDataMotorCADImport)
