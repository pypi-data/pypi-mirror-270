...
from mastapy.system_model import _2232
from mastapy.gears import _344
from mastapy.nodal_analysis.nodal_entities import _131
from mastapy.bearings.bearing_results.rolling.iso_rating_results import _2127
...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _1985, _2087
    from mastapy.system_model import _2228, _2242
...
class LoadCase(_2673.Context):
    ...
    class _Cast_LoadCase:
        ...
        @property
        def context(self: "LoadCase._Cast_LoadCase") -> "_2673.Context":
        ...
        @property
        def static_load_case(self: "LoadCase._Cast_LoadCase") -> "_6831.StaticLoadCase":
    ...
    @enforce_parameter_types
    def ball_bearing_contact_calculation(
        self: Self, value: "_1985.BallBearingContactCalculation"
    ):
    ...
    @enforce_parameter_types
    def ball_bearing_friction_model_for_gyroscopic_moment(
        self: Self, value: "_1990.FrictionModelForGyroscopicMoment"
    ):
    ...
    def hypoid_gear_wind_up_removal_method_for_misalignments(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2228", "HypoidWindUpRemovalMethod"
        )(value)

    @hypoid_gear_wind_up_removal_method_for_misalignments.setter
    @enforce_parameter_types
    def hypoid_gear_wind_up_removal_method_for_misalignments(
        self: Self, value: "_2228.HypoidWindUpRemovalMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def mesh_stiffness_model(self: Self, value: "_2232.MeshStiffnessModel"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def micro_geometry_model_in_system_deflection(
        self: Self,
        value: "Union[_344.MicroGeometryModel, Tuple[_344.MicroGeometryModel, bool]]",
    ):
    ...
    @property
    def roller_analysis_method(self: Self) -> "_2087.RollerAnalysisMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_results.rolling._2087", "RollerAnalysisMethod"
        )(value)

    @roller_analysis_method.setter
    @enforce_parameter_types
    def roller_analysis_method(self: Self, value: "_2087.RollerAnalysisMethod"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def shear_area_factor_method(self: Self, value: "_131.ShearAreaFactorMethod"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def stress_concentration_method_for_rating(
        self: Self, value: "_2127.StressConcentrationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def additional_acceleration(self: Self) -> "_6837.AdditionalAccelerationOptions":
    ...
    @property
    def input_power_load(self: Self) -> "_6966.PowerLoadLoadCase":
    ...
    @property
    def output_power_load(self: Self) -> "_6966.PowerLoadLoadCase":
        """mastapy.system_model.analyses_and_results.static_loads.PowerLoadLoadCase
    ...
    @property
    def parametric_study_tool_options(self: Self) -> "_4412.ParametricStudyToolOptions":
    ...
    @property
    def temperatures(self: Self) -> "_2242.TransmissionTemperatureSet":
    ...
    @enforce_parameter_types
    def inputs_for_cvt(self: Self, design_entity: "_2605.CVT") -> "_6882.CVTLoadCase":
