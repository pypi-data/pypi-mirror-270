...
class ConceptGearSetLoadCase(_6922.GearSetLoadCase):
    """ConceptGearSetLoadCase
    ...
    @property
    def gears_load_case(self: Self) -> "List[_6868.ConceptGearLoadCase]":
    ...
    @property
    def concept_gears_load_case(self: Self) -> "List[_6868.ConceptGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConceptGearLoadCase]
    ...
    @property
    def meshes_load_case(self: Self) -> "List[_6869.ConceptGearMeshLoadCase]":
    ...
    @property
    def concept_meshes_load_case(self: Self) -> "List[_6869.ConceptGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConceptGearMeshLoadCase]
