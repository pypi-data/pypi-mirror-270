...
class ZerolBevelGearSetLoadCase(_6856.BevelGearSetLoadCase):
    """ZerolBevelGearSetLoadCase
    ...
    @property
    def bevel_gears_load_case(self: Self) -> "List[_7012.ZerolBevelGearLoadCase]":
    ...
    @property
    def zerol_bevel_gears_load_case(self: Self) -> "List[_7012.ZerolBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ZerolBevelGearLoadCase]
    ...
    @property
    def bevel_meshes_load_case(self: Self) -> "List[_7013.ZerolBevelGearMeshLoadCase]":
    ...
    def zerol_bevel_meshes_load_case(
        self: Self,
    ) -> "List[_7013.ZerolBevelGearMeshLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ZerolBevelGearMeshLoadCase]
