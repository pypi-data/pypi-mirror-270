...
class StraightBevelGearSetLoadCase(_6856.BevelGearSetLoadCase):
    """StraightBevelGearSetLoadCase
    ...
    @property
    def bevel_gears_load_case(self: Self) -> "List[_6989.StraightBevelGearLoadCase]":
    ...
    def straight_bevel_gears_load_case(
        self: Self,
    ) -> "List[_6989.StraightBevelGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.StraightBevelGearLoadCase]
    ...
    def bevel_meshes_load_case(
        self: Self,
    ) -> "List[_6990.StraightBevelGearMeshLoadCase]":
