...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results import _2662, _2643, _2673
...
class TimeSeriesLoadCase(_6830.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    def multibody_dynamics_analysis(self: Self) -> "_2662.MultibodyDynamicsAnalysis":
    ...
    @property
    def driva_analysis_options(self: Self) -> "_5485.MBDAnalysisOptions":
    ...
    @property
    def time_series_load_case_group(self: Self) -> "_5697.TimeSeriesLoadCaseGroup":
    ...
    def duplicate(
        self: Self,
        new_load_case_group: "_5697.TimeSeriesLoadCaseGroup",
        name: "str" = "None",
    ) -> "TimeSeriesLoadCase":
