...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6881, _6876
...
class BeltConnectionLoadCase(_6938.InterMountableComponentConnectionLoadCase):
    """BeltConnectionLoadCase
