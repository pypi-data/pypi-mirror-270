...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5792, _5796
    from mastapy.system_model.analyses_and_results.load_case_groups import (
        _5687,
        _5688,
        _5689,
    )
    from mastapy.system_model.analyses_and_results.static_loads import _6844, _6838
...
class StaticLoadCase(_6830.LoadCase):
    """StaticLoadCase
    ...
    class _Cast_StaticLoadCase:
        ...
        @property
        def load_case(self: "StaticLoadCase._Cast_StaticLoadCase") -> "_6830.LoadCase":
            return self._parent._cast(_6830.LoadCase)

        @property
        def context(self: "StaticLoadCase._Cast_StaticLoadCase") -> "_2673.Context":
    ...
    @property
    def system_deflection(self: Self) -> "_2669.SystemDeflectionAnalysis":
    ...
    @property
    def power_flow(self: Self) -> "_2664.PowerFlowAnalysis":
    ...
    @property
    def harmonic_analysis(self: Self) -> "_2655.HarmonicAnalysis":
    ...
    @property
    def parametric_study_tool(self: Self) -> "_2663.ParametricStudyToolAnalysis":
    ...
    @property
    def modal_analysis(self: Self) -> "_2658.ModalAnalysis":
    ...
    @property
    def critical_speed_analysis(self: Self) -> "_2648.CriticalSpeedAnalysis":
    ...
    @property
    def stability_analysis(self: Self) -> "_2665.StabilityAnalysis":
    ...
    def planetary_rating_load_sharing_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._348", "PlanetaryRatingLoadSharingOption"
        )(value)

    @planetary_rating_load_sharing_method.setter
    @enforce_parameter_types
    def planetary_rating_load_sharing_method(
        self: Self, value: "_348.PlanetaryRatingLoadSharingOption"
    ):
    ...
    def unbalanced_mass_inclusion(
        self: Self,
        value: "Union[_2496.UnbalancedMassInclusionOption, Tuple[_2496.UnbalancedMassInclusionOption, bool]]",
    ):
        wrapper_type = (
    ...
    @property
    def clutch_engagements(self: Self) -> "List[_5687.ClutchEngagementStatus]":
    ...
    def concept_clutch_engagements(
        self: Self,
    ) -> "List[_5688.ConceptSynchroGearEngagementStatus]":
    ...
    @property
    def design_state_load_case_group(self: Self) -> "_5689.DesignState":
    ...
    @enforce_parameter_types
    def duplicate(
        self: Self, new_design_state_group: "_5689.DesignState", name: "str" = "None"
    ) -> "StaticLoadCase":
