...
class WindTurbineCertificationReport(_6294.CombinationAnalysis):
    """WindTurbineCertificationReport
    ...
    @property
    def design(self: Self) -> "_2492.RootAssembly":
    ...
    @property
    def ldd_static_analysis(self: Self) -> "_2969.RootAssemblyCompoundSystemDeflection":
