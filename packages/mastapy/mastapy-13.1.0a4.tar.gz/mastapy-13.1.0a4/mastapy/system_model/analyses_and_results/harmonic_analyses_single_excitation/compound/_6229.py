...
class HypoidGearSetCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6099.HypoidGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def hypoid_gears_compound_harmonic_analysis_of_single_excitation(
        self: Self,
    ) -> "List[_6227.HypoidGearCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def hypoid_meshes_compound_harmonic_analysis_of_single_excitation(
        self: Self,
    ) -> "List[_6228.HypoidGearMeshCompoundHarmonicAnalysisOfSingleExcitation]":
