...
class SpiralBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6137.SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def spiral_bevel_gears_compound_harmonic_analysis_of_single_excitation(
        self: Self,
    ) -> "List[_6264.SpiralBevelGearCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def spiral_bevel_meshes_compound_harmonic_analysis_of_single_excitation(
        self: Self,
    ) -> "List[_6265.SpiralBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation]":
