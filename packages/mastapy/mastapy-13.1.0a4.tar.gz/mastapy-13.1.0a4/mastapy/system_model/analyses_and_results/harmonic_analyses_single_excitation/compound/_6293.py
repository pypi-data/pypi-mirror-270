...
class ZerolBevelGearSetCompoundHarmonicAnalysisOfSingleExcitation(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6164.ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def zerol_bevel_gears_compound_harmonic_analysis_of_single_excitation(
        self: Self,
    ) -> "List[_6291.ZerolBevelGearCompoundHarmonicAnalysisOfSingleExcitation]":
    ...
    def zerol_bevel_meshes_compound_harmonic_analysis_of_single_excitation(
        self: Self,
    ) -> "List[_6292.ZerolBevelGearMeshCompoundHarmonicAnalysisOfSingleExcitation]":
