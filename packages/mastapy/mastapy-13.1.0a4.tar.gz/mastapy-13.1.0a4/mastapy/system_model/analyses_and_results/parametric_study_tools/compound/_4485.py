...
class BoltCompoundParametricStudyTool(_4491.ComponentCompoundParametricStudyTool):
    """BoltCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6858.BoltLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4339.BoltParametricStudyTool]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4339.BoltParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.BoltParametricStudyTool]
