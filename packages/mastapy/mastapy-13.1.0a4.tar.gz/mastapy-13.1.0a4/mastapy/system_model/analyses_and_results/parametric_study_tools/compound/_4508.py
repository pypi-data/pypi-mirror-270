...
class CVTPulleyCompoundParametricStudyTool(_4554.PulleyCompoundParametricStudyTool):
    """CVTPulleyCompoundParametricStudyTool
    ...
    @property
    def properties_changing_all_load_cases(self: Self) -> "_6883.CVTPulleyLoadCase":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4361.CVTPulleyParametricStudyTool]":
