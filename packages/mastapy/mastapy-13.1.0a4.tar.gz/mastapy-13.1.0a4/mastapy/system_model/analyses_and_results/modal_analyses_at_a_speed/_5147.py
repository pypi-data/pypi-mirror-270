...
class AssemblyModalAnalysisAtASpeed(_5140.AbstractAssemblyModalAnalysisAtASpeed):
    """AssemblyModalAnalysisAtASpeed
    ...
    @property
    def bearings(self: Self) -> "List[_5148.BearingModalAnalysisAtASpeed]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_5150.BeltDriveModalAnalysisAtASpeed]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_5159.BoltedJointModalAnalysisAtASpeed]":
    ...
    @property
    def bolts(self: Self) -> "List[_5160.BoltModalAnalysisAtASpeed]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5181.CVTModalAnalysisAtASpeed]":
    ...
    @property
    def clutches(self: Self) -> "List[_5163.ClutchModalAnalysisAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5183.CycloidalAssemblyModalAnalysisAtASpeed]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_5185.CycloidalDiscModalAnalysisAtASpeed]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5196.FEPartModalAnalysisAtASpeed]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_5195.FaceGearSetModalAnalysisAtASpeed]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5197.FlexiblePinAssemblyModalAnalysisAtASpeed]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_5204.HypoidGearSetModalAnalysisAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_5211.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtASpeed]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_5215.MassDiscModalAnalysisAtASpeed]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5219.OilSealModalAnalysisAtASpeed]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_5226.PlanetCarrierModalAnalysisAtASpeed]":
    ...
    @property
    def point_loads(self: Self) -> "List[_5227.PointLoadModalAnalysisAtASpeed]":
    ...
    @property
    def power_loads(self: Self) -> "List[_5228.PowerLoadModalAnalysisAtASpeed]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_5230.RingPinsModalAnalysisAtASpeed]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5232.RollingRingAssemblyModalAnalysisAtASpeed]":
    ...
    @property
    def shafts(self: Self) -> "List[_5237.ShaftModalAnalysisAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5242.SpiralBevelGearSetModalAnalysisAtASpeed]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_5245.SpringDamperModalAnalysisAtASpeed]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_5248.StraightBevelDiffGearSetModalAnalysisAtASpeed]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_5255.SynchroniserModalAnalysisAtASpeed]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_5262.UnbalancedMassModalAnalysisAtASpeed]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_5266.WormGearSetModalAnalysisAtASpeed]":
