...
class WormGearSetModalAnalysisAtASpeed(_5200.GearSetModalAnalysisAtASpeed):
    """WormGearSetModalAnalysisAtASpeed
    ...
    def gears_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5265.WormGearModalAnalysisAtASpeed]":
    ...
    def meshes_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5264.WormGearMeshModalAnalysisAtASpeed]":
