...
from mastapy.system_model.analyses_and_results.modal_analyses.reporting import _4742
...
class SingleExcitationResultsModalAnalysis(_4742.DesignEntityModalAnalysisGroupResults):
    """SingleExcitationResultsModalAnalysis
    ...
    class _Cast_SingleExcitationResultsModalAnalysis:
        ...
        def design_entity_modal_analysis_group_results(
            ...
            return self._parent._cast(_4742.DesignEntityModalAnalysisGroupResults)
    ...
    def all_rigidly_connected_groups(
        ...
        "List[_4745.RigidlyConnectedDesignEntityGroupForSingleExcitationModalAnalysis]"
    ):
