...
class ClutchCompoundModalAnalysis(_4788.CouplingCompoundModalAnalysis):
    """ClutchCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4618.ClutchModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4618.ClutchModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ClutchModalAnalysis]
