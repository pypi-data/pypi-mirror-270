...
class DatumCompoundModalAnalysis(_4776.ComponentCompoundModalAnalysis):
    """DatumCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4647.DatumModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4647.DatumModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.DatumModalAnalysis]
