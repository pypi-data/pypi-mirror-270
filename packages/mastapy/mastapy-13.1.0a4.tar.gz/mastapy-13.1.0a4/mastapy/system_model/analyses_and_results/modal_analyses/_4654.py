...
class FaceGearSetModalAnalysis(_4660.GearSetModalAnalysis):
    """FaceGearSetModalAnalysis
    ...
    @property
    def gears_modal_analysis(self: Self) -> "List[_4653.FaceGearModalAnalysis]":
    ...
    @property
    def face_gears_modal_analysis(self: Self) -> "List[_4653.FaceGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearModalAnalysis]
    ...
    @property
    def meshes_modal_analysis(self: Self) -> "List[_4652.FaceGearMeshModalAnalysis]":
