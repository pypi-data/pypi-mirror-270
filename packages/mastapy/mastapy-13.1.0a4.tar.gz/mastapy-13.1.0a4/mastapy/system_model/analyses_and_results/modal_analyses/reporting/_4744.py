...
class PerModeResultsReport(_1769.CustomReportChart):
    """PerModeResultsReport
    ...
    @property
    def display_option(self: Self) -> "_1835.TableAndChartOptions":
    ...
    def display_option(self: Self, value: "_1835.TableAndChartOptions"):
