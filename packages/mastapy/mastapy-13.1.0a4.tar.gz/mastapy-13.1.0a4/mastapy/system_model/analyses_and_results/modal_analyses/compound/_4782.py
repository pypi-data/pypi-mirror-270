...
class ConceptGearSetCompoundModalAnalysis(_4811.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4626.ConceptGearSetModalAnalysis]":
    ...
    def concept_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4780.ConceptGearCompoundModalAnalysis]":
    ...
    def concept_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4781.ConceptGearMeshCompoundModalAnalysis]":
