...
class BoltedJointCompoundModalAnalysis(_4849.SpecialisedAssemblyCompoundModalAnalysis):
    """BoltedJointCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4614.BoltedJointModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4614.BoltedJointModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.BoltedJointModalAnalysis]
