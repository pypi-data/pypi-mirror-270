...
if TYPE_CHECKING:
    from mastapy.utility.modal_analysis import _1811
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2675.DesignEntityGroupAnalysis):
    """RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    def excitation_frequencies_at_reference_speed(
        self: Self,
    ) -> "List[_1811.DesignEntityExcitationDescription]":
