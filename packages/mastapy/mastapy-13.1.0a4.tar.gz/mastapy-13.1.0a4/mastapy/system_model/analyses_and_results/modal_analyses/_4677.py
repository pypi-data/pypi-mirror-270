...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.modal_analyses import _4680, _4678
...
class ModalAnalysis(_7576.StaticLoadAnalysisCase):
    """ModalAnalysis
    ...
    class _Cast_ModalAnalysis:
        ...
        @property
        def context(self: "ModalAnalysis._Cast_ModalAnalysis") -> "_2673.Context":
            from mastapy.system_model.analyses_and_results import _2673
    ...
    @property
    def analysis_settings(self: Self) -> "_4680.ModalAnalysisOptions":
    ...
    @property
    def bar_model_export(self: Self) -> "_4678.ModalAnalysisBarModelFEExportOptions":
    ...
    @property
    def modal_analysis_results(self: Self) -> "_6355.DynamicAnalysis":
