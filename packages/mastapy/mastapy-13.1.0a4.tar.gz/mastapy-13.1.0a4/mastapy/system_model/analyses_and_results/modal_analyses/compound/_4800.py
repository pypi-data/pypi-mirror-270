...
class CylindricalGearSetCompoundModalAnalysis(_4811.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4645.CylindricalGearSetModalAnalysis]":
    ...
    def cylindrical_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4798.CylindricalGearCompoundModalAnalysis]":
    ...
    def cylindrical_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4799.CylindricalGearMeshCompoundModalAnalysis]":
