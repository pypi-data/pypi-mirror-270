...
class AssemblyCompoundModalAnalysis(_4751.AbstractAssemblyCompoundModalAnalysis):
    """AssemblyCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4602.AssemblyModalAnalysis]":
    ...
    @property
    def bearings(self: Self) -> "List[_4759.BearingCompoundModalAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4761.BeltDriveCompoundModalAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_4764.BevelDifferentialGearSetCompoundModalAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4771.BoltedJointCompoundModalAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_4770.BoltCompoundModalAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4792.CVTCompoundModalAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_4772.ClutchCompoundModalAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_4777.ConceptCouplingCompoundModalAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_4782.ConceptGearSetCompoundModalAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_4794.CycloidalAssemblyCompoundModalAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4796.CycloidalDiscCompoundModalAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_4800.CylindricalGearSetCompoundModalAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4807.FEPartCompoundModalAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4806.FaceGearSetCompoundModalAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_4808.FlexiblePinAssemblyCompoundModalAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_4815.HypoidGearSetCompoundModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_4822.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4825.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4826.MassDiscCompoundModalAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_4827.MeasurementComponentCompoundModalAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4829.OilSealCompoundModalAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_4831.PartToPartShearCouplingCompoundModalAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4836.PlanetCarrierCompoundModalAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4837.PointLoadCompoundModalAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4838.PowerLoadCompoundModalAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4840.RingPinsCompoundModalAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_4842.RollingRingAssemblyCompoundModalAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_4847.ShaftHubConnectionCompoundModalAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_4846.ShaftCompoundModalAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4852.SpiralBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4853.SpringDamperCompoundModalAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_4858.StraightBevelDiffGearSetCompoundModalAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4861.StraightBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4864.SynchroniserCompoundModalAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_4868.TorqueConverterCompoundModalAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_4872.UnbalancedMassCompoundModalAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4876.WormGearSetCompoundModalAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_4879.ZerolBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4602.AssemblyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.AssemblyModalAnalysis]
