...
class SpiralBevelGearSetCompoundModalAnalysis(_4769.BevelGearSetCompoundModalAnalysis):
    """SpiralBevelGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4708.SpiralBevelGearSetModalAnalysis]":
    ...
    def spiral_bevel_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4850.SpiralBevelGearCompoundModalAnalysis]":
    ...
    def spiral_bevel_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4851.SpiralBevelGearMeshCompoundModalAnalysis]":
