...
class AssemblyModalAnalysis(_4595.AbstractAssemblyModalAnalysis):
    """AssemblyModalAnalysis
    ...
    @property
    def bearings(self: Self) -> "List[_4603.BearingModalAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4605.BeltDriveModalAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4614.BoltedJointModalAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_4615.BoltModalAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4637.CVTModalAnalysis]":
    ...
    def calculate_full_fe_results_by_mode(
        self: Self,
    ) -> "List[_4739.CalculateFullFEResultsForMode]":
    ...
    @property
    def clutches(self: Self) -> "List[_4618.ClutchModalAnalysis]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_4623.ConceptCouplingModalAnalysis]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_4626.ConceptGearSetModalAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4641.CycloidalDiscModalAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4655.FEPartModalAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4654.FaceGearSetModalAnalysis]":
    ...
    def full_fe_meshes_for_calculating_modes(
        self: Self,
    ) -> "List[_4655.FEPartModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FEPartModalAnalysis]
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_4664.HypoidGearSetModalAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4675.MassDiscModalAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4683.OilSealModalAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4691.PlanetCarrierModalAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4692.PointLoadModalAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4693.PowerLoadModalAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4695.RingPinsModalAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_4702.ShaftModalAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4711.SpringDamperModalAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4717.StraightBevelGearSetModalAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4721.SynchroniserModalAnalysis]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_4725.TorqueConverterModalAnalysis]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_4728.UnbalancedMassModalAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4735.WormGearSetModalAnalysis]":
