...
class WormGearCompoundModalAnalysis(_4809.GearCompoundModalAnalysis):
    """WormGearCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4734.WormGearModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4734.WormGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.WormGearModalAnalysis]
