...
class FESubstructureWithSelectionForHarmonicAnalysis(_2408.FESubstructureWithSelection):
    """FESubstructureWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self: Self) -> "_193.FEModelHarmonicAnalysisDrawStyle":
