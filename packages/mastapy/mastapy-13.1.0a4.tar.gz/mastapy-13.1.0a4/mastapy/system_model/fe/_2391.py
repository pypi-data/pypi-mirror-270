...
class ElectricMachineDataSet(_0.APIBase):
    ...
    @enforce_parameter_types
    def node_for_first_tooth(self: Self, value: "_2403.FESubstructureNode"):
        wrapper_type = (
    ...
    @property
    def torque_ripple_input_type(self: Self) -> "_7003.TorqueRippleInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads._7003",
            "TorqueRippleInputType",
        )(value)

    @torque_ripple_input_type.setter
    @enforce_parameter_types
    def torque_ripple_input_type(self: Self, value: "_7003.TorqueRippleInputType"):
    ...
    def multiple_fourier_series_interpolator_for(
        self: Self, harmonic_load_data_type: "_1394.HarmonicLoadDataType"
