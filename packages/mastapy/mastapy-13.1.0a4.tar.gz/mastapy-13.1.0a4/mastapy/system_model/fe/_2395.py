...
if TYPE_CHECKING:
    from mastapy.system_model.fe import _2393, _2419
...
class FEEntityGroupWithSelection(_0.APIBase, Generic[TGroup, TGroupContents]):
    ...
    class _Cast_FEEntityGroupWithSelection:
        ...
        def element_face_group_with_selection(
            ...
            return self._parent._cast(_2393.ElementFaceGroupWithSelection)

        @property
        def node_group_with_selection(
            self: "FEEntityGroupWithSelection._Cast_FEEntityGroupWithSelection",
        ) -> "_2419.NodeGroupWithSelection":
            from mastapy.system_model.fe import _2419

            return self._parent._cast(_2419.NodeGroupWithSelection)
