...
if TYPE_CHECKING:
    from mastapy.system_model.fe.links import _2443, _2436
...
class GearMeshFELink(_2441.MultiAngleConnectionFELink):
    """GearMeshFELink
    ...
    class _Cast_GearMeshFELink:
        ...
        @property
        def fe_link(self: "GearMeshFELink._Cast_GearMeshFELink") -> "_2436.FELink":
    ...
    def reference_fe_substructure_node_for_misalignments(
        self: Self, value: "_2403.FESubstructureNode"
    ):
        wrapper_type = (
