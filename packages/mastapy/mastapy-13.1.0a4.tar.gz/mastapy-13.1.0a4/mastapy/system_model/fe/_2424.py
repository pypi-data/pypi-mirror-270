...
if TYPE_CHECKING:
    from mastapy.system_model.fe import _2375, _2382
...
class RaceBearingFE(_0.APIBase):
    ...
    @property
    def alignment_method(self: Self) -> "_2375.AlignmentMethodForRaceBearing":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2375", "AlignmentMethodForRaceBearing"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(self: Self, value: "_2375.AlignmentMethodForRaceBearing"):
    ...
    @property
    def links(self: Self) -> "List[_2382.BearingRaceNodeLink]":
