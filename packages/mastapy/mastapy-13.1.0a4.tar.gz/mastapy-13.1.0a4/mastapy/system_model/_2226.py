...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1272, _1278, _1298
...
class ElectricMachineGroup(_0.APIBase):
    ...
    @property
    def electric_machine_details(self: Self) -> "List[_1272.ElectricMachineDetail]":
    ...
    def electric_machine_load_case_groups(
        self: Self,
    ) -> "List[_1372.ElectricMachineLoadCaseGroup]":
    ...
    def add_electric_machine_detail(
        self: Self, type_: "_1278.ElectricMachineType", name: "str" = "Motor"
    ...
    def duplicate_electric_machine_detail(
        self: Self, detail: "_1272.ElectricMachineDetail"
    ...
    def remove_electric_machine_detail(
        self: Self, motor: "_1272.ElectricMachineDetail"
    ) -> "bool":
        """bool
    ...
    def try_remove_load_case_group(
        self: Self, load_case_group: "_1372.ElectricMachineLoadCaseGroup"
    ) -> "bool":
        """bool
