...
from mastapy.utility.enums import _1837, _1838
...
class PartAnalysisCaseWithContourViewable(_0.APIBase):
    ...
    class _Cast_PartAnalysisCaseWithContourViewable:
        ...
        def abstract_system_deflection_viewable(
            ...
            return self._parent._cast(_2261.AbstractSystemDeflectionViewable)
        ...
        def harmonic_analysis_viewable(
            ...
            return self._parent._cast(_2267.HarmonicAnalysisViewable)
        ...
        def modal_analysis_viewable(
            ...
            return self._parent._cast(_2269.ModalAnalysisViewable)
    ...
    def contour(self: Self, value: "_1837.ThreeDViewContourOptionFirstSelection"):
    ...
    @enforce_parameter_types
    def contour_secondary(
        self: Self, value: "_1838.ThreeDViewContourOptionSecondSelection"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
