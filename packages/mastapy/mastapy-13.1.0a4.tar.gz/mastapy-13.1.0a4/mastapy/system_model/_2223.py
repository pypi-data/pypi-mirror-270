...
class DesignSettings(_0.APIBase, _1598.IHaveAllSettings):
    """DesignSettings
    ...
    @property
    def bearing_settings(self: Self) -> "_1898.BearingSettingsItem":
    ...
    @property
    def design_constraints_settings(self: Self) -> "_954.DesignConstraintsCollection":
    ...
    @property
    def materials_settings(self: Self) -> "_280.MaterialsSettingsItem":
