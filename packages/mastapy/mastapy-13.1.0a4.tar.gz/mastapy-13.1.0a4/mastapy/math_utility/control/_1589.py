...
class PIDControlSettings(_0.APIBase):
    ...
    @property
    def integral_gain_vs_time_and_error(self: Self) -> "_1577.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @property
    def update_method(self: Self) -> "_1535.PIDControlUpdateMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility._1535", "PIDControlUpdateMethod"
        )(value)

    @update_method.setter
    @enforce_parameter_types
    def update_method(self: Self, value: "_1535.PIDControlUpdateMethod"):
