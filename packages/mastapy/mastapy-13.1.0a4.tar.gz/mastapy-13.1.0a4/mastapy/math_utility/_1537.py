...
if TYPE_CHECKING:
    from mastapy.math_utility import _1521, _1536, _1538, _1543, _1548
...
class RealMatrix(_1526.GenericMatrix[float, "RealMatrix"]):
    """RealMatrix
    ...
    class _Cast_RealMatrix:
        ...
        @property
        def quaternion(self: "RealMatrix._Cast_RealMatrix") -> "_1536.Quaternion":
            from mastapy.math_utility import _1536

            return self._parent._cast(_1536.Quaternion)

        @property
        def real_vector(self: "RealMatrix._Cast_RealMatrix") -> "_1538.RealVector":
            from mastapy.math_utility import _1538

            return self._parent._cast(_1538.RealVector)

        @property
        def square_matrix(self: "RealMatrix._Cast_RealMatrix") -> "_1543.SquareMatrix":
            from mastapy.math_utility import _1543

            return self._parent._cast(_1543.SquareMatrix)

        @property
        def vector_6d(self: "RealMatrix._Cast_RealMatrix") -> "_1548.Vector6D":
