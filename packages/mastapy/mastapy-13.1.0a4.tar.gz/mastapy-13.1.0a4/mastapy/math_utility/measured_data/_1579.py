...
class OnedimensionalFunctionLookupTable(
    _1578.LookupTableBase["OnedimensionalFunctionLookupTable"]
):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: Self) -> "_1547.Vector2DListAccessor":
    ...
    def lookup_table(self: Self, value: "_1547.Vector2DListAccessor"):
