...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.optimisation import _1570, _1569, _1559, _1560, _1565
...
class ParetoOptimisationVariableBase(_0.APIBase):
    ...
    class _Cast_ParetoOptimisationVariableBase:
        ...
        def pareto_optimisation_input(
            ...
            return self._parent._cast(_1559.ParetoOptimisationInput)
        ...
        def pareto_optimisation_output(
            ...
            return self._parent._cast(_1560.ParetoOptimisationOutput)
        ...
        def pareto_optimisation_variable(
            ...
            return self._parent._cast(_1565.ParetoOptimisationVariable)
        ...
        def parametric_study_doe_result_variable(
            ...
            return self._parent._cast(_4407.ParametricStudyDOEResultVariable)
    ...
    @property
    def integer_range(self: Self) -> "_1601.IntegerRange":
    ...
    @enforce_parameter_types
    def integer_range(self: Self, value: "_1601.IntegerRange"):
    ...
    @property
    def range(self: Self) -> "_1501.Range":
    ...
    @range.setter
    @enforce_parameter_types
    def range(self: Self, value: "_1501.Range"):
        self.wrapped.Range = value.wrapped

    @property
    def specification_type(self: Self) -> "_1570.TargetingPropertyTo":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation._1570", "TargetingPropertyTo"
        )(value)

    @specification_type.setter
    @enforce_parameter_types
    def specification_type(self: Self, value: "_1570.TargetingPropertyTo"):
    ...
    @property
    def specify_input_range_as(self: Self) -> "_1569.SpecifyOptimisationInputAs":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation._1569", "SpecifyOptimisationInputAs"
        )(value)

    @specify_input_range_as.setter
    @enforce_parameter_types
    def specify_input_range_as(self: Self, value: "_1569.SpecifyOptimisationInputAs"):
        value = conversion.mp_to_pn_enum(
