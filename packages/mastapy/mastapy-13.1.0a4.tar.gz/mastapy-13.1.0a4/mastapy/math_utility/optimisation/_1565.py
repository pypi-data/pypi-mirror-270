...
if TYPE_CHECKING:
    from mastapy.math_utility.optimisation import _1567, _1559, _1560
...
class ParetoOptimisationVariable(_1566.ParetoOptimisationVariableBase):
    """ParetoOptimisationVariable
    ...
    def property_target_for_dominant_candidate_search(
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation._1567",
    ...
    def property_target_for_dominant_candidate_search(
        self: Self, value: "_1567.PropertyTargetForDominantCandidateSearch"
    ):
