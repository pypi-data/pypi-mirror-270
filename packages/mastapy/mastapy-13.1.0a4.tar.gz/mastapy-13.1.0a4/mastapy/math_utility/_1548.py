...
class Vector6D(_1538.RealVector):
    """Vector6D
    ...
    class _Cast_Vector6D:
        ...
        @property
        def real_vector(self: "Vector6D._Cast_Vector6D") -> "_1538.RealVector":
            return self._parent._cast(_1538.RealVector)

        @property
        def real_matrix(self: "Vector6D._Cast_Vector6D") -> "_1537.RealMatrix":
            from mastapy.math_utility import _1537

            return self._parent._cast(_1537.RealMatrix)

        @property
        def generic_matrix(self: "Vector6D._Cast_Vector6D") -> "_1526.GenericMatrix":
