...
if TYPE_CHECKING:
    from mastapy.math_utility.measured_vectors import _1576, _1572, _1573
...
class AbstractForceAndDisplacementResults(_0.APIBase):
    ...
    class _Cast_AbstractForceAndDisplacementResults:
        ...
        def force_and_displacement_results(
            ...
            return self._parent._cast(_1572.ForceAndDisplacementResults)
        ...
        def force_results(
            ...
            return self._parent._cast(_1573.ForceResults)
    ...
    @property
    def force(self: Self) -> "_1576.VectorWithLinearAndAngularComponents":
