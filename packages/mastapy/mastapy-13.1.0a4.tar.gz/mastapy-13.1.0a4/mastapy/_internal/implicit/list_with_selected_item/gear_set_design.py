...
class ListWithSelectedItem_GearSetDesign(
    _958.GearSetDesign, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_958.GearSetDesign.TYPE":
        ...
        return _958.GearSetDesign.TYPE

    @property
    def selected_value(self: Self) -> "_958.GearSetDesign":
    ...
    @property
    def available_values(self: Self) -> "List[_958.GearSetDesign]":
