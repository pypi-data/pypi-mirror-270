...
class ListWithSelectedItem_GearMeshSystemDeflection(
    _2782.GearMeshSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2782.GearMeshSystemDeflection.TYPE":
        ...
        return _2782.GearMeshSystemDeflection.TYPE

    @property
    def selected_value(self: Self) -> "_2782.GearMeshSystemDeflection":
    ...
    @property
    def available_values(self: Self) -> "List[_2782.GearMeshSystemDeflection]":
