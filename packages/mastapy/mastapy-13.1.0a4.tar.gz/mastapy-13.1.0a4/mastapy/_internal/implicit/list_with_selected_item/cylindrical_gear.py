...
class ListWithSelectedItem_CylindricalGear(
    _2543.CylindricalGear, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2543.CylindricalGear.TYPE":
        ...
        return _2543.CylindricalGear.TYPE

    @property
    def selected_value(self: Self) -> "_2543.CylindricalGear":
    ...
    @property
    def available_values(self: Self) -> "List[_2543.CylindricalGear]":
