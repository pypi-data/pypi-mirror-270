...
class ListWithSelectedItem_MeasurementBase(
    _1618.MeasurementBase, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1618.MeasurementBase.TYPE":
        ...
        return _1618.MeasurementBase.TYPE

    @property
    def selected_value(self: Self) -> "_1618.MeasurementBase":
    ...
    @property
    def available_values(self: Self) -> "List[_1618.MeasurementBase]":
