...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5877
...
class ListWithSelectedItem_ResultLocationSelectionGroup(
    _5877.ResultLocationSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5877.ResultLocationSelectionGroup.TYPE":
        ...
        return _5877.ResultLocationSelectionGroup.TYPE

    @property
    def selected_value(self: Self) -> "_5877.ResultLocationSelectionGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_5877.ResultLocationSelectionGroup]":
