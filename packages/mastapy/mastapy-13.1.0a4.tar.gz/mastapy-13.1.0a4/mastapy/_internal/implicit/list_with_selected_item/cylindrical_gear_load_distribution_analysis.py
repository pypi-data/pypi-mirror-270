...
class ListWithSelectedItem_CylindricalGearLoadDistributionAnalysis(
    _863.CylindricalGearLoadDistributionAnalysis, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_863.CylindricalGearLoadDistributionAnalysis.TYPE":
        ...
        return _863.CylindricalGearLoadDistributionAnalysis.TYPE

    @property
    def selected_value(self: Self) -> "_863.CylindricalGearLoadDistributionAnalysis":
    ...
    def available_values(
        self: Self,
    ) -> "List[_863.CylindricalGearLoadDistributionAnalysis]":
