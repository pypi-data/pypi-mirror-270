...
class ListWithSelectedItem_AbstractPeriodicExcitationDetail(
    _5705.AbstractPeriodicExcitationDetail, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5705.AbstractPeriodicExcitationDetail.TYPE":
        ...
        return _5705.AbstractPeriodicExcitationDetail.TYPE

    @property
    def selected_value(self: Self) -> "_5705.AbstractPeriodicExcitationDetail":
    ...
    @property
    def available_values(self: Self) -> "List[_5705.AbstractPeriodicExcitationDetail]":
