...
class ListWithSelectedItem_SystemDirectory(
    _1613.SystemDirectory, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1613.SystemDirectory.TYPE":
        ...
        return _1613.SystemDirectory.TYPE

    @property
    def selected_value(self: Self) -> "_1613.SystemDirectory":
    ...
    @property
    def available_values(self: Self) -> "List[_1613.SystemDirectory]":
