...
class ListWithSelectedItem_CylindricalSetManufacturingConfig(
    _632.CylindricalSetManufacturingConfig, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_632.CylindricalSetManufacturingConfig.TYPE":
        ...
        return _632.CylindricalSetManufacturingConfig.TYPE

    @property
    def selected_value(self: Self) -> "_632.CylindricalSetManufacturingConfig":
    ...
    @property
    def available_values(self: Self) -> "List[_632.CylindricalSetManufacturingConfig]":
