...
class ListWithSelectedItem_CylindricalGearSystemDeflection(
    _2768.CylindricalGearSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2768.CylindricalGearSystemDeflection.TYPE":
        ...
        return _2768.CylindricalGearSystemDeflection.TYPE

    @property
    def selected_value(self: Self) -> "_2768.CylindricalGearSystemDeflection":
    ...
    @property
    def available_values(self: Self) -> "List[_2768.CylindricalGearSystemDeflection]":
