...
class ListWithSelectedItem_FEPart(_2471.FEPart, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2471.FEPart.TYPE":
        ...
        return _2471.FEPart.TYPE

    @property
    def selected_value(self: Self) -> "_2471.FEPart":
    ...
    @property
    def available_values(self: Self) -> "List[_2471.FEPart]":
