...
class ListWithSelectedItem_DutyCycle(_5690.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_5690.DutyCycle.TYPE":
        ...
        return _5690.DutyCycle.TYPE

    @property
    def selected_value(self: Self) -> "_5690.DutyCycle":
    ...
    @property
    def available_values(self: Self) -> "List[_5690.DutyCycle]":
