...
class ListWithSelectedItem_GuideDxfModel(
    _2473.GuideDxfModel, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2473.GuideDxfModel.TYPE":
        ...
        return _2473.GuideDxfModel.TYPE

    @property
    def selected_value(self: Self) -> "_2473.GuideDxfModel":
    ...
    @property
    def available_values(self: Self) -> "List[_2473.GuideDxfModel]":
