...
class ListWithSelectedItem_DesignState(
    _5689.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5689.DesignState.TYPE":
        ...
        return _5689.DesignState.TYPE

    @property
    def selected_value(self: Self) -> "_5689.DesignState":
    ...
    @property
    def available_values(self: Self) -> "List[_5689.DesignState]":
