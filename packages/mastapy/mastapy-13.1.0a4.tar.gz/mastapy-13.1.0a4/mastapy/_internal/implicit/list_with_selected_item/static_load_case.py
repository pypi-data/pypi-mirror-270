...
class ListWithSelectedItem_StaticLoadCase(
    _6831.StaticLoadCase, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_6831.StaticLoadCase.TYPE":
        ...
        return _6831.StaticLoadCase.TYPE

    @property
    def selected_value(self: Self) -> "_6831.StaticLoadCase":
    ...
    @property
    def available_values(self: Self) -> "List[_6831.StaticLoadCase]":
