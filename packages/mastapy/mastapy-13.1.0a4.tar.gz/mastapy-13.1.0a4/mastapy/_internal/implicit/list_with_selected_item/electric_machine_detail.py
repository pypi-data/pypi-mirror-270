...
class ListWithSelectedItem_ElectricMachineDetail(
    _1272.ElectricMachineDetail, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1272.ElectricMachineDetail.TYPE":
        ...
        return _1272.ElectricMachineDetail.TYPE

    @property
    def selected_value(self: Self) -> "_1272.ElectricMachineDetail":
    ...
    @property
    def available_values(self: Self) -> "List[_1272.ElectricMachineDetail]":
