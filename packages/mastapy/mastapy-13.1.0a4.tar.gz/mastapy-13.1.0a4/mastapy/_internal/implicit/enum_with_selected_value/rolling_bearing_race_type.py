...
class EnumWithSelectedValue_RollingBearingRaceType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1912.RollingBearingRaceType":
        ...
        return _1912.RollingBearingRaceType

    @classmethod
    def implicit_type(cls) -> "_1912.RollingBearingRaceType.type_()":
        ...
        return _1912.RollingBearingRaceType.type_()

    @property
    def selected_value(self: Self) -> "_1912.RollingBearingRaceType":
    ...
    @property
    def available_values(self: Self) -> "List[_1912.RollingBearingRaceType]":
