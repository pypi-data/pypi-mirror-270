...
class EnumWithSelectedValue_RaceRadialMountingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1982.RaceRadialMountingType":
        ...
        return _1982.RaceRadialMountingType

    @classmethod
    def implicit_type(cls) -> "_1982.RaceRadialMountingType.type_()":
        ...
        return _1982.RaceRadialMountingType.type_()

    @property
    def selected_value(self: Self) -> "_1982.RaceRadialMountingType":
    ...
    @property
    def available_values(self: Self) -> "List[_1982.RaceRadialMountingType]":
