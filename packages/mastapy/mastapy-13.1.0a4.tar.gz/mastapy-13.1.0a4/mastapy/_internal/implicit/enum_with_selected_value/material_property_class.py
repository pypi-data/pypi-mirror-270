...
from mastapy.fe_tools.enums import _1252
...
class EnumWithSelectedValue_MaterialPropertyClass(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1252.MaterialPropertyClass":
        ...
        return _1252.MaterialPropertyClass

    @classmethod
    def implicit_type(cls) -> "_1252.MaterialPropertyClass.type_()":
        ...
        return _1252.MaterialPropertyClass.type_()

    @property
    def selected_value(self: Self) -> "_1252.MaterialPropertyClass":
    ...
    @property
    def available_values(self: Self) -> "List[_1252.MaterialPropertyClass]":
