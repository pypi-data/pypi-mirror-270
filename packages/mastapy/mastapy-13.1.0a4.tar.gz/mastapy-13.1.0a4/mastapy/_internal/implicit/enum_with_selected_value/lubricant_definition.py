...
class EnumWithSelectedValue_LubricantDefinition(
    ...
    @classmethod
    def wrapped_type(cls) -> "_268.LubricantDefinition":
        ...
        return _268.LubricantDefinition

    @classmethod
    def implicit_type(cls) -> "_268.LubricantDefinition.type_()":
        ...
        return _268.LubricantDefinition.type_()

    @property
    def selected_value(self: Self) -> "_268.LubricantDefinition":
    ...
    @property
    def available_values(self: Self) -> "List[_268.LubricantDefinition]":
