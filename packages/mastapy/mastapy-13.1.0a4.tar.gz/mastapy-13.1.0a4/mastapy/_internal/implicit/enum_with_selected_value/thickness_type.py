...
class EnumWithSelectedValue_ThicknessType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1089.ThicknessType":
        ...
        return _1089.ThicknessType

    @classmethod
    def implicit_type(cls) -> "_1089.ThicknessType.type_()":
        ...
        return _1089.ThicknessType.type_()

    @property
    def selected_value(self: Self) -> "_1089.ThicknessType":
    ...
    @property
    def available_values(self: Self) -> "List[_1089.ThicknessType]":
