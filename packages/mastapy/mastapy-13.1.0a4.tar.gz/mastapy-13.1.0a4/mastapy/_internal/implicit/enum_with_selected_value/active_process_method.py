...
class EnumWithSelectedValue_ActiveProcessMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_665.ActiveProcessMethod":
        ...
        return _665.ActiveProcessMethod

    @classmethod
    def implicit_type(cls) -> "_665.ActiveProcessMethod.type_()":
        ...
        return _665.ActiveProcessMethod.type_()

    @property
    def selected_value(self: Self) -> "_665.ActiveProcessMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_665.ActiveProcessMethod]":
