...
class EnumWithSelectedValue_LubricationMethods(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_342.LubricationMethods":
        ...
        return _342.LubricationMethods

    @classmethod
    def implicit_type(cls) -> "_342.LubricationMethods.type_()":
        ...
        return _342.LubricationMethods.type_()

    @property
    def selected_value(self: Self) -> "_342.LubricationMethods":
    ...
    @property
    def available_values(self: Self) -> "List[_342.LubricationMethods]":
