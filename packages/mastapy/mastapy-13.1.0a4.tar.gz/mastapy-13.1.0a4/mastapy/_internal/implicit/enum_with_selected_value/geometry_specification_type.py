...
class EnumWithSelectedValue_GeometrySpecificationType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1058.GeometrySpecificationType":
        ...
        return _1058.GeometrySpecificationType

    @classmethod
    def implicit_type(cls) -> "_1058.GeometrySpecificationType.type_()":
        ...
        return _1058.GeometrySpecificationType.type_()

    @property
    def selected_value(self: Self) -> "_1058.GeometrySpecificationType":
    ...
    @property
    def available_values(self: Self) -> "List[_1058.GeometrySpecificationType]":
