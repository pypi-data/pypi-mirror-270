...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6924.HarmonicExcitationType":
        ...
        return _6924.HarmonicExcitationType

    @classmethod
    def implicit_type(cls) -> "_6924.HarmonicExcitationType.type_()":
        ...
        return _6924.HarmonicExcitationType.type_()

    @property
    def selected_value(self: Self) -> "_6924.HarmonicExcitationType":
    ...
    @property
    def available_values(self: Self) -> "List[_6924.HarmonicExcitationType]":
