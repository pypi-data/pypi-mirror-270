...
class EnumWithSelectedValue_TorqueSpecificationForSystemDeflection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_7004.TorqueSpecificationForSystemDeflection":
        ...
        return _7004.TorqueSpecificationForSystemDeflection

    @classmethod
    def implicit_type(cls) -> "_7004.TorqueSpecificationForSystemDeflection.type_()":
        ...
        return _7004.TorqueSpecificationForSystemDeflection.type_()

    @property
    def selected_value(self: Self) -> "_7004.TorqueSpecificationForSystemDeflection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_7004.TorqueSpecificationForSystemDeflection]":
