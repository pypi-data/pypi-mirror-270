...
class EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2170.FatigueLoadLimitCalculationMethodEnum":
        ...
        return _2170.FatigueLoadLimitCalculationMethodEnum

    @classmethod
    def implicit_type(cls) -> "_2170.FatigueLoadLimitCalculationMethodEnum.type_()":
        ...
        return _2170.FatigueLoadLimitCalculationMethodEnum.type_()

    @property
    def selected_value(self: Self) -> "_2170.FatigueLoadLimitCalculationMethodEnum":
    ...
    def available_values(
        self: Self,
    ) -> "List[_2170.FatigueLoadLimitCalculationMethodEnum]":
