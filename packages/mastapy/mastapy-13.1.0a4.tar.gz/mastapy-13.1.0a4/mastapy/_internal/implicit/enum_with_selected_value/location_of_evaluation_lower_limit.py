...
class EnumWithSelectedValue_LocationOfEvaluationLowerLimit(
    ...
    @classmethod
    def wrapped_type(cls) -> "_580.LocationOfEvaluationLowerLimit":
        ...
        return _580.LocationOfEvaluationLowerLimit

    @classmethod
    def implicit_type(cls) -> "_580.LocationOfEvaluationLowerLimit.type_()":
        ...
        return _580.LocationOfEvaluationLowerLimit.type_()

    @property
    def selected_value(self: Self) -> "_580.LocationOfEvaluationLowerLimit":
    ...
    @property
    def available_values(self: Self) -> "List[_580.LocationOfEvaluationLowerLimit]":
