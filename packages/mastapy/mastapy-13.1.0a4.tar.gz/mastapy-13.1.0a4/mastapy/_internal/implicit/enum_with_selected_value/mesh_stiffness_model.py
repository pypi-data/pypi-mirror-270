...
class EnumWithSelectedValue_MeshStiffnessModel(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2232.MeshStiffnessModel":
        ...
        return _2232.MeshStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_2232.MeshStiffnessModel.type_()":
        ...
        return _2232.MeshStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_2232.MeshStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_2232.MeshStiffnessModel]":
