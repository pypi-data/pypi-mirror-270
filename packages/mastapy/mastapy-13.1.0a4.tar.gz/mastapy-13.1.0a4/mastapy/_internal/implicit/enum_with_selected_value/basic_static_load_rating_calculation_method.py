...
class EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1888.BasicStaticLoadRatingCalculationMethod":
        ...
        return _1888.BasicStaticLoadRatingCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_1888.BasicStaticLoadRatingCalculationMethod.type_()":
        ...
        return _1888.BasicStaticLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1888.BasicStaticLoadRatingCalculationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1888.BasicStaticLoadRatingCalculationMethod]":
