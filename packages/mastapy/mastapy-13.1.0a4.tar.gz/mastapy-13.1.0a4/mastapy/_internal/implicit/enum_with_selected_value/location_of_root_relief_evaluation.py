...
class EnumWithSelectedValue_LocationOfRootReliefEvaluation(
    ...
    @classmethod
    def wrapped_type(cls) -> "_582.LocationOfRootReliefEvaluation":
        ...
        return _582.LocationOfRootReliefEvaluation

    @classmethod
    def implicit_type(cls) -> "_582.LocationOfRootReliefEvaluation.type_()":
        ...
        return _582.LocationOfRootReliefEvaluation.type_()

    @property
    def selected_value(self: Self) -> "_582.LocationOfRootReliefEvaluation":
    ...
    @property
    def available_values(self: Self) -> "List[_582.LocationOfRootReliefEvaluation]":
