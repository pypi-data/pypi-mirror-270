...
class EnumWithSelectedValue_ElmerResultType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_180.ElmerResultType":
        ...
        return _180.ElmerResultType

    @classmethod
    def implicit_type(cls) -> "_180.ElmerResultType.type_()":
        ...
        return _180.ElmerResultType.type_()

    @property
    def selected_value(self: Self) -> "_180.ElmerResultType":
    ...
    @property
    def available_values(self: Self) -> "List[_180.ElmerResultType]":
