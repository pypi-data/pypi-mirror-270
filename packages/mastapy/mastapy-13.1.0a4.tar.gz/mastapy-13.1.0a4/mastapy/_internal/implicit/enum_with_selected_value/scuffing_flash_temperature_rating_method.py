...
class EnumWithSelectedValue_ScuffingFlashTemperatureRatingMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_488.ScuffingFlashTemperatureRatingMethod":
        ...
        return _488.ScuffingFlashTemperatureRatingMethod

    @classmethod
    def implicit_type(cls) -> "_488.ScuffingFlashTemperatureRatingMethod.type_()":
        ...
        return _488.ScuffingFlashTemperatureRatingMethod.type_()

    @property
    def selected_value(self: Self) -> "_488.ScuffingFlashTemperatureRatingMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_488.ScuffingFlashTemperatureRatingMethod]":
