...
class EnumWithSelectedValue_BallBearingAnalysisMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1984.BallBearingAnalysisMethod":
        ...
        return _1984.BallBearingAnalysisMethod

    @classmethod
    def implicit_type(cls) -> "_1984.BallBearingAnalysisMethod.type_()":
        ...
        return _1984.BallBearingAnalysisMethod.type_()

    @property
    def selected_value(self: Self) -> "_1984.BallBearingAnalysisMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_1984.BallBearingAnalysisMethod]":
