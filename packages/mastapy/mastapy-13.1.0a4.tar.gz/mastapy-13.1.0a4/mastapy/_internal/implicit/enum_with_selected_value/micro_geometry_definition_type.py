...
class EnumWithSelectedValue_MicroGeometryDefinitionType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_653.MicroGeometryDefinitionType":
        ...
        return _653.MicroGeometryDefinitionType

    @classmethod
    def implicit_type(cls) -> "_653.MicroGeometryDefinitionType.type_()":
        ...
        return _653.MicroGeometryDefinitionType.type_()

    @property
    def selected_value(self: Self) -> "_653.MicroGeometryDefinitionType":
    ...
    @property
    def available_values(self: Self) -> "List[_653.MicroGeometryDefinitionType]":
