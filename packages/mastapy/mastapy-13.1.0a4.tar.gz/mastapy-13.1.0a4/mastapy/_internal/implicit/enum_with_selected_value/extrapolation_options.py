...
class EnumWithSelectedValue_ExtrapolationOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1522.ExtrapolationOptions":
        ...
        return _1522.ExtrapolationOptions

    @classmethod
    def implicit_type(cls) -> "_1522.ExtrapolationOptions.type_()":
        ...
        return _1522.ExtrapolationOptions.type_()

    @property
    def selected_value(self: Self) -> "_1522.ExtrapolationOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1522.ExtrapolationOptions]":
