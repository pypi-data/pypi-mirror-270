...
class EnumWithSelectedValue_RigidConnectorTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2615.RigidConnectorTypes":
        ...
        return _2615.RigidConnectorTypes

    @classmethod
    def implicit_type(cls) -> "_2615.RigidConnectorTypes.type_()":
        ...
        return _2615.RigidConnectorTypes.type_()

    @property
    def selected_value(self: Self) -> "_2615.RigidConnectorTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_2615.RigidConnectorTypes]":
