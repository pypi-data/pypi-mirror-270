...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2611.RigidConnectorStiffnessType":
        ...
        return _2611.RigidConnectorStiffnessType

    @classmethod
    def implicit_type(cls) -> "_2611.RigidConnectorStiffnessType.type_()":
        ...
        return _2611.RigidConnectorStiffnessType.type_()

    @property
    def selected_value(self: Self) -> "_2611.RigidConnectorStiffnessType":
    ...
    @property
    def available_values(self: Self) -> "List[_2611.RigidConnectorStiffnessType]":
