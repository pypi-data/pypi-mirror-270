...
class EnumWithSelectedValue_ThreeDViewContourOptionFirstSelection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1837.ThreeDViewContourOptionFirstSelection":
        ...
        return _1837.ThreeDViewContourOptionFirstSelection

    @classmethod
    def implicit_type(cls) -> "_1837.ThreeDViewContourOptionFirstSelection.type_()":
        ...
        return _1837.ThreeDViewContourOptionFirstSelection.type_()

    @property
    def selected_value(self: Self) -> "_1837.ThreeDViewContourOptionFirstSelection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1837.ThreeDViewContourOptionFirstSelection]":
