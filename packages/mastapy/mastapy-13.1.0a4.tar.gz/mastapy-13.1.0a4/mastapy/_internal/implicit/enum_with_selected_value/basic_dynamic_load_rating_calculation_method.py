...
class EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1887.BasicDynamicLoadRatingCalculationMethod":
        ...
        return _1887.BasicDynamicLoadRatingCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_1887.BasicDynamicLoadRatingCalculationMethod.type_()":
        ...
        return _1887.BasicDynamicLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1887.BasicDynamicLoadRatingCalculationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1887.BasicDynamicLoadRatingCalculationMethod]":
