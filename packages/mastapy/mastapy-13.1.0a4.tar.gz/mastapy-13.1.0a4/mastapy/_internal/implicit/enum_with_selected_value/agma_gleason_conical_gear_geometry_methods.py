...
class EnumWithSelectedValue_AGMAGleasonConicalGearGeometryMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1189.AGMAGleasonConicalGearGeometryMethods":
        ...
        return _1189.AGMAGleasonConicalGearGeometryMethods

    @classmethod
    def implicit_type(cls) -> "_1189.AGMAGleasonConicalGearGeometryMethods.type_()":
        ...
        return _1189.AGMAGleasonConicalGearGeometryMethods.type_()

    @property
    def selected_value(self: Self) -> "_1189.AGMAGleasonConicalGearGeometryMethods":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1189.AGMAGleasonConicalGearGeometryMethods]":
