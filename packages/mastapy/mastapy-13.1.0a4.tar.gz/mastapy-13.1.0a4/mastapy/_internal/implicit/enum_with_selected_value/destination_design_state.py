...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    @classmethod
    def wrapped_type(cls) -> "_7018.DestinationDesignState":
        ...
        return _7018.DestinationDesignState

    @classmethod
    def implicit_type(cls) -> "_7018.DestinationDesignState.type_()":
        ...
        return _7018.DestinationDesignState.type_()

    @property
    def selected_value(self: Self) -> "_7018.DestinationDesignState":
    ...
    @property
    def available_values(self: Self) -> "List[_7018.DestinationDesignState]":
