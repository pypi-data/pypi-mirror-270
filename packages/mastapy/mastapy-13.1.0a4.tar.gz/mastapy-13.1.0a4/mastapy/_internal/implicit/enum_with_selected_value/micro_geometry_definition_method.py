...
class EnumWithSelectedValue_MicroGeometryDefinitionMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_652.MicroGeometryDefinitionMethod":
        ...
        return _652.MicroGeometryDefinitionMethod

    @classmethod
    def implicit_type(cls) -> "_652.MicroGeometryDefinitionMethod.type_()":
        ...
        return _652.MicroGeometryDefinitionMethod.type_()

    @property
    def selected_value(self: Self) -> "_652.MicroGeometryDefinitionMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_652.MicroGeometryDefinitionMethod]":
