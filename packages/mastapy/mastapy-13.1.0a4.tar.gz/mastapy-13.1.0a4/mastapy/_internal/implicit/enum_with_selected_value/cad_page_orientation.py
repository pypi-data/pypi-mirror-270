...
class EnumWithSelectedValue_CadPageOrientation(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1758.CadPageOrientation":
        ...
        return _1758.CadPageOrientation

    @classmethod
    def implicit_type(cls) -> "_1758.CadPageOrientation.type_()":
        ...
        return _1758.CadPageOrientation.type_()

    @property
    def selected_value(self: Self) -> "_1758.CadPageOrientation":
    ...
    @property
    def available_values(self: Self) -> "List[_1758.CadPageOrientation]":
