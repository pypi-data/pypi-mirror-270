...
class EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1586.HertzianContactDeflectionCalculationMethod":
        ...
        return _1586.HertzianContactDeflectionCalculationMethod

    @classmethod
    def implicit_type(
        cls,
    ) -> "_1586.HertzianContactDeflectionCalculationMethod.type_()":
        ...
        return _1586.HertzianContactDeflectionCalculationMethod.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_1586.HertzianContactDeflectionCalculationMethod]":
