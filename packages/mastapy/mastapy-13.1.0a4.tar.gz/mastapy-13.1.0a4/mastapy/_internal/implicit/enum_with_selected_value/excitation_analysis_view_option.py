...
class EnumWithSelectedValue_ExcitationAnalysisViewOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2280.ExcitationAnalysisViewOption":
        ...
        return _2280.ExcitationAnalysisViewOption

    @classmethod
    def implicit_type(cls) -> "_2280.ExcitationAnalysisViewOption.type_()":
        ...
        return _2280.ExcitationAnalysisViewOption.type_()

    @property
    def selected_value(self: Self) -> "_2280.ExcitationAnalysisViewOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2280.ExcitationAnalysisViewOption]":
