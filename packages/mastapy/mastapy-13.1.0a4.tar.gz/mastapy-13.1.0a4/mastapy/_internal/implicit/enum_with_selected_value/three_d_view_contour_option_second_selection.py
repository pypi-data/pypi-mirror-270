...
class EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1838.ThreeDViewContourOptionSecondSelection":
        ...
        return _1838.ThreeDViewContourOptionSecondSelection

    @classmethod
    def implicit_type(cls) -> "_1838.ThreeDViewContourOptionSecondSelection.type_()":
        ...
        return _1838.ThreeDViewContourOptionSecondSelection.type_()

    @property
    def selected_value(self: Self) -> "_1838.ThreeDViewContourOptionSecondSelection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1838.ThreeDViewContourOptionSecondSelection]":
