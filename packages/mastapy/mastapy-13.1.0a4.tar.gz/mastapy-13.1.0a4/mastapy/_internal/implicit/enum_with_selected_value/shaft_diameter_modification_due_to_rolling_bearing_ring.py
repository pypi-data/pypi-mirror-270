...
class EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2493.ShaftDiameterModificationDueToRollingBearingRing":
        ...
        return _2493.ShaftDiameterModificationDueToRollingBearingRing

    @classmethod
    def implicit_type(
        cls,
    ) -> "_2493.ShaftDiameterModificationDueToRollingBearingRing.type_()":
        ...
        return _2493.ShaftDiameterModificationDueToRollingBearingRing.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_2493.ShaftDiameterModificationDueToRollingBearingRing]":
