...
class EnumWithSelectedValue_ChartType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_650.ChartType":
        ...
        return _650.ChartType

    @classmethod
    def implicit_type(cls) -> "_650.ChartType.type_()":
        ...
        return _650.ChartType.type_()

    @property
    def selected_value(self: Self) -> "_650.ChartType":
    ...
    @property
    def available_values(self: Self) -> "List[_650.ChartType]":
