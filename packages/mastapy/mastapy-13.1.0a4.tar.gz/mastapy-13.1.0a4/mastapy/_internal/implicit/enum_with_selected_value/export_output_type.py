...
class EnumWithSelectedValue_ExportOutputType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_5771.ExportOutputType":
        ...
        return _5771.ExportOutputType

    @classmethod
    def implicit_type(cls) -> "_5771.ExportOutputType.type_()":
        ...
        return _5771.ExportOutputType.type_()

    @property
    def selected_value(self: Self) -> "_5771.ExportOutputType":
    ...
    @property
    def available_values(self: Self) -> "List[_5771.ExportOutputType]":
