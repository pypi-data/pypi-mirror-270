...
class EnumWithSelectedValue_CutterFlankSections(
    ...
    @classmethod
    def wrapped_type(cls) -> "_616.CutterFlankSections":
        ...
        return _616.CutterFlankSections

    @classmethod
    def implicit_type(cls) -> "_616.CutterFlankSections.type_()":
        ...
        return _616.CutterFlankSections.type_()

    @property
    def selected_value(self: Self) -> "_616.CutterFlankSections":
    ...
    @property
    def available_values(self: Self) -> "List[_616.CutterFlankSections]":
