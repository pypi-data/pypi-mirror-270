...
class EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2235.PowerLoadInputTorqueSpecificationMethod":
        ...
        return _2235.PowerLoadInputTorqueSpecificationMethod

    @classmethod
    def implicit_type(cls) -> "_2235.PowerLoadInputTorqueSpecificationMethod.type_()":
        ...
        return _2235.PowerLoadInputTorqueSpecificationMethod.type_()

    @property
    def selected_value(self: Self) -> "_2235.PowerLoadInputTorqueSpecificationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_2235.PowerLoadInputTorqueSpecificationMethod]":
