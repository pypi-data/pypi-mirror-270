...
class EnumWithSelectedValue_DynamicsResponseType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_4650.DynamicsResponseType":
        ...
        return _4650.DynamicsResponseType

    @classmethod
    def implicit_type(cls) -> "_4650.DynamicsResponseType.type_()":
        ...
        return _4650.DynamicsResponseType.type_()

    @property
    def selected_value(self: Self) -> "_4650.DynamicsResponseType":
    ...
    @property
    def available_values(self: Self) -> "List[_4650.DynamicsResponseType]":
