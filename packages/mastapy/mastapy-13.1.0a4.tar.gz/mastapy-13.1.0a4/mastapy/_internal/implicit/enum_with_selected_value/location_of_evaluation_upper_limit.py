...
from mastapy.gears.micro_geometry import _581
...
class EnumWithSelectedValue_LocationOfEvaluationUpperLimit(
    ...
    @classmethod
    def wrapped_type(cls) -> "_581.LocationOfEvaluationUpperLimit":
        ...
        return _581.LocationOfEvaluationUpperLimit

    @classmethod
    def implicit_type(cls) -> "_581.LocationOfEvaluationUpperLimit.type_()":
        ...
        return _581.LocationOfEvaluationUpperLimit.type_()

    @property
    def selected_value(self: Self) -> "_581.LocationOfEvaluationUpperLimit":
    ...
    @property
    def available_values(self: Self) -> "List[_581.LocationOfEvaluationUpperLimit]":
