...
from mastapy.utility.model_validation import _1808
...
class EnumWithSelectedValue_StatusItemSeverity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1808.StatusItemSeverity":
        ...
        return _1808.StatusItemSeverity

    @classmethod
    def implicit_type(cls) -> "_1808.StatusItemSeverity.type_()":
        ...
        return _1808.StatusItemSeverity.type_()

    @property
    def selected_value(self: Self) -> "_1808.StatusItemSeverity":
    ...
    @property
    def available_values(self: Self) -> "List[_1808.StatusItemSeverity]":
