...
class EnumWithSelectedValue_ToothThicknessSpecificationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1200.ToothThicknessSpecificationMethod":
        ...
        return _1200.ToothThicknessSpecificationMethod

    @classmethod
    def implicit_type(cls) -> "_1200.ToothThicknessSpecificationMethod.type_()":
        ...
        return _1200.ToothThicknessSpecificationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1200.ToothThicknessSpecificationMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_1200.ToothThicknessSpecificationMethod]":
