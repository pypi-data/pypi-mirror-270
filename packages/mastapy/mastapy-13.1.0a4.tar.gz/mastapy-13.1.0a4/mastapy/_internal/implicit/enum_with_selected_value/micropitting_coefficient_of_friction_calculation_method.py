...
class EnumWithSelectedValue_MicropittingCoefficientOfFrictionCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_345.MicropittingCoefficientOfFrictionCalculationMethod":
        ...
        return _345.MicropittingCoefficientOfFrictionCalculationMethod

    @classmethod
    def implicit_type(
        cls,
    ) -> "_345.MicropittingCoefficientOfFrictionCalculationMethod.type_()":
        ...
        return _345.MicropittingCoefficientOfFrictionCalculationMethod.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_345.MicropittingCoefficientOfFrictionCalculationMethod]":
