...
class EnumWithSelectedValue_HarmonicAnalysisTorqueInputType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5795.HarmonicAnalysisTorqueInputType":
        ...
        return _5795.HarmonicAnalysisTorqueInputType

    @classmethod
    def implicit_type(cls) -> "_5795.HarmonicAnalysisTorqueInputType.type_()":
        ...
        return _5795.HarmonicAnalysisTorqueInputType.type_()

    @property
    def selected_value(self: Self) -> "_5795.HarmonicAnalysisTorqueInputType":
    ...
    @property
    def available_values(self: Self) -> "List[_5795.HarmonicAnalysisTorqueInputType]":
