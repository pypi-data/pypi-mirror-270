...
class EnumWithSelectedValue_OilSealLossCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_307.OilSealLossCalculationMethod":
        ...
        return _307.OilSealLossCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_307.OilSealLossCalculationMethod.type_()":
        ...
        return _307.OilSealLossCalculationMethod.type_()

    @property
    def selected_value(self: Self) -> "_307.OilSealLossCalculationMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_307.OilSealLossCalculationMethod]":
