...
class EnumWithSelectedValue_RotationalDirections(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1914.RotationalDirections":
        ...
        return _1914.RotationalDirections

    @classmethod
    def implicit_type(cls) -> "_1914.RotationalDirections.type_()":
        ...
        return _1914.RotationalDirections.type_()

    @property
    def selected_value(self: Self) -> "_1914.RotationalDirections":
    ...
    @property
    def available_values(self: Self) -> "List[_1914.RotationalDirections]":
