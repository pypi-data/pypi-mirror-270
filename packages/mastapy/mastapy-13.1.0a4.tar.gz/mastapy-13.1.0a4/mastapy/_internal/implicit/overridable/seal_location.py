...
class Overridable_SealLocation(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1915.SealLocation":
        ...
        return _1915.SealLocation

    @classmethod
    def implicit_type(cls) -> "_1915.SealLocation.type_()":
        ...
        return _1915.SealLocation.type_()

    @property
    def value(self: Self) -> "_1915.SealLocation":
    ...
    @property
    def override_value(self: Self) -> "_1915.SealLocation":
        """mastapy.bearings.SealLocation
    ...
    @property
    def calculated_value(self: Self) -> "_1915.SealLocation":
        """mastapy.bearings.SealLocation
