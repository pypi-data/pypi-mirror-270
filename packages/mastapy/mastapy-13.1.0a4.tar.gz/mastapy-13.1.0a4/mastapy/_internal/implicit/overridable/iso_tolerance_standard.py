...
class Overridable_ISOToleranceStandard(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_341.ISOToleranceStandard":
        ...
        return _341.ISOToleranceStandard

    @classmethod
    def implicit_type(cls) -> "_341.ISOToleranceStandard.type_()":
        ...
        return _341.ISOToleranceStandard.type_()

    @property
    def value(self: Self) -> "_341.ISOToleranceStandard":
    ...
    @property
    def override_value(self: Self) -> "_341.ISOToleranceStandard":
        """mastapy.gears.ISOToleranceStandard
    ...
    @property
    def calculated_value(self: Self) -> "_341.ISOToleranceStandard":
        """mastapy.gears.ISOToleranceStandard
