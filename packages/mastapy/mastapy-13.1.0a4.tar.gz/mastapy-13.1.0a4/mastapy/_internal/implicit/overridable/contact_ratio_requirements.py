...
class Overridable_ContactRatioRequirements(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_329.ContactRatioRequirements":
        ...
        return _329.ContactRatioRequirements

    @classmethod
    def implicit_type(cls) -> "_329.ContactRatioRequirements.type_()":
        ...
        return _329.ContactRatioRequirements.type_()

    @property
    def value(self: Self) -> "_329.ContactRatioRequirements":
    ...
    @property
    def override_value(self: Self) -> "_329.ContactRatioRequirements":
        """mastapy.gears.ContactRatioRequirements
    ...
    @property
    def calculated_value(self: Self) -> "_329.ContactRatioRequirements":
        """mastapy.gears.ContactRatioRequirements
