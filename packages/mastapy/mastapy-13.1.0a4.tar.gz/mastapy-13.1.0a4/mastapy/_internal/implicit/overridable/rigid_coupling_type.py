...
class Overridable_RigidCouplingType(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_209.RigidCouplingType":
        ...
        return _209.RigidCouplingType

    @classmethod
    def implicit_type(cls) -> "_209.RigidCouplingType.type_()":
        ...
        return _209.RigidCouplingType.type_()

    @property
    def value(self: Self) -> "_209.RigidCouplingType":
    ...
    @property
    def override_value(self: Self) -> "_209.RigidCouplingType":
        """mastapy.nodal_analysis.dev_tools_analyses.RigidCouplingType
    ...
    @property
    def calculated_value(self: Self) -> "_209.RigidCouplingType":
        """mastapy.nodal_analysis.dev_tools_analyses.RigidCouplingType
