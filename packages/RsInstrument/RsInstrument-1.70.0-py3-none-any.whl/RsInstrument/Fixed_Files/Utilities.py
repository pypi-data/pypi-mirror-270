...
class Utilities:
	...
	def visa_tout_suppressor(self, visa_tout_ms: int = 0, instr_status_checking: bool = None) -> VisaTimeoutSuppressor:
		...
		:param visa_tout_ms: VISA Timeout in milliseconds, that is set for this context.
			Afterward, it is changed back. Default value: do-not-change.
		:param instr_status_checking: Changes the instrument status checking for the context.
			Afterward, it is changed back. Default value: do-not-change.
		"""
		return VisaTimeoutSuppressor(self._core.io, visa_tout_ms, instr_status_checking)
