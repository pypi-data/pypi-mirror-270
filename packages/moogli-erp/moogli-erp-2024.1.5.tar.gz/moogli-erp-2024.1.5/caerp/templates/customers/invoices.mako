...
<div>
    ...
    <div class='table_container'>
        ${request.layout_manager.render_panel('task_list', records, datatype="invoice", is_admin_view=is_admin, is_project_view=True, tva_on_margin_display=customer.has_tva_on_margin_business())}
    </div>
    ${pager(records)}
</div>
