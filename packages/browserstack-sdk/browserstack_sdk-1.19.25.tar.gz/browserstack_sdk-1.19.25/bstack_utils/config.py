...
conf = {
    bstack11ll111_opy_ (u"࠭ࡡࡱࡲࡢࡥࡺࡺ࡯࡮ࡣࡷࡩࠬ໭"): False,
    bstack11ll111_opy_ (u"ࠧࡣࡵࡷࡥࡨࡱ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࠨ໮"): True,
    bstack11ll111_opy_ (u"ࠨࡵ࡮࡭ࡵࡥࡳࡦࡵࡶ࡭ࡴࡴ࡟ࡴࡶࡤࡸࡺࡹࠧ໯"): False
}
class Config(object):
    instance = None
    def __init__(self):
    ...
    def bstack1l1lll1ll1_opy_(self, property_name, bstack11l1l1l11l_opy_):
        self._11l1l1l1l1_opy_[property_name] = bstack11l1l1l11l_opy_
    def bstack1l11ll11ll_opy_(self, val):
        self._11l1l1l1l1_opy_[bstack11ll111_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨ໰")] = bool(val)
    def bstack11ll1l1ll1_opy_(self):
        return self._11l1l1l1l1_opy_.get(bstack11ll111_opy_ (u"ࠪࡷࡰ࡯ࡰࡠࡵࡨࡷࡸ࡯࡯࡯ࡡࡶࡸࡦࡺࡵࡴࠩ໱"), False)