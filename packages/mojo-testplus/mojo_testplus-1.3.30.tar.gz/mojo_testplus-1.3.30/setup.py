...
['click>=8.1.3,<9.0.0',
 'debugpy>=1.6.5,<2.0.0',
 'mojo-collections>=1.3.8,<1.4.0',
 'mojo-config>=1.3.17,<1.4.0',
 'mojo-errors>=1.3.4,<1.4.0',
 'mojo-extension>=1.3.17,<1.4.0',
 'mojo-results>=1.3.12,<1.4.0',
 'mojo-runtime>=1.3.17,<1.4.0',
 'mojo-xmodules>=1.3.17,<1.4.0',
 'requests<=2.31.0']
