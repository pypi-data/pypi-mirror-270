...
class Qbittorrent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = readarr.download_clients.Qbittorrent("example",
        ...
        ```sh
         $ pulumi import readarr:DownloadClients/qbittorrent:Qbittorrent example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Qbittorrent, __self__).__init__(
            'readarr:DownloadClients/qbittorrent:Qbittorrent',
            resource_name,
            __props__,
            opts)
