...
class UtorrentArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a Utorrent resource.
        ...
        :param pulumi.Input[int] older_book_priority: Older Music priority. `0` Last, `1` First.
        :param pulumi.Input[str] password: Password.
        :param pulumi.Input[int] port: Port.
        :param pulumi.Input[int] priority: Priority.
        :param pulumi.Input[int] recent_book_priority: Recent Music priority. `0` Last, `1` First.
...
class _UtorrentState:
    def __init__(__self__, *,
                 ...
                 username: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering Utorrent resources.
        :param pulumi.Input[str] book_category: Book category.
        :param pulumi.Input[str] book_imported_category: Book imported category.
        :param pulumi.Input[bool] enable: Enable flag.
        :param pulumi.Input[str] host: host.
...
class Utorrent(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example = readarr.download_clients.Utorrent("example",
        ...
        ```sh
         $ pulumi import readarr:DownloadClients/utorrent:Utorrent example 1
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[UtorrentArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        <!-- subcategory:Download Clients -->Download Client uTorrent resource.
        For more information refer to [Download Client](https://wiki.servarr.com/readarr/settings#download-clients) and [uTorrent](https://wiki.servarr.com/readarr/supported#utorrent).
        ...
        :param str resource_name: The name of the resource.
        :param UtorrentArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(UtorrentArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = UtorrentArgs.__new__(UtorrentArgs)
        ...
        super(Utorrent, __self__).__init__(
            'readarr:DownloadClients/utorrent:Utorrent',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            url_base: Optional[pulumi.Input[str]] = None,
            use_ssl: Optional[pulumi.Input[bool]] = None,
            username: Optional[pulumi.Input[str]] = None) -> 'Utorrent':
        """
        Get an existing Utorrent resource's state with the given name, id, and optional extra
        ...
        __props__ = _UtorrentState.__new__(_UtorrentState)
        ...
        __props__.__dict__["use_ssl"] = use_ssl
        __props__.__dict__["username"] = username
        return Utorrent(resource_name, opts=opts, __props__=__props__)
