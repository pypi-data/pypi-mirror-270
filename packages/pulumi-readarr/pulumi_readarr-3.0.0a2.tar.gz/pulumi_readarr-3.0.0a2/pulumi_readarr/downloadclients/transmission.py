...
class TransmissionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] older_book_priority: Older TV priority. `0` Last, `1` First.
        :param pulumi.Input[str] password: password.
        :param pulumi.Input[int] port: Port.
        :param pulumi.Input[int] priority: Priority.
        :param pulumi.Input[int] recent_book_priority: Recent TV priority. `0` Last, `1` First.
...
class Transmission(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = readarr.download_clients.Transmission("example",
            enable=True,
            host="transmission",
            port=9091,
            priority=1,
        ...
        ```sh
         $ pulumi import readarr:DownloadClients/transmission:Transmission example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Transmission, __self__).__init__(
            'readarr:DownloadClients/transmission:Transmission',
            resource_name,
            __props__,
            opts)
