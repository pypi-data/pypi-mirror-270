...
class Hadouken(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = readarr.download_clients.Hadouken("example",
            enable=True,
            host="hadouken",
            password="password",
            port=9091,
        ...
        ```sh
         $ pulumi import readarr:DownloadClients/hadouken:Hadouken example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Hadouken, __self__).__init__(
            'readarr:DownloadClients/hadouken:Hadouken',
            resource_name,
            __props__,
            opts)
