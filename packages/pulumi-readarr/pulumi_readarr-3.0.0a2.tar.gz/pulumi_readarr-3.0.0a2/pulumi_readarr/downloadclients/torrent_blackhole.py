...
class TorrentBlackhole(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = readarr.download_clients.TorrentBlackhole("example",
            enable=True,
        ...
        ```sh
         $ pulumi import readarr:DownloadClients/torrentBlackhole:TorrentBlackhole example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(TorrentBlackhole, __self__).__init__(
            'readarr:DownloadClients/torrentBlackhole:TorrentBlackhole',
            resource_name,
            __props__,
            opts)
