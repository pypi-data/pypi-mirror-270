...
def get_exclusions(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetExclusionsResult:
    ...
    example = readarr.ImportLists.get_exclusions()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('readarr:ImportLists/getExclusions:getExclusions', __args__, opts=opts, typ=GetExclusionsResult).value
