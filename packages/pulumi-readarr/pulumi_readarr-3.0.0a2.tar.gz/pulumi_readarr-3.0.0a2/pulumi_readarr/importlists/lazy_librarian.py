...
class LazyLibrarian(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = readarr.import_lists.LazyLibrarian("example",
            api_key="APIKey",
        ...
        ```sh
         $ pulumi import readarr:ImportLists/lazyLibrarian:LazyLibrarian example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(LazyLibrarian, __self__).__init__(
            'readarr:ImportLists/lazyLibrarian:LazyLibrarian',
            resource_name,
            __props__,
            opts)
