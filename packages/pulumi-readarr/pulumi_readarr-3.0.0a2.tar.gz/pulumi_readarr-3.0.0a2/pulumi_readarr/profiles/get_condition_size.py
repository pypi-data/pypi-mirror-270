...
def get_condition_size(max: Optional[int] = None,
    ...
    example_condition_size = readarr.Profiles.get_condition_size(name="Example",
        negate=False,
        required=False,
        min=5,
        max=50)
    ...
    __ret__ = pulumi.runtime.invoke('readarr:Profiles/getConditionSize:getConditionSize', __args__, opts=opts, typ=GetConditionSizeResult).value
