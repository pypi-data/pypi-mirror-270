...
class FilelistArgs:
    def __init__(__self__, *,
                 ...
                 author_seed_time: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input[int] author_seed_time: Author seed time.
        ...
        if author_seed_time is not None:
            pulumi.set(__self__, "author_seed_time", author_seed_time)
    ...
    @property
    @pulumi.getter(name="authorSeedTime")
    def author_seed_time(self) -> Optional[pulumi.Input[int]]:
        """
        Author seed time.
        """
        return pulumi.get(self, "author_seed_time")

    @author_seed_time.setter
    def author_seed_time(self, value: Optional[pulumi.Input[int]]):
        pulumi.set(self, "author_seed_time", value)
...
class Filelist(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        ```sh
         $ pulumi import readarr:Indexers/filelist:Filelist example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["author_seed_time"] = author_seed_time
        ...
        super(Filelist, __self__).__init__(
            'readarr:Indexers/filelist:Filelist',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter(name="authorSeedTime")
    def author_seed_time(self) -> pulumi.Output[int]:
        """
        Author seed time.
        """
        return pulumi.get(self, "author_seed_time")
