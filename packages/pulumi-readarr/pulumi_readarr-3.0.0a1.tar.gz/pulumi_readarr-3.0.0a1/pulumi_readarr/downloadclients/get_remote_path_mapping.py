...
def get_remote_path_mapping(id: Optional[int] = None,
    ...
    __ret__ = pulumi.runtime.invoke('readarr:DownloadClients/getRemotePathMapping:getRemotePathMapping', __args__, opts=opts, typ=GetRemotePathMappingResult).value
