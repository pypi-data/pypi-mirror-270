...
class NzbgetArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a Nzbget resource.
        ...
        :param pulumi.Input[int] older_book_priority: Older Music priority. `-100` VeryLow, `-50` Low, `0` Normal, `50` High, `100` VeryHigh, `900` Force.
        :param pulumi.Input[str] password: Password.
        :param pulumi.Input[int] port: Port.
        :param pulumi.Input[int] priority: Priority.
        :param pulumi.Input[int] recent_book_priority: Recent Music priority. `-100` VeryLow, `-50` Low, `0` Normal, `50` High, `100` VeryHigh, `900` Force.
...
class _NzbgetState:
    def __init__(__self__, *,
                 ...
                 username: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering Nzbget resources.
        :param pulumi.Input[bool] add_paused: Add paused flag.
        :param pulumi.Input[str] book_category: Book category.
        :param pulumi.Input[bool] enable: Enable flag.
        :param pulumi.Input[str] host: host.
...
class Nzbget(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example = readarr.download_clients.Nzbget("example",
            enable=True,
            host="nzbget",
            port=6789,
            priority=1,
        ...
        ```sh
         $ pulumi import readarr:DownloadClients/nzbget:Nzbget example 1
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param NzbgetArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(NzbgetArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = NzbgetArgs.__new__(NzbgetArgs)
        ...
        super(Nzbget, __self__).__init__(
            'readarr:DownloadClients/nzbget:Nzbget',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            url_base: Optional[pulumi.Input[str]] = None,
            use_ssl: Optional[pulumi.Input[bool]] = None,
            username: Optional[pulumi.Input[str]] = None) -> 'Nzbget':
        """
        Get an existing Nzbget resource's state with the given name, id, and optional extra
        ...
        __props__ = _NzbgetState.__new__(_NzbgetState)
        ...
        __props__.__dict__["use_ssl"] = use_ssl
        __props__.__dict__["username"] = username
        return Nzbget(resource_name, opts=opts, __props__=__props__)
