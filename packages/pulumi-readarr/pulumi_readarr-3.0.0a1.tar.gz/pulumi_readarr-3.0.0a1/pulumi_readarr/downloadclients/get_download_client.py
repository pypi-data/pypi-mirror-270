...
class GetDownloadClientResult:
    ...
    """
    def __init__(__self__, add_paused=None, add_stopped=None, additional_tags=None, api_key=None, book_category=None, book_directory=None, book_imported_category=None, bookdirectory=None, category=None, config_contract=None, destination=None, enable=None, field_tags=None, first_and_last=None, host=None, id=None, implementation=None, initial_state=None, intial_state=None, magnet_file_extension=None, name=None, nzb_folder=None, older_book_priority=None, password=None, port=None, post_import_tags=None, priority=None, protocol=None, read_only=None, recent_book_priority=None, remove_completed_downloads=None, remove_failed_downloads=None, rpc_path=None, save_magnet_files=None, secret_token=None, sequential_order=None, start_on_add=None, strm_folder=None, tags=None, torrent_folder=None, url_base=None, use_ssl=None, username=None, watch_folder=None):
        ...
        if book_category and not isinstance(book_category, str):
            raise TypeError("Expected argument 'book_category' to be a str")
        pulumi.set(__self__, "book_category", book_category)
        if book_directory and not isinstance(book_directory, str):
            raise TypeError("Expected argument 'book_directory' to be a str")
        pulumi.set(__self__, "book_directory", book_directory)
        if book_imported_category and not isinstance(book_imported_category, str):
            raise TypeError("Expected argument 'book_imported_category' to be a str")
        pulumi.set(__self__, "book_imported_category", book_imported_category)
        if bookdirectory and not isinstance(bookdirectory, str):
            raise TypeError("Expected argument 'bookdirectory' to be a str")
        pulumi.set(__self__, "bookdirectory", bookdirectory)
        ...
        if older_book_priority and not isinstance(older_book_priority, int):
            raise TypeError("Expected argument 'older_book_priority' to be a int")
        pulumi.set(__self__, "older_book_priority", older_book_priority)
        ...
        if recent_book_priority and not isinstance(recent_book_priority, int):
            raise TypeError("Expected argument 'recent_book_priority' to be a int")
        pulumi.set(__self__, "recent_book_priority", recent_book_priority)
    ...
    @property
    @pulumi.getter(name="bookCategory")
    def book_category(self) -> str:
        """
        Book category.
        """
        return pulumi.get(self, "book_category")

    @property
    @pulumi.getter(name="bookDirectory")
    def book_directory(self) -> str:
        """
        Book directory.
        """
        return pulumi.get(self, "book_directory")

    @property
    @pulumi.getter(name="bookImportedCategory")
    def book_imported_category(self) -> str:
        """
        Book imported category.
        """
        return pulumi.get(self, "book_imported_category")

    @property
    @pulumi.getter
    def bookdirectory(self) -> str:
        """
        Book directory.
        """
        return pulumi.get(self, "bookdirectory")
    ...
    @property
    @pulumi.getter(name="olderBookPriority")
    def older_book_priority(self) -> int:
        """
        Older Book priority. `0` Last, `1` First.
        """
        return pulumi.get(self, "older_book_priority")
    ...
    @property
    @pulumi.getter(name="recentBookPriority")
    def recent_book_priority(self) -> int:
        """
        Recent Book priority. `0` Last, `1` First.
        """
        return pulumi.get(self, "recent_book_priority")
...
class AwaitableGetDownloadClientResult(GetDownloadClientResult):
    ...
    def __await__(self):
        ...
        return GetDownloadClientResult(
            ...
            book_imported_category=self.book_imported_category,
            bookdirectory=self.bookdirectory,
            ...
            older_book_priority=self.older_book_priority,
            ...
            recent_book_priority=self.recent_book_priority,
...
def get_download_client(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('readarr:DownloadClients/getDownloadClient:getDownloadClient', __args__, opts=opts, typ=GetDownloadClientResult).value
    ...
    return AwaitableGetDownloadClientResult(
        ...
        book_category=pulumi.get(__ret__, 'book_category'),
        book_directory=pulumi.get(__ret__, 'book_directory'),
        book_imported_category=pulumi.get(__ret__, 'book_imported_category'),
        bookdirectory=pulumi.get(__ret__, 'bookdirectory'),
        ...
        older_book_priority=pulumi.get(__ret__, 'older_book_priority'),
        ...
        recent_book_priority=pulumi.get(__ret__, 'recent_book_priority'),
