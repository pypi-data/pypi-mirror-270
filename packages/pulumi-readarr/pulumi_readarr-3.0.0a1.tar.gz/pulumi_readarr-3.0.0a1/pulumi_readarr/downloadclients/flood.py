...
class FloodArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[int]]] additional_tags: Additional tags, `0` Author, `1` Quality, `2` ReleaseGroup, `3` Year, `4` Indexer.
...
class Flood(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = readarr.download_clients.Flood("example",
            add_paused=True,
            additional_tags=[
                0,
                1,
    ...
    def _internal_init(__self__,
        ...
        super(Flood, __self__).__init__(
            'readarr:DownloadClients/flood:Flood',
            resource_name,
            __props__,
            opts)
