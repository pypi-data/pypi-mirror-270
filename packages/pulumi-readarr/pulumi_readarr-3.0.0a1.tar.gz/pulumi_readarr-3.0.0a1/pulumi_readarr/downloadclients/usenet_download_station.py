...
class UsenetDownloadStation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = readarr.download_clients.UsenetDownloadStation("example",
            enable=True,
        ...
        ```sh
         $ pulumi import readarr:DownloadClients/usenetDownloadStation:UsenetDownloadStation example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(UsenetDownloadStation, __self__).__init__(
            'readarr:DownloadClients/usenetDownloadStation:UsenetDownloadStation',
            resource_name,
            __props__,
            opts)
