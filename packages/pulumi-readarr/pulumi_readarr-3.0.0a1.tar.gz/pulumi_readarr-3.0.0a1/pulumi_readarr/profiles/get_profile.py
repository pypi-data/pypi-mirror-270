...
def get_profile(name: Optional[str] = None,
    ...
    example = readarr.Profiles.get_profile(name="Example")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('readarr:Profiles/getProfile:getProfile', __args__, opts=opts, typ=GetProfileResult).value
