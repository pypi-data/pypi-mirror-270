...
def get_definition(id: Optional[int] = None,
    ...
    example = readarr.Profiles.get_definition(id=3)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('readarr:Profiles/getDefinition:getDefinition', __args__, opts=opts, typ=GetDefinitionResult).value
