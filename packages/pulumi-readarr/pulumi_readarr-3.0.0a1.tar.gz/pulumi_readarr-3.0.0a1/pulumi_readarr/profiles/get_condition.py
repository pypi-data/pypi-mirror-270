...
def get_condition(implementation: Optional[str] = None,
    ...
    example_condition = readarr.Profiles.get_condition(name="Example",
    ...
    __ret__ = pulumi.runtime.invoke('readarr:Profiles/getCondition:getCondition', __args__, opts=opts, typ=GetConditionResult).value
