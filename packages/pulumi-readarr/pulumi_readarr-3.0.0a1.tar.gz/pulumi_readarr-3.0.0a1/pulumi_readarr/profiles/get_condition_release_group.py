...
def get_condition_release_group(name: Optional[str] = None,
    ...
    example_condition_release_group = readarr.Profiles.get_condition_release_group(name="HDBits",
        negate=False,
        required=False,
        value=".*HDBits.*")
    ...
    __ret__ = pulumi.runtime.invoke('readarr:Profiles/getConditionReleaseGroup:getConditionReleaseGroup', __args__, opts=opts, typ=GetConditionReleaseGroupResult).value
