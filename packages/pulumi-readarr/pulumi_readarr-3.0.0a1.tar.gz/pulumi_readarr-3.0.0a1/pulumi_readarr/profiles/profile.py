...
class Profile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = readarr.profiles.Profile("example",
            cutoff=1100,
            quality_groups=[readarr.profiles.ProfileQualityGroupArgs(
                id=1100,
                name="native",
                qualities=[
                    readarr.profiles.ProfileQualityGroupQualityArgs(
                        id=3,
                        name="EPUB",
                    ),
                    readarr.profiles.ProfileQualityGroupQualityArgs(
        ...
        ```sh
         $ pulumi import readarr:Profiles/profile:Profile example 10
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Profile, __self__).__init__(
            'readarr:Profiles/profile:Profile',
            resource_name,
            __props__,
            opts)
