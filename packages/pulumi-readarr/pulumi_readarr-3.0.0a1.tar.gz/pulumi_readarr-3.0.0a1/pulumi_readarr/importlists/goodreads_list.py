...
__all__ = ['GoodreadsListArgs', 'GoodreadsList']

@pulumi.input_type
class GoodreadsListArgs:
    def __init__(__self__, *,
                 list_id: pulumi.Input[int],
        ...
        """
        The set of arguments for constructing a GoodreadsList resource.
    ...
    def list_id(self) -> pulumi.Input[int]:
        """
        List ID.
        """
    ...
    @list_id.setter
    def list_id(self, value: pulumi.Input[int]):
...
class _GoodreadsListState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None):
        """
        Input properties used for looking up and filtering GoodreadsList resources.
        :param pulumi.Input[bool] enable_automatic_add: Enable automatic add flag.
        :param pulumi.Input[int] list_id: List ID.
        :param pulumi.Input[int] list_order: List order.
        :param pulumi.Input[int] metadata_profile_id: Metadata profile ID.
...
class GoodreadsList(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example = readarr.import_lists.GoodreadsList("example",
        ...
        ```sh
         $ pulumi import readarr:ImportLists/goodreadsList:GoodreadsList example 1
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param GoodreadsListArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GoodreadsListArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GoodreadsListArgs.__new__(GoodreadsListArgs)
        ...
        super(GoodreadsList, __self__).__init__(
            'readarr:ImportLists/goodreadsList:GoodreadsList',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            should_monitor_existing: Optional[pulumi.Input[bool]] = None,
            should_search: Optional[pulumi.Input[bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None) -> 'GoodreadsList':
        """
        Get an existing GoodreadsList resource's state with the given name, id, and optional extra
        ...
        __props__ = _GoodreadsListState.__new__(_GoodreadsListState)
        ...
        __props__.__dict__["should_search"] = should_search
        __props__.__dict__["tags"] = tags
        return GoodreadsList(resource_name, opts=opts, __props__=__props__)
