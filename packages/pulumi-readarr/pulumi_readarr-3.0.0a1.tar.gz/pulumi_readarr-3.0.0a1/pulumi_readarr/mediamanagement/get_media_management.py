...
class GetMediaManagementResult:
    ...
    """
    def __init__(__self__, allow_fingerprinting=None, chmod_folder=None, chown_group=None, create_empty_author_folders=None, delete_empty_folders=None, download_propers_repacks=None, extra_file_extensions=None, file_date=None, hardlinks_copy=None, id=None, import_extra_files=None, minimum_free_space=None, recycle_bin_days=None, recycle_bin_path=None, rescan_after_refresh=None, set_permissions=None, skip_free_space_check=None, unmonitor_previous_books=None, watch_ibrary_for_changes=None):
        ...
        if create_empty_author_folders and not isinstance(create_empty_author_folders, bool):
            raise TypeError("Expected argument 'create_empty_author_folders' to be a bool")
        ...
        if unmonitor_previous_books and not isinstance(unmonitor_previous_books, bool):
            raise TypeError("Expected argument 'unmonitor_previous_books' to be a bool")
        pulumi.set(__self__, "unmonitor_previous_books", unmonitor_previous_books)
        if watch_ibrary_for_changes and not isinstance(watch_ibrary_for_changes, bool):
            raise TypeError("Expected argument 'watch_ibrary_for_changes' to be a bool")
    ...
    def create_empty_author_folders(self) -> bool:
        """
    ...
    def unmonitor_previous_books(self) -> bool:
        """
    ...
    def watch_ibrary_for_changes(self) -> bool:
        """
...
class AwaitableGetMediaManagementResult(GetMediaManagementResult):
    ...
    def __await__(self):
        ...
        return GetMediaManagementResult(
            ...
            create_empty_author_folders=self.create_empty_author_folders,
            ...
            unmonitor_previous_books=self.unmonitor_previous_books,
            watch_ibrary_for_changes=self.watch_ibrary_for_changes)
...
def get_media_management(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMediaManagementResult:
    ...
    __ret__ = pulumi.runtime.invoke('readarr:MediaManagement/getMediaManagement:getMediaManagement', __args__, opts=opts, typ=GetMediaManagementResult).value
    ...
    return AwaitableGetMediaManagementResult(
        ...
        create_empty_author_folders=pulumi.get(__ret__, 'create_empty_author_folders'),
        ...
        unmonitor_previous_books=pulumi.get(__ret__, 'unmonitor_previous_books'),
        watch_ibrary_for_changes=pulumi.get(__ret__, 'watch_ibrary_for_changes'))
