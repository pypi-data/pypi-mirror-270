...
class GetIndexerResult:
    ...
    """
    def __init__(__self__, additional_parameters=None, allow_zero_size=None, api_key=None, api_path=None, api_user=None, author_seed_time=None, base_url=None, captcha_token=None, categories=None, config_contract=None, cookie=None, delay=None, early_release_limit=None, enable_automatic_search=None, enable_interactive_search=None, enable_rss=None, id=None, implementation=None, minimum_seeders=None, name=None, passkey=None, password=None, priority=None, protocol=None, ranked_only=None, seed_ratio=None, seed_time=None, tags=None, username=None):
        ...
        if author_seed_time and not isinstance(author_seed_time, int):
            raise TypeError("Expected argument 'author_seed_time' to be a int")
...
class AwaitableGetIndexerResult(GetIndexerResult):
    ...
    def __await__(self):
        ...
        return GetIndexerResult(
            ...
            author_seed_time=self.author_seed_time,
...
def get_indexer(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('readarr:Indexers/getIndexer:getIndexer', __args__, opts=opts, typ=GetIndexerResult).value
    ...
    return AwaitableGetIndexerResult(
        ...
        author_seed_time=pulumi.get(__ret__, 'author_seed_time'),
