...
class JoinArgs:
    ...
    def device_names(self) -> pulumi.Input[str]:
        """
    ...
    @device_names.setter
    def device_names(self, value: pulumi.Input[str]):
...
class Join(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = readarr.notifications.Join("example",
            api_key="Key",
        ...
        ```sh
         $ pulumi import readarr:Notifications/join:Join example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if device_names is None and not opts.urn:
                raise TypeError("Missing required property 'device_names'")
        ...
        super(Join, __self__).__init__(
            'readarr:Notifications/join:Join',
            resource_name,
            __props__,
            opts)
