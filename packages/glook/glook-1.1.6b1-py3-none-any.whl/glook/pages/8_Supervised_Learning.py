...
selected_type = st.radio("Select Model Type", ["Regression Models", "Regression Models(continuous)", "Classification Models", "Multi Class Classification"], captions=["Binary Output Variable", "Continuous Output Variable", "Binary Output Variable", "Output Variable with more than 2 class"])
