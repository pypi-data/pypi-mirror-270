...
class DateMixin:
    ...
    def delta(self, period: int, periodicity: str = 'D', calendar: str = None) -> Self:
        """
    ...
    def days_delta(self, days: int) -> Self:
        """
    ...
    def bizdays_delta(self, bizdays: int, calendar: str = None) -> Self:
        """
    ...
    def weeks_delta(self, weeks: int) -> Self:
        """
