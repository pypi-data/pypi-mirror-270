...
EVERYSK_APP_URL_SCHEME = StrField(default='https', readonly=True)
EVERYSK_APP_URL_DOMAIN = StrField(default='app.everysk.com', readonly=True)
EVERYSK_APP_URL: str = '{EVERYSK_APP_URL_SCHEME}://{EVERYSK_APP_URL_DOMAIN}'

EVERYSK_API_URL_SCHEME = StrField(default='https', readonly=True)
EVERYSK_API_URL_DOMAIN = StrField(default='api.everysk.com', readonly=True)
EVERYSK_API_URL = '{EVERYSK_API_URL_SCHEME}://{EVERYSK_API_URL_DOMAIN}'

EVERYSK_API_VERSION = StrField(default='v2', readonly=True)
