...
class User(BaseInfuzuObject):
    ...
    record_storage_used: PositiveInt | None = Field(frozen=True, default=None)
    total_storage_used: PositiveInt | None = Field(frozen=True, default=None)
    cogitobot_storage_used: PositiveInt | None = Field(frozen=True, default=None)
