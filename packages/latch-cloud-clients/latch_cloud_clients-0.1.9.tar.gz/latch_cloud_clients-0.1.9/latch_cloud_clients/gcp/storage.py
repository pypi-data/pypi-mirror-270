...
class AsyncGCPStorageClient:
    ...
    async def multipart_initiate_upload(
        ...
        *,
        ...
        resp = await self._make_api_request(
            "POST",
            f"https://storage.googleapis.com/{bucket_name}/{key}?uploads",
    ...
    async def multipart_upload_part(
        ...
        resp = await self._make_api_request(
            "PUT",
            f"https://storage.googleapis.com/{bucket_name}/{key}?uploadId={upload_id}&partNumber={part_number}",
            "UploadPart",
            data=data,
    ...
    async def multipart_complete_upload(
        ...
        await self._make_api_request(
            "POST",
            f"https://storage.googleapis.com/{bucket_name}/{key}?uploadId={upload_id}",
