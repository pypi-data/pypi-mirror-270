...
class RestClient:
    def __init__(self, endpoint : Optional[str] = None):
        ...
        """
        if endpoint is None:
            logger.debug("Endpoint not set, defaulting to `https://lotgi.ai/api`.")
            self.endpoint = "https://lotgi.ai/api"
        else:
    ...
    def submit_job(self, *, model : str, input_url : str, field : str, target_cost : float, target_deadline : int, execution_tradeoff : str) -> rest.JobStatus:
