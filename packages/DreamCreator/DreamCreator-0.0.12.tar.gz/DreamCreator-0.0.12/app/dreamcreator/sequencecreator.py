...
class GUI(QWidget):
    ...
    def on_itembox4_checked(self):
        ...
        if len(checked_items) == 1:
            ...
            self.custom_reset_parameters(checked_items[0].text())
    ...
    def custom_reset_parameters(self, sequenceName):
        # Get the sequence name
            ...
            sequence_file = Path('./app/dreamcreator/sequences', self.branch, sequence_name_og)
            sequence_file = str(sequence_file.resolve())
    ...
    def reset_parameters(self, sequenceName):
        ...
        sequence_file = Path('./app/dreamcreator/sequences', self.branch, sequence_name)
        sequence_file = str(sequence_file.resolve())
