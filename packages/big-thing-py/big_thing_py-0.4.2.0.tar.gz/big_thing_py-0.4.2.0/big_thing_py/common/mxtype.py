                ...
                if name is not None:
                    for mxtype in MXType:
                        if mxtype.value == name:
                            ...
                            return cls.STRING
                        elif mxtype.value == 'binary' and name == 'bytearray':
                            return cls.STRING
...
class MXDeviceCategory(Enum):
    ...
    AirConditioner = auto()
    AirPurifier = auto()
    AirQualityDetector = auto()
    Battery = auto()
    Blind = auto()
    BluRayPlayer = auto()
    BluetoothCarSpeaker = auto()
    BluetoothTracker = auto()
    Bridges = auto()
    Button = auto()
    Camera = auto()
    Car = auto()
    Charger = auto()
    ClothingCareMachine = auto()
    CoffeeMaker = auto()
    ContactSensor = auto()
    Cooktop = auto()
    CubeRefrigerator = auto()
    CurbPowerMeter = auto()
    Curtain = auto()
    Dehumidifier = auto()
    Dishwasher = auto()
    ...
    IrRemote = auto()
    Irrigation = auto()
    KimchiRefrigerator = auto()
    KitchenHood = auto()
    LeakSensor = auto()
    Light = auto()
    LightSensor = auto()
    MicroFiberFilter = auto()
    Microwave = auto()
    Mobile = auto()
    MobilePresence = auto()
    MotionSensor = auto()
    MultiFunctionalSensor = auto()
    NetworkAudio = auto()
    Networking = auto()
    Others = auto()
    Oven = auto()
    PresenceSensor = auto()
    Printer = auto()
    PrinterMultiFunction = auto()
    Projector = auto()
    Pump = auto()
    Range = auto()
    Receiver = auto()
    Refrigerator = auto()
    RemoteController = auto()
    RiceCooker = auto()
    RobotCleaner = auto()
    ScaleToMeasureMassOfHumanBody = auto()
    Scanner = auto()
    SecurityPanel = auto()
    SetTop = auto()
    Shade = auto()
    ShoesCareMachine = auto()
    Siren = auto()
    SmartLock = auto()
    SmartPlug = auto()
    SmokeDetector = auto()
    ...
    Thermostat = auto()
    Tracker = auto()
    UPnPMediaRenderer = auto()
    Vent = auto()
    VisionSensor = auto()
    VoiceAssistance = auto()
    Washer = auto()
    WaterHeater = auto()
    WaterValve = auto()
    WaterPurifier = auto()
    ...
    @classmethod
    def get(cls, name: str) -> 'MXDeviceCategory':
        try:
            return cls[name]
        except Exception:
            return cls.Undefined
...
class MXValueCategory(Enum):
    ...
    @classmethod
    def get(cls, name: str) -> 'MXValueCategory':
        try:
            return cls[name]
        except KeyError:
            return cls.undefined
...
class MXFunctionCategory(Enum):
    ...
    setPurifierFanMode = auto()
    setOperationMode = auto()
    open = auto()
    close = auto()

    @classmethod
    def get(cls, name: str) -> 'MXFunctionCategory':
        try:
            return cls[name]
        except KeyError:
            return cls.undefined
