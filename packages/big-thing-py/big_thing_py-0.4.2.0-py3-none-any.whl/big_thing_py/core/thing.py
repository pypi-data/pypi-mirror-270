...
class MXThing:
    ...
    DEFAULT_CATEGORY = MXDeviceCategory.Undefined
    ...
    def add_service(self, service: MXService) -> 'MXThing':
        ...
        service.add_tag(MXTag(name=self._category.value))
    ...
    def add_dependency(
        ...
        dependency_info = dict(value=value, set_value=set_value, set_to_result=set_to_result)
    ...
    @property
    def category(self) -> MXDeviceCategory:
    ...
    @category.setter
    def category(self, category: MXDeviceCategory) -> None:
        self._category = category
