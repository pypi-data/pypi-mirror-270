...
class CompoundMessage(GenericCRUD, metaclass=MetaLogger, object=object_message):
    ...
    def set_compound_message_after_text_template(
        ...
        if message_id:
            ...
            self.__compound_message = json.loads(
                self.select_one_value_by_id(select_clause_value="compound_message_json", id_column_value=message_id))
            return
        ...
        if body:  # TODO constract textblocks_and_attributes
            ...
            textblocks_and_attributes = self.message_template.get_textblocks_and_attributes_by_message_template_id(message_template_id)
...
"""
        ...
        for page_number, message_templates in grouped_data.items():
            ...
            for message_template_id, text_blocks in message_templates.items():
                ...
                if message_template_data["MessageTemplateTextBlocks"] and message_template_data not in page["MessageTemplates"]:
