...
from langchain_community.document_loaders import JSONLoader, PyPDFLoader, WebBaseLoader,UnstructuredWordDocumentLoader,UnstructuredMarkdownLoader,UnstructuredHTMLLoader

logging.basicConfig(level=logging.INFO)
class DocumentLoader:
    """
    This class is used to load documents from different sources and return them as a list of strings.
    The supported sources include CSV, JSON, PDF, HTML, Markdown, and Word documents.
    """
    ...
    def load_and_get_data(self, file_path: Optional[str]= None, url_path: Optional[str] = None):
        ...
        if file_path is not None:
            try:
                ...
                return "Error loading the file. We currently support csv files, json files, pdf files and html files"
