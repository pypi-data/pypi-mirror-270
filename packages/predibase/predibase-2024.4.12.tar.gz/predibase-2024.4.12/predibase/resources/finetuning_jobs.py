...
class FinetuningJobs:
    ...
    def _stream_model_metrics(
        ...
        for resp in self._client.listen_websocket(f"/v2/finetuning/jobs/{job_uuid}/metrics/stream",
            ...
            try:
                ...
                if metrics.data.steps and metrics.data.steps > 0:
                    ...
                    table["validation_loss"] = metrics.data.validation_metrics_loss
                    table.next_row()
