...
DATA_HOME = f'/data/home/{os.environ["USER"]}/data'
...
class AdiRunner:
    ...
    def __post_init__(self):
        ...
        self.process_cache = ProcessCache(
            ...
            hook_manager=self.process_hook_manager,
            cache_dir=ADI_ENV_VAR_DEFAULT["ADI_CACHE_DIR"],
        )
    ...
    def run_data_consolidator(
        ...
        **kwargs,
        ...
        self.controller = RunnerController(
            self.sys_argv,
            self.process_hook_manager,
            self.process_env_var_manager,
            self.process_cache,
            self.pcm,
        )
    ...
    def _empty_datastore_warning(self):
        print("Warning: If empty, process data first.")
...
class RunnerController:
    sys_argv: SysArgv
    process_hook_manager: Any = field(repr=False)  # type: setup_process_hook.ProcessHookManager
    process_env_var_manager: Any = field(repr=False)  # type: setup_environment_variables.ProcessEnvVarManager
    ...
    def _run_per_processing_interval(
        ...
        if self.show_progressbar:
            ...
            print(
                f"Warning: show_progressbar = {self.show_progressbar}. \n"
...
class ProcessCache:
    def __init__(
        ...
        cache_dir: str = ADI_ENV_VAR_DEFAULT["ADI_CACHE_DIR"],
    ) -> None:
...
class ProcessWrapper(Process):
    def __init__(
        ...
        **kwargs,
        ...
        self.pickle_path = process_cache.pickle_path
