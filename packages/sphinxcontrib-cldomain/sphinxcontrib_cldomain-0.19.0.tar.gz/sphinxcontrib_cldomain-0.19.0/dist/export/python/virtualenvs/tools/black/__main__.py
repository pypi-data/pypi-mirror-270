#!/home/russell/projects/sphinxcontrib-cldomain/dist/export/python/virtualenvs/tools/black/bin/python3.9 -sE
...
if __name__ == "__main__":
    ...
    shebang_python = '/home/russell/projects/sphinxcontrib-cldomain/dist/export/python/virtualenvs/tools/black/bin/python3.9'
    ...
    entry_point = (
        ...
        if pex_interpreter
        else pex_overrides.get("PEX_MODULE", 'black:patched_main' or PEX_INTERPRETER_ENTRYPOINT)
    )
