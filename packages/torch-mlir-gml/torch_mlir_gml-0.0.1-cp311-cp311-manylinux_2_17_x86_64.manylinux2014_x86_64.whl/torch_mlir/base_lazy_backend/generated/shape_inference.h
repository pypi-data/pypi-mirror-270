...
TORCH_API std::vector<torch::lazy::Shape> compute_shape__make_per_channel_quantized_tensor(const at::Tensor & self, const at::Tensor & scale, const at::Tensor & zero_point, int64_t axis);
TORCH_API std::vector<torch::lazy::Shape> compute_shape__make_per_tensor_quantized_tensor(const at::Tensor & self, double scale, int64_t zero_point);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_conv_tbc(const at::Tensor & self, const at::Tensor & weight, const at::Tensor & bias, int64_t pad);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_dequantize(const at::Tensor & self);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_diag_embed(const at::Tensor & self, int64_t offset, int64_t dim1, int64_t dim2);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_diagonal(const at::Tensor & self, int64_t offset, int64_t dim1, int64_t dim2);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_div(const at::Tensor & self, const at::Scalar & other, c10::optional<c10::string_view> rounding_mode);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_empty(at::IntArrayRef size, c10::optional<at::ScalarType> dtype, c10::optional<at::Layout> layout, c10::optional<at::Device> device, c10::optional<bool> pin_memory, c10::optional<at::MemoryFormat> memory_format);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_empty_strided(at::IntArrayRef size, at::IntArrayRef stride, c10::optional<at::ScalarType> dtype, c10::optional<at::Layout> layout, c10::optional<at::Device> device, c10::optional<bool> pin_memory);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_exponential(const at::Tensor & self, double lambd, c10::optional<at::Generator> generator);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_fill(const at::Tensor & self, const at::Scalar & value);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_int_repr(const at::Tensor & self);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_isinf(const at::Tensor & self);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_isnan(const at::Tensor & self);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_linspace(const at::Scalar & start, const at::Scalar & end, int64_t steps, c10::optional<at::ScalarType> dtype, c10::optional<at::Layout> layout, c10::optional<at::Device> device, c10::optional<bool> pin_memory);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_logit(const at::Tensor & self, c10::optional<double> eps);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_nan_to_num(const at::Tensor & self, c10::optional<double> nan, c10::optional<double> posinf, c10::optional<double> neginf);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_norm(const at::Tensor & self, const at::Scalar & p);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_prod(const at::Tensor & self, c10::optional<at::ScalarType> dtype);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_quantize_per_channel(const at::Tensor & self, const at::Tensor & scales, const at::Tensor & zero_points, int64_t axis, at::ScalarType dtype);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_quantize_per_tensor(const at::Tensor & self, double scale, int64_t zero_point, at::ScalarType dtype);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_reflection_pad2d(const at::Tensor & self, at::IntArrayRef padding);
...
TORCH_API std::vector<torch::lazy::Shape> compute_shape_resize(const at::Tensor & self, at::IntArrayRef size, c10::optional<at::MemoryFormat> memory_format);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_roll(const at::Tensor & self, at::IntArrayRef shifts, at::IntArrayRef dims);
TORCH_API std::vector<torch::lazy::Shape> compute_shape_scalar_tensor(const at::Scalar & s, c10::optional<at::ScalarType> dtype, c10::optional<at::Layout> layout, c10::optional<at::Device> device, c10::optional<bool> pin_memory);
