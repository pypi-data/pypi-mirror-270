...
help_texts = {
    ...
    'lino.core.model.Model.get_request_queryset' : _("""Return the Django queryset to be used by action request ar for any data view on this model."""),
    ...
    'lino.modlib.users.User.verification_code' : _("""A random string set for every new user. Used for online registration."""),
    ...
    'lino.modlib.users.Users' : _("""Base class for all data views on User."""),
