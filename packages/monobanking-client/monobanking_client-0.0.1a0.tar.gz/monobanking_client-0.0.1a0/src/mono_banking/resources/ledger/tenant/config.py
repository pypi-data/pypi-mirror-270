...
from ....types.ledger.tenant.config_retrieve_response import ConfigRetrieveResponse
...
class ConfigResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        Get the configuration variables tailored for your ledger environment by
        accessing the tenant configuration endpoint.
        """
        return self._get(
