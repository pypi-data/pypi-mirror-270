...
__all__ = ["CollectionLinkRetrieveResponse", "Amount", "Payer", "PayerNote", "Reference"]
...
class CollectionLinkRetrieveResponse(BaseModel):
    account_id: str
