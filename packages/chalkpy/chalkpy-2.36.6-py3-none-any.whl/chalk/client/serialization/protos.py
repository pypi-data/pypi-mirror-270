...
class OnlineQueryConverter:
    ...
    def online_query_request_feather_encode(
    ...
    ) -> online_query_pb2.OnlineQueryFeatherRequest:
        ...
        context_proto = OnlineQueryConverter.online_query_context_encode(request, options=context_options_dict)
        return online_query_pb2.OnlineQueryFeatherRequest(
    ...
    def _feature_result_encode(feature_result: FeatureResult) -> online_query_pb2.FeatureResult:
        ...
        if feature_result.error:
            feature_result_proto.error = ChalkErrorConverter.chalk_error_encode(feature_result.error)
    ...
    ) -> online_query_pb2.OnlineQueryFeatherResponse:
        proto_response = online_query_pb2.OnlineQueryFeatherResponse()
    ...
    @staticmethod
    def online_query_feather_response_decode(
        response_proto: online_query_pb2.OnlineQueryFeatherResponse,
    ) -> BulkOnlineQueryResult:
        import polars as pl
        import pyarrow as pa
