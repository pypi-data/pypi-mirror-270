...
class QueryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.OnlineQueryFeather = channel.unary_unary(
            "/chalk.engine.v1.QueryService/OnlineQueryFeather",
            request_serializer=chalk_dot_common_dot_v1_dot_online__query__pb2.OnlineQueryFeatherRequest.SerializeToString,
            response_deserializer=chalk_dot_common_dot_v1_dot_online__query__pb2.OnlineQueryFeatherResponse.FromString,
        )
...
class QueryServiceServicer(object):
    ...
    def OnlineQueryFeather(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details("Method not implemented!")
        raise NotImplementedError("Method not implemented!")
...
def add_QueryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "OnlineQueryFeather": grpc.unary_unary_rpc_method_handler(
            servicer.OnlineQueryFeather,
            request_deserializer=chalk_dot_common_dot_v1_dot_online__query__pb2.OnlineQueryFeatherRequest.FromString,
            response_serializer=chalk_dot_common_dot_v1_dot_online__query__pb2.OnlineQueryFeatherResponse.SerializeToString,
        ),
    }
...
class QueryService(object):
    ...
    def OnlineQueryFeather(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/chalk.engine.v1.QueryService/OnlineQueryFeather",
            chalk_dot_common_dot_v1_dot_online__query__pb2.OnlineQueryFeatherRequest.SerializeToString,
            chalk_dot_common_dot_v1_dot_online__query__pb2.OnlineQueryFeatherResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
