...
class QueryServiceStub:
    ...
    OnlineQueryFeather: UnaryUnaryMultiCallable[
        OnlineQueryFeatherRequest,
        OnlineQueryFeatherResponse,
    ]
...
class QueryServiceServicer(metaclass=ABCMeta):
    ...
    def OnlineQueryFeather(
        self,
        request: OnlineQueryFeatherRequest,
        context: _ServicerContext,
    ) -> Union[OnlineQueryFeatherResponse, Awaitable[OnlineQueryFeatherResponse]]: ...
