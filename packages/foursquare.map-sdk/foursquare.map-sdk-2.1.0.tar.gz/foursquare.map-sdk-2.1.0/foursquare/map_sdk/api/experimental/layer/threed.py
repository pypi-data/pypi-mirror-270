...
from foursquare.map_sdk.api.experimental.columns import LatLngAltColumns
...
class ThreeDLayer:
    ...
    Optional:
      ...
      angle_x: Union[int, float] - Additional X angle offset
      angle_y: Union[int, float] - Additional Y angle offset
      angle_z: Union[int, float] - Additional Z angle offset
    ...
    angle_x: Optional[Union[int, float]] = None
    angle_y: Optional[Union[int, float]] = None
    angle_z: Optional[Union[int, float]] = None
    model_3d: Optional[
        Literal[
            "airplane",
            "helicopter",
