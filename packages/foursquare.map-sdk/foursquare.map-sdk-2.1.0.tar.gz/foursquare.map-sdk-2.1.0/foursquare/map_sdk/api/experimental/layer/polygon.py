...
class PolygonLayer:
    ...
    Optional:
      ...
      stroke_opacity: Union[int, float] - Stroke opacity of the layer
      ...
      radius: Union[int, float] - Radius of points
      ...
      elevation_scale: Union[int, float] - Factor for scaling the elevation values with
    ...
    stroke_opacity: Optional[Union[int, float]] = None
    ...
    elevation_scale: Optional[Union[int, float]] = None
