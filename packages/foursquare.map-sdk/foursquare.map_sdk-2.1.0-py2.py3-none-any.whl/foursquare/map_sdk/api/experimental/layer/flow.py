...
class FlowLayer:
    ...
    Optional:
      ...
      flow_fade_amount: Union[int, float] - Flow fade amount
      max_top_flows_display_num: Union[int, float] - Maximum top flow value
    ...
    flow_fade_amount: Optional[Union[int, float]] = None
    max_top_flows_display_num: Optional[Union[int, float]] = None
