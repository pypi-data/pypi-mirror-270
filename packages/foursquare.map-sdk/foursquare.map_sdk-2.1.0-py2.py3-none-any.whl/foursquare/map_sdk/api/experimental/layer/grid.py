...
from foursquare.map_sdk.api.experimental.columns import LatLngColumns
...
class GridLayer:
    ...
    Optional:
      ...
      world_unit_size: Union[int, float] - World unit size
    ...
    world_unit_size: Optional[Union[int, float]] = None
