...
class GPF:
    ...
    def ShowStruct(self,Json="",Img="./gpf.png"):
        DotInfo=""
    ...
    def ShowGrid(self,Json="",Img="./gpf.png",IsShowRel=True):
        Heade='''
        ...
        if isinstance(Json,list):
            for i in range(len(Json)):
                if isinstance(Json[i],str) or isinstance(Json[i],int):
                    ...
                    DoctInfo+=self.DrawJson(Json[i],Root)
            ...
            for K,V in Json.items():
                ...
                if isinstance(V,str) or isinstance(V,int):
                    ...
                    DoctInfo+=self.DrawJson(V,K)
        return DoctInfo



    #Json='{"S":[{"NP":[{"r":"我们"},{"n":"大家"}]},{"VP":{"v":"喜欢"}}]}'
    #Json='{"ID1":"我们","ID2":"大家","ID3":"喜欢"}'
    #Json='{"1":10,"2":20,"33":1,"我呢":1,"31":1,"3":3,"44":1}'
    #Json='["我们","大家","喜欢"]'
    ...
    def ShowTree(self,Json):
        ...
        Script=""
        Script+=Head
        Script+=self.DrawJson(json.loads(Json))
        Script+=Tail
        return Script
