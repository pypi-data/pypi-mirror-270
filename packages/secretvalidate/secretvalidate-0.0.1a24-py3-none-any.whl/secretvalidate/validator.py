...
def get_headers(service, secret):
    headers_map = {
        ...
        'githubpat': {'Authorization': f'Bearer {secret}'}
...
parser.add_argument("-service",type=lowercase_choice,  choices=["snyk", "sonarcloud"], required=True, help="Service to validate secret for")
