...
class array:
    ...
    def __lshift__(self, other: bool | int | float | complex | object) -> array: ...

    def __ilshift__(self, other: bool | int | float | complex | object) -> array: ...

    def __rshift__(self, other: bool | int | float | complex | object) -> array: ...

    def __irshift__(self, other: bool | int | float | complex | object) -> array: ...
