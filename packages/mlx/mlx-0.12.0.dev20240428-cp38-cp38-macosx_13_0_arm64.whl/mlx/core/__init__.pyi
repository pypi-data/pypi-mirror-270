...
class array:
    ...
    def __lshift__(self, other: Union[bool, int, float, complex, object]) -> array: ...

    def __ilshift__(self, other: Union[bool, int, float, complex, object]) -> array: ...

    def __rshift__(self, other: Union[bool, int, float, complex, object]) -> array: ...

    def __irshift__(self, other: Union[bool, int, float, complex, object]) -> array: ...
