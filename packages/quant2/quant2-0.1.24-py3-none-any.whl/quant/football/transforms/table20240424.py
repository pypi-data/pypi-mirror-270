# data type: NDArrayDataset
# model type: NDArrayNet
# notes: 以线上数据作为数据源
import numpy as np
import pathlib
...
def get_params(**kwargs):
    ...
    time_limit = kwargs.get("time_limit", 90)

    slices = [(i, i + window_size - 1) for i in range(1, 2 + time_limit - window_size, shift_size)]
