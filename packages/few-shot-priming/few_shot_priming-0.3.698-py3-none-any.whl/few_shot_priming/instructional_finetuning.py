...
def run_instructiona_fine_tuning_similar(config, params, experiment, validate, logger, debug=False, topic_count=None, similarity=None, fine_tune=True, analyze_primes=False, path_similar_examples=None ):
    all_test_preds = []
    all_test_labels = []
...
def run_instructional_fine_tuning(config, params, experiment, validate, logger, debug, topic_count=None, sampling_strategy=None,
    ...
    if sampling_strategy =="similar":
        return run_instructiona_fine_tuning_similar(config, params, experiment, validate, logger, debug, topic_count, similarity,
