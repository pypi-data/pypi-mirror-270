...
if __name__ == "__main__":
    # 邮箱服务器地址
    MAIL_HOST = 'imap.zju.edu.cn'
    # 用户名
    MAIL_USER = 'zju_huye@zju.edu.cn'
    # 密码(部分邮箱为授权码)
    MAIL_PASS = 'huyele0920'
    # 邮件发送方邮箱地址
    SENDER = 'zju_huye@zju.edu.cn'

    email_notify = EmailNotify(MAIL_HOST, MAIL_USER, MAIL_PASS, SENDER)
    if email_notify.send_email("测试标题", "测试正文", attachment_filename=None, receiver='zjuhuye@zju.edu.cn'):
        print("邮件发送成功√")
    else:
        print("邮件发送失败×")