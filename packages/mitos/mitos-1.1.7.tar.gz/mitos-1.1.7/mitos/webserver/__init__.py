...
</html>""".format(imgidx=imgidx, content=content, news=news,
...
def genoutput(featurelist, acc, outputtype, request, sequence, code=None):
    """
    ...
    if outputtype == "bed":
        ...
        gffwriter(featurelist, acc, len(sequence), request)
    elif outputtype == "tbl":
