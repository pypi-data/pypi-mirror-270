...
from vortexes.stats.clique import stats_group
from vortexes.scans.clique import scans_group
from vortexes.__data_nodes.moon.clique import moon_group
...
def clique ():
	...
	def example_command ():	
		...
		#
		#	vortexes/structures/ride/season_1/TV_technicals_shares/ETF/rise.proc.py
		#
