...
'''
	import vortexes.rides.season_3.physical_span_reversals as PSR
	PSR.calc ()
'''
...
def calc (
	...
	'''
	import vortexes.rides.season_3.physical_span as PS_rides
	PS_rides.calc (
		places = places,
		label = "PS"
	)
	...
	'''
	import vortexes.rides.season_3.physical_span_average as PSA_rides
	PSA = PSA_rides.calc (
		places = places,
		spans = spans
	)
