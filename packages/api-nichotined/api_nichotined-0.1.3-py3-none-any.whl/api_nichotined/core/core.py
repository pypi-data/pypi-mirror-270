...
class Api:
    ...
    def put(self, path, params=None, data=None, json_data=None, headers=None) -> Response:
        return self._make_request("PUT", path, params=params, data=data, headers=headers, json_data=json_data)

    def delete(self, path, params=None, data=None, json_data=None, headers=None) -> Response:
