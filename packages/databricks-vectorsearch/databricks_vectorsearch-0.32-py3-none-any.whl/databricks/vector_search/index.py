...
class VectorSearchIndex:
    ...
    def similarity_search(
        ...
        :param offset: If offset is not None, returns the num_results of the similarity search ranked after offset (exclusive), otherwise returns the first num_results.
