...
def Instruction() -> None:
    ...
    # 8. Thresholding: 
        ...
        - dst: Output image (optional)
        > cv2.threshold(img, 150, 255, cv2.THRESH_BINARY), cv2.threshold(img, 150, 255, cv2.THRESH_TRUNC), 
        > cv2.threshold(img, 150, 255, cv2.THRESH_TOZERO), cv2.threshold(img, 150, 255, cv2.THRESH_TOZERO_INV)
