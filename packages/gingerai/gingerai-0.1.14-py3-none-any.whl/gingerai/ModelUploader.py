...
class ModelParams:
    ...
    def json(self):
        dataset_info = {
            "x_train": str(self.x_train.tolist()),
            "y_train": str(self.y_train.tolist()),
            "x_test": str(self.x_test.tolist()),
            "y_test": str(self.y_test.tolist())
        }
        
        if self.x_val is not None and self.y_val is not None:
            dataset_info["x_val"] = str(self.x_val.tolist())
            dataset_info["y_val"] = str(self.y_val.tolist())
