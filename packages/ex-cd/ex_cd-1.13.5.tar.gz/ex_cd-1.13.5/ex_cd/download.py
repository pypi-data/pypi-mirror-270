...
from .validate import _validate_gallery, DOWNLOAD_RESUME_FILE
from .collect import _load_gallery_history
from .common import metadata_args, META_FOLDER
...
def _download_gallery(url, gallery_dir, config, logger, history={}):
    ...
    args = [*gallery_dl_exec, *metadata_args, *gallery_dl_meta_args, resume_url]
