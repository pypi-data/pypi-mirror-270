...
from data_transformation_yfhsi.data_transformation_yfhsi import validations
...
def transpose2d(input_matrix: list[list[float]]) -> list:
    ...
    """
    try:
        validations.validate_transpose2d_matrix(input_matrix)
...
def window1d(
    ...
    """
    try:
        validations.validate_window1d_matrix(input_array)

        validations.function_variables_verification(size)
        validations.function_variables_verification(shift)
        validations.function_variables_verification(stride)
...
def convolution2d(
    ...
    """
    try:
        validations.validate_convolution2d_matrix(input_matrix)
        validations.validate_convolution2d_matrix(kernel)
