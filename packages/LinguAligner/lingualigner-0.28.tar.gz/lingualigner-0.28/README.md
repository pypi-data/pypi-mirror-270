...
target_annotation = aligner.align_annotation("he was a good man because he had a kind heart","he", "ele era um bom homem porque ele tinha um bom coração","ele", src_ann_start=29)
print(target_annotation)
