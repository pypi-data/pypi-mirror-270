...
def link_format_to_message(request, linkformat,
    ...
    if ct == numbers.ContentFormat.LINKFORMAT:
        ...
        return message_coapts.Message(code=numbers.NOT_ACCEPTABLE)

    return message_coapts.Message(payload=payload, content_format=ct)
