...
// EXTERNAL MODULE: ./node_modules/@difizen/libro-widget/es/index.js + 37 modules
var libro_widget_es = __webpack_require__(79862);
...
}(libro_widget_es/* WidgetView */.Lf), (view_descriptor = applyDecoratedDescriptor_default()(view_class2.prototype, "value", [view_dec3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
...
var SchemaFormModelContribution = (contribution_dec = (0,mana_syringe_es/* singleton */.ri)({
  contrib: libro_widget_es/* WidgetViewContribution */.ro
...
var LibroSchemaFormWidgetModule = mana_module/* ManaModule */.R.create().register(LibroSchemaFormtWidget, SchemaFormModelContribution).dependOn(libro_widget_es/* WidgetModule */.yF);
...
var App = function App() {
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsx)(components/* ManaComponents */.rF.Application, {
      asChild: true,
      modules: [mana_app_es/* ManaAppPreset */.n6L, es/* LibroLabModule */.kn, BaseModule, libro_widget_es/* WidgetModule */.yF, LibroSchemaFormWidgetModule]
    }, "libro")
  });
};
