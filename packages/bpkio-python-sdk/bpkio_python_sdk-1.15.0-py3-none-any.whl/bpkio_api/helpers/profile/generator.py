...
class TranscodingProfileGenerator:
    config = dict(preset="veryfast", schema="bkt-v1", framerate=25)
    ...
    def generate(self, renditions, packaging):
        if self.config["schema"] == "bkt-v1":
            ...
            return self.generate_bkt_v2(renditions, packaging)
        else:
    ...
    def generate_bkt_v2(self, renditions, packaging):
        ...
        video_ladder = {
            "common": {
                ...
                "gop_size": selected_duration[0],
                "keyint_min": selected_duration[0],
            }
        }
