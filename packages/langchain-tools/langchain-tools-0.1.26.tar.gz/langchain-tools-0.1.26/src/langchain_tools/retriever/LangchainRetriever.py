...
class LangChainRetriever:
    ...
    @staticmethod
    def create_retriever_from_path(path, embedding=None):
        """
    ...
    @staticmethod
    def create_question_and_context_from_path(path, embedding=None):
        """
        ...
        """
        retriever = LangChainRetriever.create_retriever_from_path(path, embedding)
