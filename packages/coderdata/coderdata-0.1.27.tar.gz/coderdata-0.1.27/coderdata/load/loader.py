...
class DatasetLoader:
    def __init__(self, dataset_type, data_directory="."):
        ...
        ----------
        dataset_type : str
            The type of dataset to load (e.g., 'hcmi', 'beataml', 'cptac', 'broad_sanger', "mpnst).
        data_directory : str
    ...
    def info(self):
        ...
        descriptions = {
            'broad_sanger': 'The cell line datasets were collected from numerous resources such as the LINCS project, DepMap, and the Sanger Institute.',
