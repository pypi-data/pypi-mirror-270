...
class IApi(System.IDisposable, metaclass=abc.ABCMeta):
    ...
    def create_live_algorithm(self, project_id: int, compile_id: str, server_type: str, base_live_algorithm_settings: System.Collections.Generic.Dictionary[str, System.Object], version_id: str = "-1", data_providers: System.Collections.Generic.Dictionary[str, System.Object] = None) -> QuantConnect.Api.LiveAlgorithm:
        """
