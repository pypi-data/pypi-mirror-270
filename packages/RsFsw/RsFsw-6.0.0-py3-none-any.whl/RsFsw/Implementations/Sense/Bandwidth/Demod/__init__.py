...
class DemodCls:
	...
	def set(self, bandwidth: float) -> None:
		...
		Sets the bandwidth for Analog Modulation Analysis. Depending on the selected demodulation bandwidth, the instrument
		selects the required sample rate. For details on the correlation between demodulation bandwidth and sample rate refer to
		'Sample rate and demodulation bandwidth'. Is identical to SENS:ADEM:BAND:DEM. \n
