...
class EventCls:
	...
	def get(self) -> str:
		...
		Queries the contents of the 'EVENt' section of the method RsFsw.Status.Questionable.Diq.Event.get_ register for IQ
		measurements. Readout deletes the contents of the 'EVENt' section. \n
