...
class FormatPyCls:
	...
	def set(self, format_py: enums.IqResultDataFormat) -> None:
		...
		available. \n
			:param format_py: COMPatible | IQBLock | IQPair COMPatible I and Q values are separated and collected in blocks: A block (512k) of I values is followed by a block (512k) of Q values, followed by a block of I values, followed by a block of Q values etc. (I,I,I,I,Q,Q,Q,Q,I,I,I,I,Q,Q,Q,Q...) IQBLock First all I-values are listed, then the Q-values (I,I,I,I,I,I,...Q,Q,Q,Q,Q,Q) This option is not available for input from SnP files (see 'Compensating for Frequency Response Using SnP Files (FSW-K544) ') . IQPair One pair of I/Q values after the other is listed (I,Q,I,Q,I,Q...) . This option is the default for input from SnP files (see 'Compensating for Frequency Response Using SnP Files (FSW-K544) ') .
		"""
	...
	def get(self) -> enums.IqResultDataFormat:
		...
		For traces captured using the optional 2 GHz / 5 GHz bandwidth extension (FSW-B2000/B5000) , only 'IQPair' format is
		available. \n
			:return: format_py: COMPatible | IQBLock | IQPair COMPatible I and Q values are separated and collected in blocks: A block (512k) of I values is followed by a block (512k) of Q values, followed by a block of I values, followed by a block of Q values etc. (I,I,I,I,Q,Q,Q,Q,I,I,I,I,Q,Q,Q,Q...) IQBLock First all I-values are listed, then the Q-values (I,I,I,I,I,I,...Q,Q,Q,Q,Q,Q) This option is not available for input from SnP files (see 'Compensating for Frequency Response Using SnP Files (FSW-K544) ') . IQPair One pair of I/Q values after the other is listed (I,Q,I,Q,I,Q...) . This option is the default for input from SnP files (see 'Compensating for Frequency Response Using SnP Files (FSW-K544) ') ."""
