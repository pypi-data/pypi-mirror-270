...
class WindowCls:
	...
	def get(self, window_name: str, direction: enums.WindowDirection, window_type: enums.WindowTypeK7) -> str:
		...
		Snippet: value: str = driver.applications.k7AnalogDemod.layout.add.window.get(window_name = 'abc', direction = enums.WindowDirection.ABOVe, window_type = enums.WindowTypeK7.AmSpectrum='XTIM:AM:RELative:AFSPectrum') \n
