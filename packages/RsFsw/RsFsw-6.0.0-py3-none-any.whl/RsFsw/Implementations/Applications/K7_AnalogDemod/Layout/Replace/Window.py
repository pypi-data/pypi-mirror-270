...
class WindowCls:
	...
	def set(self, window_name: str, window_type: enums.WindowTypeK7) -> None:
		...
		Snippet: driver.applications.k7AnalogDemod.layout.replace.window.set(window_name = 'abc', window_type = enums.WindowTypeK7.AmSpectrum='XTIM:AM:RELative:AFSPectrum') \n
