...
class ApacketsCls:
	...
	def get(self, window=repcap.Window.Default) -> str:
		"""SCPI: FETCh<n>:PACKet:STS:BST:APACkets \n
		Snippet: value: str = driver.applications.k149Uwb.fetch.packet.sts.bst.apackets.get(window = repcap.Window.Default) \n
		...
		response = self._core.io.query_str(f'FETCh{window_cmd_val}:PACKet:STS:BST:APACkets?')
