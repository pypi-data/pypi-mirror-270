...
class PeakCls:
	...
	def get(self, window=repcap.Window.Default) -> float:
		"""SCPI: FETCh<n>:SUMMary:POWer:PACKet:PEAK \n
		Snippet: value: float = driver.applications.k149Uwb.fetch.summary.power.packet.peak.get(window = repcap.Window.Default) \n
		...
		response = self._core.io.query_str(f'FETCh{window_cmd_val}:SUMMary:POWer:PACKet:PEAK?')
