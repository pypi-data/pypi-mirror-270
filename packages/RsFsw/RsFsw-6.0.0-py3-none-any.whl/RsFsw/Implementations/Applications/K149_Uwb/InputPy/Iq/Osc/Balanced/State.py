...
class StateCls:
	...
	def set(self, state: bool) -> None:
		...
		Snippet: driver.applications.k149Uwb.inputPy.iq.osc.balanced.state.set(state = False) \n
	...
	def get(self) -> bool:
		"""SCPI: INPut:IQ:OSC:BALanced[:STATe] \n
		Snippet: value: bool = driver.applications.k149Uwb.inputPy.iq.osc.balanced.state.get() \n
		No command help available \n
