...
class DefineCls:
	...
	def set(self, placeholder: str, type_py: str, interface: str, serial_no: str, powerMeter=repcap.PowerMeter.Default) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.system.communicate.rdevice.pmeter.define.set(placeholder = 'abc', type_py = 'abc', interface = 'abc', serial_no = 'abc', powerMeter = repcap.PowerMeter.Default) \n
