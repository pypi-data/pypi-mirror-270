...
class PathCls:
	...
	def set(self, filename: str, bandwidth: float = None) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.inputPy.file.path.set(filename = 'abc', bandwidth = 1.0) \n
		...
		I/Q Data Files'. \n
			...
			:param bandwidth: Optionally: The analysis bandwidth to be used by the measurement. The bandwidth must be smaller than or equal to the bandwidth of the data that was stored in the file. Unit: HZ
		"""
