...
class WindowCls:
	...
	def get(self, window_name: str, direction: enums.WindowDirection, window_type: enums.WindowTypeK14X) -> str:
		...
		Snippet: value: str = driver.applications.k14Xnr5G.layout.add.window.get(window_name = 'abc', direction = enums.WindowDirection.ABOVe, window_type = enums.WindowTypeK14X.AllocIDvsSymbolXcarrier=AISC) \n
