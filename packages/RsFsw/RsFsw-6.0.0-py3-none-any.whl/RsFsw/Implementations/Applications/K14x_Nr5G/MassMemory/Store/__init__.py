...
class StoreCls:
	"""Store commands group definition. 12 total commands, 8 Subgroups, 0 group commands
	...
	@property
	def iqnc(self):
		"""iqnc commands group. 1 Sub-classes, 0 commands."""
		if not hasattr(self, '_iqnc'):
			from .Iqnc import IqncCls
			self._iqnc = IqncCls(self._core, self._cmd_group)
		return self._iqnc
