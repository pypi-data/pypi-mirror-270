...
class TypePyCls:
	...
	def get(self) -> enums.IqType:
		"""SCPI: INPut:IQ:TYPE \n
		Snippet: value: enums.IqType = driver.applications.k70Vsa.inputPy.iq.typePy.get() \n
		Defines the format of the input signal. \n
