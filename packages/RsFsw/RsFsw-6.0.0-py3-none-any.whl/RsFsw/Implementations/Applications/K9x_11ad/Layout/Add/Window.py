...
class WindowCls:
	...
	def get(self, window_name: str, direction: enums.WindowDirection, window_type: enums.WindowTypeK9X) -> str:
		...
		Snippet: value: str = driver.applications.k9X11Ad.layout.add.window.get(window_name = 'abc', direction = enums.WindowDirection.ABOVe, window_type = enums.WindowTypeK9X.ChannelFreqResponse=CFR) \n
