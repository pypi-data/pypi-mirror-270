...
class DpathCls:
	...
	def set(self, direct_path_setting: enums.AutoOrOff) -> None:
		"""SCPI: INPut:DPATh \n
		Snippet: driver.applications.k17Mcgd.inputPy.dpath.set(direct_path_setting = enums.AutoOrOff.AUTO) \n
	...
	def get(self) -> enums.AutoOrOff:
		"""SCPI: INPut:DPATh \n
		Snippet: value: enums.AutoOrOff = driver.applications.k17Mcgd.inputPy.dpath.get() \n
		Enables or disables the use of the direct path for frequencies close to 0 Hz. If an external frontend is active, the
		direct path is always used. \n
