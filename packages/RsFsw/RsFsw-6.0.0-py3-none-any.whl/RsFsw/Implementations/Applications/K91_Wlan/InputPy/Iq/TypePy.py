...
class TypePyCls:
	...
	def set(self, data_type: enums.IqType) -> None:
		"""SCPI: INPut:IQ:TYPE \n
		Snippet: driver.applications.k91Wlan.inputPy.iq.typePy.set(data_type = enums.IqType.Ipart=I) \n
	...
	def get(self) -> enums.IqType:
		"""SCPI: INPut:IQ:TYPE \n
		Snippet: value: enums.IqType = driver.applications.k91Wlan.inputPy.iq.typePy.get() \n
		Defines the format of the input signal. \n
