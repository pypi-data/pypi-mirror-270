...
class ImpedanceCls:
	...
	def set(self, impedance: enums.LowHigh) -> None:
		"""SCPI: INPut:IQ:IMPedance \n
		Snippet: driver.applications.k91Wlan.inputPy.iq.impedance.set(impedance = enums.LowHigh.HIGH) \n
	...
	def get(self) -> enums.LowHigh:
		"""SCPI: INPut:IQ:IMPedance \n
		Snippet: value: enums.LowHigh = driver.applications.k91Wlan.inputPy.iq.impedance.get() \n
		Selects the nominal input impedance of the analog baseband input. Not available for input from the optional 'Digital
		Baseband' interface. For input from the RF input, use the method RsFsw.Applications.K10x_Lte.InputPy.Impedance.
		set command. \n
