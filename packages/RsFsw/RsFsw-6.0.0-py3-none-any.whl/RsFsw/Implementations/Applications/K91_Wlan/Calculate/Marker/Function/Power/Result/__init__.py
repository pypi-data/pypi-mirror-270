...
class ResultCls:
	...
	def set(self, measurement: enums.PowerMeasFunction, window=repcap.Window.Default, marker=repcap.Marker.Default) -> None:
		...
		Queries the results of power measurements. Is only available for measurements on RF data (see 'Frequency sweep
		measurements') . To get a valid result, you have to perform a complete measurement with synchronization to the end of the
