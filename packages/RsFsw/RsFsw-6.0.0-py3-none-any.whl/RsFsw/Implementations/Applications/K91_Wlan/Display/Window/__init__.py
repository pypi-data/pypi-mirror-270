...
class WindowCls:
	"""Window commands group definition. 48 total commands, 6 Subgroups, 0 group commands
	...
	def flags(self):
		...
		if not hasattr(self, '_flags'):
			from .Flags import FlagsCls
			self._flags = FlagsCls(self._core, self._cmd_group)
		return self._flags
