...
class WindowCls:
	...
	def get(self, window_name: str, direction: enums.WindowDirection, window_type: enums.WindowTypeK40) -> str:
		...
		Snippet: value: str = driver.applications.k40PhaseNoise.layout.add.window.get(window_name = 'abc', direction = enums.WindowDirection.ABOVe, window_type = enums.WindowTypeK40.FrequencyDrift=FDRift) \n
