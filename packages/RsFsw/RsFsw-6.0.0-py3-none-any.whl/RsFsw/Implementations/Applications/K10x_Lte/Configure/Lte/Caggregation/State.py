...
class StateCls:
	...
	def set(self, state: bool) -> None:
		...
		Turns carrier aggregation for time alignment error measurements on and off. You can select the number of component
		carriers with method RsFsw.Applications.K10x_Lte.Configure.Lte.NoCc.set. \n
