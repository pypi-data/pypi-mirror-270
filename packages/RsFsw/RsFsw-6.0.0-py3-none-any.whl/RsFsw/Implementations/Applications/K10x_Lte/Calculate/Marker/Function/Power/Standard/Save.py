...
class SaveCls:
	...
	def set(self, standard: str, window=repcap.Window.Default, marker=repcap.Marker.Default, subBlock=repcap.SubBlock.Default) -> None:
		...
		Snippet: driver.applications.k10Xlte.calculate.marker.function.power.standard.save.set(standard = 'abc', window = repcap.Window.Default, marker = repcap.Marker.Default, subBlock = repcap.SubBlock.Default) \n
