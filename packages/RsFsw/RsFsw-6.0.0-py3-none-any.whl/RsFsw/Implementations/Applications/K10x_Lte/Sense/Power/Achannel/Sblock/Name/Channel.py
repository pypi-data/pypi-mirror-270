...
class ChannelCls:
	...
	def set(self, name: str, subBlock=repcap.SubBlock.Default, channel=repcap.Channel.Default) -> None:
		...
		Snippet: driver.applications.k10Xlte.sense.power.achannel.sblock.name.channel.set(name = 'abc', subBlock = repcap.SubBlock.Default, channel = repcap.Channel.Default) \n
