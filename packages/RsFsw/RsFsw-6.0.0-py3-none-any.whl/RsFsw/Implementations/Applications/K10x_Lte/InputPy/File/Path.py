...
class PathCls:
	...
	def set(self, filename: str, demod_bw: float = None) -> None:
		...
		Snippet: driver.applications.k10Xlte.inputPy.file.path.set(filename = 'abc', demod_bw = 1.0) \n
		...
		I/Q Data Files'. \n
			...
			:param demod_bw: Optionally: The analysis bandwidth to be used by the measurement. The bandwidth must be smaller than or equal to the bandwidth of the data that was stored in the file. Unit: HZ
		"""
