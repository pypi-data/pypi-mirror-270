...
class ResultCls:
	...
	def get(self, window=repcap.Window.Default, marker=repcap.Marker.Default, trace=repcap.Trace.Default) -> float:
		...
		Queries the result of the signal-to-noise-and-distortion (SINAD) measurement in the specified window for the specified
		trace. Note that this value is only calculated if an AF Spectrum window is displayed. \n
