...
class PathCls:
	...
	def set(self, file_path: str, analysis_bw: float) -> None:
		...
		Snippet: driver.inputPy.file.path.set(file_path = 'abc', analysis_bw = 1.0) \n
		...
		I/Q Data Files'. \n
			:param file_path: String containing the path and name of the source file. The file type is determined by the file extension. If no file extension is provided, the file type is assumed to be .iq.tar. For .mat files, Matlab(R) v4 is assumed.
