...
class StandardDevCls:
	...
	def get(self, query_range: enums.SelectionRangeB) -> List[float]:
		"""SCPI: [SENSe]:PULSe:EMODel:FHPTime:SDEViation \n
		Snippet: value: List[float] = driver.applications.k6Pulse.sense.pulse.emodel.fallHighPoint.time.standardDev.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_bin_or_ascii_float_list(f'SENSe:PULSe:EMODel:FHPTime:SDEViation? {param}')
		return response
