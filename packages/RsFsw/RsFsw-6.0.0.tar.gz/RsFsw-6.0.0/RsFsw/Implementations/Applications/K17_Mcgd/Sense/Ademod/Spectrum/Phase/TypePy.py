...
class TypePyCls:
	...
	def set(self, trace_1: enums.TraceModeA, trace_2: enums.TraceModeA, trace_3: enums.TraceModeA) -> None:
		...
		Sets the modes of the first three traces of phase windows. Note that this command is maintained for compatibility reasons
		only. Use method RsFsw.Display.Window.Subwindow.Trace.Mode.set for new remote control programs. \n
