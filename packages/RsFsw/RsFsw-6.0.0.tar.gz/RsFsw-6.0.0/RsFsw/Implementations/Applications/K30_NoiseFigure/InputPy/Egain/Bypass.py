...
class BypassCls:
	...
	def set(self, state: bool) -> None:
		...
		Snippet: driver.applications.k30NoiseFigure.inputPy.egain.bypass.set(state = False) \n
	...
	def get(self) -> bool:
		"""SCPI: INPut:EGAin:BYPass \n
		Snippet: value: bool = driver.applications.k30NoiseFigure.inputPy.egain.bypass.get() \n
		No command help available \n
