...
class DpathCls:
	...
	def set(self, state: enums.AutoOrOff) -> None:
		"""SCPI: INPut:DPATh \n
		Snippet: driver.applications.k30NoiseFigure.inputPy.dpath.set(state = enums.AutoOrOff.AUTO) \n
		...
		direct path is always used. \n
			:param state: AUTO | OFF AUTO | 1 (Default) the direct path is used automatically for frequencies close to 0 Hz. OFF | 0 The analog mixer path is always used.
		"""
	...
	def get(self) -> enums.AutoOrOff:
		"""SCPI: INPut:DPATh \n
		Snippet: value: enums.AutoOrOff = driver.applications.k30NoiseFigure.inputPy.dpath.get() \n
		Enables or disables the use of the direct path for frequencies close to 0 Hz. If an external frontend is active, the
		direct path is always used. \n
