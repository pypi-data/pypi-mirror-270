...
class AttenuationCls:
	...
	def set(self, attenuation: float) -> None:
		...
		Snippet: driver.applications.k70Vsa.inputPy.sanalyzer.attenuation.set(attenuation = 1.0) \n
	...
	def get(self) -> float:
		"""SCPI: INPut:SANalyzer:ATTenuation \n
		Snippet: value: float = driver.applications.k70Vsa.inputPy.sanalyzer.attenuation.get() \n
		Configures attenuation at the analyzer input for an active external frontend manually. \n
