...
class TypePyCls:
	...
	def set(self, type_py: enums.LisnType) -> None:
		...
		Snippet: driver.applications.k70Vsa.inputPy.lisn.typePy.set(type_py = enums.LisnType.ENV216) \n
	...
	def get(self) -> enums.LisnType:
		"""SCPI: INPut:LISN[:TYPE] \n
		Snippet: value: enums.LisnType = driver.applications.k70Vsa.inputPy.lisn.typePy.get() \n
		Turns automatic control of a LISN on and off. It also selects the type of network. \n
