...
class PhaseCls:
	...
	def set(self, phase: enums.LisnPhase) -> None:
		...
		Snippet: driver.applications.k70Vsa.inputPy.lisn.phase.set(phase = enums.LisnPhase.L1) \n
	...
	def get(self) -> enums.LisnPhase:
		"""SCPI: INPut:LISN:PHASe \n
		Snippet: value: enums.LisnPhase = driver.applications.k70Vsa.inputPy.lisn.phase.get() \n
		Selects one LISN phase to be measured. \n
