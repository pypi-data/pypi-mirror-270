...
class WindowCls:
	...
	def get(self, window_name: str, direction: enums.WindowDirection, window_type: enums.WindowTypeK70) -> str:
		...
		Snippet: value: str = driver.applications.k70Vsa.layout.add.window.get(window_name = 'abc', direction = enums.WindowDirection.ABOVe, window_type = enums.WindowTypeK70.CaptureBufferMagnAbs=CBUFfer) \n
