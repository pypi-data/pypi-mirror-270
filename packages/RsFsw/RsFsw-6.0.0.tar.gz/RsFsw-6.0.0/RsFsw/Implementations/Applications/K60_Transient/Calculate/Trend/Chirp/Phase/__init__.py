...
class PhaseCls:
	...
	def set(self, yaxis: enums.AxisbK60, xaxis: enums.ChirpXaxisItems, window=repcap.Window.Default) -> None:
		"""SCPI: CALCulate<n>:TRENd:CHIRp:PHASe \n
		Snippet: driver.applications.k60Transient.calculate.trend.chirp.phase.set(yaxis = enums.AxisbK60.AVPHm, xaxis = enums.ChirpXaxisItems.AVGFm, window = repcap.Window.Default) \n
		...
		"""
		param = ArgSingleList().compose_cmd_string(ArgSingle('yaxis', yaxis, DataType.Enum, enums.AxisbK60), ArgSingle('xaxis', xaxis, DataType.Enum, enums.ChirpXaxisItems))
