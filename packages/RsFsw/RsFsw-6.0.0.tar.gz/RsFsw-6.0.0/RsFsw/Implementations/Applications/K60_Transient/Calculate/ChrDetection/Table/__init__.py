...
class TableCls:
	"""Table commands group definition. 40 total commands, 10 Subgroups, 0 group commands"""
	...
	@property
	def timing(self):
		"""timing commands group. 5 Sub-classes, 0 commands."""
	...
	@property
	def frequency(self):
		"""frequency commands group. 12 Sub-classes, 0 commands."""
