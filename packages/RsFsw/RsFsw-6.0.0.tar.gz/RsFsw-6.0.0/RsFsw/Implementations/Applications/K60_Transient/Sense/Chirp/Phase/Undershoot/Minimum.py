...
class MinimumCls:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:CHIRp:PHASe:UNDershoot:MINimum \n
		Snippet: value: float = driver.applications.k60Transient.sense.chirp.phase.undershoot.minimum.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:CHIRp:PHASe:UNDershoot:MINimum? {param}')
