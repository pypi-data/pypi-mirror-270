...
class PeakCls:
	...
	def set(self, window=repcap.Window.Default, deltaMarker=repcap.DeltaMarker.Default) -> None:
		...
		Moves a delta marker vertically to the highest level for the current frequency. The search includes all frames. It does
		not change the horizontal position of the marker. If the marker hasn't been active yet, the command looks for the peak
		level in the whole spectrogram. \n
