...
class UndershootCls:
	...
	def get(self, query_range: enums.SelectionRange) -> float:
		"""SCPI: [SENSe]:CHIRp:PHASe:UNDershoot \n
		Snippet: value: float = driver.applications.k60Transient.sense.chirp.phase.undershoot.get(query_range = enums.SelectionRange.ALL) \n
		Queries chirp phase undershoot from the result table. \n
		...
		response = self._core.io.query_str(f'SENSe:CHIRp:PHASe:UNDershoot? {param}')
