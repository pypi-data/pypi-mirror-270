...
class WindowCls:
	...
	def get(self, window_name: str, direction: enums.WindowDirection, window_type: enums.WindowTypeK60) -> str:
		...
		Snippet: value: str = driver.applications.k60Transient.layout.add.window.get(window_name = 'abc', direction = enums.WindowDirection.ABOVe, window_type = enums.WindowTypeK60.ChirpRateTimeDomain=CRTime) \n
