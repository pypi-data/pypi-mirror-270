...
class StandardDevCls:
	...
	def get(self, query_range: enums.SelectionRangeB) -> float:
		"""SCPI: [SENSe]:CHIRp:PHASe:OVERshoot:SDEViation \n
		Snippet: value: float = driver.applications.k60Transient.sense.chirp.phase.overshoot.standardDev.get(query_range = enums.SelectionRangeB.ALL) \n
		...
		response = self._core.io.query_str(f'SENSe:CHIRp:PHASe:OVERshoot:SDEViation? {param}')
