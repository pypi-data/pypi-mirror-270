...
class CouplingCls:
	...
	def set(self, coupling: enums.CouplingTypeB) -> None:
		...
		Snippet: driver.applications.k149Uwb.inputPy.iq.osc.coupling.set(coupling = enums.CouplingTypeB.AC) \n
	...
	def get(self) -> enums.CouplingTypeB:
		"""SCPI: INPut:IQ:OSC:COUPling \n
		Snippet: value: enums.CouplingTypeB = driver.applications.k149Uwb.inputPy.iq.osc.coupling.get() \n
		Determines the coupling of the oscilloscope to the FSW. \n
