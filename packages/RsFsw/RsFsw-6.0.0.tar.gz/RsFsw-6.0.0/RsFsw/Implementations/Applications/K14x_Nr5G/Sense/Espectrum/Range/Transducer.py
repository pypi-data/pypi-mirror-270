...
class TransducerCls:
	...
	def set(self, transducer: str, subBlock=repcap.SubBlock.Default, rangePy=repcap.RangePy.Default) -> None:
		...
		Snippet: driver.applications.k14Xnr5G.sense.espectrum.range.transducer.set(transducer = 'abc', subBlock = repcap.SubBlock.Default, rangePy = repcap.RangePy.Default) \n
