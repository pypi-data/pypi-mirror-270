...
class AlternateCls:
	...
	def set(self, state: bool, channel=repcap.Channel.Default) -> None:
		...
		Turns the weighting filter for an alternate channel on and off. For asymmetrical MSR signals, this command turns the
		weighting filter for the lower alternate channels on and off. To configure the filter state for the upper alternate
		channels, use the [SENSe:]POWer:ACHannel:FILTer[:STATe]:UALTernate<ch> command. \n
