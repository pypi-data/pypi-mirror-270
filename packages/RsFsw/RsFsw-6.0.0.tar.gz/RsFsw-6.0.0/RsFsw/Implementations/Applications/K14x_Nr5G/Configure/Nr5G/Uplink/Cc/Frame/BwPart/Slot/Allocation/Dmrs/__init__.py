...
class DmrsCls:
	"""Dmrs commands group definition. 15 total commands, 14 Subgroups, 0 group commands"""
	...
	@property
	def niOne(self):
		"""niOne commands group. 0 Sub-classes, 1 commands."""
		if not hasattr(self, '_niOne'):
			from .NiOne import NiOneCls
			self._niOne = NiOneCls(self._core, self._cmd_group)
		return self._niOne
