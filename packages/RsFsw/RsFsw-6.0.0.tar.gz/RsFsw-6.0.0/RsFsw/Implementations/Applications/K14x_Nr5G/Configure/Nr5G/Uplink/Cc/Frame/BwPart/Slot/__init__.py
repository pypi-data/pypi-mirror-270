...
class SlotCls:
	"""Slot commands group definition. 79 total commands, 8 Subgroups, 2 group commands
	...
	def uccCount(self):
		...
		if not hasattr(self, '_uccCount'):
			from .UccCount import UccCountCls
			self._uccCount = UccCountCls(self._core, self._cmd_group)
