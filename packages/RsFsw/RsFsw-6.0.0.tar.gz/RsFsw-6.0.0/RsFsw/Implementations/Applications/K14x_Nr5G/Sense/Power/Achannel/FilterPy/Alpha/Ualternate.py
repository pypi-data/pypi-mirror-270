...
class UalternateCls:
	...
	def set(self, alpha: float, upperAltChannel=repcap.UpperAltChannel.Default) -> None:
		...
		Defines the roll-off factor for the upper alternate channels' weighting filter for asymmetrical MSR signals. To configure
		the factor for the upper alternate channels, use the [SENSe:]POWer:ACHannel:FILTer:ALPHa:ALTernate<ch> command. \n
