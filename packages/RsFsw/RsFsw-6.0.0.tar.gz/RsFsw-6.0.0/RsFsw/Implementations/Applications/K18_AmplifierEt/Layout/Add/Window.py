...
class WindowCls:
	...
	def get(self, window_name: str, direction: enums.WindowDirection, window_type: enums.WindowTypeK18) -> str:
		...
		Snippet: value: str = driver.applications.k18AmplifierEt.layout.add.window.get(window_name = 'abc', direction = enums.WindowDirection.ABOVe, window_type = enums.WindowTypeK18.AdjChPowerTable=ACP) \n
