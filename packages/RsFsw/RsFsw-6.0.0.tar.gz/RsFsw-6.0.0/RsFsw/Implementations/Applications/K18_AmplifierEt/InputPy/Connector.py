...
class ConnectorCls:
	...
	def set(self, input_connectors: enums.InputConnector) -> None:
		"""SCPI: INPut:CONNector \n
		Snippet: driver.applications.k18AmplifierEt.inputPy.connector.set(input_connectors = enums.InputConnector.AIQI) \n
	...
	def get(self) -> enums.InputConnector:
		"""SCPI: INPut:CONNector \n
		Snippet: value: enums.InputConnector = driver.applications.k18AmplifierEt.inputPy.connector.get() \n
		Determines which connector the input for the measurement is taken from. For more information, see 'Receiving Data Input
		and Providing Data Output'. If an external frontend is active, the connector is automatically set to RF. \n
