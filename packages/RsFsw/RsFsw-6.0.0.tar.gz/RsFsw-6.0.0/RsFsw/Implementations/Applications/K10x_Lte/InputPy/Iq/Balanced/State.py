...
class StateCls:
	...
	def set(self, state: bool) -> None:
		...
		Snippet: driver.applications.k10Xlte.inputPy.iq.balanced.state.set(state = False) \n
	...
	def get(self) -> bool:
		"""SCPI: INPut:IQ:BALanced[:STATe] \n
		Snippet: value: bool = driver.applications.k10Xlte.inputPy.iq.balanced.state.get() \n
		Defines whether the input is provided as a differential signal via all 4 Analog Baseband connectors or as a plain I/Q
		signal via 2 single-ended lines. \n
