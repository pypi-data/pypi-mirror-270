...
class ResultCls:
	...
	def get(self, window=repcap.Window.Default, marker=repcap.Marker.Default, trace=repcap.Trace.Default) -> float:
		...
		Queries the result of the total harmonic distortion (THD) measurement in the specified window. Note that this value is
		only calculated if an AF Spectrum window is displayed. \n
