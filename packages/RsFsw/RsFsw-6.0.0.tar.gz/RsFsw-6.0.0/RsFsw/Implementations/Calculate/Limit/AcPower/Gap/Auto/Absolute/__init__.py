...
class AbsoluteCls:
	...
	def set(self, limit: float, reserved: float = None, window=repcap.Window.Default, limitIx=repcap.LimitIx.Default, gapChannel=repcap.GapChannel.Default) -> None:
		...
		Defines the absolute limit of the specified gap (CACLR) channel. If you define both an absolute limit and a relative
		limit, the FSW uses the lower value for the limit check. \n
