...
class AttenuationCls:
	...
	def set(self, attenuation: float, subBlock=repcap.SubBlock.Default, rangePy=repcap.RangePy.Default) -> None:
		...
		If an external frontend is active (see [SENSe:]EFRontend[:STATe]) , you can configure attenuation settings for the
		external frontend and the analyzer separately. This setting defines the attenuation for the analyzer. In case of high
		speed measurements, the input attenuation has to be identical for all ranges. \n
