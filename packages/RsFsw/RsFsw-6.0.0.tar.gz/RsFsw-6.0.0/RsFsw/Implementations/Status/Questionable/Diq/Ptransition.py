...
class PtransitionCls:
	...
	def set(self, bit_definition: int, channel_name: str = None) -> None:
		...
		Snippet: driver.status.questionable.diq.ptransition.set(bit_definition = 1, channel_name = 'abc') \n
		Controls the Positive TRansition part of a register. Setting a bit causes a 0 to 1 transition in the corresponding bit of
