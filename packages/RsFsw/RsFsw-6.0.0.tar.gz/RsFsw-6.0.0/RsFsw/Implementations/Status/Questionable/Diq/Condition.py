...
class ConditionCls:
	...
	def get(self) -> str:
		...
		Reads out the CONDition section of the method RsFsw.Status.Questionable.Diq.Condition.get_ status register. The command
		does not delete the contents of the EVENt section. \n
