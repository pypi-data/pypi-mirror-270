...
def get_mysql_client(host="", user="", password="", db="", port=3306, mincached=1, pattern=1, charset="utf8"):
    return StoreMysqlPool(host=host, user=user, password=password, db=db, port=port, mincached=mincached, pattern=pattern, charset=charset)
