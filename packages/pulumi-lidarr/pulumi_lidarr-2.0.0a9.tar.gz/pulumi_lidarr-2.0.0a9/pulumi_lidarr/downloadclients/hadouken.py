...
class Hadouken(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = lidarr.download_clients.Hadouken("example",
            enable=True,
            host="hadouken",
            password="password",
            port=9091,
        ...
        ```sh
         $ pulumi import lidarr:DownloadClients/hadouken:Hadouken example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Hadouken, __self__).__init__(
            'lidarr:DownloadClients/hadouken:Hadouken',
            resource_name,
            __props__,
            opts)
