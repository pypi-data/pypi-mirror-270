...
class Profile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = lidarr.profiles.Profile("example",
            cutoff=1100,
            quality_groups=[lidarr.profiles.ProfileQualityGroupArgs(
                id=1100,
                name="lossless",
                qualities=[
                    lidarr.profiles.ProfileQualityGroupQualityArgs(
                        id=7,
                        name="ALAC",
                    ),
                    lidarr.profiles.ProfileQualityGroupQualityArgs(
        ...
        ```sh
         $ pulumi import lidarr:Profiles/profile:Profile example 10
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Profile, __self__).__init__(
            'lidarr:Profiles/profile:Profile',
            resource_name,
            __props__,
            opts)
