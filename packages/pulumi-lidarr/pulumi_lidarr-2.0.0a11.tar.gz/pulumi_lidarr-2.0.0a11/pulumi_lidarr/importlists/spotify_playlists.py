...
__all__ = ['SpotifyPlaylistsArgs', 'SpotifyPlaylists']

@pulumi.input_type
class SpotifyPlaylistsArgs:
    def __init__(__self__, *,
                 access_token: pulumi.Input[str],
                 expires: pulumi.Input[str],
                 playlist_ids: pulumi.Input[Sequence[pulumi.Input[str]]],
        ...
        """
        The set of arguments for constructing a SpotifyPlaylists resource.
    ...
    def playlist_ids(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        """
        Playlist IDs.
        """
    ...
    @playlist_ids.setter
    def playlist_ids(self, value: pulumi.Input[Sequence[pulumi.Input[str]]]):
...
class _SpotifyPlaylistsState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None):
        """
        Input properties used for looking up and filtering SpotifyPlaylists resources.
        :param pulumi.Input[str] access_token: Access token.
        :param pulumi.Input[bool] enable_automatic_add: Enable automatic add flag.
        :param pulumi.Input[str] expires: Expires.
        :param pulumi.Input[int] list_order: List order.
...
class SpotifyPlaylists(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example = lidarr.import_lists.SpotifyPlaylists("example",
        ...
        ```sh
         $ pulumi import lidarr:ImportLists/spotifyPlaylists:SpotifyPlaylists example 1
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param SpotifyPlaylistsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SpotifyPlaylistsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SpotifyPlaylistsArgs.__new__(SpotifyPlaylistsArgs)
            ...
            if playlist_ids is None and not opts.urn:
                raise TypeError("Missing required property 'playlist_ids'")
        ...
        super(SpotifyPlaylists, __self__).__init__(
            'lidarr:ImportLists/spotifyPlaylists:SpotifyPlaylists',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            should_monitor_existing: Optional[pulumi.Input[bool]] = None,
            should_search: Optional[pulumi.Input[bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None) -> 'SpotifyPlaylists':
        """
        Get an existing SpotifyPlaylists resource's state with the given name, id, and optional extra
        ...
        __props__ = _SpotifyPlaylistsState.__new__(_SpotifyPlaylistsState)
        ...
        __props__.__dict__["should_search"] = should_search
        __props__.__dict__["tags"] = tags
        return SpotifyPlaylists(resource_name, opts=opts, __props__=__props__)
