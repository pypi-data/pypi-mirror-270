...
class TorrentDownloadStation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = lidarr.download_clients.TorrentDownloadStation("example",
            enable=True,
        ...
        ```sh
         $ pulumi import lidarr:DownloadClients/torrentDownloadStation:TorrentDownloadStation example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(TorrentDownloadStation, __self__).__init__(
            'lidarr:DownloadClients/torrentDownloadStation:TorrentDownloadStation',
            resource_name,
            __props__,
            opts)
