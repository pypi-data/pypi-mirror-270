...
class Utorrent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = lidarr.download_clients.Utorrent("example",
            enable=True,
            host="utorrent",
        ...
        ```sh
         $ pulumi import lidarr:DownloadClients/utorrent:Utorrent example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Utorrent, __self__).__init__(
            'lidarr:DownloadClients/utorrent:Utorrent',
            resource_name,
            __props__,
            opts)
