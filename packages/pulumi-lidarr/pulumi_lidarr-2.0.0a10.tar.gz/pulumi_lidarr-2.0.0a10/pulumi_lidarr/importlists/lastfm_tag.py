...
__all__ = ['LastfmTagArgs', 'LastfmTag']
...
class LastfmTagArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a LastfmTag resource.
...
class _LastfmTagState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None):
        """
        Input properties used for looking up and filtering LastfmTag resources.
        :param pulumi.Input[int] count_list: Elements to pull from list.
        :param pulumi.Input[bool] enable_automatic_add: Enable automatic add flag.
        :param pulumi.Input[int] list_order: List order.
        :param pulumi.Input[int] metadata_profile_id: Metadata profile ID.
...
class LastfmTag(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        for range in [{"value": i} for i in range(0, 25)]:
            example.append(lidarr.import_lists.LastfmTag(f"example-{range['value']}",
        ...
        ```sh
         $ pulumi import lidarr:ImportLists/lastfmTag:LastfmTag example 1
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param LastfmTagArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(LastfmTagArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = LastfmTagArgs.__new__(LastfmTagArgs)
        ...
        super(LastfmTag, __self__).__init__(
            'lidarr:ImportLists/lastfmTag:LastfmTag',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            should_search: Optional[pulumi.Input[bool]] = None,
            tag_id: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None) -> 'LastfmTag':
        """
        Get an existing LastfmTag resource's state with the given name, id, and optional extra
        ...
        __props__ = _LastfmTagState.__new__(_LastfmTagState)
        ...
        __props__.__dict__["tag_id"] = tag_id
        __props__.__dict__["tags"] = tags
        return LastfmTag(resource_name, opts=opts, __props__=__props__)
