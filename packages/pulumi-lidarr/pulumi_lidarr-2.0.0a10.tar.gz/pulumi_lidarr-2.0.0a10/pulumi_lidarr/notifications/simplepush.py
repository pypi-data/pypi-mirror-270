...
class Simplepush(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = lidarr.notifications.Simplepush("example",
            event="Event",
        ...
        ```sh
         $ pulumi import lidarr:Notifications/simplepush:Simplepush example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Simplepush, __self__).__init__(
            'lidarr:Notifications/simplepush:Simplepush',
            resource_name,
            __props__,
            opts)
