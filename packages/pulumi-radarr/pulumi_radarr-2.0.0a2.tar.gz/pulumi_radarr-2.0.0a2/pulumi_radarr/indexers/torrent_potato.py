...
class TorrentPotato(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = radarr.indexers.TorrentPotato("example",
        ...
        ```sh
         $ pulumi import radarr:Indexers/torrentPotato:TorrentPotato example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(TorrentPotato, __self__).__init__(
            'radarr:Indexers/torrentPotato:TorrentPotato',
            resource_name,
            __props__,
            opts)
