...
def get_condition_edition(name: Optional[str] = None,
    ...
    example_condition_edition = radarr.Profiles.get_condition_edition(name="Example",
        negate=False,
        required=False,
        value=".*Extended.*")
    ...
    __ret__ = pulumi.runtime.invoke('radarr:Profiles/getConditionEdition:getConditionEdition', __args__, opts=opts, typ=GetConditionEditionResult).value
