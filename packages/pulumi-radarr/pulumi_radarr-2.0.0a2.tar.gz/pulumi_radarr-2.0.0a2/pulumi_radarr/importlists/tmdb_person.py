...
class TmdbPerson(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = radarr.import_lists.TmdbPerson("example",
            cast=True,
            cast_director=True,
            cast_producer=True,
            cast_sound=True,
        ...
        ```sh
         $ pulumi import radarr:ImportLists/tmdbPerson:TmdbPerson example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(TmdbPerson, __self__).__init__(
            'radarr:ImportLists/tmdbPerson:TmdbPerson',
            resource_name,
            __props__,
            opts)
