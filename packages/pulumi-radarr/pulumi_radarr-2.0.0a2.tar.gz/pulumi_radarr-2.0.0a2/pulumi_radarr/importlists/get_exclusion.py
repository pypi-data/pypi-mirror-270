...
def get_exclusion(tmdb_id: Optional[int] = None,
    ...
    example = radarr.ImportLists.get_exclusion(tmdb_id=987)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('radarr:ImportLists/getExclusion:getExclusion', __args__, opts=opts, typ=GetExclusionResult).value
