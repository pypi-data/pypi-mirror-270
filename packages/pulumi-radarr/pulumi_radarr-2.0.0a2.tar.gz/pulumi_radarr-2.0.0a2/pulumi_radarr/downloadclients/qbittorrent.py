...
class Qbittorrent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = radarr.download_clients.Qbittorrent("example",
            enable=True,
            first_and_last=True,
            host="qbittorrent",
        ...
        ```sh
         $ pulumi import radarr:DownloadClients/qbittorrent:Qbittorrent example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Qbittorrent, __self__).__init__(
            'radarr:DownloadClients/qbittorrent:Qbittorrent',
            resource_name,
            __props__,
            opts)
