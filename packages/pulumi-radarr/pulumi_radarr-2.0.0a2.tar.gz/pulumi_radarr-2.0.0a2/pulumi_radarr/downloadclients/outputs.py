...
class GetDownloadClientsDownloadClientResult(dict):
    def __init__(__self__, *,
                 ...
                 movie_category: str,
                 movie_directory: str,
                 movie_imported_category: str,
                 name: str,
                 nzb_folder: str,
                 older_movie_priority: int,
                 older_priority: int,
                 password: str,
                 port: int,
        ...
        :param str movie_category: Movie category.
        :param str movie_directory: Movie directory.
        :param str movie_imported_category: Movie imported category.
        :param str name: Download Client name.
        :param str nzb_folder: NZB folder.
        :param int older_movie_priority: Older Movie priority. `0` Last, `1` First.
        :param int older_priority: Older Movie priority. `0` Last, `1` First.
        ...
        :param int recent_movie_priority: Recent Movie priority. `0` Last, `1` First.
        :param int recent_priority: Recent Movie priority. `0` Last, `1` First.
