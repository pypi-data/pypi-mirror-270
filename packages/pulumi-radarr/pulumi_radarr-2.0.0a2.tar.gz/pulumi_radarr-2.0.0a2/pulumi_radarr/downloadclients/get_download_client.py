...
def get_download_client(name: Optional[str] = None,
    ...
    example = radarr.DownloadClients.get_download_client(name="Example")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('radarr:DownloadClients/getDownloadClient:getDownloadClient', __args__, opts=opts, typ=GetDownloadClientResult).value
