...
class Transmission(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = radarr.download_clients.Transmission("example",
            enable=True,
            host="transmission",
            port=9091,
            priority=1,
        ...
        ```sh
         $ pulumi import radarr:DownloadClients/transmission:Transmission example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Transmission, __self__).__init__(
            'radarr:DownloadClients/transmission:Transmission',
            resource_name,
            __props__,
            opts)
