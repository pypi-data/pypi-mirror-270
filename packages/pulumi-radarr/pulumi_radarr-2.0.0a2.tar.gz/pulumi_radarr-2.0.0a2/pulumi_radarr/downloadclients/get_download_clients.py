...
def get_download_clients(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDownloadClientsResult:
    ...
    example = radarr.DownloadClients.get_download_clients()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('radarr:DownloadClients/getDownloadClients:getDownloadClients', __args__, opts=opts, typ=GetDownloadClientsResult).value
