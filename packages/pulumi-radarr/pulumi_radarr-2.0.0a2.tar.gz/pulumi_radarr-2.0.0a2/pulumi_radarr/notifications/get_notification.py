...
class GetNotificationResult:
    ...
    def __init__(__self__, access_token=None, access_token_secret=None, always_update=None, api_key=None, app_token=None, arguments=None, auth_password=None, auth_token=None, auth_user=None, auth_username=None, author=None, avatar=None, bccs=None, bot_token=None, ccs=None, channel=None, channel_tags=None, chat_id=None, clean_library=None, click_url=None, config_contract=None, configuration_key=None, consumer_key=None, consumer_secret=None, device_ids=None, device_names=None, devices=None, direct_message=None, display_time=None, event=None, expire=None, expires=None, field_tags=None, from_=None, grab_fields=None, host=None, icon=None, id=None, implementation=None, import_fields=None, include_health_warnings=None, instance_name=None, key=None, map_from=None, map_to=None, mention=None, method=None, name=None, notification_type=None, notify=None, on_application_update=None, on_download=None, on_grab=None, on_health_issue=None, on_health_restored=None, on_manual_interaction_required=None, on_movie_added=None, on_movie_delete=None, on_movie_file_delete=None, on_movie_file_delete_for_upgrade=None, on_rename=None, on_upgrade=None, password=None, path=None, port=None, priority=None, recipients=None, refresh_token=None, retry=None, send_silently=None, sender_domain=None, sender_id=None, server=None, server_url=None, sign_in=None, sound=None, stateless_urls=None, tags=None, token=None, topic_id=None, topics=None, tos=None, update_library=None, url=None, use_encryption=None, use_eu_endpoint=None, use_ssl=None, user_key=None, username=None, web_hook_url=None):
        ...
        if on_movie_added and not isinstance(on_movie_added, bool):
            raise TypeError("Expected argument 'on_movie_added' to be a bool")
        pulumi.set(__self__, "on_movie_added", on_movie_added)
        if on_movie_delete and not isinstance(on_movie_delete, bool):
            raise TypeError("Expected argument 'on_movie_delete' to be a bool")
        pulumi.set(__self__, "on_movie_delete", on_movie_delete)
        if on_movie_file_delete and not isinstance(on_movie_file_delete, bool):
            raise TypeError("Expected argument 'on_movie_file_delete' to be a bool")
        pulumi.set(__self__, "on_movie_file_delete", on_movie_file_delete)
        if on_movie_file_delete_for_upgrade and not isinstance(on_movie_file_delete_for_upgrade, bool):
            raise TypeError("Expected argument 'on_movie_file_delete_for_upgrade' to be a bool")
    ...
    def on_movie_file_delete(self) -> bool:
        """
    ...
    def on_movie_file_delete_for_upgrade(self) -> bool:
        """
...
def get_notification(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('radarr:Notifications/getNotification:getNotification', __args__, opts=opts, typ=GetNotificationResult).value
    ...
    return AwaitableGetNotificationResult(
        ...
        on_movie_added=pulumi.get(__ret__, 'on_movie_added'),
        on_movie_delete=pulumi.get(__ret__, 'on_movie_delete'),
        on_movie_file_delete=pulumi.get(__ret__, 'on_movie_file_delete'),
        on_movie_file_delete_for_upgrade=pulumi.get(__ret__, 'on_movie_file_delete_for_upgrade'),
