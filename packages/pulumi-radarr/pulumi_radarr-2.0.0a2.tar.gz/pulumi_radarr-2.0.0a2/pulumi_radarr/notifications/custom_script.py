...
class CustomScript(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = radarr.notifications.CustomScript("example",
        ...
        ```sh
         $ pulumi import radarr:Notifications/customScript:CustomScript example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(CustomScript, __self__).__init__(
            'radarr:Notifications/customScript:CustomScript',
            resource_name,
            __props__,
            opts)
