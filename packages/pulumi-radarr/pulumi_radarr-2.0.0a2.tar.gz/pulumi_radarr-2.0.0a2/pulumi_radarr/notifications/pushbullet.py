...
class Pushbullet(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = radarr.notifications.Pushbullet("example",
            api_key="Token",
            device_ids=["test"],
        ...
        ```sh
         $ pulumi import radarr:Notifications/pushbullet:Pushbullet example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Pushbullet, __self__).__init__(
            'radarr:Notifications/pushbullet:Pushbullet',
            resource_name,
            __props__,
            opts)
