...
__all__ = [
    'GetConditionYearResult',
    'AwaitableGetConditionYearResult',
    'get_condition_year',
    'get_condition_year_output',
]

@pulumi.output_type
class GetConditionYearResult:
    """
    A collection of values returned by getConditionYear.
    """
...
class AwaitableGetConditionYearResult(GetConditionYearResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetConditionYearResult(
            id=self.id,
...
def get_condition_year(max: Optional[int] = None,
                       min: Optional[int] = None,
                       name: Optional[str] = None,
                       negate: Optional[bool] = None,
                       required: Optional[bool] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConditionYearResult:
    """
    <!-- subcategory:Tags -->
    ...
    :param int max: Maximum Year.
    :param int min: Minimum Year.
    ...
    __ret__ = pulumi.runtime.invoke('radarr:Tags/getConditionYear:getConditionYear', __args__, opts=opts, typ=GetConditionYearResult).value

    return AwaitableGetConditionYearResult(
...
@_utilities.lift_output_func(get_condition_year)
def get_condition_year_output(max: Optional[pulumi.Input[int]] = None,
                              min: Optional[pulumi.Input[int]] = None,
                              name: Optional[pulumi.Input[str]] = None,
                              negate: Optional[pulumi.Input[bool]] = None,
                              required: Optional[pulumi.Input[bool]] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetConditionYearResult]:
    """
    <!-- subcategory:Tags -->
     Auto Tag Condition Series Type data source.
    For more intagion refer to [Auto Tag Conditions](https://wiki.servarr.com/radarr/settings#conditions).
