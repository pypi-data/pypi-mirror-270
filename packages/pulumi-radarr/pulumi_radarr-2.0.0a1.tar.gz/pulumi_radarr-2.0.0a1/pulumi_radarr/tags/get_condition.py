...
class GetConditionResult:
    ...
    def __init__(__self__, id=None, implementation=None, max=None, min=None, name=None, negate=None, required=None, value=None):
        ...
        if max and not isinstance(max, str):
            raise TypeError("Expected argument 'max' to be a str")
        pulumi.set(__self__, "max", max)
        if min and not isinstance(min, str):
            raise TypeError("Expected argument 'min' to be a str")
...
def get_condition(implementation: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('radarr:Tags/getCondition:getCondition', __args__, opts=opts, typ=GetConditionResult).value
...
def get_condition_output(implementation: Optional[pulumi.Input[str]] = None,
                         max: Optional[pulumi.Input[Optional[str]]] = None,
                         min: Optional[pulumi.Input[Optional[str]]] = None,
