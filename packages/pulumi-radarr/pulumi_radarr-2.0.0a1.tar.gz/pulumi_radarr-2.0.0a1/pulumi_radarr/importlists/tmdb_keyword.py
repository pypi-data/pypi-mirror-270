...
class TmdbKeyword(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = radarr.import_lists.TmdbKeyword("example",
            enable_auto=False,
            enabled=True,
            keyword_id="11842",
        ...
        ```sh
         $ pulumi import radarr:ImportLists/tmdbKeyword:TmdbKeyword example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(TmdbKeyword, __self__).__init__(
            'radarr:ImportLists/tmdbKeyword:TmdbKeyword',
            resource_name,
            __props__,
            opts)
