...
class TmdbCompany(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = radarr.import_lists.TmdbCompany("example",
            company_id="11842",
            enable_auto=False,
            enabled=True,
        ...
        ```sh
         $ pulumi import radarr:ImportLists/tmdbCompany:TmdbCompany example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(TmdbCompany, __self__).__init__(
            'radarr:ImportLists/tmdbCompany:TmdbCompany',
            resource_name,
            __props__,
            opts)
