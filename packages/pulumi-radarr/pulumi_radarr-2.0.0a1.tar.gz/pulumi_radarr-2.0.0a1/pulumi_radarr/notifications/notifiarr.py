...
class Notifiarr(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = radarr.notifications.Notifiarr("example",
            api_key="Token",
        ...
        ```sh
         $ pulumi import radarr:Notifications/notifiarr:Notifiarr example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Notifiarr, __self__).__init__(
            'radarr:Notifications/notifiarr:Notifiarr',
            resource_name,
            __props__,
            opts)
