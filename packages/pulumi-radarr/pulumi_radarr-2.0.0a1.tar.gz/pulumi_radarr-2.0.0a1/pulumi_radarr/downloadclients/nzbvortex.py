...
class Nzbvortex(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = radarr.download_clients.Nzbvortex("example",
            enable=True,
            host="nzbvortex",
            port=6789,
            priority=1,
        ...
        ```sh
         $ pulumi import radarr:DownloadClients/nzbvortex:Nzbvortex example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Nzbvortex, __self__).__init__(
            'radarr:DownloadClients/nzbvortex:Nzbvortex',
            resource_name,
            __props__,
            opts)
