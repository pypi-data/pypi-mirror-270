...
class Rtorrent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = radarr.download_clients.Rtorrent("example",
            enable=True,
            host="rtorrent",
            port=9091,
            priority=1,
        ...
        ```sh
         $ pulumi import radarr:DownloadClients/rtorrent:Rtorrent example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Rtorrent, __self__).__init__(
            'radarr:DownloadClients/rtorrent:Rtorrent',
            resource_name,
            __props__,
            opts)
