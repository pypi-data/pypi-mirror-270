...
__all__ = ['PassThePopcornArgs', 'PassThePopcorn']

@pulumi.input_type
class PassThePopcornArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a PassThePopcorn resource.
        ...
        :param pulumi.Input[str] name: IndexerPassThePopcorn name.
...
class _PassThePopcornState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None):
        """
        Input properties used for looking up and filtering PassThePopcorn resources.
        :param pulumi.Input[str] api_key: API key.
        :param pulumi.Input[str] api_user: API user.
        :param pulumi.Input[str] base_url: Base URL.
        :param pulumi.Input[int] download_client_id: Download client ID.
...
class PassThePopcorn(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example = radarr.indexers.PassThePopcorn("example",
            api_key="Key",
            api_user="User",
        ...
        ```sh
         $ pulumi import radarr:Indexers/passThePopcorn:PassThePopcorn example 1
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param PassThePopcornArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(PassThePopcornArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = PassThePopcornArgs.__new__(PassThePopcornArgs)
        ...
        super(PassThePopcorn, __self__).__init__(
            'radarr:Indexers/passThePopcorn:PassThePopcorn',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            seed_ratio: Optional[pulumi.Input[float]] = None,
            seed_time: Optional[pulumi.Input[int]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None) -> 'PassThePopcorn':
        """
        Get an existing PassThePopcorn resource's state with the given name, id, and optional extra
        ...
        __props__ = _PassThePopcornState.__new__(_PassThePopcornState)
        ...
        __props__.__dict__["seed_time"] = seed_time
        __props__.__dict__["tags"] = tags
        return PassThePopcorn(resource_name, opts=opts, __props__=__props__)
