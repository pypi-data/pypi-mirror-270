...
class GetMetadataResult:
    ...
    """
    def __init__(__self__, add_collection_name=None, config_contract=None, enable=None, id=None, implementation=None, movie_images=None, movie_metadata=None, movie_metadata_language=None, movie_metadata_url=None, name=None, tags=None, use_movie_nfo=None):
        if add_collection_name and not isinstance(add_collection_name, bool):
            raise TypeError("Expected argument 'add_collection_name' to be a bool")
...
class AwaitableGetMetadataResult(GetMetadataResult):
    ...
    def __await__(self):
        ...
        return GetMetadataResult(
            add_collection_name=self.add_collection_name,
...
def get_metadata(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('radarr:Metadata/getMetadata:getMetadata', __args__, opts=opts, typ=GetMetadataResult).value

    return AwaitableGetMetadataResult(
        add_collection_name=pulumi.get(__ret__, 'add_collection_name'),
