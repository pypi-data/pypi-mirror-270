...
def get_quality(name: Optional[str] = None,
    ...
    example = radarr.profiles.Profile("example",
        ...
        quality_groups=[
            radarr.profiles.ProfileQualityGroupArgs(
                id=2000,
                name="WEB 2160p",
                qualities=[
                    webdl,
    ...
    __ret__ = pulumi.runtime.invoke('radarr:Profiles/getQuality:getQuality', __args__, opts=opts, typ=GetQualityResult).value
