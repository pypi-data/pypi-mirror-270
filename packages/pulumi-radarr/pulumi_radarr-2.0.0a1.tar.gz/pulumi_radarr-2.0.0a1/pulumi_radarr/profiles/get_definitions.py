...
def get_definitions(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDefinitionsResult:
    ...
    example = radarr.Profiles.get_definitions()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('radarr:Profiles/getDefinitions:getDefinitions', __args__, opts=opts, typ=GetDefinitionsResult).value
