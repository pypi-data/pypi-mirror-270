...
def _set_trace_if_needed(
    ...
    if trace_data_singleton.trace_id is None:
        ...
        #  racer.start_span() is run as the root span without context manager (with statement or annotation), it will create a new span
        # and get_current_span is not linked to the get_current_span(). current_span WON'T have the id of the span created by start_span
        current_span = span or trace_api.get_current_span()
