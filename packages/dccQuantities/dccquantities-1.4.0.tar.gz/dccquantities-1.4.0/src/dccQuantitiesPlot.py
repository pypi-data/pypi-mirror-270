...
class dccQuantityTablePlot:
    def __init__(self, quantTab, colors=None):
        self.quntTab = copy(quantTab)
        self.quantityNames = self.quntTab.valueVectorsQuantities
        self.indexVectorQuantities = self.quntTab.indexVectorQuantities
        self.axisLogLin = "log"
        ...
        if colors == None:
            ...
            for idx, qn in enumerate(
                    self.quntTab.valueVectorsQuantities + self.quntTab.indexVectorQuantities
            ):
        ...
        self.indexSelectorRadioButtonGroup = RadioButtonGroup(
            labels=self.indexVectorQuantities, active=0
        )
        ...
        self.data_table = DataTable(source=self.tabDataSource, columns=self.columns, width=1600, height=400)
