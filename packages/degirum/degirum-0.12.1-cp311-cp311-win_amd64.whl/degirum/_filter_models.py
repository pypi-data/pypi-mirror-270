...
def check_runtime_device_supported(
    ...
    for t in supported_list:
        ...
        runtime_match = (
            ...
            or t[0] == "*"
            or runtime == t[0]
            or runtime == mparams.RuntimeAgent
        )
        device_match = (
            device is None
            or t[1] == "*"
            or device == t[1]
            or device == mparams.DeviceType
        )
...
def _filter_models(
    ...
    *,
    ...
    def is_device_supported(mparams, device_list):
        system_devices = [d.split("/")[1] for d in system_supported_device_types]
        return any(
    ...
    def is_runtime_supported(mparams, runtime_list):
        system_runtimes = [d.split("/")[0] for d in system_supported_device_types]
        return any(
