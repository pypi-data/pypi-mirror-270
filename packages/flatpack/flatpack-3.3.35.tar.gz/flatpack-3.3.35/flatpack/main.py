...
def main():
    try:
        with SessionManager() as session:
            ...
            # Add vector command subparsers
            vector_subparsers = parser.add_subparsers(dest='vector_command', help='Commands for vector operations')

            parser_add_text = vector_subparsers.add_parser('vector-add-texts',
                                                           help='Add new texts to generate embeddings and store them.')
            parser_add_text.add_argument('texts', nargs='+', help='Texts to add.')

            parser_search_text = vector_subparsers.add_parser('vector-search-text',
                                                              help='Search for texts similar to the given query.')
            parser_search_text.add_argument('query', help='Text query to search for.')

            parser_add_pdf = vector_subparsers.add_parser('vector-add-pdf',
            ...
            parser_add_url = vector_subparsers.add_parser('vector-add-url',
                                                          help='Add text from a URL to the vector database.')
            parser_add_url.add_argument('url', help='URL to add.')

            parser_add_wikipedia_page = vector_subparsers.add_parser('vector-add-wikipedia-page',
            ...
            if args.command.startswith('vector-'):
