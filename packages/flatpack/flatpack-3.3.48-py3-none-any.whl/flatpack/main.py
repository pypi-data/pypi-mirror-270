...
def setup_arg_parser():
    ...
    parser_terminate.set_defaults(func=handle_terminate_agent)
...
def handle_spawn_agent(args, session):
...
def handle_list_agents(args, session):
    """List active agents."""
    agent_manager = AgentManager()
    agent_manager.list_agents()


def handle_terminate_agent(args, session):
