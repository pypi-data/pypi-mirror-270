...
class TextSplitter(BaseSplitter):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if with_separators:
            cutter_config = (cutter_config or self.cutter_config or {}) | {
                "count_separators": True
            }
            joiner_config = (joiner_config or self.joiner_config or {}) | {
                "add_separator_to_parts_end": True
            }
        super().__init__(
