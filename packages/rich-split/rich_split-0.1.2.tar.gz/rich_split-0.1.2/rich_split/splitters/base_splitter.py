...
class BaseSplitter(ABC):
    ...
    def __init__(
        ...
        self.cutter_config = (cutter_config or {}) or (self.cutter_config or {})
        self.cutter_config = copy.deepcopy(self.cutter_config)
        self.joiner_config = (joiner_config or {}) or (self.joiner_config or {})
        self.joiner_config = copy.deepcopy(self.joiner_config)
        self.part_header_config = (part_header_config or {}) or (
