...
def fake_get() -> collections.abc.Callable:
...
@pytest.fixture
def successful_gitlab_interaction(mocker: pytest_mock.MockFixture) -> None:
    mocker.patch("gitlab.Gitlab.http_get", side_effect=fake_get())
