...
def cb_unsubscribe(result: Result, data: typing.Optional[Variant], userdata: ctrlxdatalayer.clib.userData_c_void_p):
    print("unsubscribe resp: ", result, int(userdata))
...
class TestClient(tests.test_integration_client.TestClientBase):
    ...
    def test_create_sub(self):
        ...
        def cb(result: Result, data: typing.Optional[Variant], userdata: ctrlxdatalayer.clib.userData_c_void_p):
            print("async resp: ", result, int(userdata))
        ...
        def cnb(result: Result, items: typing.List[ctrlxdatalayer.subscription.NotifyItem], userdata: ctrlxdatalayer.clib.userData_c_void_p):
            print("Sub: result={}, user={}".format(result, int(userdata)))

        v = ctrlxdatalayer.subscription.create_properties("Hallo")
        with v:
            r, sub = self.client.create_subscription_async(v, cnb, cb, 1)
            self.assertTrue(r == Result.OK)
            r = sub.wait_on_response_cb()
            self.assertTrue(r)
            sub.close()
    ...
    def test_unsubscribe_all(self):
        ...
        v = ctrlxdatalayer.subscription.create_properties("Hallo")
        with v:
            r, sub = self.client.create_subscription_async(v, cnb, cb, 2)
            with sub:
                self.assertTrue(r == Result.OK)
                r = sub.wait_on_response_cb()
                self.assertTrue(r)
                r = sub.unsubscribe_all(cb, 5678)
                self.assertTrue(r == Result.OK)
                r = sub.wait_on_response_cb()
                self.assertTrue(r)
    ...
    def test_subscribe(self):
        ...
        def cnb(result: Result, items: typing.List[ctrlxdatalayer.subscription.NotifyItem], userdata: ctrlxdatalayer.clib.userData_c_void_p):
            print("Sub: result={}, user={}, len={}".format(result, userdata,
        ...
        with v:
            r, sub = self.client.create_subscription_async(v, cnb, cb, 3)
            self.assertTrue(r == Result.OK)
            r = sub.wait_on_response_cb()
            self.assertTrue(r)
            with sub:
                r = sub.subscribe(
                    "framework/metrics/system/cpu-utilisation-percent", cb, 4)
                self.assertTrue(r == Result.OK)
                r = sub.wait_on_response_cb()
                self.assertTrue(r)
                self.wait()
    ...
    def test_unsubscribe_without(self):
        ...
        v = ctrlxdatalayer.subscription.create_properties("id: Hallo")
        with v:
            r, sub = self.client.create_subscription_async(v, cnb, cb, 5)
            r = sub.wait_on_response_cb()
            self.assertTrue(r)
            with sub:
                r = sub.unsubscribe(
                    "framework/metrics/system/cpu-utilisation-percent", cb, 6)
                self.assertTrue(r == Result.OK)
                r = sub.wait_on_response_cb()
                self.assertTrue(r)
    ...
    def test_unsubscribe(self):
        ...
        v = ctrlxdatalayer.subscription.create_properties("id: Hallo")
        with v:
            r, sub = self.client.create_subscription_async(v, cnb, cb, 7)
            r = sub.wait_on_response_cb()
            self.assertTrue(r)
            with sub:
                r = sub.subscribe(
                    "framework/metrics/system/cpu-utilisation-percent", cb, 8)
                self.assertTrue(r == Result.OK)
                r = sub.wait_on_response_cb()
                self.assertTrue(r)
                self.wait()
                self.assertTrue(self.ev.is_set())
                r = sub.unsubscribe(
                    "framework/metrics/system/cpu-utilisation-percent", cb, 9)
                self.assertTrue(r == Result.OK)
                r = sub.wait_on_response_cb()
                self.assertTrue(r)
    ...
    def test_subscribe_multi(self):
        ...
        v = ctrlxdatalayer.subscription.create_properties("id: Hallo")
        with v:
            r, sub = self.client.create_subscription_async(v, cnb, cb, 10)
            r = sub.wait_on_response_cb()
            self.assertTrue(r)
            with sub:
                self.__cpu = False
                ...
                r = sub.subscribe_multi(l, cb, 11)
                self.assertTrue(r == Result.OK)
                r = sub.wait_on_response_cb()  # you don't need this here
                self.assertTrue(r)
                self.wait()
                self.assertTrue(self.ev.is_set())
    ...
    def test_unsubscribe_multi_without(self):
        ...
        v = ctrlxdatalayer.subscription.create_properties("id: Hallo")
        with v:
            r, sub = self.client.create_subscription_async(v, cnb, cb, 12)
            r = sub.wait_on_response_cb()
            self.assertTrue(r)
            with sub:
                self.__cpu = False
                ...
                l = ["framework/metrics/system/cpu-utilisation-percent",
                     "framework/metrics/system/memused-percent"]
                r = sub.unsubscribe_multi(l, cb, 13)
                self.assertTrue(r == Result.OK)
                r = sub.wait_on_response_cb()
                self.assertTrue(r)
    ...
    def test_unsubscribe_multi(self):
        ...
        v = ctrlxdatalayer.subscription.create_properties("id: Hallo")
        with v:
            r, sub = self.client.create_subscription_async(v, cnb, cb, 14)
            r = sub.wait_on_response_cb()
            self.assertTrue(r)
            with sub:
                self.__cpu = False
                ...
                l = ["framework/metrics/system/cpu-utilisation-percent",
                     "framework/metrics/system/memused-percent"]
                r = sub.subscribe_multi(l, cb, 15)
                self.assertTrue(r == Result.OK)
                self.wait()
                r = sub.wait_on_response_cb()
                self.assertTrue(r)
                self.assertTrue(self.ev.is_set())
                r = sub.unsubscribe_multi(l, cb, 16)
                self.assertTrue(r == Result.OK)
                r = sub.wait_on_response_cb()
                self.assertTrue(r)
    ...
    def test_unsubscribe_multi_cpu(self):
        ...
        v = ctrlxdatalayer.subscription.create_properties("id: Hallo")
        with v:
            r, sub = self.client.create_subscription_async(v, cnb, cb, 17)
            self.assertTrue(r == Result.OK)
            r = sub.wait_on_response_cb()
            self.assertTrue(r)
            with sub:
                ...
                self.assertTrue(self.ev.is_set())
                l = ["framework/metrics/system/cpu-utilisation-percent"]
                r = sub.unsubscribe_multi(l, cb, 19)
                self.assertTrue(r == Result.OK)
                r = sub.wait_on_response_cb()
                self.assertTrue(r)
    ...
    def test_unsubscribe_multi_mem(self):
        ...
        v = ctrlxdatalayer.subscription.create_properties("id: Hallo")
        with v:
            r, sub = self.client.create_subscription_async(v, cnb, cb, 20)
            self.assertTrue(r == Result.OK)
            r = sub.wait_on_response_cb(10)
            self.assertTrue(r)
            with sub:
                self.__cpu = False
                self.__mem = False
                ...
                r = sub.unsubscribe_multi(l, cb, 22)
                self.assertTrue(r == Result.OK)
                r = sub.wait_on_response_cb(10)
                self.assertTrue(r)
