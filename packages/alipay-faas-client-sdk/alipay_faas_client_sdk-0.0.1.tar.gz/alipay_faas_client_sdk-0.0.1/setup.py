...
NAME = "alipay-faas-client-sdk"
DESCRIPTION = "Alipay FaaS Client SDK"
...
with open("alipay_faas_client_sdk/__init__.py", "r") as f:
    version_line = [
...
packages = find_packages(include=["alipay_faas_client_sdk", "alipay_faas_client_sdk.*"])
...
setup(
    ...
    packages=packages,
    package_data={"": []},
    package_dir={"alipay_faas_client_sdk": "alipay_faas_client_sdk"},
