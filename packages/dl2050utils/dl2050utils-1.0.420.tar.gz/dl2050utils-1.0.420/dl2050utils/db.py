...
def get_select_q(tbl, join=None, lookups=None, filters=None, sfilters=None, cols=None, sort=None, ascending=True,
    ...
    fs,sfs = parse_filters(filters, tbl),parse_filters(sfilters)
...
def rec_to_row(rec, lcols):
    """
    Converts record into db row colapsing all the lookup dicts into the id attr (ignoring the name attributes).
