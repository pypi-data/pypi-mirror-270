...
-- Easier and more future proof to copy whole thing and update single column
-- instead of a large update/select statement.
INSERT INTO _snapshot SELECT * FROM snapshot;
