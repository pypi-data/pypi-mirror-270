...
class MMDB(object):
    def __init__(self, storage_path=None, server_address="https://mmdb.piaqia.com/"):
    ...
    def get_mmdb_info(url):
        ...
        return pd.DataFrame(result.json())[['ID', 'Species', 'Tissue', 'Disease', 'Technology', 'Cell_num', 'Title']]
