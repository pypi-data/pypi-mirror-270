...
class BsSalary_Extractor:
        ...
        def handle_salary_fields_extraction(self, extraction_input, doc):
        ...
        def extract_data_for_SC(self, doc):
            ...
            data = self.handle_salary_fields_extraction(extraction_input, doc)
    ...
    ### 1. Data Extraction (from pdf) ---------------------------------
            ...
            if plain_text_data:
                ...
                ### raise an error : not a valid file
                try:
            ...
            try:
                ...
                try:
                    ...
                    result_data = self.handle_salary_fields_extraction(text, doc)
