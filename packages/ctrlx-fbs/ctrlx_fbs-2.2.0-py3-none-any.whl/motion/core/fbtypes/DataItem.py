...
def DataItemStart(builder): builder.StartObject(4)
def Start(builder):
...
def DataItemAddValue(builder, value): builder.PrependFloat64Slot(1, value, 0.0)
def AddValue(builder, value):
    return DataItemAddValue(builder, value)
def DataItemAddUnit(builder, unit): builder.PrependUOffsetTRelativeSlot(2, flatbuffers.number_types.UOffsetTFlags.py_type(unit), 0)
def AddUnit(builder, unit):
    return DataItemAddUnit(builder, unit)
def DataItemAddStatus(builder, status): builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(status), 0)
...
class DataItemT(object):
    ...
    def Pack(self, builder):
        ...
        DataItemAddValue(builder, self.value)
        if self.unit is not None:
