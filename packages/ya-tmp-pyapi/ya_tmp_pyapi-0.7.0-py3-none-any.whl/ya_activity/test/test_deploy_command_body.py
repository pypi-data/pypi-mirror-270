...
import ya_activity
from ya_activity.models.deploy_command_body import DeployCommandBody  # noqa: E501
from ya_activity.rest import ApiException

class TestDeployCommandBody(unittest.TestCase):
    """DeployCommandBody unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test DeployCommandBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ya_activity.models.deploy_command_body.DeployCommandBody()  # noqa: E501
        if include_optional :
            return DeployCommandBody(
                net = [
                    ya_activity.models.deploy_network.DeployNetwork(
                        id = '0', 
                        ip = '0', 
                        mask = '0', )
                    ], 
    ...
    def testDeployCommandBody(self):
        """Test DeployCommandBody"""
