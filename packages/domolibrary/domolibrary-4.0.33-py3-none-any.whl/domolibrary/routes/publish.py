...
__all__ = ['search_publications', 'get_publication_by_id', 'generate_publish_body', 'create_publish_job', 'udpate_publish_job',
           'get_subscription_summaries', 'get_subscriber_content_details', 'get_subscription_invititations',
           'accept_invite_by_id', 'accept_invite_by_id_v2', 'refresh_publish_jobs']
...
async def get_subscriber_content_details(
    ...
    if not res.is_success:
        raise GET_Publish_Error(status = res.status,
