...
class CtripAppService(object):
    ...
    @LoopFindElementSubmit(loop=8, action="隐藏导航栏")
    ...
    @LoopFindElementSubmit(loop=8, action="首页")
    def touch_home(self):
        """进入app后，点击【首页】"""
    ...
    @LoopFindElementSubmit(loop=8, action="我的")
    def touch_my(self):
        """进入app后，点击【我的】"""
    ...
    @LoopFindElementSubmit(loop=1, action="待付款")
    def touch_unpaid(self):
        """进入my主页后，点击【待付款】"""
        # 登录后的待付款元素定位
