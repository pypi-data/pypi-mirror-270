...
class WranglerResult():
    ...
    def __init__(self,
        ...
        Args:
        - split_dataset (SplitDataset): The ground truth and folds used to rank the pipelines.
        - train_results (PipelineResults): Predictions on train data, acquired
            using cross-validation.
        - test_results (Optional[PipelineResults]): Predictions on test data, if supplied
            in the problem definition.
        - rankings (Rankings): The rankings of all bound pipelines.
        '''
