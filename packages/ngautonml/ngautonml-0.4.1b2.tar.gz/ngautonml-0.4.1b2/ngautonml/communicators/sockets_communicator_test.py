...
def test_send() -> None:
    ...
    try:
        ...
        dut.send(dest_id=NodeID(0), payload=b'Hello World!')
...
def test_exchange() -> None:
    ...
    try:
        dut0.send(dest_id=NodeID(1), payload=b'Hello, Node 1!')
        ...
        dut1.send(dest_id=NodeID(0), payload=b'Nice to meet you, Node 0 :)')
