...
The sources for MAGNets can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/meghnathomas/magnets
.. _tarball: https://github.com/meghnathomas/magnets/tarball/master
