...
class AutoSpider(object):
    """
    AutoSpider : A Smart, Automatic, Fast and Lightweight Web Scraper for Python.
    AutoSpider automatically learns a set of rules required to extract the needed content
        from a web page. So the programmer doesn't need to explicitly construct the rules.

    Attributes
    ----------
    stack_list: list
        List of rules learned by AutoSpider
    ...
    def build(
        ...
        wanted_list: list of strings or compiled regular expressions, optional
            A list of needed contents to be scraped.
                AutoSpider learns a set of rules to scrape these targets. If specified,
        ...
        wanted_dict: dict, optional
            A dict of needed contents to be scraped. Keys are aliases and values are list of target texts
                ...
                AutoSpider learns a set of rules to scrape these targets and sets its aliases.
