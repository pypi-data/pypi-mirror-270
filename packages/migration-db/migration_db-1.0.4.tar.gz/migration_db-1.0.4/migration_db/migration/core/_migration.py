...
from common.calc_time import calc_func_time
...
class Migration(Base):
    ...
    def _restore_database(self):
        if self.migration_type == MigrationTypeEnum.MYSQL.code and self.local_sql_path:
            ...
            return MysqlConnector(**self.app_db_route).restore_from_slice_path(
                self.slice_path, self.is_restore_all_tables, self.restore_tables)
