...
#----
#
import vegan.clouds.supp_NIH.nature_v2.measured_ingredients.measured_ingredient as measured_ingredient_builder
import vegan.clouds.supp_NIH.nature_v2.measured_ingredients._ops.seek as seek
#
import vegan.clouds.supp_NIH.nature_v2._interpret.ingredientRows.for_each as for_each_IR
#
#
import json
#
...
def build (
	...
	def action (ingredient, indent, parent_ingredient):
		...
		if (parent_ingredient == None):
			...
			print ("inclusionary_ingredient name:", parent_ingredient ["name"])
