...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, content_guard=None, base_path=None, pulp_href=None, base_url=None, name=None, pulp_last_updated=None, pulp_labels=None, hidden=False, local_vars_configuration=None):  # noqa: E501
