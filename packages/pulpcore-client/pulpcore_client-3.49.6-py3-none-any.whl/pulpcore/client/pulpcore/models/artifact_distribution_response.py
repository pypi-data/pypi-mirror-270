...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, name=None, pulp_created=None, pulp_labels=None, base_url=None, pulp_href=None, base_path=None, hidden=False, content_guard=None, local_vars_configuration=None):  # noqa: E501
