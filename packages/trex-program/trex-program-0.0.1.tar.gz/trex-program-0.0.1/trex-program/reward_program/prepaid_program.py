...
class PrepaidSchemeProgram(SchemeRewardProgram):
    ...
    def __init__(self, program_configuration, currency=None):
        super(PrepaidSchemeProgram, self).__init__(program_configuration, currency=currency)
...
class PrepaidGiveawayProgram(GiveawayRewardBaseProgram):
    ...
    def __init__(self, program_configuration, reward_set=1):
        super(PrepaidGiveawayProgram, self).__init__(program_configuration, reward_set=reward_set)
