...
class SchemeBaseRewardProgram(RewardProgramBase):
    ...
    def __init__(self, program_configuration, currency=None):
        ...
        self.currency               = currency or app_conf.DEFAULT_CURRENCY
...
class SchemeRewardProgram(SchemeBaseRewardProgram):
    ...
    def __init__(self, program_configuration, currency=None):
        super(SchemeRewardProgram, self).__init__(program_configuration, currency=currency)
        self.expiration_type        = self.program_settings.get('scheme').get('expiration_type')
        self.expiration_value       = self.program_settings.get('scheme').get('expiration_value')
...
class GiveawayRewardBaseProgram(RewardProgramBase):
    def __init__(self, program_configuration, reward_set=1):
        super(GiveawayRewardBaseProgram, self).__init__(program_configuration)
...
class VoucherRewardProgramBase(GiveawayRewardBaseProgram):
    ...
    def __init__(self, program_configuration):
        super(VoucherRewardProgramBase, self).__init__(program_configuration)
