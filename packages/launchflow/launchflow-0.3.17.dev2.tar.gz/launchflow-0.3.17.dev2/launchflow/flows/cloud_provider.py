        ...
        if process.returncode == 127:
            ...
            if system == "Darwin":
                ...
                if proc.returncode != 0:
                    ...
                    return
                if proc_type == "arm64":
                    download_url = "https://dl.google.com/dl/cloudsdk/channels/rapid/downloads/google-cloud-sdk-371.0.0-darwin-arm.tar.gz"
                elif proc_type == "x86_64":
                    download_url = "https://dl.google.com/dl/cloudsdk/channels/rapid/downloads/google-cloud-sdk-371.0.0-darwin-x86_64.tar.gz"
                elif proc_type == "x86":
                    download_url = "https://dl.google.com/dl/cloudsdk/channels/rapid/downloads/google-cloud-sdk-371.0.0-darwin-x86.tar.gz"
                else:
                    rich.print(
