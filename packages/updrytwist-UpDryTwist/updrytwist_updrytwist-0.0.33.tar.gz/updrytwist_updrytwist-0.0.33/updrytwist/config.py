...
class ConfigReader:
    ...
    def floatreadNoneOk ( self, key: str, default: Optional[ float ] = None ) -> Union[
        float, None ]:
        val = self.read( key, default )
        if val is not None:
            return float( val )
...
def floatreadNoneOk ( dictionary, key : str, default : Optional[float] = None ) -> Union[float, None]:
...
class Config:
    ...
    def floatValueNoneOk ( self, key : str, default : Optional[float] = None, fromBlock : str = None ) -> Union[float, None]:
        return floatreadNoneOk( self.blockFor(fromBlock), key, default)

    def floatValue ( self, key : str, default : Optional[float] = None, fromBlock : str = None ) -> float:
    ...
    @staticmethod
    def getFloatNoneOk ( key : str, default : Optional[float] = None, fromBlock : str = None ) -> Union[float, None]:
        return Config.c.floatValueNoneOk( key, default, fromBlock )

    @staticmethod
    def getFloat ( key : str, default : Optional[float] = None, fromBlock : str = None ) -> float:
