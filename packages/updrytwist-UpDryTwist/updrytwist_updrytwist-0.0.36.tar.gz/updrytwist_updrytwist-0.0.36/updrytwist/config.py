...
class CannedConfig( Config ):
    ...
    def __init__ ( self, cannedConfig: { }, force_keys_lowercase : Optional[bool] = True):
        super().__init__( None, False, cannedConfig, force_keys_lowercase )
...
def loadConfig ( optional_config: bool = False,
                 ...
                 force_keys_lowercase : Optional[bool] = True):
    try:
        Config.c = Config( None, optional_config, force_keys_lowercase )
        ...
        if merge_environment:
            environment_dictionary = command_to_config.environment_variables_as_config_dictionary(force_keys_lowercase)
