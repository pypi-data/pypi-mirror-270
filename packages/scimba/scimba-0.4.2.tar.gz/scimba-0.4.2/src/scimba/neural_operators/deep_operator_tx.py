...
def LinearGreenOperator_tx(knet: nn.Module, **kwargs):
    class LinearGreenOperator_tx(knet):
        def __int__(self, in_size, out_size, **kwargs):
            ...
            self.activate_source_sublayer = kwargs.get("activate_source_sublayer", True)
            self.time_continuous = kwargs.get("time_continuous", True)

    ## TOO DOO finish init
    ## TOO DOO implement forward

    return LinearGreenOperator_tx(**kwargs)


def LowRank_LinearGreenOperator_tx(knet: nn.Module, **kwargs):
    class LowRank_LinearGreenOperator_tx(knet):
        def __int__(self, in_size, out_size, **kwargs):
            self.in_size = in_size
            self.out_size = out_size
            self.activate_local_sublayer = kwargs.get("activate_local_sublayer", True)
    ...
    return LowRank_LinearGreenOperator_tx(**kwargs)


def DeepGreenOperator_tx(layer: nn.Module, **kwargs):
    class DeepGreenOperator_tx(layer):
        def __int__(self, in_size, out_size, **kwargs):
    ...
    return DeepGreenOperator_tx(**kwargs)
