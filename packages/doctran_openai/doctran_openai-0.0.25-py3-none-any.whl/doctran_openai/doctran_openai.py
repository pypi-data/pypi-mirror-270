...
class Doctran:
    def __init__(self, openai_api_key: str = None, openai_api_base: str = None, openai_model: str = "gpt-3.5-turbo",
                 openai_token_limit: int = 8000, openai_deployment_id: Optional[str, None] = None):
        if openai_api_key is None and os.environ.get("OPENAI_API_KEY") is None:
            raise ValueError("OPENAI_API_KEY environment variable is not set or No OpenAI API Key provided")
