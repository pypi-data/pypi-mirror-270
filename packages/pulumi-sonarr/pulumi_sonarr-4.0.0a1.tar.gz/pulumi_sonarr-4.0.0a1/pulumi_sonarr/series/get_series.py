...
__all__ = [
    'GetSeriesResult',
    'AwaitableGetSeriesResult',
    'get_series',
    'get_series_output',
]

@pulumi.output_type
class GetSeriesResult:
    """
...
class AwaitableGetSeriesResult(GetSeriesResult):
...
def get_series(title: Optional[str] = None,
               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSeriesResult:
    """
    <!-- subcategory:Series -->
    Single Series.
    ...
    example = sonarr.Series.get_series(title="Friends")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('sonarr:Series/getSeries:getSeries', __args__, opts=opts, typ=GetSeriesResult).value

    return AwaitableGetSeriesResult(
...
@_utilities.lift_output_func(get_series)
def get_series_output(title: Optional[pulumi.Input[str]] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSeriesResult]:
    """
    <!-- subcategory:Series -->
    Single Series.
