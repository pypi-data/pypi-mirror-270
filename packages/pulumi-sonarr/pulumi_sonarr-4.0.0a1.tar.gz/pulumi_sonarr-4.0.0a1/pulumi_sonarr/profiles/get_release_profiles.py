...
def get_release_profiles(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetReleaseProfilesResult:
    ...
    List all available Release Profiles.
    ...
    example = sonarr.Profiles.get_release_profiles()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('sonarr:Profiles/getReleaseProfiles:getReleaseProfiles', __args__, opts=opts, typ=GetReleaseProfilesResult).value
