...
class Profile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.profiles.Profile("example",
            cutoff=1100,
            quality_groups=[sonarr.profiles.ProfileQualityGroupArgs(
                id=1100,
                name="4k",
                qualities=[
                    sonarr.profiles.ProfileQualityGroupQualityArgs(
                        id=18,
                        name="WEBDL-2160p",
                        resolution=2160,
                        source="web",
        ...
        ```sh
         $ pulumi import sonarr:Profiles/profile:Profile example 10
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Profile, __self__).__init__(
            'sonarr:Profiles/profile:Profile',
            resource_name,
            __props__,
            opts)
