...
def get_condition_language(name: Optional[str] = None,
    ...
    example_condition_language = sonarr.Profiles.get_condition_language(name="Example",
        negate=False,
        required=False,
        value="31")
    ...
    __ret__ = pulumi.runtime.invoke('sonarr:Profiles/getConditionLanguage:getConditionLanguage', __args__, opts=opts, typ=GetConditionLanguageResult).value
