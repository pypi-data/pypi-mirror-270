...
def get_delay_profiles(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDelayProfilesResult:
    ...
    List all available Delay Profiles.
    ...
    example = sonarr.Profiles.get_delay_profiles()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('sonarr:Profiles/getDelayProfiles:getDelayProfiles', __args__, opts=opts, typ=GetDelayProfilesResult).value
