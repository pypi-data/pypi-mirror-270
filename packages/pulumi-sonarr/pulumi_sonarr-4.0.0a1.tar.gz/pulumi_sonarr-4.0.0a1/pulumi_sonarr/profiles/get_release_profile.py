...
class GetReleaseProfileResult:
    ...
    """
    def __init__(__self__, enabled=None, id=None, ignoreds=None, indexer_id=None, name=None, requireds=None, tags=None):
...
def get_release_profile(id: Optional[int] = None,
    ...
    example = sonarr.Profiles.get_release_profile(id=1)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('sonarr:Profiles/getReleaseProfile:getReleaseProfile', __args__, opts=opts, typ=GetReleaseProfileResult).value
