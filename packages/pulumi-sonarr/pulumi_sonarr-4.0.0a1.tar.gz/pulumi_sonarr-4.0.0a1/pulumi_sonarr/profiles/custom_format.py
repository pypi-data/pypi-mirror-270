...
class CustomFormat(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.profiles.CustomFormat("example",
            include_custom_format_when_renaming=True,
            specifications=[
                sonarr.profiles.CustomFormatSpecificationArgs(
        ...
        ```sh
         $ pulumi import sonarr:Profiles/customFormat:CustomFormat example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(CustomFormat, __self__).__init__(
            'sonarr:Profiles/customFormat:CustomFormat',
            resource_name,
            __props__,
            opts)
