...
def get_profiles(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetProfilesResult:
    ...
    example = sonarr.Profiles.get_profiles()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('sonarr:Profiles/getProfiles:getProfiles', __args__, opts=opts, typ=GetProfilesResult).value
