...
def get_condition_resolution(name: Optional[str] = None,
    ...
    example_condition_resolution = sonarr.Profiles.get_condition_resolution(name="Example",
        negate=False,
        required=False,
        value="1080")
    ...
    __ret__ = pulumi.runtime.invoke('sonarr:Profiles/getConditionResolution:getConditionResolution', __args__, opts=opts, typ=GetConditionResolutionResult).value
