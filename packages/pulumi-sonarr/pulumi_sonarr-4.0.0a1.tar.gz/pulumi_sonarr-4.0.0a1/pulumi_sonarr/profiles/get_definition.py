...
def get_definition(id: Optional[int] = None,
    ...
    example = sonarr.Profiles.get_definition(id=21)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('sonarr:Profiles/getDefinition:getDefinition', __args__, opts=opts, typ=GetDefinitionResult).value
