...
def get_profile(name: Optional[str] = None,
    ...
    example = sonarr.Profiles.get_profile(name="HD")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('sonarr:Profiles/getProfile:getProfile', __args__, opts=opts, typ=GetProfileResult).value
