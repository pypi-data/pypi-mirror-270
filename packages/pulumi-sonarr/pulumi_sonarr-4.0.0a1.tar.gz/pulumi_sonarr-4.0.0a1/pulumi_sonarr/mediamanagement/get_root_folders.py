...
def get_root_folders(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRootFoldersResult:
    ...
    List all available Root Folders.
    ...
    example = sonarr.MediaManagement.get_root_folders()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('sonarr:MediaManagement/getRootFolders:getRootFolders', __args__, opts=opts, typ=GetRootFoldersResult).value
