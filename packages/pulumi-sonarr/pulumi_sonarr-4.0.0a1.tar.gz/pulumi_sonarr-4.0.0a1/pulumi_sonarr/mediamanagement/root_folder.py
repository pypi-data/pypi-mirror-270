...
class RootFolder(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.media_management.RootFolder("example", path="/tmp")
        ```
        ...
        ```sh
         $ pulumi import sonarr:MediaManagement/rootFolder:RootFolder example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(RootFolder, __self__).__init__(
            'sonarr:MediaManagement/rootFolder:RootFolder',
            resource_name,
            __props__,
            opts)
