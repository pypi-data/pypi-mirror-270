...
class UsenetBlackhole(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.download_clients.UsenetBlackhole("example",
            enable=True,
            nzb_folder="/nzb/",
            priority=1,
            watch_folder="/watch/")
        ...
        ```sh
         $ pulumi import sonarr:DownloadClients/usenetBlackhole:UsenetBlackhole example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(UsenetBlackhole, __self__).__init__(
            'sonarr:DownloadClients/usenetBlackhole:UsenetBlackhole',
            resource_name,
            __props__,
            opts)
