...
class GetDownloadClientResult:
    ...
    """
    def __init__(__self__, add_paused=None, add_stopped=None, additional_tags=None, api_key=None, category=None, config_contract=None, destination=None, enable=None, field_tags=None, first_and_last=None, host=None, id=None, implementation=None, initial_state=None, intial_state=None, magnet_file_extension=None, name=None, nzb_folder=None, older_tv_priority=None, password=None, port=None, post_import_tags=None, priority=None, protocol=None, read_only=None, recent_tv_priority=None, remove_completed_downloads=None, remove_failed_downloads=None, rpc_path=None, save_magnet_files=None, secret_token=None, sequential_order=None, start_on_add=None, strm_folder=None, tags=None, torrent_folder=None, tv_category=None, tv_directory=None, tv_imported_category=None, url_base=None, use_ssl=None, username=None, watch_folder=None):
        ...
        if older_tv_priority and not isinstance(older_tv_priority, int):
            raise TypeError("Expected argument 'older_tv_priority' to be a int")
        ...
        if recent_tv_priority and not isinstance(recent_tv_priority, int):
            raise TypeError("Expected argument 'recent_tv_priority' to be a int")
        ...
        if tv_category and not isinstance(tv_category, str):
            raise TypeError("Expected argument 'tv_category' to be a str")
        pulumi.set(__self__, "tv_category", tv_category)
        if tv_directory and not isinstance(tv_directory, str):
            raise TypeError("Expected argument 'tv_directory' to be a str")
...
class AwaitableGetDownloadClientResult(GetDownloadClientResult):
    ...
    def __await__(self):
        ...
        return GetDownloadClientResult(
            ...
            older_tv_priority=self.older_tv_priority,
            ...
            recent_tv_priority=self.recent_tv_priority,
            ...
            tv_directory=self.tv_directory,
...
def get_download_client(name: Optional[str] = None,
    ...
    example = sonarr.DownloadClients.get_download_client(name="Example")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('sonarr:DownloadClients/getDownloadClient:getDownloadClient', __args__, opts=opts, typ=GetDownloadClientResult).value
    ...
    return AwaitableGetDownloadClientResult(
        ...
        older_tv_priority=pulumi.get(__ret__, 'older_tv_priority'),
        ...
        recent_tv_priority=pulumi.get(__ret__, 'recent_tv_priority'),
        ...
        tv_category=pulumi.get(__ret__, 'tv_category'),
        tv_directory=pulumi.get(__ret__, 'tv_directory'),
