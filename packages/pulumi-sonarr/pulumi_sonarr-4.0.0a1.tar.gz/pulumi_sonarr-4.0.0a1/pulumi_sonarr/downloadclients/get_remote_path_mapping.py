...
def get_remote_path_mapping(id: Optional[int] = None,
    ...
    example = sonarr.DownloadClients.get_remote_path_mapping(id=1)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('sonarr:DownloadClients/getRemotePathMapping:getRemotePathMapping', __args__, opts=opts, typ=GetRemotePathMappingResult).value
