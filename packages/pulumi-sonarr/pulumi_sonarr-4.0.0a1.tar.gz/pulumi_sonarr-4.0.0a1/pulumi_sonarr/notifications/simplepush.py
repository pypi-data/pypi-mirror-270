...
class Simplepush(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.notifications.Simplepush("example",
        ...
        ```sh
         $ pulumi import sonarr:Notifications/simplepush:Simplepush example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Simplepush, __self__).__init__(
            'sonarr:Notifications/simplepush:Simplepush',
            resource_name,
            __props__,
            opts)
