...
class NewznabArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[int]]] anime_categories: Anime list.
...
class Newznab(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.indexers.Newznab("example",
            api_path="/api",
        ...
        ```sh
         $ pulumi import sonarr:Indexers/newznab:Newznab example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Newznab, __self__).__init__(
            'sonarr:Indexers/newznab:Newznab',
            resource_name,
            __props__,
            opts)
