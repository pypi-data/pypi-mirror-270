...
class GetIndexersIndexerResult(dict):
    def __init__(__self__, *,
        ...
        :param Sequence[int] anime_categories: Anime list.
        :param bool anime_standard_format_search: Search anime in standard format.
        ...
        :param int season_pack_seed_time: Season seed time.
