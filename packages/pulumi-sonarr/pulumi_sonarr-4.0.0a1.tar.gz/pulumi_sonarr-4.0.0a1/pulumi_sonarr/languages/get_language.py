...
def get_language(name: Optional[str] = None,
    ...
    example = sonarr.Languages.get_language(name="English")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('sonarr:Languages/getLanguage:getLanguage', __args__, opts=opts, typ=GetLanguageResult).value
