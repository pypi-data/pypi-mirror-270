...
class GetNotificationResult:
    ...
    def __init__(__self__, access_token=None, access_token_secret=None, always_update=None, api_key=None, app_token=None, arguments=None, auth_password=None, auth_token=None, auth_user=None, auth_username=None, author=None, avatar=None, bccs=None, bot_token=None, ccs=None, channel=None, channel_tags=None, chat_id=None, clean_library=None, click_url=None, config_contract=None, configuration_key=None, consumer_key=None, consumer_secret=None, device_ids=None, device_names=None, devices=None, direct_message=None, display_time=None, event=None, expire=None, expires=None, field_tags=None, from_=None, grab_fields=None, host=None, icon=None, id=None, implementation=None, import_fields=None, include_health_warnings=None, key=None, mention=None, method=None, name=None, notification_type=None, notify=None, on_application_update=None, on_download=None, on_episode_file_delete=None, on_episode_file_delete_for_upgrade=None, on_grab=None, on_health_issue=None, on_health_restored=None, on_manual_interaction_required=None, on_rename=None, on_series_add=None, on_series_delete=None, on_upgrade=None, password=None, path=None, port=None, priority=None, receiver_id=None, recipients=None, refresh_token=None, retry=None, send_silently=None, sender_domain=None, sender_id=None, sender_number=None, server=None, server_url=None, sign_in=None, sound=None, stateless_urls=None, tags=None, token=None, topics=None, tos=None, update_library=None, url=None, use_encryption=None, use_eu_endpoint=None, use_ssl=None, user_key=None, username=None, web_hook_url=None):
        ...
        if on_download and not isinstance(on_download, bool):
            raise TypeError("Expected argument 'on_download' to be a bool")
        pulumi.set(__self__, "on_download", on_download)
        if on_episode_file_delete and not isinstance(on_episode_file_delete, bool):
            raise TypeError("Expected argument 'on_episode_file_delete' to be a bool")
        pulumi.set(__self__, "on_episode_file_delete", on_episode_file_delete)
        if on_episode_file_delete_for_upgrade and not isinstance(on_episode_file_delete_for_upgrade, bool):
            raise TypeError("Expected argument 'on_episode_file_delete_for_upgrade' to be a bool")
        ...
        if on_manual_interaction_required and not isinstance(on_manual_interaction_required, bool):
            raise TypeError("Expected argument 'on_manual_interaction_required' to be a bool")
        ...
        if on_series_add and not isinstance(on_series_add, bool):
            raise TypeError("Expected argument 'on_series_add' to be a bool")
        pulumi.set(__self__, "on_series_add", on_series_add)
        if on_series_delete and not isinstance(on_series_delete, bool):
            raise TypeError("Expected argument 'on_series_delete' to be a bool")
        ...
        if use_encryption and not isinstance(use_encryption, int):
            raise TypeError("Expected argument 'use_encryption' to be a int")
    ...
    def on_episode_file_delete(self) -> bool:
        """
    ...
    def on_episode_file_delete_for_upgrade(self) -> bool:
        """
    ...
    def on_manual_interaction_required(self) -> bool:
        """
    ...
    def on_series_delete(self) -> bool:
        """
...
def get_notification(name: Optional[str] = None,
    ...
    example = sonarr.Notifications.get_notification(name="Example")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('sonarr:Notifications/getNotification:getNotification', __args__, opts=opts, typ=GetNotificationResult).value
    ...
    return AwaitableGetNotificationResult(
        ...
        on_download=pulumi.get(__ret__, 'on_download'),
        on_episode_file_delete=pulumi.get(__ret__, 'on_episode_file_delete'),
        on_episode_file_delete_for_upgrade=pulumi.get(__ret__, 'on_episode_file_delete_for_upgrade'),
        ...
        on_manual_interaction_required=pulumi.get(__ret__, 'on_manual_interaction_required'),
        on_rename=pulumi.get(__ret__, 'on_rename'),
        on_series_add=pulumi.get(__ret__, 'on_series_add'),
        on_series_delete=pulumi.get(__ret__, 'on_series_delete'),
        ...
        use_encryption=pulumi.get(__ret__, 'use_encryption'),
