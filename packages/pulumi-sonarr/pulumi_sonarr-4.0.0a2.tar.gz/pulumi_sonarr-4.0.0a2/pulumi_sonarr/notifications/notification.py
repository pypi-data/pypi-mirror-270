...
class Notification(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.notifications.Notification("example",
        ...
        ```sh
         $ pulumi import sonarr:Notifications/notification:Notification example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["accessTokenSecret", "apiKey", "appToken", "authPassword", "authToken", "configurationKey", "consumerSecret", "key", "password", "token"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(Notification, __self__).__init__(
            'sonarr:Notifications/notification:Notification',
            resource_name,
            __props__,
            opts)
