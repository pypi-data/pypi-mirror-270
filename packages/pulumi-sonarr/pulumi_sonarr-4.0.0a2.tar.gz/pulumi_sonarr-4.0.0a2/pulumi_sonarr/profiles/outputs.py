...
class GetDelayProfilesDelayProfileResult(dict):
    def __init__(__self__, *,
                 bypass_if_above_custom_format_score: bool,
                 ...
                 usenet_delay: int):
        """
        :param bool bypass_if_above_custom_format_score: Bypass for higher custom format score flag.
        ...
        :param int minimum_custom_format_score: Minimum custom format score.
...
class GetQualityProfilesQualityProfileResult(dict):
    def __init__(__self__, *,
        ...
        :param Sequence['GetQualityProfilesQualityProfileFormatItemArgs'] format_items: Quality groups.
...
class GetReleaseProfilesReleaseProfileResult(dict):
    def __init__(__self__, *,
        ...
        :param Sequence[str] ignoreds: Ignored terms.
        :param int indexer_id: Indexer ID. Set `0` for all.
        :param str name: Release profile name.
        :param Sequence[str] requireds: Required terms.
        :param Sequence[int] tags: List of associated tags.
        """
