...
def get_condition_source(name: Optional[str] = None,
    ...
    example_condition_source = sonarr.Profiles.get_condition_source(name="Example",
        negate=False,
        required=False,
        value="7")
    ...
    __ret__ = pulumi.runtime.invoke('sonarr:Profiles/getConditionSource:getConditionSource', __args__, opts=opts, typ=GetConditionSourceResult).value
