...
class QualityProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.profiles.QualityProfile("example",
            cutoff=1100,
            quality_groups=[sonarr.profiles.QualityProfileQualityGroupArgs(
                id=1100,
                name="4k",
                qualities=[
                    sonarr.profiles.QualityProfileQualityGroupQualityArgs(
                        id=18,
                        name="WEBDL-2160p",
                        resolution=2160,
                        source="web",
    ...
    def _internal_init(__self__,
        ...
        super(QualityProfile, __self__).__init__(
            'sonarr:Profiles/qualityProfile:QualityProfile',
            resource_name,
            __props__,
            opts)
