...
def get_quality_profile(name: Optional[str] = None,
    ...
    example = sonarr.Profiles.get_quality_profile(name="HD")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('sonarr:Profiles/getQualityProfile:getQualityProfile', __args__, opts=opts, typ=GetQualityProfileResult).value
