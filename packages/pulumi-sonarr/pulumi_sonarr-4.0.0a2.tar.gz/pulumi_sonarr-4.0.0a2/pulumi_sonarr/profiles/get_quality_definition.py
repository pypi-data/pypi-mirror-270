...
class GetQualityDefinitionResult:
    ...
    """
    def __init__(__self__, id=None, max_size=None, min_size=None, quality_id=None, quality_name=None, resolution=None, source=None, title=None):
...
def get_quality_definition(id: Optional[int] = None,
    ...
    example = sonarr.Profiles.get_quality_definition(id=21)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('sonarr:Profiles/getQualityDefinition:getQualityDefinition', __args__, opts=opts, typ=GetQualityDefinitionResult).value
