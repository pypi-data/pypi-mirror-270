...
def get_condition_release_title(name: Optional[str] = None,
    ...
    example_condition_release_title = sonarr.Profiles.get_condition_release_title(name="x265",
        negate=False,
        required=False,
        value="(((x|h)\\\\.?265)|(HEVC))")
    ...
    __ret__ = pulumi.runtime.invoke('sonarr:Profiles/getConditionReleaseTitle:getConditionReleaseTitle', __args__, opts=opts, typ=GetConditionReleaseTitleResult).value
