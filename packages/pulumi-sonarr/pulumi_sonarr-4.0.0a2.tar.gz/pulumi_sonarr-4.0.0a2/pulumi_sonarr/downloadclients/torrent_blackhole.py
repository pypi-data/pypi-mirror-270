...
class TorrentBlackhole(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.download_clients.TorrentBlackhole("example",
            enable=True,
        ...
        ```sh
         $ pulumi import sonarr:DownloadClients/torrentBlackhole:TorrentBlackhole example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(TorrentBlackhole, __self__).__init__(
            'sonarr:DownloadClients/torrentBlackhole:TorrentBlackhole',
            resource_name,
            __props__,
            opts)
