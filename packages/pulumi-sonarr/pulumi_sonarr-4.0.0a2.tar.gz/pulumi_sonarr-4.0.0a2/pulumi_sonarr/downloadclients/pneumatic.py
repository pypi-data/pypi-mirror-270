...
class Pneumatic(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.download_clients.Pneumatic("example",
            enable=True,
            nzb_folder="/nzb/",
            priority=1,
            strm_folder="/strm/")
        ...
        ```sh
         $ pulumi import sonarr:DownloadClients/pneumatic:Pneumatic example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Pneumatic, __self__).__init__(
            'sonarr:DownloadClients/pneumatic:Pneumatic',
            resource_name,
            __props__,
            opts)
