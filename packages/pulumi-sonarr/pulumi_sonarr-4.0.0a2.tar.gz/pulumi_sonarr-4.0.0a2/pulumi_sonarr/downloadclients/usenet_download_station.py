...
class UsenetDownloadStation(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.download_clients.UsenetDownloadStation("example",
            enable=True,
        ...
        ```sh
         $ pulumi import sonarr:DownloadClients/usenetDownloadStation:UsenetDownloadStation example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(UsenetDownloadStation, __self__).__init__(
            'sonarr:DownloadClients/usenetDownloadStation:UsenetDownloadStation',
            resource_name,
            __props__,
            opts)
