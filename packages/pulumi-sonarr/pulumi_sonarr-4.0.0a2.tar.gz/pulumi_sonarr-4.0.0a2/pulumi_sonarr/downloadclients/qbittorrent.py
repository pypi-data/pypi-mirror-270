...
class Qbittorrent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.download_clients.Qbittorrent("example",
            enable=True,
            first_and_last=True,
            host="qbittorrent",
            port=9091,
        ...
        ```sh
         $ pulumi import sonarr:DownloadClients/qbittorrent:Qbittorrent example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Qbittorrent, __self__).__init__(
            'sonarr:DownloadClients/qbittorrent:Qbittorrent',
            resource_name,
            __props__,
            opts)
