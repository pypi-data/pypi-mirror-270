...
class NzbvortexArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] older_tv_priority: Older TV priority. `-1` Low, `0` Normal, `1` High.
        :param pulumi.Input[int] port: Port.
        :param pulumi.Input[int] priority: Priority.
        :param pulumi.Input[int] recent_tv_priority: Recent TV priority. `-1` Low, `0` Normal, `1` High.
...
class Nzbvortex(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.download_clients.Nzbvortex("example",
            enable=True,
            host="nzbvortex",
            port=6789,
            priority=1,
        ...
        ```sh
         $ pulumi import sonarr:DownloadClients/nzbvortex:Nzbvortex example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Nzbvortex, __self__).__init__(
            'sonarr:DownloadClients/nzbvortex:Nzbvortex',
            resource_name,
            __props__,
            opts)
