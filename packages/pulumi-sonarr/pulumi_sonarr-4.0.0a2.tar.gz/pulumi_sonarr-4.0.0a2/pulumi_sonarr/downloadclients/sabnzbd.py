...
class SabnzbdArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] older_tv_priority: Older TV priority. `-100` Default, `-2` Paused, `-1` Low, `0` Normal, `1` High, `2` Force.
        :param pulumi.Input[str] password: Password.
        :param pulumi.Input[int] port: Port.
        :param pulumi.Input[int] priority: Priority.
        :param pulumi.Input[int] recent_tv_priority: Recent TV priority. `-100` Default, `-2` Paused, `-1` Low, `0` Normal, `1` High, `2` Force.
...
class Sabnzbd(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.download_clients.Sabnzbd("example",
            api_key="test",
            enable=True,
            host="sabnzbd",
            port=9091,
        ...
        ```sh
         $ pulumi import sonarr:DownloadClients/sabnzbd:Sabnzbd example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Sabnzbd, __self__).__init__(
            'sonarr:DownloadClients/sabnzbd:Sabnzbd',
            resource_name,
            __props__,
            opts)
