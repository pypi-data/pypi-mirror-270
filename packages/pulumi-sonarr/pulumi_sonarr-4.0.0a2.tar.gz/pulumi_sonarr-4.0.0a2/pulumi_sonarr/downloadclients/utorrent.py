...
class UtorrentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] older_tv_priority: Older TV priority. `0` Last, `1` First.
        :param pulumi.Input[str] password: Password.
        :param pulumi.Input[int] port: Port.
        :param pulumi.Input[int] priority: Priority.
        :param pulumi.Input[int] recent_tv_priority: Recent TV priority. `0` Last, `1` First.
...
class Utorrent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.download_clients.Utorrent("example",
            enable=True,
            host="utorrent",
            port=9091,
            priority=1,
        ...
        ```sh
         $ pulumi import sonarr:DownloadClients/utorrent:Utorrent example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Utorrent, __self__).__init__(
            'sonarr:DownloadClients/utorrent:Utorrent',
            resource_name,
            __props__,
            opts)
