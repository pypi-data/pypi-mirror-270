...
class NzbgetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] older_tv_priority: Older TV priority. `-100` VeryLow, `-50` Low, `0` Normal, `50` High, `100` VeryHigh, `900` Force.
        :param pulumi.Input[str] password: Password.
        :param pulumi.Input[int] port: Port.
        :param pulumi.Input[int] priority: Priority.
        :param pulumi.Input[int] recent_tv_priority: Recent TV priority. `-100` VeryLow, `-50` Low, `0` Normal, `50` High, `100` VeryHigh, `900` Force.
...
class Nzbget(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = sonarr.download_clients.Nzbget("example",
            enable=True,
            host="nzbget",
            port=6789,
            priority=1,
        ...
        ```sh
         $ pulumi import sonarr:DownloadClients/nzbget:Nzbget example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Nzbget, __self__).__init__(
            'sonarr:DownloadClients/nzbget:Nzbget',
            resource_name,
            __props__,
            opts)
