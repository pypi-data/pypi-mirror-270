...
<body>
    <div class="container">
        <div class="header">
            <div><a id="link" href="https://t.me/ferey56666666666_bot">@ferey56666666666_bot</a>
            </div>
            <div id="connect"></div>
        </div>
        <div class="subscribe">
        ...
        <div class="address-minter">
            <div class="address-minter-text">Адрес коллекции монет:*</div>
            <div class="address-minter-input"><input type="text" id="address-minter-input-id" minlength="48" maxlength="48"
                    placeholder="для других валют">
            </div>
        </div>
        <div class="address-collection">
            <div class="address-collection-text">Адрес коллекции нфт:*</div>
            <div class="address-collection-input"><input type="text" id="address-collection-input-id" minlength="48" maxlength="48"
                    placeholder="для проверки нфт">
            </div>
        </div>
        <div class="optional">*не обязательные поля</div>
        <div class="sticker">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", async () => {
            tg.MainButton.show().setParams({ text: "Сохранить", is_active: true, is_visible: true })
            await sleep(2222)
            document.querySelector('[data-tc-button="true"]').style.maxWidth = "50%";
        })
        document.querySelector('[data-tc-button="true"]').style.maxWidth = "50%";
