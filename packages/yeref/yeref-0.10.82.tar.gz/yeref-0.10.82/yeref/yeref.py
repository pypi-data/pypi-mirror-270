...
<body>
    <div class="container">
        ...
        <div class="address-minter">
            ...
            <div class="address-minter-input"><input type="text" id="address-minter-input-id" length="48"
                    placeholder="для других валют">
            </div>
        </div>
        <div class="address-collection">
            <div class="address-collection-text">Адрес коллекции нфт:*</div>
            <div class="address-collection-input"><input type="text" id="address-collection-input-id" length="48"
    ...
    <script>
        ...
        tg.MainButton.onClick(async () => {
            ...
            console.log(value, currency, period, addressMinter, addressCollection)
