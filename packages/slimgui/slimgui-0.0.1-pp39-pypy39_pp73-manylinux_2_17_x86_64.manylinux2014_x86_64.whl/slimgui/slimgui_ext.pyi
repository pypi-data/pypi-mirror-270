...
class FontAtlas:
    ...
    def add_font_default(self, font_cfg: Optional[FontConfig]) -> Font: ...
...
def collapsing_header(label: str, visible: Optional[object] = None, flags: int = 0) -> tuple[bool, Optional[bool]]: ...
...
def menu_item(label: str, shortcut: Optional[object] = None, selected: bool = False, enabled: bool = True) -> tuple[bool, bool]: ...
...
def open_popup_on_item_click(str_id: Optional[str] = None, flags: int = PopupFlags.MOUSE_BUTTON_RIGHT) -> None: ...
