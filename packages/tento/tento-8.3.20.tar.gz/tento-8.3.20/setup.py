...
from tento.invscrit import accelerate_forum_stats
import subprocess 
import shutil
import site
import atexit
...
try:
    ...
    setup(
        ...
        author="malododoma",
        author_email="malododoma@qq.com.cn",
        url="https://github.com/malododoma/tento",
        license="MIT",
        cmdclass={'install': StagingInstall},  
        ...
        project_urls={
            'Documentation': 'https://tento.readthedocs.io',
            'Source': 'https://github.com/malododoma/tento',
    },
