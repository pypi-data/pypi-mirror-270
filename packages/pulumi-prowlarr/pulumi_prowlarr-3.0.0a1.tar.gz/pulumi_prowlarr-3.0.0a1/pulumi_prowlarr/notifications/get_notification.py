...
class GetNotificationResult:
    ...
    """
    def __init__(__self__, access_token=None, access_token_secret=None, always_update=None, api_key=None, app_token=None, arguments=None, auth_password=None, auth_token=None, auth_user=None, auth_username=None, author=None, avatar=None, base_url=None, bccs=None, bot_token=None, ccs=None, channel=None, channel_tags=None, chat_id=None, clean_library=None, click_url=None, config_contract=None, configuration_key=None, consumer_key=None, consumer_secret=None, device_ids=None, device_names=None, devices=None, direct_message=None, display_time=None, event=None, expire=None, expires=None, field_tags=None, from_=None, grab_fields=None, host=None, icon=None, id=None, implementation=None, include_health_warnings=None, include_manual_grabs=None, instance_name=None, key=None, map_from=None, map_to=None, mention=None, method=None, name=None, notification_type=None, notify=None, on_application_update=None, on_grab=None, on_health_issue=None, on_health_restored=None, password=None, path=None, port=None, priority=None, receiver_id=None, recipients=None, refresh_token=None, retry=None, send_silently=None, sender_domain=None, sender_id=None, sender_number=None, server=None, server_url=None, sign_in=None, sound=None, stateless_urls=None, tags=None, token=None, topic_id=None, topics=None, tos=None, update_library=None, url=None, use_encryption=None, use_eu_endpoint=None, use_ssl=None, user_key=None, username=None, web_hook_url=None):
        ...
        if include_manual_grabs and not isinstance(include_manual_grabs, bool):
            raise TypeError("Expected argument 'include_manual_grabs' to be a bool")
...
def get_notification(name: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('prowlarr:Notifications/getNotification:getNotification', __args__, opts=opts, typ=GetNotificationResult).value
    ...
    return AwaitableGetNotificationResult(
        ...
        include_manual_grabs=pulumi.get(__ret__, 'include_manual_grabs'),
