...
class AppriseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] auth_password: AuthPassword.
        :param pulumi.Input[str] auth_username: AuthUsername.
        :param pulumi.Input[str] configuration_key: ConfigurationKey.
...
class Apprise(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = prowlarr.notifications.Apprise("example",
            auth_password="Pass",
            auth_username="User",
        ...
        ```sh
         $ pulumi import prowlarr:Notifications/apprise:Apprise example 1
        ```
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[AppriseArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        <!-- subcategory:Notifications -->Notification Apprise resource.
        For more information refer to [Notification](https://wiki.servarr.com/prowlarr/settings#connect) and [Apprise](https://wiki.servarr.com/prowlarr/supported#apprise).
    ...
    def _internal_init(__self__,
        ...
        super(Apprise, __self__).__init__(
            'prowlarr:Notifications/apprise:Apprise',
            resource_name,
            __props__,
            opts)
