...
class _RadarrState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None):
        """
        Input properties used for looking up and filtering Radarr resources.
        :param pulumi.Input[str] api_key: API key.
        :param pulumi.Input[str] base_url: Base URL.
        :param pulumi.Input[str] name: Application name.
        :param pulumi.Input[str] prowlarr_url: Prowlarr URL.
...
class Radarr(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example = prowlarr.applications.Radarr("example",
            api_key="APIKey",
        ...
        ```sh
         $ pulumi import prowlarr:Applications/radarr:Radarr example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Radarr, __self__).__init__(
            'prowlarr:Applications/radarr:Radarr',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            sync_categories: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
            sync_level: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None) -> 'Radarr':
        """
        Get an existing Radarr resource's state with the given name, id, and optional extra
        ...
        __props__ = _RadarrState.__new__(_RadarrState)
        ...
        __props__.__dict__["sync_level"] = sync_level
        __props__.__dict__["tags"] = tags
        return Radarr(resource_name, opts=opts, __props__=__props__)
