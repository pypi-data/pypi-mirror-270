...
class MylarArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a Mylar resource.
...
class _MylarState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None):
        """
        Input properties used for looking up and filtering Mylar resources.
        :param pulumi.Input[str] api_key: API key.
        :param pulumi.Input[str] base_url: Base URL.
        :param pulumi.Input[str] name: Application name.
        :param pulumi.Input[str] prowlarr_url: Prowlarr URL.
...
class Mylar(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example = prowlarr.applications.Mylar("example",
            api_key="APIKey",
        ...
        ```sh
         $ pulumi import prowlarr:Applications/mylar:Mylar example 1
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param MylarArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MylarArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MylarArgs.__new__(MylarArgs)
        ...
        super(Mylar, __self__).__init__(
            'prowlarr:Applications/mylar:Mylar',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            sync_categories: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
            sync_level: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None) -> 'Mylar':
        """
        Get an existing Mylar resource's state with the given name, id, and optional extra
        ...
        __props__ = _MylarState.__new__(_MylarState)
        ...
        __props__.__dict__["sync_level"] = sync_level
        __props__.__dict__["tags"] = tags
        return Mylar(resource_name, opts=opts, __props__=__props__)
