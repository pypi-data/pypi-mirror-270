...
class NzbgetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] item_priority: Recent Movie priority. `-100` VeryLow, `-50` Low, `0` Normal, `50` High, `100` VeryHigh, `900` Force.
...
class _NzbgetState:
    def __init__(__self__, *,
                 add_paused: Optional[pulumi.Input[bool]] = None,
                 categories: Optional[pulumi.Input[Sequence[pulumi.Input['NzbgetCategoryArgs']]]] = None,
                 category: Optional[pulumi.Input[str]] = None,
                 enable: Optional[pulumi.Input[bool]] = None,
                 host: Optional[pulumi.Input[str]] = None,
                 item_priority: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input[bool] add_paused: Add paused flag.
        :param pulumi.Input[Sequence[pulumi.Input['NzbgetCategoryArgs']]] categories: List of categories.
        :param pulumi.Input[str] category: Category.
        :param pulumi.Input[bool] enable: Enable flag.
        :param pulumi.Input[str] host: host.
        :param pulumi.Input[int] item_priority: Recent Movie priority. `-100` VeryLow, `-50` Low, `0` Normal, `50` High, `100` VeryHigh, `900` Force.
    ...
    @property
    @pulumi.getter
    def categories(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['NzbgetCategoryArgs']]]]:
        """
        List of categories.
        """
    ...
    @categories.setter
    def categories(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['NzbgetCategoryArgs']]]]):
...
class Nzbget(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = prowlarr.download_clients.Nzbget("example",
            enable=True,
            host="nzbget",
            port=6789,
            priority=1,
        ...
        ```sh
         $ pulumi import prowlarr:DownloadClients/nzbget:Nzbget example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Nzbget, __self__).__init__(
            'prowlarr:DownloadClients/nzbget:Nzbget',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            add_paused: Optional[pulumi.Input[bool]] = None,
            categories: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NzbgetCategoryArgs']]]]] = None,
            category: Optional[pulumi.Input[str]] = None,
            enable: Optional[pulumi.Input[bool]] = None,
            host: Optional[pulumi.Input[str]] = None,
            item_priority: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[bool] add_paused: Add paused flag.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['NzbgetCategoryArgs']]]] categories: List of categories.
        :param pulumi.Input[str] category: Category.
        :param pulumi.Input[bool] enable: Enable flag.
        :param pulumi.Input[str] host: host.
        :param pulumi.Input[int] item_priority: Recent Movie priority. `-100` VeryLow, `-50` Low, `0` Normal, `50` High, `100` VeryHigh, `900` Force.
    ...
    @property
    @pulumi.getter
    def categories(self) -> pulumi.Output[Sequence['outputs.NzbgetCategory']]:
        """
        List of categories.
        """
        return pulumi.get(self, "categories")
