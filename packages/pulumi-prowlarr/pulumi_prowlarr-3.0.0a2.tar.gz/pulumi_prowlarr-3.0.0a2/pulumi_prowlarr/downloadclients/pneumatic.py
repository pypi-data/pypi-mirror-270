...
class _PneumaticState:
    def __init__(__self__, *,
                 categories: Optional[pulumi.Input[Sequence[pulumi.Input['PneumaticCategoryArgs']]]] = None,
                 enable: Optional[pulumi.Input[bool]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PneumaticCategoryArgs']]] categories: List of categories.
        :param pulumi.Input[bool] enable: Enable flag.
        :param pulumi.Input[str] name: Name of client category.
        :param pulumi.Input[str] nzb_folder: NZB folder.
        :param pulumi.Input[int] priority: Priority.
    ...
    @property
    @pulumi.getter
    def categories(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['PneumaticCategoryArgs']]]]:
        """
        List of categories.
        """
    ...
    @categories.setter
    def categories(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['PneumaticCategoryArgs']]]]):
...
class Pneumatic(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = prowlarr.download_clients.Pneumatic("example",
            enable=True,
            nzb_folder="/nzb/",
            priority=1,
            strm_folder="/strm/")
        ...
        ```sh
         $ pulumi import prowlarr:DownloadClients/pneumatic:Pneumatic example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Pneumatic, __self__).__init__(
            'prowlarr:DownloadClients/pneumatic:Pneumatic',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            categories: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['PneumaticCategoryArgs']]]]] = None,
            enable: Optional[pulumi.Input[bool]] = None,
            name: Optional[pulumi.Input[str]] = None,
            nzb_folder: Optional[pulumi.Input[str]] = None,
            priority: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['PneumaticCategoryArgs']]]] categories: List of categories.
        :param pulumi.Input[bool] enable: Enable flag.
        :param pulumi.Input[str] name: Name of client category.
        :param pulumi.Input[str] nzb_folder: NZB folder.
        :param pulumi.Input[int] priority: Priority.
    ...
    @property
    @pulumi.getter
    def categories(self) -> pulumi.Output[Sequence['outputs.PneumaticCategory']]:
        """
        List of categories.
        """
        return pulumi.get(self, "categories")
