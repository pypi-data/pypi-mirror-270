...
class _QbittorrentState:
    def __init__(__self__, *,
                 categories: Optional[pulumi.Input[Sequence[pulumi.Input['QbittorrentCategoryArgs']]]] = None,
                 category: Optional[pulumi.Input[str]] = None,
                 enable: Optional[pulumi.Input[bool]] = None,
                 host: Optional[pulumi.Input[str]] = None,
                 initial_state: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['QbittorrentCategoryArgs']]] categories: List of categories.
        :param pulumi.Input[str] category: Category.
        :param pulumi.Input[bool] enable: Enable flag.
        :param pulumi.Input[str] host: host.
        :param pulumi.Input[int] initial_state: Initial state, with Stop support. `0` Start, `1` ForceStart, `2` Pause.
    ...
    @property
    @pulumi.getter
    def categories(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['QbittorrentCategoryArgs']]]]:
        """
        List of categories.
        """
    ...
    @categories.setter
    def categories(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['QbittorrentCategoryArgs']]]]):
...
class Qbittorrent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = prowlarr.download_clients.Qbittorrent("example",
        ...
        ```sh
         $ pulumi import prowlarr:DownloadClients/qbittorrent:Qbittorrent example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Qbittorrent, __self__).__init__(
            'prowlarr:DownloadClients/qbittorrent:Qbittorrent',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            categories: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['QbittorrentCategoryArgs']]]]] = None,
            category: Optional[pulumi.Input[str]] = None,
            enable: Optional[pulumi.Input[bool]] = None,
            host: Optional[pulumi.Input[str]] = None,
            initial_state: Optional[pulumi.Input[int]] = None,
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['QbittorrentCategoryArgs']]]] categories: List of categories.
        :param pulumi.Input[str] category: Category.
        :param pulumi.Input[bool] enable: Enable flag.
        :param pulumi.Input[str] host: host.
        :param pulumi.Input[int] initial_state: Initial state, with Stop support. `0` Start, `1` ForceStart, `2` Pause.
    ...
    @property
    @pulumi.getter
    def categories(self) -> pulumi.Output[Sequence['outputs.QbittorrentCategory']]:
        """
        List of categories.
        """
        return pulumi.get(self, "categories")
