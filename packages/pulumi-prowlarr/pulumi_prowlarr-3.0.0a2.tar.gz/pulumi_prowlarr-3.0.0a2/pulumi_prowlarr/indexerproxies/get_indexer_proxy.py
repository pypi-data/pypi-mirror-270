...
__all__ = [
    'GetIndexerProxyResult',
    'AwaitableGetIndexerProxyResult',
    'get_indexer_proxy',
    'get_indexer_proxy_output',
]

@pulumi.output_type
class GetIndexerProxyResult:
    """
...
class AwaitableGetIndexerProxyResult(GetIndexerProxyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetIndexerProxyResult(
...
def get_indexer_proxy(name: Optional[str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIndexerProxyResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('prowlarr:IndexerProxies/getIndexerProxy:getIndexerProxy', __args__, opts=opts, typ=GetIndexerProxyResult).value

    return AwaitableGetIndexerProxyResult(
...
@_utilities.lift_output_func(get_indexer_proxy)
def get_indexer_proxy_output(name: Optional[pulumi.Input[str]] = None,
                             opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetIndexerProxyResult]:
    """
    <!-- subcategory:Indexer Proxies -->Single Indexer Proxy.
