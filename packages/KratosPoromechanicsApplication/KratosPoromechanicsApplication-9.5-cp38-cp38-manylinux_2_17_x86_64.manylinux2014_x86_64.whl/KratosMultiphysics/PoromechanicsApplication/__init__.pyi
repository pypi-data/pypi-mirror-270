...
class HistoryLinearElastic3DLaw(Kratos.ConstitutiveLaw):
    def __init__(self) -> None: ...

class HistoryLinearElasticPlaneStrain2DLaw(Kratos.ConstitutiveLaw):
    def __init__(self) -> None: ...

class HistoryLinearElasticPlaneStress2DLaw(Kratos.ConstitutiveLaw):
    def __init__(self) -> None: ...
...
class InitialStress2DUtilities:
    ...
    def TransferInitialStresses(self, arg0: Kratos.ModelPart, arg1: Kratos.ModelPart) -> None: ...
