...
def get_root_folders(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRootFoldersResult:
    ...
    example = whisparr.MediaManagement.get_root_folders()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('whisparr:MediaManagement/getRootFolders:getRootFolders', __args__, opts=opts, typ=GetRootFoldersResult).value
