...
def get_movie(tmdb_id: Optional[int] = None,
    ...
    example = whisparr.Movies.get_movie(tmdb_id=123)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('whisparr:Movies/getMovie:getMovie', __args__, opts=opts, typ=GetMovieResult).value
