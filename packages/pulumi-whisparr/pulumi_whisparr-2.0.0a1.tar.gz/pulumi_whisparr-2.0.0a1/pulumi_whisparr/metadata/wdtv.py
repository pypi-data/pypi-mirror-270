...
class Wdtv(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = whisparr.metadata.Wdtv("example",
            enable=True,
            movie_images=True,
            movie_metadata=True)
        ```
        ...
        ```sh
         $ pulumi import whisparr:Metadata/wdtv:Wdtv example 1
        ```
    ...
    def get(resource_name: str,
            ...
            movie_metadata: Optional[pulumi.Input[bool]] = None,
            name: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None) -> 'Wdtv':
        """
