...
def get_consumers(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConsumersResult:
    ...
    example = whisparr.Metadata.get_consumers()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('whisparr:Metadata/getConsumers:getConsumers', __args__, opts=opts, typ=GetConsumersResult).value
