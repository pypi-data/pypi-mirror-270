...
def get_languages(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLanguagesResult:
    ...
    example = whisparr.Languages.get_languages()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('whisparr:Languages/getLanguages:getLanguages', __args__, opts=opts, typ=GetLanguagesResult).value
