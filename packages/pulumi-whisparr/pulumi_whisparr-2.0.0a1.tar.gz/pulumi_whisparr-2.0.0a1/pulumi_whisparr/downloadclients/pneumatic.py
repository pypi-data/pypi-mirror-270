...
class Pneumatic(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = whisparr.download_clients.Pneumatic("example",
            enable=True,
            nzb_folder="/nzb/",
            priority=1,
            strm_folder="/strm/")
        ...
        ```sh
         $ pulumi import whisparr:DownloadClients/pneumatic:Pneumatic example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Pneumatic, __self__).__init__(
            'whisparr:DownloadClients/pneumatic:Pneumatic',
            resource_name,
            __props__,
            opts)
