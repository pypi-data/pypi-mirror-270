...
class UsenetBlackhole(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = whisparr.download_clients.UsenetBlackhole("example",
            enable=True,
            nzb_folder="/nzb/",
            priority=1,
            watch_folder="/watch/")
        ...
        ```sh
         $ pulumi import whisparr:DownloadClients/usenetBlackhole:UsenetBlackhole example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(UsenetBlackhole, __self__).__init__(
            'whisparr:DownloadClients/usenetBlackhole:UsenetBlackhole',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            remove_failed_downloads: Optional[pulumi.Input[bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
            watch_folder: Optional[pulumi.Input[str]] = None) -> 'UsenetBlackhole':
        """
