...
class SabnzbdArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] older_movie_priority: Older Movie priority. `-100` Default, `-2` Paused, `-1` Low, `0` Normal, `1` High, `2` Force.
        :param pulumi.Input[str] password: Password.
        :param pulumi.Input[int] port: Port.
        :param pulumi.Input[int] priority: Priority.
        :param pulumi.Input[int] recent_movie_priority: Recent Movie priority. `-100` Default, `-2` Paused, `-1` Low, `0` Normal, `1` High, `2` Force.
...
class Sabnzbd(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = whisparr.download_clients.Sabnzbd("example",
            api_key="test",
            enable=True,
            host="sabnzbd",
            port=9091,
        ...
        ```sh
         $ pulumi import whisparr:DownloadClients/sabnzbd:Sabnzbd example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Sabnzbd, __self__).__init__(
            'whisparr:DownloadClients/sabnzbd:Sabnzbd',
            resource_name,
            __props__,
            opts)
