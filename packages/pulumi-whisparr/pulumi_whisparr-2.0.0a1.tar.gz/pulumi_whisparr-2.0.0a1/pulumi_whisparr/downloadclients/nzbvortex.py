...
class NzbvortexArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] older_movie_priority: Older Movie priority. `-1` Low, `0` Normal, `1` High.
        :param pulumi.Input[int] port: Port.
        :param pulumi.Input[int] priority: Priority.
        :param pulumi.Input[int] recent_movie_priority: Recent Movie priority. `-1` Low, `0` Normal, `1` High.
...
class Nzbvortex(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = whisparr.download_clients.Nzbvortex("example",
            enable=True,
            host="nzbvortex",
            port=6789,
            priority=1,
        ...
        ```sh
         $ pulumi import whisparr:DownloadClients/nzbvortex:Nzbvortex example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Nzbvortex, __self__).__init__(
            'whisparr:DownloadClients/nzbvortex:Nzbvortex',
            resource_name,
            __props__,
            opts)
