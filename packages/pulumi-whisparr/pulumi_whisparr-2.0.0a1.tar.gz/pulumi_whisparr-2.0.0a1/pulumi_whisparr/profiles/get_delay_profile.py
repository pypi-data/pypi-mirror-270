...
class GetDelayProfileResult:
    ...
    """
    def __init__(__self__, bypass_if_highest_quality=None, enable_torrent=None, enable_usenet=None, id=None, order=None, preferred_protocol=None, tags=None, torrent_delay=None, usenet_delay=None):
...
def get_delay_profile(id: Optional[int] = None,
    ...
    example = whisparr.Profiles.get_delay_profile(id=1)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('whisparr:Profiles/getDelayProfile:getDelayProfile', __args__, opts=opts, typ=GetDelayProfileResult).value
