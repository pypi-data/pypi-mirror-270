...
def get_condition(implementation: Optional[str] = None,
    ...
    example_condition = whisparr.Profiles.get_condition(name="Example",
    ...
    __ret__ = pulumi.runtime.invoke('whisparr:Profiles/getCondition:getCondition', __args__, opts=opts, typ=GetConditionResult).value
