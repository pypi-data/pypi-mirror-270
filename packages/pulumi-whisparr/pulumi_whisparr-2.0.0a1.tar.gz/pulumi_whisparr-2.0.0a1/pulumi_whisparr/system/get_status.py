...
def get_status(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetStatusResult:
    ...
    example = whisparr.System.get_status()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('whisparr:System/getStatus:getStatus', __args__, opts=opts, typ=GetStatusResult).value
