...
class BoxcarArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a Boxcar resource.
...
class _BoxcarState:
    def __init__(__self__, *,
        ...
        """
        Input properties used for looking up and filtering Boxcar resources.
        :param pulumi.Input[bool] include_health_warnings: Include health warnings.
        :param pulumi.Input[str] name: NotificationBoxcar name.
        :param pulumi.Input[bool] on_application_update: On application update flag.
        :param pulumi.Input[bool] on_download: On download flag.
...
class Boxcar(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example = whisparr.notifications.Boxcar("example",
        ...
        ```sh
         $ pulumi import whisparr:Notifications/boxcar:Boxcar example 1
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param BoxcarArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BoxcarArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BoxcarArgs.__new__(BoxcarArgs)
        ...
        super(Boxcar, __self__).__init__(
            'whisparr:Notifications/boxcar:Boxcar',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            on_upgrade: Optional[pulumi.Input[bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
            token: Optional[pulumi.Input[str]] = None) -> 'Boxcar':
        """
        Get an existing Boxcar resource's state with the given name, id, and optional extra
        ...
        __props__ = _BoxcarState.__new__(_BoxcarState)
        ...
        return Boxcar(resource_name, opts=opts, __props__=__props__)
