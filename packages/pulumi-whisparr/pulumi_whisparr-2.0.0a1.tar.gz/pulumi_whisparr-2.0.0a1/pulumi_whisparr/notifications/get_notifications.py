...
def get_notifications(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetNotificationsResult:
    ...
    example = whisparr.Notifications.get_notifications()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('whisparr:Notifications/getNotifications:getNotifications', __args__, opts=opts, typ=GetNotificationsResult).value
