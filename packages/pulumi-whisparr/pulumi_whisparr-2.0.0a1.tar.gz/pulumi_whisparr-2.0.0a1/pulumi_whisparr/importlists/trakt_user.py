...
class TraktUser(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = whisparr.import_lists.TraktUser("example",
            access_token="Token",
            auth_user="User1",
            enable_auto=False,
            enabled=True,
        ...
        ```sh
         $ pulumi import whisparr:ImportLists/traktUser:TraktUser example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(TraktUser, __self__).__init__(
            'whisparr:ImportLists/traktUser:TraktUser',
            resource_name,
            __props__,
            opts)
