...
class Stevenlu2(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = whisparr.import_lists.Stevenlu2("example",
            enable_auto=False,
            enabled=True,
            min_score=5,
        ...
        ```sh
         $ pulumi import whisparr:ImportLists/stevenlu2:Stevenlu2 example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Stevenlu2, __self__).__init__(
            'whisparr:ImportLists/stevenlu2:Stevenlu2',
            resource_name,
            __props__,
            opts)
