...
class TmdbUserArgs:
    def __init__(__self__, *,
                 ...
                 user_list_type: pulumi.Input[int],
        ...
        """
        The set of arguments for constructing a TmdbUser resource.
        :param pulumi.Input[str] access_token: Access token.
        :param pulumi.Input[str] account_id: User ID.
        ...
        :param pulumi.Input[int] user_list_type: TMDB list type. `1` Watchlist, `2` Recommendations, `3` Rated, `4` Favorite.
    ...
    def user_list_type(self) -> pulumi.Input[int]:
        """
    ...
    def user_list_type(self, value: pulumi.Input[int]):
...
class _TmdbUserState:
    def __init__(__self__, *,
        ...
        """
        Input properties used for looking up and filtering TmdbUser resources.
        :param pulumi.Input[str] access_token: Access token.
        :param pulumi.Input[str] account_id: User ID.
        :param pulumi.Input[bool] enable_auto: Enable automatic add flag.
        :param pulumi.Input[bool] enabled: Enabled flag.
...
class TmdbUser(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        ```sh
         $ pulumi import whisparr:ImportLists/tmdbUser:TmdbUser example 1
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param TmdbUserArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TmdbUserArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TmdbUserArgs.__new__(TmdbUserArgs)
            ...
            if user_list_type is None and not opts.urn:
                raise TypeError("Missing required property 'user_list_type'")
        ...
        super(TmdbUser, __self__).__init__(
            'whisparr:ImportLists/tmdbUser:TmdbUser',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            should_monitor: Optional[pulumi.Input[bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
            user_list_type: Optional[pulumi.Input[int]] = None) -> 'TmdbUser':
        """
        Get an existing TmdbUser resource's state with the given name, id, and optional extra
        ...
        __props__ = _TmdbUserState.__new__(_TmdbUserState)
        ...
        __props__.__dict__["tags"] = tags
        __props__.__dict__["user_list_type"] = user_list_type
        return TmdbUser(resource_name, opts=opts, __props__=__props__)
