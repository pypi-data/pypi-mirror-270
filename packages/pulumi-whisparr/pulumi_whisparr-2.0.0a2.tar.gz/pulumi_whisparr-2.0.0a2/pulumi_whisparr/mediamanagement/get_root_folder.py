...
def get_root_folder(path: Optional[str] = None,
    ...
    example = whisparr.MediaManagement.get_root_folder(path="/example")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('whisparr:MediaManagement/getRootFolder:getRootFolder', __args__, opts=opts, typ=GetRootFolderResult).value
