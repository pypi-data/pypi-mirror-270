...
class Emby(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = whisparr.metadata.Emby("example",
            enable=True,
            movie_metadata=True)
        ```
        ...
        ```sh
         $ pulumi import whisparr:Metadata/emby:Emby example 1
        ```
    ...
    def get(resource_name: str,
            ...
            movie_metadata: Optional[pulumi.Input[bool]] = None,
            name: Optional[pulumi.Input[str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None) -> 'Emby':
        """
