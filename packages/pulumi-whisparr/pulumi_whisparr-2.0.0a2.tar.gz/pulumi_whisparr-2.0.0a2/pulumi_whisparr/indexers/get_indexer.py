...
def get_indexer(name: Optional[str] = None,
    ...
    example = whisparr.Indexers.get_indexer(name="Example")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('whisparr:Indexers/getIndexer:getIndexer', __args__, opts=opts, typ=GetIndexerResult).value
