...
def get_indexers(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetIndexersResult:
    ...
    example = whisparr.Indexers.get_indexers()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('whisparr:Indexers/getIndexers:getIndexers', __args__, opts=opts, typ=GetIndexersResult).value
