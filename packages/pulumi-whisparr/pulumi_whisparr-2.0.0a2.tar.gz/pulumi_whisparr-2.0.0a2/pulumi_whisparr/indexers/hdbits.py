...
class HdbitsArgs:
    def __init__(__self__, *,
                 ...
                 codecs: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
                 ...
                 mediums: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
        ...
        """
        The set of arguments for constructing a Hdbits resource.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[int]]] codecs: Codecs.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[int]]] mediums: Mediumd.
        ...
        :param pulumi.Input[str] name: IndexerHdbits name.
    ...
    @property
    @pulumi.getter
    def codecs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[int]]]]:
        """
        Codecs.
        """
    ...
    @codecs.setter
    def codecs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]]):
    ...
    @property
    @pulumi.getter
    def mediums(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[int]]]]:
        """
        Mediumd.
        """
    ...
    @mediums.setter
    def mediums(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]]):
        pulumi.set(self, "mediums", value)
...
class _HdbitsState:
    def __init__(__self__, *,
        ...
        """
        Input properties used for looking up and filtering Hdbits resources.
        :param pulumi.Input[str] api_key: API key.
        :param pulumi.Input[str] base_url: Base URL.
        :param pulumi.Input[Sequence[pulumi.Input[int]]] categories: Categories list.
        :param pulumi.Input[Sequence[pulumi.Input[int]]] codecs: Codecs.
...
class Hdbits(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example = whisparr.indexers.Hdbits("example",
            api_key="APIKey",
        ...
        ```sh
         $ pulumi import whisparr:Indexers/hdbits:Hdbits example 1
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param HdbitsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(HdbitsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = HdbitsArgs.__new__(HdbitsArgs)
            ...
            __props__.__dict__["mediums"] = mediums
        ...
        super(Hdbits, __self__).__init__(
            'whisparr:Indexers/hdbits:Hdbits',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            seed_time: Optional[pulumi.Input[int]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
            username: Optional[pulumi.Input[str]] = None) -> 'Hdbits':
        """
        Get an existing Hdbits resource's state with the given name, id, and optional extra
        ...
        __props__ = _HdbitsState.__new__(_HdbitsState)
        ...
        __props__.__dict__["tags"] = tags
        __props__.__dict__["username"] = username
        return Hdbits(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter
    def codecs(self) -> pulumi.Output[Sequence[int]]:
        """
        Codecs.
        """
        return pulumi.get(self, "codecs")
    ...
    @property
    @pulumi.getter
    def mediums(self) -> pulumi.Output[Sequence[int]]:
        """
        Mediumd.
        """
        return pulumi.get(self, "mediums")
