...
def get_custom_format(name: Optional[str] = None,
    ...
    example = whisparr.Profiles.get_custom_format(name="Example")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('whisparr:Profiles/getCustomFormat:getCustomFormat', __args__, opts=opts, typ=GetCustomFormatResult).value
