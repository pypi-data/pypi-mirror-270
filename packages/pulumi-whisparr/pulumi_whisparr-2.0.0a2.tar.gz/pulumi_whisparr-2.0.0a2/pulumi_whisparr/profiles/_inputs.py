...
@pulumi.input_type
class QualityProfileLanguageArgs:
    def __init__(__self__, *,
                 id: pulumi.Input[int],
                 name: Optional[pulumi.Input[str]] = None):
        """
...
class QualityProfileQualityGroupArgs:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input['QualityProfileQualityGroupQualityArgs']]] qualities: Qualities in group.
...
class QualityProfileQualityGroupQualityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] id: ID.
        :param pulumi.Input[str] name: Name.
        :param pulumi.Input[int] resolution: Resolution.
