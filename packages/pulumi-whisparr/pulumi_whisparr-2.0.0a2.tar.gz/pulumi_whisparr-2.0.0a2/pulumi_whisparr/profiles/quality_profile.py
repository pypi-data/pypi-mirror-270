...
class QualityProfileArgs:
    def __init__(__self__, *,
                 language: pulumi.Input['QualityProfileLanguageArgs'],
        ...
        :param pulumi.Input['QualityProfileLanguageArgs'] language: Language.
        :param pulumi.Input[Sequence[pulumi.Input['QualityProfileQualityGroupArgs']]] quality_groups: Quality groups.
        :param pulumi.Input[int] cutoff: Quality ID to which cutoff.
        :param pulumi.Input[int] cutoff_format_score: Cutoff format score.
        :param pulumi.Input[Sequence[pulumi.Input['QualityProfileFormatItemArgs']]] format_items: Format items.
    ...
    @property
    @pulumi.getter
    def language(self) -> pulumi.Input['QualityProfileLanguageArgs']:
        """
        Language.
        """
    ...
    @language.setter
    def language(self, value: pulumi.Input['QualityProfileLanguageArgs']):
...
class _QualityProfileState:
    def __init__(__self__, *,
                 ...
                 cutoff_format_score: Optional[pulumi.Input[int]] = None,
                 format_items: Optional[pulumi.Input[Sequence[pulumi.Input['QualityProfileFormatItemArgs']]]] = None,
                 language: Optional[pulumi.Input['QualityProfileLanguageArgs']] = None,
                 min_format_score: Optional[pulumi.Input[int]] = None,
                 name: Optional[pulumi.Input[str]] = None,
    ...
    @property
    @pulumi.getter
    def language(self) -> Optional[pulumi.Input['QualityProfileLanguageArgs']]:
        """
        Language.
        """
        return pulumi.get(self, "language")
    ...
    @language.setter
    def language(self, value: Optional[pulumi.Input['QualityProfileLanguageArgs']]):
        pulumi.set(self, "language", value)
...
class QualityProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 language: Optional[pulumi.Input[pulumi.InputType['QualityProfileLanguageArgs']]] = None,
                 min_format_score: Optional[pulumi.Input[int]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        example = whisparr.profiles.QualityProfile("example",
            cutoff=1100,
            language=whisparr.profiles.QualityProfileLanguageArgs(
                id=1,
                name="English",
            ),
            quality_groups=[whisparr.profiles.QualityProfileQualityGroupArgs(
                id=1100,
                name="4k",
                qualities=[
                    whisparr.profiles.QualityProfileQualityGroupQualityArgs(
                        id=18,
                        name="WEBDL-2160p",
                        resolution=2160,
                        source="web",
        ...
        :param pulumi.Input[int] cutoff: Quality ID to which cutoff.
        :param pulumi.Input[int] cutoff_format_score: Cutoff format score.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['QualityProfileFormatItemArgs']]]] format_items: Format items.
        :param pulumi.Input[pulumi.InputType['QualityProfileLanguageArgs']] language: Language.
        :param pulumi.Input[int] min_format_score: Min format score.
        :param pulumi.Input[str] name: Name.
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['QualityProfileQualityGroupArgs']]]] quality_groups: Quality groups.
        :param pulumi.Input[bool] upgrade_allowed: Upgrade allowed flag.
        """
        ...
    @overload
    ...
    def _internal_init(__self__,
        ...
        super(QualityProfile, __self__).__init__(
            'whisparr:Profiles/qualityProfile:QualityProfile',
            resource_name,
            __props__,
            opts)
    ...
    @property
    @pulumi.getter
    def language(self) -> pulumi.Output['outputs.QualityProfileLanguage']:
        """
        Language.
        """
        return pulumi.get(self, "language")
