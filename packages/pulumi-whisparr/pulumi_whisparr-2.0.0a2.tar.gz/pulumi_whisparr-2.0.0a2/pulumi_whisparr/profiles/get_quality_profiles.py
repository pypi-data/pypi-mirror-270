...
def get_quality_profiles(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetQualityProfilesResult:
    ...
    example = whisparr.Profiles.get_quality_profiles()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('whisparr:Profiles/getQualityProfiles:getQualityProfiles', __args__, opts=opts, typ=GetQualityProfilesResult).value
