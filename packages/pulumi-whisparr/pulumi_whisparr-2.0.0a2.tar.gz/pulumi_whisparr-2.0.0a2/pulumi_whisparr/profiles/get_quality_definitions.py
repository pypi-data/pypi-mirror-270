...
def get_quality_definitions(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetQualityDefinitionsResult:
    ...
    example = whisparr.Profiles.get_quality_definitions()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('whisparr:Profiles/getQualityDefinitions:getQualityDefinitions', __args__, opts=opts, typ=GetQualityDefinitionsResult).value
