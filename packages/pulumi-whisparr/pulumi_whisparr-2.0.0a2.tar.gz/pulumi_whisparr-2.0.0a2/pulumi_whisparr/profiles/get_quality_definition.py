...
def get_quality_definition(id: Optional[int] = None,
    ...
    example = whisparr.Profiles.get_quality_definition(id=21)
    ```
    ...
    __ret__ = pulumi.runtime.invoke('whisparr:Profiles/getQualityDefinition:getQualityDefinition', __args__, opts=opts, typ=GetQualityDefinitionResult).value
