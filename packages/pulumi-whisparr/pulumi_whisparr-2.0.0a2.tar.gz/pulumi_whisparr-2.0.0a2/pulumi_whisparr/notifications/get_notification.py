...
class GetNotificationResult:
    ...
    """
    def __init__(__self__, access_token=None, access_token_secret=None, always_update=None, api_key=None, app_token=None, arguments=None, auth_token=None, auth_user=None, author=None, avatar=None, bccs=None, bot_token=None, ccs=None, channel=None, channel_tags=None, chat_id=None, clean_library=None, click_url=None, config_contract=None, consumer_key=None, consumer_secret=None, device_ids=None, device_names=None, devices=None, direct_message=None, display_time=None, event=None, expire=None, expires=None, field_tags=None, from_=None, grab_fields=None, host=None, icon=None, id=None, implementation=None, import_fields=None, include_health_warnings=None, instance_name=None, key=None, map_from=None, map_to=None, mention=None, method=None, name=None, notify=None, on_application_update=None, on_download=None, on_grab=None, on_health_issue=None, on_movie_delete=None, on_movie_file_delete=None, on_movie_file_delete_for_upgrade=None, on_rename=None, on_upgrade=None, password=None, path=None, port=None, priority=None, recipients=None, refresh_token=None, require_encryption=None, retry=None, send_silently=None, sender_domain=None, sender_id=None, server=None, server_url=None, sign_in=None, sound=None, tags=None, token=None, topics=None, tos=None, update_library=None, url=None, use_eu_endpoint=None, use_ssl=None, user_key=None, username=None, web_hook_url=None):
...
def get_notification(name: Optional[str] = None,
    ...
    example = whisparr.Notifications.get_notification(name="Example")
    ```
    ...
    __ret__ = pulumi.runtime.invoke('whisparr:Notifications/getNotification:getNotification', __args__, opts=opts, typ=GetNotificationResult).value
