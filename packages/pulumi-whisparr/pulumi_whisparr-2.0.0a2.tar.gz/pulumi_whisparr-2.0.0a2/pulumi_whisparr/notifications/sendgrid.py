...
class Sendgrid(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = whisparr.notifications.Sendgrid("example",
            api_key="APIkey",
        ...
        ```sh
         $ pulumi import whisparr:Notifications/sendgrid:Sendgrid example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Sendgrid, __self__).__init__(
            'whisparr:Notifications/sendgrid:Sendgrid',
            resource_name,
            __props__,
            opts)
