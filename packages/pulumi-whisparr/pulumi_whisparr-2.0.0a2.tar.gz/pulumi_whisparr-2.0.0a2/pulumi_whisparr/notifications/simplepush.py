...
__all__ = ['SimplepushArgs', 'Simplepush']

@pulumi.input_type
class SimplepushArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a Simplepush resource.
        ...
        :param pulumi.Input[str] name: NotificationSimplepush name.
...
class _SimplepushState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None):
        """
        Input properties used for looking up and filtering Simplepush resources.
        :param pulumi.Input[str] event: Event.
        :param pulumi.Input[bool] include_health_warnings: Include health warnings.
        :param pulumi.Input[str] key: Key.
        :param pulumi.Input[str] name: NotificationSimplepush name.
...
class Simplepush(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example = whisparr.notifications.Simplepush("example",
        ...
        ```sh
         $ pulumi import whisparr:Notifications/simplepush:Simplepush example 1
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param SimplepushArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SimplepushArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SimplepushArgs.__new__(SimplepushArgs)
        ...
        super(Simplepush, __self__).__init__(
            'whisparr:Notifications/simplepush:Simplepush',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            on_movie_file_delete_for_upgrade: Optional[pulumi.Input[bool]] = None,
            on_upgrade: Optional[pulumi.Input[bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None) -> 'Simplepush':
        """
        Get an existing Simplepush resource's state with the given name, id, and optional extra
        ...
        __props__ = _SimplepushState.__new__(_SimplepushState)
        ...
        __props__.__dict__["on_upgrade"] = on_upgrade
        __props__.__dict__["tags"] = tags
        return Simplepush(resource_name, opts=opts, __props__=__props__)
