...
class DownloadClient(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = whisparr.download_clients.DownloadClient("example",
    ...
    def _internal_init(__self__,
        ...
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["appToken", "password"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(DownloadClient, __self__).__init__(
            'whisparr:DownloadClients/downloadClient:DownloadClient',
            resource_name,
            __props__,
            opts)
