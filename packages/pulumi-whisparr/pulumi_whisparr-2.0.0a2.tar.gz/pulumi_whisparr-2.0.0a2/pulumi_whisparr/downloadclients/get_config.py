...
def get_config(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConfigResult:
    ...
    example = whisparr.DownloadClients.get_config()
    ```
    """
    __args__ = dict()
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('whisparr:DownloadClients/getConfig:getConfig', __args__, opts=opts, typ=GetConfigResult).value
