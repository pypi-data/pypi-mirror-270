...
class RtorrentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] older_movie_priority: Older Movie priority. `0` VeryLow, `1` Low, `2` Normal, `3` High.
        :param pulumi.Input[str] password: Password.
        :param pulumi.Input[int] port: Port.
        :param pulumi.Input[int] priority: Priority.
        :param pulumi.Input[int] recent_movie_priority: Recent Movie priority. `0` VeryLow, `1` Low, `2` Normal, `3` High.
...
class Rtorrent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = whisparr.download_clients.Rtorrent("example",
            enable=True,
            host="rtorrent",
            port=9091,
            priority=1,
        ...
        ```sh
         $ pulumi import whisparr:DownloadClients/rtorrent:Rtorrent example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Rtorrent, __self__).__init__(
            'whisparr:DownloadClients/rtorrent:Rtorrent',
            resource_name,
            __props__,
            opts)
