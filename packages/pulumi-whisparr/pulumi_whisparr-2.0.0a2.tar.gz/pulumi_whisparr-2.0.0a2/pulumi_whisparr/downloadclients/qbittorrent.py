...
class Qbittorrent(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = whisparr.download_clients.Qbittorrent("example",
            enable=True,
            first_and_last=True,
            host="qbittorrent",
        ...
        ```sh
         $ pulumi import whisparr:DownloadClients/qbittorrent:Qbittorrent example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Qbittorrent, __self__).__init__(
            'whisparr:DownloadClients/qbittorrent:Qbittorrent',
            resource_name,
            __props__,
            opts)
