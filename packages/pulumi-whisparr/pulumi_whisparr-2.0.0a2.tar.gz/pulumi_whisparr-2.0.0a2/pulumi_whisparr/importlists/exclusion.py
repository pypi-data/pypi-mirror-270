...
class Exclusion(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = whisparr.import_lists.Exclusion("example",
            title="Gladiator",
            tmdb_id=172495,
            year=2000)
        ```
        ...
        ```sh
         $ pulumi import whisparr:ImportLists/exclusion:Exclusion example 10
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Exclusion, __self__).__init__(
            'whisparr:ImportLists/exclusion:Exclusion',
            resource_name,
            __props__,
            opts)
