...
class TmdbListArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a TmdbList resource.
...
class _TmdbListState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None):
        """
        Input properties used for looking up and filtering TmdbList resources.
        :param pulumi.Input[bool] enable_auto: Enable automatic add flag.
        :param pulumi.Input[bool] enabled: Enabled flag.
        :param pulumi.Input[str] list_id: List ID.
        :param pulumi.Input[int] list_order: List order.
...
class TmdbList(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example = whisparr.import_lists.TmdbList("example",
            enable_auto=False,
            enabled=True,
            list_id="11842",
        ...
        ```sh
         $ pulumi import whisparr:ImportLists/tmdbList:TmdbList example 1
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param TmdbListArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TmdbListArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TmdbListArgs.__new__(TmdbListArgs)
        ...
        super(TmdbList, __self__).__init__(
            'whisparr:ImportLists/tmdbList:TmdbList',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            search_on_add: Optional[pulumi.Input[bool]] = None,
            should_monitor: Optional[pulumi.Input[bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None) -> 'TmdbList':
        """
        Get an existing TmdbList resource's state with the given name, id, and optional extra
        ...
        __props__ = _TmdbListState.__new__(_TmdbListState)
        ...
        __props__.__dict__["should_monitor"] = should_monitor
        __props__.__dict__["tags"] = tags
        return TmdbList(resource_name, opts=opts, __props__=__props__)
