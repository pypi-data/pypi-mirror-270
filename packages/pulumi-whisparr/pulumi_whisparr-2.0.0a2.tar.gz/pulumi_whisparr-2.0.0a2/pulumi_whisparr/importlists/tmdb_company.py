...
__all__ = ['TmdbCompanyArgs', 'TmdbCompany']

@pulumi.input_type
class TmdbCompanyArgs:
    def __init__(__self__, *,
        ...
        """
        The set of arguments for constructing a TmdbCompany resource.
...
class _TmdbCompanyState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None):
        """
        Input properties used for looking up and filtering TmdbCompany resources.
        :param pulumi.Input[str] company_id: Company ID.
        :param pulumi.Input[bool] enable_auto: Enable automatic add flag.
        :param pulumi.Input[bool] enabled: Enabled flag.
        :param pulumi.Input[int] list_order: List order.
...
class TmdbCompany(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example = whisparr.import_lists.TmdbCompany("example",
            company_id="11842",
            enable_auto=False,
            enabled=True,
        ...
        ```sh
         $ pulumi import whisparr:ImportLists/tmdbCompany:TmdbCompany example 1
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param TmdbCompanyArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TmdbCompanyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TmdbCompanyArgs.__new__(TmdbCompanyArgs)
        ...
        super(TmdbCompany, __self__).__init__(
            'whisparr:ImportLists/tmdbCompany:TmdbCompany',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            search_on_add: Optional[pulumi.Input[bool]] = None,
            should_monitor: Optional[pulumi.Input[bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None) -> 'TmdbCompany':
        """
        Get an existing TmdbCompany resource's state with the given name, id, and optional extra
        ...
        __props__ = _TmdbCompanyState.__new__(_TmdbCompanyState)
        ...
        __props__.__dict__["should_monitor"] = should_monitor
        __props__.__dict__["tags"] = tags
        return TmdbCompany(resource_name, opts=opts, __props__=__props__)
