...
__all__ = ['TmdbPersonArgs', 'TmdbPerson']

@pulumi.input_type
class TmdbPersonArgs:
    def __init__(__self__, *,
                 minimum_availability: pulumi.Input[str],
                 person_id: pulumi.Input[str],
        ...
        """
        The set of arguments for constructing a TmdbPerson resource.
    ...
    def person_id(self) -> pulumi.Input[str]:
        """
        Person ID.
        """
    ...
    @person_id.setter
    def person_id(self, value: pulumi.Input[str]):
...
class _TmdbPersonState:
    def __init__(__self__, *,
                 ...
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None):
        """
        Input properties used for looking up and filtering TmdbPerson resources.
        :param pulumi.Input[bool] cast: Include cast.
        :param pulumi.Input[bool] cast_director: Include cast director.
        :param pulumi.Input[bool] cast_producer: Include cast producer.
        :param pulumi.Input[bool] cast_sound: Include cast sound.
...
class TmdbPerson(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
        ...
        example = whisparr.import_lists.TmdbPerson("example",
            cast=True,
            cast_director=True,
            cast_producer=True,
            cast_sound=True,
        ...
        ```sh
         $ pulumi import whisparr:ImportLists/tmdbPerson:TmdbPerson example 1
        ```
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param TmdbPersonArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(TmdbPersonArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = TmdbPersonArgs.__new__(TmdbPersonArgs)
            ...
            if person_id is None and not opts.urn:
                raise TypeError("Missing required property 'person_id'")
        ...
        super(TmdbPerson, __self__).__init__(
            'whisparr:ImportLists/tmdbPerson:TmdbPerson',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            search_on_add: Optional[pulumi.Input[bool]] = None,
            should_monitor: Optional[pulumi.Input[bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None) -> 'TmdbPerson':
        """
        Get an existing TmdbPerson resource's state with the given name, id, and optional extra
        ...
        __props__ = _TmdbPersonState.__new__(_TmdbPersonState)
        ...
        __props__.__dict__["should_monitor"] = should_monitor
        __props__.__dict__["tags"] = tags
        return TmdbPerson(resource_name, opts=opts, __props__=__props__)
