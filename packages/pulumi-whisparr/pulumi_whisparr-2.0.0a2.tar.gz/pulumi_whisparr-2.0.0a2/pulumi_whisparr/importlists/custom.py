...
class Custom(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = whisparr.import_lists.Custom("example",
            enable_auto=False,
            enabled=True,
        ...
        ```sh
         $ pulumi import whisparr:ImportLists/custom:Custom example 1
        ```
    ...
    def _internal_init(__self__,
        ...
        super(Custom, __self__).__init__(
            'whisparr:ImportLists/custom:Custom',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            should_monitor: Optional[pulumi.Input[bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[int]]]] = None,
            url: Optional[pulumi.Input[str]] = None) -> 'Custom':
        """
