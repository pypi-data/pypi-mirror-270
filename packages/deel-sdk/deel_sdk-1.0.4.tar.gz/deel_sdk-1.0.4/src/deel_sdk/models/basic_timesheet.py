...
class BasicTimesheet(BaseModel):
    ...
    :type worksheet: BasicTimesheetWorksheet
    :param reviewed_by: reviewed_by
    :type reviewed_by: BasicTimesheetReviewedBy
    :param contract: contract
    :type contract: BasicTimesheetContract
    :param payment_cycle: payment_cycle, defaults to None
    :type payment_cycle: BasicTimesheetPaymentCycle, optional
    :param reported_by: reported_by
    :type reported_by: BasicTimesheetReportedBy
    """
    ...
    def __init__(
        ...
        payment_cycle: BasicTimesheetPaymentCycle = None,
    ):
        self.id_ = IdentifierValueGuard.return_one_of(id_)
        self.type_ = type_
        ...
        self.worksheet = self._define_object(worksheet, BasicTimesheetWorksheet)
        self.reviewed_by = self._define_object(reviewed_by, BasicTimesheetReviewedBy)
        self.contract = self._define_object(contract, BasicTimesheetContract)
        if payment_cycle is not None:
            self.payment_cycle = self._define_object(
                payment_cycle, BasicTimesheetPaymentCycle
            )
        self.reported_by = self._define_object(reported_by, BasicTimesheetReportedBy)
