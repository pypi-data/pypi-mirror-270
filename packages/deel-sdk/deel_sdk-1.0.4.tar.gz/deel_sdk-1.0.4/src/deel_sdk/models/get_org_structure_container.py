...
class GetOrgStructureContainerData(BaseModel):
    """GetOrgStructureContainerData
    ...
    :type roles: List[DataRoles2], optional
    ...
    def __init__(
        ...
        if roles is not None:
            self.roles = self._define_list(roles, DataRoles2)
...
class GetOrgStructureContainer(BaseModel):
    ...
    :type data: GetOrgStructureContainerData, optional
    """

    def __init__(self, data: GetOrgStructureContainerData = None):
        if data is not None:
            self.data = self._define_object(data, GetOrgStructureContainerData)
