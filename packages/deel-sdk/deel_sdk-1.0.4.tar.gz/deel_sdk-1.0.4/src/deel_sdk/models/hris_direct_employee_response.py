...
class HrisDirectEmployeeResponseJobInformationGuard(OneOfBaseModel):
    class_list = {
...
HrisDirectEmployeeResponseJobInformation = Union[
    HrisJobInformationTitleId, HrisJobInformationTitleName
]


class HrisDirectEmployeeResponseContractGuard(OneOfBaseModel):
    class_list = {
...
HrisDirectEmployeeResponseContract = Union[HrisContractPartTime, HrisContractFullTime]


@JsonMap({})
class HrisDirectEmployeeResponseVacationInfo(BaseModel):
    """HrisDirectEmployeeResponseVacationInfo
...
class HrisDirectEmployeeResponse(BaseModel):
    ...
    :type job_information: HrisDirectEmployeeResponseJobInformation
    :param compensation: compensation
    :type compensation: HrisCompensation
    :param contract: contract
    :type contract: HrisDirectEmployeeResponseContract
    :param vacation_info: vacation_info, defaults to None
    :type vacation_info: HrisDirectEmployeeResponseVacationInfo, optional
    :param id_: The Hris Direct employee ID, defaults to None
    ...
    def __init__(
        ...
        job_information: HrisDirectEmployeeResponseJobInformation,
        compensation: HrisCompensation,
        contract: HrisDirectEmployeeResponseContract,
        vacation_info: HrisDirectEmployeeResponseVacationInfo = None,
        id_: str = None,
    ):
        ...
        self.job_information = (
            HrisDirectEmployeeResponseJobInformationGuard.return_one_of(job_information)
        )
        self.compensation = self._define_object(compensation, HrisCompensation)
        self.contract = HrisDirectEmployeeResponseContractGuard.return_one_of(contract)
        if vacation_info is not None:
            self.vacation_info = self._define_object(
                vacation_info, HrisDirectEmployeeResponseVacationInfo
            )
        if id_ is not None:
            self.id_ = id_
