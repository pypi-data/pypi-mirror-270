...
@JsonMap({"id_": "id"})
class EmployeeDirectReports(BaseModel):
...
class Employee(BaseModel):
    ...
    :type direct_manager: EmployeeDirectManager, optional
    :param direct_reports: The direct reports to the employee., defaults to None
    :type direct_reports: List[EmployeeDirectReports], optional
    ...
    :type department: EmployeeDepartment, optional
    ...
    def __init__(
        ...
        direct_manager: EmployeeDirectManager = None,
        direct_reports: List[EmployeeDirectReports] = None,
        ...
        if direct_manager is not None:
            self.direct_manager = self._define_object(
                direct_manager, EmployeeDirectManager
            )
        if direct_reports is not None:
            self.direct_reports = self._define_list(
        ...
        if department is not None:
            self.department = self._define_object(department, EmployeeDepartment)
